...
if ($acao == "mostrar" AND $ajax == "sim") {
	...
	if(@pg_numrows($res1)>0){
		...
		$resultado .= "<div id='explodir_os' $bloqueio ><input type='button' name='btn_acao' id='btn_acao' value='Finalizar Recebimento' onclick=\"window.location='rg_recebimento_teste.php?explodir=$produto_rg'\"></div>";
		...
		for($i=0;$i<@pg_numrows($res);$i++) {
			...
			$resultado .= "</td>\n";
			$resultado .= "<td><a href='rg_recebimento_teste.php?excluir=$produto_rg_item'><img src='imagens/icone_deletar.png'></a></td>\n";
			$resultado .= "</tr>\n";
		}
		$z = $i ;
		$resultado .= "<tr>";
