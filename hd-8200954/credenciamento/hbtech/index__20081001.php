...
<tr>
	<td align='center' style='font-size: 12px'>
		<a href="index_.php?estado=AC">AC</a>&nbsp;&nbsp;
		<a href="index_.php?estado=AL">AL</a>&nbsp;&nbsp;
		<a href="index_.php?estado=AP">AP</a>&nbsp;&nbsp;
		<a href="index_.php?estado=AM">AM</a>&nbsp;&nbsp;
		<a href="index_.php?estado=BA">BA</a>&nbsp;&nbsp;
		<a href="index_.php?estado=CE">CE</a>&nbsp;&nbsp;
		<a href="index_.php?estado=DF">DF</a>&nbsp;&nbsp;
		<a href="index_.php?estado=ES">ES</a>&nbsp;&nbsp;
		<a href="index_.php?estado=GO">GO</a>&nbsp;&nbsp;
		<a href="index_.php?estado=MA">MA</a>&nbsp;&nbsp;
		<a href="index_.php?estado=MG">MG</a>&nbsp;&nbsp;
		<a href="index_.php?estado=MT">MT</a>&nbsp;&nbsp;
		<a href="index_.php?estado=MS">MS</a>&nbsp;&nbsp;
		<a href="index_.php?estado=PA">PA</a>&nbsp;&nbsp;
		<a href="index_.php?estado=PB">PB</a>&nbsp;&nbsp;
		<a href="index_.php?estado=PR">PR</a>&nbsp;&nbsp;
		<a href="index_.php?estado=PE">PE</a>&nbsp;&nbsp;
		<a href="index_.php?estado=PI">PI</a>&nbsp;&nbsp;
		<a href="index_.php?estado=RJ">RJ</a>&nbsp;&nbsp;
		<a href="index_.php?estado=RN">RN</a>&nbsp;&nbsp;
		<a href="index_.php?estado=RS">RS</a>&nbsp;&nbsp;
		<a href="index_.php?estado=RO">RO</a>&nbsp;&nbsp;
		<a href="index_.php?estado=RR">RR</a>&nbsp;&nbsp;
		<a href="index_.php?estado=SC">SC</a>&nbsp;&nbsp;
		<a href="index_.php?estado=SE">SE</a>&nbsp;&nbsp;
		<a href="index_.php?estado=SP">SP</a>&nbsp;&nbsp;
		<a href="index_.php?estado=TO">TO</a><br><br>
		<a href="index_.php?estado=todos">TODOS</a>
	</td>
</tr>
<tr>
	...
	if(pg_numrows($res) > 0){
		for($i = 0; $i < pg_numrows($res); $i++){
			...
			echo "<div id='conteudo$i' style='display: none;'>";
				...
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>Linhas que atende:</b> $linhas</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>Qtde de funcionários:</b> $funcionario_qtde</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>Qtde de OS:</b> $os_qtde</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>As cidades que atende:</b> $atende_cidade_proxima</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>Marcas que não quer trabalhar:</b> $marca_nao_autorizada</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>Marcas que quer trabalhar:</b> $marca_ser_autorizada</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>Melhor sistema que o posto acha:</b> $melhor_sistema</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td><b>Última data que foi alterada:</b> $data_modificado</td>";
				echo "</tr>";
				echo "</table>";
			echo "</div>";
			echo "</td>";
