...
<TABLE align='center' style='fon-size: 14px' border='0' cellspacing='0' cellpadding='0'>
<TR>
...
while ($nome_itens = readdir($ponteiro)) {
	if($nome_itens <> "index.php" AND $nome_itens <> "posto_cadastro_hbtec.php" AND $nome_itens <> "index2.php" AND $nome_itens <> "index3.php")
		$itens[] = $nome_itens;
}
...
if ($arquivos != "") {
	...
	$sql = "SELECT nome, cidade, estado, posto , fabricantes, descricao
