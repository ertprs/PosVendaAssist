...
if(1==1){
echo "<p style='font-family: verdana; font-size: 12px;' align='center'>Página não encontrada</b></p>";
exit;
}
...
if ($arquivos != "" AND strlen($estado) > 0) {
	...
	$sql = "SELECT nome, cidade, estado, tbl_posto.posto , fabricantes, descricao, email, codigo_posto, credenciamento
					FROM tbl_posto_extra 
					JOIN tbl_posto using(posto) 
					LEFT JOIN tbl_posto_fabrica ON tbl_posto.posto = tbl_posto_fabrica.posto and tbl_posto_fabrica.fabrica = 25
