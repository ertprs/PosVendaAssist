...
if ($totalRegistros == 0){
	...
	echo "<TABLE width='750' align='center' border='0' cellspacing='0' cellpadding='1'>\n";
	echo "<tr>";
	...
	if ($login_fabrica == 6){
		...
		echo "<td class='menu_top' align='center'>MO</td>\n";
		echo "<td class='menu_top' align='center'>PEÇAS</td>\n";
	    	echo "<td class='menu_top' align='center'>INSTALAÇÃO</td>\n";
	    	echo "<td class='menu_top' align='center'>DESLOC</td>\n";
...
*/		
		...
		*/
		if ($login_fabrica == 6){
			if ($tipo_posto == "P") {
				echo "<td class='table_line' align='right' style='padding-right:5px'> R$ " . number_format ($mao_de_obra,2,",",".") . "</td>\n";
				echo "<td class='table_line' align='right' style='padding-right:5px'> R$ " . number_format ($mao_de_obra_revenda,2,",",".") . "</td>\n";
			}else{
				echo "<td class='table_line' align='right' style='padding-right:5px'> R$ " . number_format ($mao_de_obra_distribuidor,2,",",".") . "</td>\n";
				echo "<td class='table_line' align='right' style='padding-right:5px'> R$ " . number_format ($mao_de_obra_revenda,2,",",".") . "</td>\n";
			}
			echo "<td class='table_line' align='right' style='padding-right:5px'> R$ " . number_format ($pecas_posto,2,",",".") . "</td>\n";
			echo "<td class='table_line' align='right' style='padding-right:5px'> R$ " . number_format ($pecas_revenda,2,",",".") . "</td>\n";
		}elseif ($login_fabrica == 19){
			echo "<td class='table_line' align='right' style='padding-right:5px'> " . number_format ($extra_mo,2,",",".") . "</td>\n";
			echo "<td class='table_line' align='right' style='padding-right:5px'> " . number_format ($extra_pecas,2,",",".") . "</td>\n";
			echo "<td class='table_line' align='right' style='padding-right:5px'> " . number_format ($extra_instalacao,2,",",".") . "</td>\n";
			echo "<td class='table_line' align='right' style='padding-right:5px'> " . number_format ($extra_deslocamento,2,",",".") . "</td>\n";
			echo "<td class='table_line' align='right' style='padding-right:5px'> " . number_format ($extra_total,2,",",".") . "</td>\n";
		}else{
			//if ($tipo_posto == "P") {
				echo "<td class='table_line' colspan=2 align='right' style='padding-right:5px'> R$ " . number_format ($mao_de_obra,2,",",".") . "</td>\n";
			//}else{
			//	echo "<td colspan=2 align='right' style='padding-right:5px'> R$ " . number_format ($mao_de_obra_distribuidor,2,",",".") . "</td>\n";
			//}
			
			echo "<td class='table_line' colspan=2 align='right' style='padding-right:5px'> R$ " . number_format ($pecas_posto,2,",",".") . "</td>\n";
		}
	...
	if ($login_fabrica == 6){
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_mao_de_obra,2,",",".") . "</b></td>\n";
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_mao_de_obra_revenda,2,",",".") . "</b></td>\n";
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_pecas,2,",",".") . "</b></td>\n";
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_pecas_revenda,2,",",".") . "</b></td>\n";
	}elseif ($login_fabrica == 19){
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_extra_mo,2,",",".") . "</b></td>\n";
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_extra_pecas,2,",",".") . "</b></td>\n";
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_extra_instalacao,2,",",".") . "</b></td>\n";
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_extra_deslocamento,2,",",".") . "</b></td>\n";
		echo "<td align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_extra_total,2,",",".") . "</b></td>\n";
	}else{
		echo "<td colspan=2 align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_mao_de_obra,2,",",".") . "</b></td>\n";
		echo "<td colspan=2 align='right' bgcolor='$cor' style='padding-right:5px' nowrap><b> R$ " . number_format ($total_pecas,2,",",".") . "</b></td>\n";
	}
	echo "</tr>\n";
	if ($login_fabrica == 19) {
	    echo "<tr class='table_line'>\n";
