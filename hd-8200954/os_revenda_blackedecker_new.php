...
<!--takashi 22/12 HD-925-->
						<input name="data_abertura" size="12" maxlength="10" value="<? echo $data_abertura; ?>" type="text" class="frm" tabindex="0"> <font face='arial' size='1'> Ex.: <? echo date("d/m/Y"); ?></font>
					</td>
					<td nowrap align='center'>
...
<?  if (temNF('r' . $os_revenda, 'bool')) { ?>
				<tr>
					<td><?=temNF("r_$os_revenda", 'linkEx')?></td>
				</tr>
<?	}?>
				<tr class="menu_top">
					<td nowrap="" colspan="4">Anexar Nota Fiscal</td>
				</tr>
				<tr>
					<td colspan="4" align="center"><?=$inputNotaFiscal?></td>
				</tr>
				<tr>
			...
			<table width="100%" border="0" cellspacing="3" cellpadding="2">
				...
				<tr>
					<td align='center'>
						<input class="frm" type="text" name="revenda_nome" size="28" maxlength="50" value="<? echo $revenda_nome ?>" onkeyup="somenteMaiusculaSemAcento(this)">&nbsp;<img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_revenda (document.frm_os.revenda_nome, "nome")' style='cursor:pointer;'>
					</td>
					<td align='center'>
