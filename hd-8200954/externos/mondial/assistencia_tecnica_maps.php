	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class='row'>
			    ...
			    <div class='col-md-8 col-sm-12 col-xs-12 text-center titulo'>
			    	Selecione as opções abaixo para encontrar a autorizada Mondial mais perto de você.
			    </div>
			    <div class='col-md-2'></div>
			</div>
			...
			<div class='row'>
			    ...
			    <div class='col-xs-12 col-sm-5 col-md-4 col-lg-4'>
			                        ...
			                        $sql = "SELECT DISTINCT
											 ...
											 WHERE tbl_linha.fabrica = $cod_fabrica
											   AND tbl_linha.ativo IS TRUE
												AND tbl_linha.linha not in (1444,1445,1447,912, 1522, 1523)
                    ...
                    <div class='form-group' id="cep_cliente-group">
						<label class="control-label" for="cep_cliente">CEP</label>
						<div class="controls controls-row">
							<div class="span12">
