	...
	<head>
		...
		<style type="text/css">
			...
			select, .select2-hidden-accessible, .select2-selection--single {
				...
				border: 1px solid #5ade63 !important;
	...
	$("#estado").data("callback", null).data("callback-param", null);
		...
		<?php if ($_GET['xcf'] == 'true'): ?>
			$(window).load(function () {
				less.modifyVars({'@map_340':'transparent url(\'br-340-xzone.png\') no-repeat -970px 0'});
			});
		<?php endif;?>
		...
		<div class="container-fluid">
			...
			<div class='row'>
			    ...
			    <div class='col-md-8 col-sm-12 col-xs-12 text-center titulo titulo_geral'>
			    	Selecione as opções abaixo para encontrar a autorizada XZone mais perto de você.
			    </div>
			    <div class='col-md-2'></div>
			</div>
