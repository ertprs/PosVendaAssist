...
$tipo = (empty($atendimento)) ? "ordem_de_servico_email" : "externo";
...
<div class="row-fluid logo-row">
    <div class="span12">
        <div id="topo">
            <div class="container">
                <br />
                <img class="logo_gl" src='../../logos/rinai_admin1.jpg'/>
            </div>
        </div>
    </div>
</div><br /><br /><hr />
...
<?php
    ...
    if (pg_num_rows($res)>0) {
	    ...
	    $cond_os = (empty($os) OR $os == "null") ? " os isnull " : " os  = $os " ;
            $cond_callcenter = (empty($atendimento) OR $atendimento == "null") ? " hd_chamado isnull " : " hd_chamado  = $atendimento " ;
...
?>
    ...
    <div class='agradecimentosPesquisa alert alert-success' style='display:none'>
        <div class="alert alert-success">
            ...
            EM NOME DA <b><?=$fabrica_nome?></b>, GOSTARIAMOS DE AGRADECER SUA ATENÇÃO, E DESEJAMOS-LHE UM EXCELENTE DIA.
        </div>
    </div>
</div>
</body>
