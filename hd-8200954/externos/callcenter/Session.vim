...
nmap <silent> \cpc :ColorVclear
nmap <silent> \cpb :ColorVpreviewblock
nmap <silent> \cpl :ColorVpreviewline
nmap <silent> \cpp :ColorVpreview
nmap <silent> \cg6 :ColorVwordgen Six-Tone
nmap <silent> \cg5 :ColorVwordgen Five-Tone
nmap <silent> \cg4 :ColorVwordgen Tetradic
nmap <silent> \cg3 :ColorVwordgen Triadic
nmap <silent> \cgt :ColorVwordgen Triadic
nmap <silent> \cg2 :ColorVwordgen Complementary
nmap <silent> \cg1 :ColorVwordgen Monochromatic
nmap <silent> \cgm :ColorVwordgen Monochromatic
nmap <silent> \cgp :ColorVwordgen Split-Complementary
nmap <silent> \cgc :ColorVwordgen Clash
nmap <silent> \cgn :ColorVwordgen Neutral
nmap <silent> \cgq :ColorVwordgen Square
nmap <silent> \cga :ColorVwordgen Analogous
nmap <silent> \cgv :ColorVwordgen Value
nmap <silent> \cgs :ColorVwordgen Saturation
nmap <silent> \cgh :ColorVwordgen Hue
nmap <silent> \cl :ColorVlist
nmap <silent> \cq :ColorVquit
nmap <silent> \cd :ColorVdropper
nmap <silent> \c2s :ColorVchange2 NS6
nmap <silent> \c2# :ColorVchange2 NS6
nmap <silent> \c2p :ColorVchange2 RGBP
nmap <silent> \c2r :ColorVchange2 RGB
nmap <silent> \c2n :ColorVchange2 NAME
nmap <silent> \c2h :ColorVchange2 HSV
nmap <silent> \c2x :ColorVchange2 HEX
nmap <silent> \ca :ColorVchangeAll
nmap <silent> \ce :ColorVchange
nmap <silent> \cw :ColorVword
nmap <silent> \c3 :ColorVmax
nmap <silent> \cx :ColorVmax
nmap <silent> \c1 :ColorVmin
nmap <silent> \cm :ColorVmin
nmap <silent> \c2 :ColorVmid
nmap <silent> \cv :ColorV
...
set smartcase
set smartindent
set statusline=%<%f\ format:%{&ff}:%{&fenc!=''?&fenc:&enc}\ type:%Y\ %h%m%r%{fugitive#statusline()}%=%-14.(%l/%L,%c%)(%p%%)\ %{strftime(\"date:%d-%m-%Y\ %H:%M\")}
...
silent only
cd /mnt/webdata/var/www/assist/www/externos/callcenter
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ajax_cep.php
badd +0 callcenter_cadastra_bestway.php
badd +291 callcenter_cadastra_cadence.php
badd +204 callcenter_cadastra_suggar.php
badd +0 callcenter_cadastro_famastil.php
badd +0 GF_form.php
badd +0 RAYOVAC_form.php
badd +0 REMINGTON_form.php
badd +3 Result
args ajax_cep.php callcenter_cadastra_bestway.php callcenter_cadastra_cadence.php callcenter_cadastra_suggar.php callcenter_cadastro_famastil.php GF_form.php RAYOVAC_form.php REMINGTON_form.php
edit callcenter_cadastra_bestway.php
...
setlocal tabstop=4
setlocal tags=./tags,./TAGS,tags,TAGS,/mnt/webdata/var/www/assist/www/.git/php.tags,/mnt/webdata/var/www/assist/www/.git/tags
...
let s:l = 53 - ((18 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
normal! 024l
tabedit callcenter_cadastro_famastil.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
