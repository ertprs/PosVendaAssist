        ...
        <div class="container" id="ng-app"  >
            ...
            <div>
                ...
                <script type="text/javascript">
                    ...
                    var consulta = function(){
                        ...
                        if (data.os.length == 0 && data.cpf_cnpj.length == 0) {
                            msgErro.push("Insira o CPF/CNPJ ou o número da OS");
                        }
                    ...
                    var showOs = function(data){
                        ...
                        $.each(data, function(key, value) {
                            ...
                            var data_abertura   = value.data_abertura;
                            var data_fechamento = value.data_fechamento;                            
                            var linha           = $("#clone").clone();
                            data_abertura       = data_abertura.replace(/(\d*)-(\d*)-(\d*).*/, '$3/$2/$1');
                            if(data_fechamento != null){
                                data_fechamento     = data_fechamento.replace(/(\d*)-(\d*)-(\d*).*/, '$3/$2/$1');
                            } else {
                                data_fechamento = 'Não há Data Fechamento';
                            }
			    ...
			    /*$(linha).find("li[rel=solucao]").html("<b>Solução</b>: "+ xsolucao);*/
                            ...
                            $(linha).find("li[rel=abertura]").html("<b>Data Abertura</b>: "+data_abertura);
                            $(linha).find("li[rel=fechamento]").html("<b>Data Fechamento</b>: "+data_fechamento);
                            if(value.codigo_rastreio == null){
                                value.codigo_rastreio = "Não há Código de Rastreio";
                            }
                            $(linha).find("li[rel=codigo_rastreio]").html("<b>Código de Rastreio</b>: "+value.codigo_rastreio);

                            $("#result").show();
                            $("#result").append($(linha).html());
                            $(".panel-primary").css('height', '358px');
                        });
                    };
                </script>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3">
                                    <div class="form-group row">
                                        ...
                                        <div style="margin-top: 10px;margin-left: -29px;" class="col-xs-1 col-sm-1 col-md-1"></div>
                                        <div class="col-xs-11 col-sm-11 col-md-3">
                            ...
                            <div class="panel panel-primary" style="height: 250px;">
                                ...
                                <div class="panel-body" style="padding: 0px;">
                                    <ul class="list-group" style="margin-bottom: 0px;">
                                        ...
                                        <li class="list-group-item" rel="abertura"></li>
                                        <li class="list-group-item" rel="fechamento"></li>
                                        <li class="list-group-item" rel="codigo_rastreio"></li>
                                    </ul>
                                </div>
                            </div>
                            </div>
