...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
    <html>
        ...
        <p class="txt_subtitulo_principal">Encontre a Revenda ou Representante mais próximo de você procurando nos campos abaixo.<br/>
                    ...
                    <form id="formAssistencia">
                        ...
                        <div id="mostra_campo_material" style="display: none;">
                            ...
                            <select id="material_serve" name="material_serve">
                                ...
                                <option value="IND">Industrialização</option>
                            </select><br>
                        </div>
