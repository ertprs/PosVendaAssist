            ...
            <div class="box_all">
                ...
                <div class="box_50_right">
                    <form id="formAssistencia">
                        ...
                        <label class="txt_label" for='cidade'>Cidade <span style='color:red; font-size:11px; font-weight: bold;'>(Se sua cidade n„o aparecer na lista abaixo, deixe o campo em branco e clique em pesquisar)</span></label>
