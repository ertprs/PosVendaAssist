...
<div class="titulo_tela">
	...
	<br><h1><a href="javascript:void(0)" style="cursor:point;"><?=ttext($a_rec_senha,"recupera_senha")?></a></h1>
...
<table style="border:solid 1px #CCCCCC;width: 948px;height:200px;" class="caixa_conteudo">
	<tr>
		<td style="padding: 1ex 2em">
			<div id='conteiner' style="min-height:200px">
			  	<div id='conteudo'>
					...
					<form name='frm_es' id='frm_es' method='post' action='<?=$PHP_SELF?>'>
				  		...
				  		<?php if (!$sucesso): ?>
				  			...
				  			<p><?=ttext($a_rec_senha,"preencha_nova_senha")?></p>
							<p>&nbsp;</p>

							<p>
								<label class='nova_senha' for='nova_senha'><?=ttext($a_rec_senha,"nova_senha")?>: *</label>
								<input name ="nova_senha" id='nova_senha' type="password" size="20" maxlength='50' value="<?=$nova_senha ?>" />
