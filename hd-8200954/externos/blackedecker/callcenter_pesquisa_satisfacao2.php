...
<div class="row-fluid">
    <div class="span12">
        <div id="topo">
            <div class="container">
                <br />
                <img class="logo_gl" src='images/topo.png'/>
            </div>
        </div>
    </div>
</div><br /><br /><hr />
        ...
        foreach (pg_fetch_all($res) as $key) {
            ...
            $html_pesquisa .= "
                    <tr>
                        ...
                        <td>
                            ".$key['descricao']."
                            <i id='btnPopover_".$key['pergunta']."' rel='popover' data-placement='top' data-trigger='hover' data-delay='500' title='EXPLICAÇÃO' data-content='".$key['texto_ajuda']."' class='icon-question-sign'></i>
                        </td>";
...
<script type="text/javascript">
    $('i[id^=btnPopover_]').each(function(k, v){
        var linha = this.id;
        // console.log(linha);
        $('#'+linha).popover();
    });
    // $('#btnPopover_298').popover();
</script>
</body>
<html>
