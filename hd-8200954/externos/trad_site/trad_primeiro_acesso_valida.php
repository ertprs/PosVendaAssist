...
$pavalida = array (
	...
	"sel_fabrica" => array (
  	...
  	"err_senha_cadastrada" => array (
        "pt-br" => "Senha já cadastrada para esta fábrica.",
        "es"    => "Ya hay registrada una clave para este fabricante.",
        "en"    => "There is already a registered password for this Manufacturer.",
        "de"    => "", 
        "zh-cn" => "", 
        "zh-tw" => ""
    ),
