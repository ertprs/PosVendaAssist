 ...
 */
		...
		$sql = "
			SELECT DISTINCT UPPER(tbl_posto.nome) AS nome, tbl_posto.posto, tbl_posto_fabrica.nome_fantasia, tbl_posto_fabrica.contato_endereco, tbl_posto_fabrica.contato_numero,
	...
	<html>
		<head>
			...
			<style>
                ...
                #resultado { float:left; width:100%; margin-top:25px; margin-left: 40px; }
                ...
                @media only all and (max-width: 838px) {
                    .box_50_left { width: 100% !important; }
		...
		<body>
	        ...
	        <p class="txt_subtitulo_principal">Encontre a assistência técnica Oster mais próxima de você procurando nos campos abaixo.<br/>
			...
			<div class="box_content">
				...
				<div class="box_all">
	                ...
	                <div class="box_50_left">
						<form id="formAssistencia">
                                ...
                                <select class="form-input" id="familia" name="familia" onchange="buscaEstado(this.value)">
                                    <?php
                                        $sql = "SELECT
                                            ...
                                            AND tbl_marca.nome ='OSTER'
                                            ORDER BY descricao ASC;";
                                        $res = pg_exec($con,$sql);

                                        if(pg_numrows($res) == 0){
                                            echo "<option selected='selected'> Nenhum produto encontrado</option>";
                                        }else{
                            ...
                            <div class="control-group">
                                ...
                                <input class="form-input" id="cep" name="cep" type="tel" /><br>
                            </div>
                            <div id="btn_estado_cidade"> 
                                <br>   
                                <a target="_blank" style="cursor:pointer;" onclick="naoSeiCep()"><strong>Não sei meu cep</strong></a>
                                <br><br><br>
                            </div>
                            <div id="estado_cidade" style="display:none">
                                ...
                                <div class="control-group">
                                    ...
                                    <select class="form-input" name="cidade" id="cidade" onchange="buscaAssistencia(this.value)">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="box_50_right">
                        <div id="resultado">
                            <div id="assistencia" style="overflow-x: hidden !important; overflow-y: visible !important; height: 600px !important;"></div>
                        </div>
			...
			<script language="JavaScript">
                ...
                */
				...
				function buscaAssistencia(cidade) {
                    ...
                    if (width_page <= 838) {
                        $('.box_50_left').css({width: '100%', float: 'left'});    
                    } else {
                        $('.box_50_left').css({width: '30%', float: 'left'});
                    }
                            ...
                            success: function(resposta){                           
                                if(resposta.length > 0){
                                    ...
                                    $.each(dados.posto, function(key, value) {
                                        ...
                                        //* RETIRADO BOTÃO 'LOCALIZAR' HD-7084357 *//
                                    ...
                                    /*alert("Prezado Consumidor, não encontramos um posto autorizado na sua região, por favor, entrar em contato com o nosso Serviço de Atendimento ao Consumidor através do contato sac@jcsbrasil.com.br ou telefone 0800 771 1300 de segunda a sexta-feira das 08:00 as 17:00 horas (exceto feriados nacionais).");*/
                                   
                                    /*alert("Importante: não encontramos um posto autorizado em sua região.\nPor favor entrar em contato com o nosso Serviço de Atendimento ao Consumidor para maiores informações.\nContatos: sac@jcsbrasil.com.br ou através do telefone 4020 2905.");
                                    $("#assistencia").html("");
                                    $("#box_mapa").hide();
                                    endereco = {};
                                    $("#cep").val("");*/
                                     ...
                                     lista = "<span class='posto-resultado' style='margin: 10px 5px; margin-top: 30px;'>\
                                                <h2 style='font-size: 24px !important;'>\
                                                    <b style='color: #014b94;'>\
                                                        Oops! No momento não localizamos uma assistência autorizada em sua cidade,\
                                                        <a href='https://www.oster.com.br/apoio-ao-consumidor' target='_blank' style='text-decoration: none; color: #002448;'>\
                ...
                //                 alert("Erro ao gerar Rota");
                //             } else {
                //                 instrucoes[p] = "<h2>Instruções</h2><button type='button' class='btn-fechar-instrucao'>Fechar instruções</button><br /><hr />";
                ...
                //     $("#map_canvas").html("<img src='"+url+"' style='width: 100%; height: 100%;' />");
                //     $("#map_canvas").prepend("<button type='button' class='btn-instrucao-rota' >Ver instruções da rota</button>");
