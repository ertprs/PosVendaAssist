...
if ($_GET['action']=='cidades') {
    ...
    if (strlen($estado) > 0) {
        $sql_cidades =  "SELECT  LOWER(x_cidade)||'#('||count(x_cidade)||')' AS cidade
                            FROM (SELECT DISTINCT posto,tipo_posto,UPPER(TRIM(TRANSLATE(contato_cidade,'áâàãäéêèëíîìïóôòõúùüçÁÂÀÃÄÉÊÈËÍÎÌÏÓÔÒÕÚÙÜÇ',
                                  ...
                                  WHERE posto NOT IN(6359,20462)
                                    ...
                                    AND tbl_posto_linha.linha = 455
                                    AND tbl_posto_fabrica.divulgar_consumidor IS TRUE
                                    AND contato_estado='$estado' 
                                    AND fabrica = $fabrica) x_posto
                               GROUP BY x_posto.x_cidade 
                               ORDER BY cidade ASC";
        $res_cidades   = pg_query($con, utf8_decode($sql_cidades));

        $lista_cidades = pg_fetch_all($res_cidades);

        if (pg_num_rows($res_cidades) > 0) {
            foreach ($lista_cidades as $cidade) {
                list($cidade_i,$cidade_c) = explode("#",htmlentities($cidade['cidade']));
               $selected = (strtoupper($cidade) == strtoupper($cidade_i)) ? " selected" : "";
                echo "<option value='$cidade_i' $selected>".ucwords($cidade_i." ".$cidade_c)."</option>\n";
                
            }
        } else {
            echo "<option value='' selected>Sem resultados</option>";
        }
    }
    exit;
}
...
if ($_GET['action']=='postos') {
    ...
    $sql = "SELECT
        ...
        $estado       = ($total_postos) ? pg_fetch_result($res, $total_postos-1, estado) : '';
        ...
        <thead>
            <tr>
                <th class="th_assist tal" width="30%">Nome do Posto</th>
                <th class="th_assist tal">Bairro - Endere&ccedil;o</th>
                <th class="th_assist tac" width="15%">Telefone</th>
                <th class="th_assist tac" width="15%">Telefone 2</th>
                <th class="th_assist tac" width="8%">E-Mail</th>
                <th class="th_assist tac" width="8%">Mapa</th>
            </tr>
        </thead>
        <?php
            for ($i = 0 ; $i < $total_postos ; $i++) {
                ...
                $cor = ($i % 2 == 0) ? "#ffffff" : "#f6f6f6" ;
                $end_completo = $bairro . " - " . $endereco . ", " . $numero . " - " . $complemento;
                $end_mapa     = "$endereco, $numero, $cep, $cidade, $estado, Brasil";

                $link_mapa = "
                            <a title='Localizar no mapa' href='http://maps.google.com/maps?f=q&source=s_q&hl=pt-BR&q=$end_mapa&ie=windows-1251' target='_blank'>
                                <img src='http://www.google.com/options/icons/maps.gif' width='16'>
                            </a>
                            ";
                $posto_nome    = iif((strlen($nome_fantasia) > 0), $nome_fantasia, $nome);
                $titlePosto    = $tooltip .= " title='".iif(($posto_nome==$nome_fantasia),"$posto_nome ($nome)", iif((strlen($posto_nome)>=30),"$posto_nome",""))."'";
                $titleEndereco = (strlen($end_completo) >= 35) ? " title='$end_completo'" : "";

                if (is_email($email)) {
                    $emailContato = "<a href='mailto:".strtolower($email)."'><img src='imagens/email_envelope.jpg'></a>";
                } else {
                    $emailContato = "<img src='imagens/no_e-mail.jpg'>";
                }
                echo "
                    <tr bgcolor='$cor'>
                        <td class='tal' $titlePosto>{$posto_nome}</td>
                        <td $titleEndereco>{$end_completo}</td>
                        <td>$fone</td>
                        <td>$fone2</td>
                        <td title='$email'>{$emailContato}</td>
                        <td>$link_mapa</td>
                    </tr>";
                unset($end_mapa, $link_mapa, $end_completo, $posto_nome, $email, $emailContato, $titleEndereco, $titlePosto);
            }
        }else{
            echo "<tr><td class='tac'> Nenhuma Assistência Técnica encontrada.</td></tr>";
        }
        echo "</table><br>";
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Mapa da Rede - Faet Eletrodomésticos</title>
    <link rel="stylesheet" href="css/style_faet.css">
</head>
<body>
    <div style="width: 100%;display: block;">
        <img src="imagens/logo_faet.jpg" alt="Faet" title="Faet" style='width: 180px;margin-left:20%'>
    </div>
    <div id="mapabr" style="text-align: center;">
        ...
        <svg id="map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="460" height="465" style="display: inline;">
            ...
            <g class="model-green">
                ...
                <a id="state_ba" class="state" data-uf='BA' title="Bahia">
                ...
                <a id="state_se" class="state" data-uf='SE' title="Sergipe">
                ...
                <a id="state_pe" class="state" data-uf='PE' title="Pernambuco">
                ...
                <a id="state_al" class="state" data-uf='AL' title="Alagoas">
                ...
                <a id="state_am" class="state" data-uf='AM' title="Amazonas">
                ...
                <a id="state_pa" class="state" data-uf='PA' title="Pará">
                ...
                <a id="state_mt" class="state" data-uf='MT' title="Mato Grosso">
                ...
                <a id="state_ro" class="state" data-uf='RO' title="Rondônia">
                ...
                <a id="state_ac" class="state" data-uf='AC' title="Acre">
                ...
                <a id="state_ap" class="state" data-uf='AP' title="Amapá">
                ...
                <a id="state_rj" class="state" data-uf='RJ' title="Rio de Janeiro">
                ...
                <a id="state_rs" class="state" data-uf='RS' title="Rio Grande do Sul">
                ...
                <a id="state_sc" class="state" data-uf='SC' title="Santa Catarina">
                ...
                <a id="state_pr" class="state" data-uf='PR' title="Paraná">
                ...
                <a id="state_sp" class="state" data-uf='SP' title="São Paulo">
                ...
                <a id="state_ms" class="state" data-uf='MS' title="Mato Grosso do Sul">
                ...
                <a id="state_go" class="state" data-uf='GO' title="Goiás">
                ...
                <a id="state_mg" class="state" data-uf='MG' title="Minas Gerais">
                ...
                <a id="state_es" class="state" data-uf='ES' title="Espírito Santo">
                ...
                <a id="state_pi" class="state" data-uf='PI' title="Piauí">
                ...
                <a id="state_ce" class="state" data-uf='CE' title="Ceará">
                ...
                <a id="state_rr" class="state" data-uf='RR' title="Roraima">
                ...
                <a id="state_to" class="state"  data-uf='TO' title="Tocantins">
                ...
                <a id="state_ma" class="state" data-uf='MA' title="Maranhão">
                ...
                <a id="state_rn" class="state" data-uf='RN' title="Rio Grande do Norte">
                ...
                <a id="state_pb" class="state" data-uf='PB' title="Paraíba">
                ...
                <a id="state_df" class="state" data-uf='DF' title="Distrito Federal">
    ...
    <div style="text-align: center;">
        ...
        <div id="mapabrUF">
            <fieldset style='float:center;border:none'>
    ...
    <script src="js/index_faet.js"></script>
        ...
        $(document).ready(function() {
            ...
            $('#estado').change(function () {
                ...
                if (estado.length == 2) {
                    ...
                    $('#ul_cidades select').load(url_base+'?action=cidades&estado='+estado, function() {
                        $('#cidade').change(function () {
                            var cidade = $(this).val();
                            $('#tbl_postos table').slideUp('fast');
                            $('#tbl_postos').html('<i>Carregando informações...</i>');
                            $.get(url_base, 'action=postos&estado='+estado+'&cidade='+cidade, function(data){
