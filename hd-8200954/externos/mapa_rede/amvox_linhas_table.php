	...
	$sql = "SELECT
        ...
        <thead>
            <tr align='center' class='bold'>
				...
				<th style="width:300px" width='300'>EndereÁo</th>
...
<!--	<div style='position: absolute;bottom:2em;right:2.5em;text-align:right'>
			Se a sua cidade n„o se encontra na relaÁ„o,<br>pode fazer a pesquisa no <a href="http://www.telecontrol.com.br/mapa_rede.php?fabrica=80" target='_blank'> <i>site</i> da <b>Telecontrol</b></a>.
		</div>
-->
		<div id='tblres'></div>
		</div>
        <div class="rodape">
            ...
            <a href="https://www.olhando.com.br" target="_blank">
                <img class="olhando-rodape" src="https://www.amvox.com.br/novo/imagens/olhando.jpg" width="51" height="7"
                        alt="Olhando ComunicaÁ„o" longdesc="https://www.olhando.com.br" />
            </a>
        </div>
