...
<html>
<head>
<title> Consulta Ordem de Serviço</title>
...
if ((strlen($data_extrato) > 0 AND strlen($peca) > 0 AND strlen($login_fabrica) > 0) OR ($login_fabrica == 140 && strlen($peca) > 0 && strlen($os) > 0)) {

	if($login_fabrica == 140){

		$sql_lavor = " AND tbl_os.os = {$os} ";
