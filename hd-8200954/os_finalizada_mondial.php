...
<div id='container'>
	...
	<div id="contentleft2" style="width: 150px;">
	<a href="os_cadastro_mondial.php"><img src="imagens/btn_lancanovaos.gif"></a>
	</div>
	<div id="contentleft2" style="width: 150px;">
	<a href="os_print_mondial.php?os=<? echo $os ?>" target="blank"><img src="imagens/btn_imprimir.gif"></a>
	</div>
</div>
