...
namespace Posvenda\Fabricas\_152;
...
class Os extends OsPosvenda
{
    ...
    function buscarOs($qtdeDias){
        ...
        $sql = "SELECT os FROM tbl_os  WHERE tbl_os.fabrica = ".$this->_fabrica." AND data_abertura + INTERVAL '".$qtdeDias." days' < CURRENT_DATE AND  finalizada IS NULL AND excluida IS NOT TRUE AND cancelada IS NOT TRUE";
