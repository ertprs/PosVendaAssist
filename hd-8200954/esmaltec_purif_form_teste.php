...
if (strpos($PHP_SELF,'esmaltec_purif_form') !== false) {
...
// 			return false;
			$.post('/assist/esmaltec_purif_form_teste.php','ajax=frm&posto='+posto+'&apto='+apto+'&valor='+valor,function(data) {
				if (data=='OK') {
	 ...
	 <div id="window_box">
		...
		<div id="fechar_msg" title='Mensagem lida.'>X</div>
	 	<div id="ei_container">
			...
			<p>Prezados SAE´s, no mês de outubro a Esmaltec estará efetuando o lançamento
