var sNotify = {
	...
	timeOpen: 325,	//change this number to the amount of second you want the message opened
	...
	createMessage: function(msg) {
		...
		//create HTML + set CSS
		var messageBox = $("<div><span><a href='http://www.telecontrol.com.br/auto_credenciamento.php' class=\"btn_cadastrar\"><img src=\"js/botaocadastrar.png\"></a></span><span class=\"sNotify_close\"><img src='js/icon_x_fechar.png' width='10px' ></span>" + msg + "</div>").prependTo("body");
...
setInterval("sNotify.loopQueue()", 2000);