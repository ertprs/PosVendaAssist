 ...
 *
 * $Id: jquery.datePicker.js 3438 2007-09-22 14:33:14Z kelvin.luck $
 **/
						...
						$('<div></div>')
							...
							.append(
								...
								$('<div id="dp-nav-prev"></div>')
									.append(
										$('<a id="dp-nav-prev-year" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '">&laquo;</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a id="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '">&lsaquo;</a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div id="dp-nav-next"></div>')
									.append(
										$('<a id="dp-nav-next-year" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '">&raquo;</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a id="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '">&rsaquo;</a>')
											.bind(
												'click',
												function()
												{
