...
function grava_os_campo_extra_fabrica() {
    ...
    $valor_adicional_revenda_estado 	= $campos["revenda"]["estado"];
    $valor_adicional_revenda_cidade 	= $campos["revenda"]["cidade"];
    ...
    if(strlen($valor_adicional_revenda_estado) > 0){
        $return["revenda"]["estado"] .= utf8_encode($valor_adicional_revenda_estado);        
    }

    if(strlen($valor_adicional_revenda_cidade) > 0){
        $return["revenda"]["cidade"] .= utf8_encode($valor_adicional_revenda_cidade);        
    }
