...
echo "<td align='center' width='150' ><br>";
    ...
    if (!empty($xpecas->attachListInfo)) {
		...
		echo "<div class='contenedorfoto'><a href='".$PHP_SELF."?ajax=true&peca=".$fotoPeca."&keepThis=trueTB_iframe=true&height=340&width=420' title='Imagem' class='thickbox'>
			<img src='".$fotoPeca."' border='0'>
			<input type='hidden' name='peca_imagem' value='".$fotoPeca."'><br>
			<font size='-4' color='#999999'>clique na foto para visualizar</font>
			</a>
			</div>";
    } else {
