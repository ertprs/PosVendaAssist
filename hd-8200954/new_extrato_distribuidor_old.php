...
if (strlen ($extrato) > 0) {
	if ($extrato>144000){
		if (array_search($login_posto, $postos_permitidos)>0){ //verifica se o posto tem permissao
			header ("Location: new_extrato_posto_devolucao_new.php?extrato=$extrato");
			exit();
		}
	}
...
<p>
<center>
<font size='+1' face='arial'>Data do Extrato - Posto</font>
<?
...
<br><br>
<p>
<center><b>Extrato do Distribuidor</b><br>
