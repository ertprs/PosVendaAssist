...
if($acao == "gravar"){
	...
	if (strlen($msg_erro) == 0){
		...
		if (strlen (trim ($sua_os)) == 0) $msg_erro .= " Digite o número da OS Fabricante.<br>";
		else                              $sua_os    = "'" . $sua_os . "'" ;
		...
		if ($admin_paga_mao_de_obra == 'admin_paga_mao_de_obra') $admin_paga_mao_de_obra = 't';
		else                                                     $admin_paga_mao_de_obra = 'f';
...
//				AND    tbl_produto.ativo IS TRUE";
		...
		if(strlen($msg_erro)==0){
			...
			if ($data_nf == 'null')                   $msg_erro .= " Digite a data de abertura da OS.<br>";
...
//
	...
	if (strlen ($msg_erro) > 0) {
		...
		echo "ok|<font color='#009900'><b>OS $sua_os gravada com sucesso</b></font><br><a href='os_cadastro.php'>Abrir Nova OS</a>&nbsp;&nbsp;&nbsp;<a href='os_press.php?os=$os' target='_blank'>Consultar OS</a>";
	}
	exit;
