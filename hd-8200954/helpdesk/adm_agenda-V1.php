...
echo "<input type='submit' name='btn_acao' value='Listas Usuários' class='botao2'>";
echo "<BR><BR>";
echo "</form>";
...
if (strlen ($aux_fabrica) > 0) {
	...
	if ($n_resu > 0) {
		echo "<BR>";
		echo "<table width = '755' align = 'center' cellpadding='0' cellspacing='0' border='0'>";
		echo "<tr>";
		...
		echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_centro_azul_claro.gif'   align = 'center' width='100%' style='font-family: arial ; color:#666666' colspan='7'><b>Resultado da busca por:</b></td>";//centro
		...
		echo "</tr>";
		echo "<tr>";
		echo "<td bgcolor='#D9E8FF' align = 'center' width='100%' style='font-family: arial ; color:#666666' colspan='7'>$aux_fabrica - <B>$aux_nome_fabrica</B></td>";
		echo "</tr>";
		echo "<tr bgcolor='#DDDDDD' style='font-family: arial ; font-size: 12px ; cursor: hand; ' height='25'>";
		echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";//coluna esquerda
		echo "<td rowspan='2' width='40'><B>Adm:</B></td>";
		echo "<td rowspan='2'><B>Nome completo:</B></td>";
		echo "<td rowspan='2'><B>Login/Senha:</B></td>";

		echo "<td rowspan='2'><B>Contato:</B></td>";
		echo "<td colspan='2' align='center'><B>Chamados</B></td>";
		echo "<td rowspan='2' align='center'><B>Logar como Admin</B></td>";
		echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_direito.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";// coluna direita
		echo "</tr>";
		echo "<tr bgcolor='#D9D9D9' style='font-family: arial ; font-size: 12px ; cursor: hand; ' height='25'>";
		echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";//coluna esquerda
		echo "<td align='center'><B>Pendente</B></td>";
		echo "<td align='center'><B>Resolvido</B></td>";
		...
		for ($i=0; $i<$n_resu; $i++){
			...
			echo "<td>$resu_admin&nbsp;</td>";
			echo "<td>$resu_nome_completo&nbsp;</td>";
			
			echo "<td><br>";
			echo "<div id='senha1'>";
			echo "<b>Login:</b>$resu_login<br>";
			echo "<b>Senha:</b>$resu_senha<br>&nbsp;";
			echo "</div>";
			echo "</td>";
			...
			echo "<td><br>";
			echo "<div id='senha1'>";
			echo "<b>Telefone:</b>$resu_fone<br>";
			echo "<b>Email:</b>$resu_email<br>&nbsp;";
			echo "</div>";
			echo "</td>";
			...
			echo "<td aling='center' title='Chamados Pendentes'><center>$total_pendente</center></td>";
			echo "<td aling='center' title='Chamados Resolvidos'><center>$total_resolvido</center></td>";
			
			echo "<td aling='center'><br>";
			echo"<form name='frm_admin' method='post' action='$PHP_SELF '><center><input type='submit' name='btn_acao' value='Logar' class='botao2'><input type='hidden' value='$resu_admin'name='admin'></center></form>";
			echo "</td>";
		...
		echo "<tr>";
		echo "<td background='/assist/helpdesk/imagem/fundo_tabela_baixo_esquerdo.gif'><img src='/assist/imagens/pixel.gif' width='9'></td>";
		echo "<td background='/assist/helpdesk/imagem/fundo_tabela_baixo_centro.gif' align = 'center' width='100%' colspan='7'></td>";
		echo "<td background='/assist/helpdesk/imagem/fundo_tabela_baixo_direito.gif'><img src='/assist/imagens/pixel.gif' width='9'></td>";
		echo "</tr>";
