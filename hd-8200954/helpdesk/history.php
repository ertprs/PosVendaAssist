...
<? if(in_array($login_admin,array(822))) { ?>
...
<?
	if($login_admin == 822) {
		echo "<body style='padding: 0px 20px 20px 20px'>";
		
		echo "<br/><div id='chamado_detalhe' ></div><br/>";

		echo'<form id="history-form" class="x-hidden"> 
