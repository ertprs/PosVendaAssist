<?
	...
	*/
	function phpHtmlChart($paData, $psOrientation = 'H', $psTitle = '', $psAxisLabel = '', $psFontSize = '8pt',
		...
		$iScale = $piMaxSize == 0 ? 0 : $iMax / $piMaxSize;
		...
		for ($iRow = 0; $iRow < sizeof($paData); $iRow++) {
			...
			$iBarLength = $iScale == 0 ? 0 : $paData[$iRow][1] / $iScale;
			$sHTML .= "
				<div style='background-color: $sColor; text-align: right; color: black;
