...
<script>
		...
		function retorna_dados_1(variavel){
			var objnome1 = document.getElementsByName('nome_1').length;//VERIFICA SE CAMPO EXISTE NO FORMULARIO
			if(variavel!="" && objnome1 =="1"){
				document.getElementById("nome_1").value = "";//LIMPA CAMPO
				document.getElementById("nome_1").value = variavel;//ADICIONA CONTEUDO
			}
			messageObj.close();//FECHA A JANELA MODAL
		}
