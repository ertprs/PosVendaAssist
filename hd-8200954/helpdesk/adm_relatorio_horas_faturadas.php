		          ...
		          <div class="row">
					<div class="col-md-3 col-sm-3"></div>	
		              <div class="col-md-2 col-sm-2">
		                <div class="form-group">
		                  <label for="CNPJ">Mês:</label>
		                  <div class="input-group">
		          			<select name='mes' class="form-control" id='mes'>
								<?php
								for($i=1;$i<13;$i++){
									echo "<option value='$i'";
									echo ($aux_mes == $i) ? 'SELECTED': "";
									echo ">$i</option>";
								}
								?>
							</select>
	...
	if (strlen($msg_erro) == 0) {
		...
		if ($com_horas_faturadas <> '') {
			...
			$sql_faturadas = "SELECT distinct tbl_fabrica.fabrica ,
							...
							tbl_hd_franquia.mes ,
							tbl_hd_franquia.ano ,
							tbl_hd_franquia.periodo_inicio,
							tbl_hd_franquia.periodo_fim ,
							tbl_hd_franquia.hora_faturada
								...
								where  (mes = '$aux_mes' or (DATE_PART('MONTH', data_implantacao) = {$aux_mes} and mes ='$aux_mes') )
								AND (ano = '$aux_ano' or (DATE_PART('YEAR', data_implantacao) = {$aux_ano} and ano = '$aux_ano'))
								AND ($condicao_tem_horas OR (
									...
									AND DATE_PART('MONTH', tbl_controle_implantacao.data_implantacao) = '$aux_mes'
									AND DATE_PART('YEAR', tbl_controle_implantacao.data_implantacao) = '$aux_ano'
								) > 0 or (select count(1) from tbl_hd_chamado
									where tbl_hd_chamado.fabrica = tbl_hd_franquia.fabrica
									and hora_faturada > 0 
									and data_aprovacao notnull
									AND DATE_PART('MONTH', data_resolvido) = '$aux_mes'
									AND DATE_PART('YEAR', data_resolvido) = '$aux_ano'
									) > 0 
								)
								$condicao_fabrica
					ORDER BY nome";
			...
			<div class="container">
					<?php
						...
						for ($d = 0; $d < pg_num_rows($res_fabrica); $d++) {
							...
							$sqlCI = "SELECT tbl_controle_implantacao.hd_chamado AS chamado, tipo, valor_implantacao AS valor
									FROM tbl_controle_implantacao
									JOIN tbl_hd_chamado ON tbl_hd_chamado.hd_chamado = tbl_controle_implantacao.hd_chamado
									LEFT JOIN tbl_hd_chamado_extra ON tbl_hd_chamado.hd_chamado = tbl_hd_chamado_extra.hd_chamado
									WHERE tbl_controle_implantacao.fabrica = {$busc_fabrica}
									$condicao_pagos
									AND DATE_PART('MONTH', data_implantacao) = {$aux_mes}
									AND DATE_PART('YEAR', data_implantacao) = {$aux_ano}";
						...
						if (pg_numrows($res) > 0) {?>
							...
							<table class="table table-bordered table-striped">
								<tr class="titulo_tabela" style="background-color: #3d3e71 !important;">
									<th colspan="100%" class='tac'><?= $nome_fabrica ?></th>
								</tr>
								<tr>
								...
								fputs ($fp,'<table class="tablesorter" width="400px" border="1"><tr><th align="center">Chamado Aprovado</th><th align="center">Horas Cobradas</th><th align="center">Horas Sup.</th><th align="center">Horas Desenv.</th><th align="center">Horas Trab.</th><th align="center">Desconto</th><th align="center">Nota Fiscal</th><th align="center">Data Emissão</th></tr>');
								...
								?>
									<tr>
										...
										<td class='tac'><?php echo $aux_hora_faturada;?></td>
									...
									fputs ($fp,'<tr><td align="center">'.$aux_hd_chamado.'</td><td align="center">'.$aux_hora_faturada.'</td><td align="center">'.$horas_sup.'</td><td align="center">'.$horas_dev.'</td><td align="center">'.$horas_tra.'</td><td align="center">R$ '.number_format($aux_desconto, 2, ",", ".").'</td><td align="center">'.$nota_fiscal.'</td><td align="center">'.mostra_data($data_nf).'</td></tr>');
								...
								<tr>
									<td>&nbsp;</td>	
									<td>&nbsp;</td>
									<td class="tac"><span style="font-size:14px;"><b>Total&nbsp;</b></span></td>
							...
							fputs ($fp,'<tr><td align="center"><span style="font-size:14px;" align="center"><b>Total&nbsp;</b></span></td><td align="center"><span style="font-size:14px;"><b>'.$total_horas.'</b></span></td><td align="center"><span style="font-size:14px;"><b>'.$totalSUP.'</b></span></td><td align="center"><span style="font-size:14px;"><b>'.$totalDEV.'</b></span></td><td align="center"><span style="font-size:14px;"><b>'.$totalTRA.'</b></span></td><td align="center"><span style="font-size:14px;"><b>R$ '.number_format($total_desconto, 2, ",", ".").'</b></span></td></tr></table>');
						...
						$res = pg_exec($con, $sql);
						 ...
						 if (pg_num_rows($res) > 0) {
							...
							$CI_valor = 0;
								$total_CI = 0 ; 
							if ($rowsCI > 0) {
								fputs ($fp,'<table class="tablesorter" width="400px" border="1"><tr class="titulo_tabela" style="background-color: darkred !important;">
										<th colspan="100%" class="tac">Faturamentos $nome_fabrica </th>
									</tr><tr><th align="center">Chamado</th><th align="center">Tipo de Venda</th><th align="center">Valor</th><th></th></tr>');
							?>
								<table class="table table-striped">
									...
									for ($j = 0; $j < $rowsCI; $j++) {
										...
										?>
										<tr>
											<td class="tac"><a href="adm_chamado_detalhe.php?hd_chamado=<?=$CI_chamado?>" style="text-decoration: none;" target="_blank" ><?=$CI_chamado?></td>
											<td class="tac"><?=$CI_tipo_venda?></td>
											<td class="tac">R$ <?=number_format($CI_valor, 2, ",", ".")?></td>
										</tr>

									<?php
										fputs ($fp,'<tr><td align="center">'.$CI_chamado.'</td><td align="center">'.$CI_tipo_venda.'</td><td align="center">R$ '.number_format($CI_valor, 2, ",", ".").'</td><td></td></tr>');
							...
							<table class="table table-striped">
								...
								$sql_chat = "SELECT COALESCE(MAX(qtde),0) as total
											  ...
											  WHERE DATE_PART('MONTH', data) = DATE_PART('MONTH', '$aux_ano-$aux_mes-01'::date)
											  AND  DATE_PART('YEAR', data) = DATE_PART('YEAR', '$aux_ano-$aux_mes-01'::date)
							...
							<?php
							fputs ($fp,'<table class="tablesorter" width="400px" border="1"><tr><th align="center">Franquia do Mês</th><th align="center">Custo Hora</th><th align="center">Horas a Faturar</th><th align="center">Valor</th><th align="center">Desconto</th></tr><tr><td align="center">'.$soma_total_horas.'</td><td align="center">'.$aux_valor_hora_franqueada.'</td><td align="center">'.$aux_hora_utilizada.'</td><td align="center"><b>R$ '. $total_pagar.'</b></td><td align="center"><b>R$ '. $total_desconto.'</b></td></tr><tr></table>');
					...
					<table class="table table-bordered">
						<tr class="titulo_tabela" style="background-color: darkcyan !important;">
							<th class='tac'><span style="color:white;font-size:15px;"><b>Total Franquia do Mês&nbsp;</b></span></th>
							<th class='tac'><span style="color:white;font-size:15px;"><b>Total Horas Desenv.&nbsp;</b></span></th>
							<th class='tac'><span style="color:white;font-size:15px;"><b>Total Horas Sup.&nbsp;</b></span></th>
							<th class='tac'><span style="color:white;font-size:15px;"><b>Total Horas Trab.&nbsp;</b></span></th>
							<th class='tac'><span style="color:white;font-size:15px;"><b>Total a Faturar&nbsp;</b></span></th>
							<th class='tac'><span style="color:white;font-size:15px;"><b>Total do Valor&nbsp;</b></span></th>
							<th class='tac'><span style="color:white;font-size:15px;"><b>Total do Desconto&nbsp;</b></span></th>
						</tr><?php

						fputs ($fp,'<table class="tablesorter" width="400px" border="1"><tr><th><span><b>Total Franquia do Mês&nbsp;</b></span></th><th><span><b>Total Horas Desenv.&nbsp;</b></span></th><th><span><b>Total Horas Sup.&nbsp;</b></span></th><th><span><b>Total Horas Trab.&nbsp;</b></span></th><th><span><b>Total a Faturar&nbsp;</b></span></th><th><span><b>Total do Valor&nbsp;</b></span></th><th align="center"><span><b>Total do Desconto&nbsp;</b></span></th></tr>'); 
						$TOTALDEV = somaHoras($totalFinalDEV);
						$TOTALSUP = somaHoras($totalFinalSUP);
						$TOTALTRAB = somaHoras(array($TOTALDEV,$TOTALSUP));
						$TOTALAFATURAR = $totalHorasAFaturarRes;
						?>

						<tr>
							<td class='tac' style="font-size:14px;"><b><?php echo $total_horas_fabrica;?></b></td>
							<td class='tac' style="font-size:14px;"><b><?php echo $TOTALDEV?></b></td>
							<td class='tac' style="font-size:14px;"><b><?php echo $TOTALSUP?></b></td>
							<td class='tac' style="font-size:14px;"><b><?php echo $TOTALTRAB;?></b></td>
					...
					fputs ($fp,'<tr><td align="center"><b>'.$total_horas_fabrica.'</b></td><td align="center"><b>'.$TOTALDEV.'</b></td><td align="center"><b>'.$TOTALSUP.'</b></td><td align="center"><b>'.$TOTALTRAB.'</b></td><td align="center"><b>'.$TOTALAFATURAR.'</b></td><td align="center"><b>R$ '.$soma_total_apagar.'</b></td><td align="center"><b>R$ '.$soma_total_desconto.'</b></td></tr></table>'); ?>
