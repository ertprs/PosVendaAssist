...
if (strlen ($btn_acao) > 0) {
	...
	if (strlen($msg_erro) == 0){
		...
		$sql ="UPDATE tbl_hd_chamado SET status = '$status' , titulo = '$titulo' WHERE hd_chamado = $hd_chamado";
		$res = pg_exec ($con,$sql);
...
<tr>
	...
	<td bgcolor="#E5EAED" style='border-style: solid; border-color: #6699CC; border-width=1px' colspan='3'>&nbsp;<input type='text' size='50' name='titulo' value='<?= $titulo ?>' > </td>
</tr>
...
if (@pg_numrows($res) > 0) {
	...
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_centro_azul_claro.gif' colspan='4' align = 'center' width='100%' style='font-family: arial ; color:#666666'><b>Interações</b></td>";
	...
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_baixo_centro.gif' colspan='4' align = 'center' width='100%'></td>";
