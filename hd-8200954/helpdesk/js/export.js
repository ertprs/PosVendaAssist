...
Ext.ux.Exporter.Button = Ext.extend(Ext.Button, {
  ...
  template: new Ext.Template(
    '<table border="0" cellpadding="0" cellspacing="0" class="x-btn-large x-btn-icon-large-left"><tbody><tr>',
    '<td class="x-btn-ml"><i> </i></td><td class="x-btn-center"><a class="x-btn-mc x-btn-text" href="{1}" target="{2}" download="file.xls">{0}</a></td><td class="x-btn-mr"><i> </i></td>',
    "</tr></tbody></table>"),
