...
echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_centro_azul_claro.gif'   align = 'center' width='100%' style='font-family: arial ; color:#666666'><b> Ferramentas de Atendimento</b></td>";//centro
...
echo "<td align='center'>";
echo "<a href='adm_estatistica.php' border='0'><img src='imagem/grafico.gif' border='0'></a>";
echo "</td><td>";
echo "<a href='adm_estatistica.php' border='0'>Estatísticas</a>";
echo "</td>";
...
echo "<tr>";
echo "<td align='center'>";
echo "<a href='adm_hora_fabrica.php'><img src='imagem/02.jpg' border='0'></a>";
echo "</td><td>";
echo "<a href='adm_hora_fabrica.php'>Horas Fábrica</a>";
echo "</td>";

echo "<td align='center'>";
echo "<a href='adm_tela.php'><img src='imagem/02.jpg' border='0'></a>";
echo "</td><td>";
echo "<a href='adm_tela.php'>Tela</a>";
echo "</td>";
...
if (pg_numrows($res) > 0) {
	...
	echo "<tr>";
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_esquerdo_azul_claro.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>"; //linha esquerda - 2 linhas
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_centro_azul_claro.gif'   align = 'center' width='100%' style='font-family: arial ; color:#666666'><b> Chamados em Andamento</b></td>";//centro
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_direito_azul_claro.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";//linha direita - 2 linhas
	echo "</tr>";
	echo "<tr>";
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";//coluna esquerda
...
if (pg_numrows($res) > 0) {
	...
	echo "<tr>";
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_esquerdo_azul_claro.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>"; //linha esquerda - 2 linhas
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_centro_azul_claro.gif'   align = 'center' width='100%' style='font-family: arial ; color:#666666'><b> Hora Fábrica</b></td>";//centro
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_top_direito_azul_claro.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";//linha direita - 2 linhas
	echo "</tr>";
	echo "<tr>";
	echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";//coluna esquerda
