...
function mostra_agendados(){
	window.location="adm_atendimento_lista_teste.php?mostra_agendados=nao";
}
...
if (@pg_numrows($res) >= 0) {
	...
	if($login_admin==568){
		$check_mostra_agendados = "";
		if($mostra_agendados =="nao"){
			$check_mostra_agendados = "checked";
		}
		echo "<br> <input type='checkbox' name='nao_agendados' value='t' $check_agendado onclick='javascript:mostra_agendados();' $check_mostra_agendados > Não Mostra Chamados Agendados ";
	}
