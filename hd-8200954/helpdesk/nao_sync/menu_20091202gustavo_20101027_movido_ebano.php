...
<tr bgcolor='#FFFFFF' valign='middle'>
		...
		if($login_admin == 822){
			$dia = date(j);
			$img = ($dia % 2 ==0) ? "<img src='imagem/tc_logo_2009_md-trans.png'>" : "<img src='imagem/logo_tc_2009_md_trans.png'>";
			echo "<td width='100%' align='left' >$img</td>";
			$bg = "bgcolor ='white'";
			$color = ($dia % 2 ==0) ?"#000000":"#330099";
			$txt_array = array('#330000','#000099','#003300','#336600','#FF0000','#996600','#669900','#990099','#FFFF00','#CCFF00','#33FFFF','#66FF66');
			$txtcolor = $txt_array[array_rand($txt_array,1)];
			switch($dia % 6) {
				case "1": $n_imagem = rand(1,3); $imagem = "menu_bg/menu_bg".$n_imagem.".gif"; break;
				case "2": $n_imagem = rand(4,6);$imagem = "menu_bg/menu_bg".$n_imagem.".gif"; break;
				case "3": $n_imagem = rand(7,9);$imagem = "menu_bg/menu_bg".$n_imagem.".gif"; break;
				case "4": $n_imagem = rand(10,12);$imagem = "menu_bg/menu_bg".$n_imagem.".gif"; break;
				case "5": $n_imagem = rand(13,15);$imagem = "menu_bg/menu_bg".$n_imagem.".gif"; break;
				default : $n_imagem = rand(16,18);$imagem = "menu_bg/menu_bg".$n_imagem.".gif"; break;
			}

		}elseif($login_admin ==1553) { 
