...
if (strlen ($cook_admin) == 0 and $_GET['user']=='1533' and $_GET['f']=='76' and $_GET['admin']=='filizola') {
	setcookie('cook_fabrica',$_GET['f']  , time() + 28800, "/");
	setcookie('cook_admin', $_GET['user'], time() + 28800, "/");
	header ("Location: $PHP_SELF");
	exit;
...
if (strlen ($cook_admin) == 0 and $_GET['user']=='3178' and $_GET['f']=='75' and $_GET['admin']=='thermoking') {
	setcookie('cook_fabrica',$_GET['f']  , time() + 28800, "/");
	setcookie('cook_admin', $_GET['user'], time() + 28800, "/");
	header ("Location: $PHP_SELF");
	exit;
}#	fim
if (strlen ($cook_admin) == 0 and $_GET['user']=='4046' and $_GET['f']=='110' and $_GET['admin']=='mallory-comercial') {
	setcookie('cook_fabrica',$_GET['f']  , time() + 28800, "/");
	setcookie('cook_admin', $_GET['user'], time() + 28800, "/");
	header ("Location: $PHP_SELF");
	exit;
