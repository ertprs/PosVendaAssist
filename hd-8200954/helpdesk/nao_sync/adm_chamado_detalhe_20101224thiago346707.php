...
if($_GET['adReq'] == 1){
	...
	<tr id="requisito_<?php echo $_GET['numero'];?>">
		<td class="sub_label">
			<textarea name="requisitos[]" style="width:100%;height:150px"></textarea>
		</td>
...
#Caso seja para adicionar alguma análise, chama este pedaço em ajax para inserir mais uma análise
	...
	<tr id="analise_<?php echo $_GET['numero'];?>">
		<td>
			<textarea name="analises[]" style="width:100%;height:150px"></textarea>
		</td>
		<td align="center">
...
#Ao adicionar algula correção
	...
	<tr id="correcao_<?php echo $rodadaCorrecao;?>_<?php echo $numero;?>">
		<td>
			<textarea name="descricaoCorrecaos[]" style="width:100%;height:100px"></textarea>
		</td>
		<td>
			<textarea name="analiseCorrecaos[]" style="width:100%;height:100px"></textarea>
		</td>
		<td align="center">
	...
	<input type="hidden" id="numeroCorrecao_<?php echo $rodadaCorrecao;?>" value="<?php echo $j;?>" />
...
if($_POST['_POST'] == 'req1'){
	...
	if(strlen($msg_erro) > 0){
		...
		$res = pg_commit();
		header ('Location: '.$_SERVER['PHP_SELF'].'?hd_chamado='.$_POST['chamado']);
	}
		...
		<ul id="menu_requisitos">
			...
			<li class="greenHD">
				...
				<div style="display:none;">
					...
					<form name="frm_requisitos" action="<?php echo $_SERVER['PHP_SELF'];?>?hd_chamado=<?php echo $hd_chamado;?>" method="post">
						...
						<table border='0' cellpadding='2' class="table_requisitos" id="frm_req">
							...
							<?php
							$sql = 'SELECT hd_chamado_requisito,requisito,analise,admin_analise,teste,admin_teste
									  FROM tbl_hd_chamado_requisito
									 WHERE hd_chamado = '.$hd_chamado.'
									   AND excluido = FALSE;';
							$res = pg_query($con,$sql);
						...
						<input type="hidden" id="numeroRequisito" value="<?php echo $i;?>" />
			...
			<li class="yellowHD">
				...
				<div style="display:none;">
					<form name='frm_analise' action="<? echo $_SERVER['PHP_SELF'];?>?hd_chamado=<?php echo $hd_chamado;?>" method='post'>
						<table border='0' cellpadding='2' class="table_requisitos" id="frm_ana">
							...
							<?php
							$sql = 'SELECT hd_chamado_analise,analise,desenvolvimento,admin_desenvolvimento,teste,admin_teste
									  FROM tbl_hd_chamado_analise
									 WHERE hd_chamado = '.$hd_chamado.'
									   AND excluido = FALSE';;
							$res = pg_query($con,$sql);
						...
						<input type="hidden" id="numeroAnalise" value="<?php echo $i;?>" />
			...
			<li class="orangeHD">
				...
				<div style="display:none;">
					...
					<div style="display:none;" id="checkListMinimo">
						<form name='frm_check_list' action="<? echo $_SERVER['PHP_SELF'];?>?hd_chamado=<?php echo $hd_chamado;?>" method='post'>
				...
				<div style="display:none;">
					...
					<?php if($totalRequisitos > 0):?>	
						...
						<div id="requisitosTestes" style="display:none">
							<form name='frm_analise_teste' action="<? echo $_SERVER['PHP_SELF'];?>?hd_chamado=<?php echo $hd_chamado;?>" method='post'>
								<table border='0' cellpadding='2' class="table_analise"">
									<tr>
					...
					<?php if($totalAnalises > 0):?>	
						...
						<div id="analisesTestes" style="display:none">
							<form name='frm_requisitose_teste' action="<? echo $_SERVER['PHP_SELF'];?>?hd_chamado=<?php echo $hd_chamado;?>" method='post'>
								<table border='0' cellpadding='2' class="table_analise"">
									<tr>
					...
					<div id="correcoes_lista" style="display:none;">
									...
									<div id="rodada_lista_<?php echo $rodadaCorrecao;?>" <?php echo $style;?> class='rodada'>
										...
										<table border='0' cellpadding='2' class="table_analise">
											...
											$sql = 'SELECT hd_chamado_correcao,hd_chamado,rodada,descricao,analise,
														   gravidade,atendido,admin_atendido,rodada_finalizada
													  FROM tbl_hd_chamado_correcao
													 WHERE hd_chamado = '.$hd_chamado.'
													...
													<?php for($j=0;$j<$totalCorrecao;$j++): ?>
														...
														<tr id="correcao_<?php echo $rodadaCorrecao;?>_<?php echo $j;?>">
															<td>
																...
																<textarea name="descricaoCorrecaos[]" style="width:100%;height:100px"><?php echo $descricaoCorrecao;?></textarea>
															</td>
															<td>
																<textarea name="analiseCorrecaos[]" style="width:100%;height:100px"><?php echo $analiseCorrecao;?></textarea>
															</td>
															<td align="center">
																<select name="gravidadeCorrecaos[]">
						...
						$maior_rodada = ($num3) ? pg_fetch_result($res3,0,'maior_rodada') : 0 ;
						$maior_rodada++;
						?>
						<div id="nova_rodada">
							<div align="center">
					...
					<div id="correcoes_teste" style="display:none;">
						...
						<?php if($totalRodada>0):?>
							...
							<?php for($i=0;$i<$totalRodada;$i++): ?>
								...
								<form name='frm_correcao_teste_<?php echo $rodadaCorrecao;?>' action="<? echo $_SERVER['PHP_SELF'];?>?hd_chamado=<?php echo $hd_chamado;?>" method='post'>
...
<td valign='top'>
	...
	<tr>
		...
		if ($totalDesenv  > 0) {
			echo "<select class='frm' style='width: 150px;' name='admin_desenvolvedor'>\n";
			...
			for ($x=0;$x<$totalDesenv;$x++){
				...
				echo "<option value='$aux_admin'"; if ($admin_desenvolvedor == $aux_admin) echo " SELECTED "; echo "> $aux_nome_completo</option>\n";
			}
			echo "</select>\n";
		}
		?>
...
<? if($analista_hd == "sim"){ ?>
	<tr>
		<td  class ='sub_label'><strong>Prazo<span title='Hora interna que será pago para o analista desenvolvedor'>(?)</span></strong></td>
		<td  class ='sub_label'align='center'>
