...
$sql = "SELECT
	...
	$ordemby = " ORDER BY tbl_hd_chamado.previsao_termino_interna ASC,tbl_hd_chamado.previsao_termino ASC,tbl_hd_chamado.data DESC";
	if(strlen($ordenar_por) > 0 and $ordenar_por == 1 and strlen($valor_chamado)==0 ){
