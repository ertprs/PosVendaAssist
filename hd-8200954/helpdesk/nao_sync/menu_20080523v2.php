...
<tr bgcolor='FFFFFFF' valign='middle'>
	<td align='left' background='imagem/fundo_dh2.jpg'>&nbsp;</td>
	<td width='100%' align='left' background='imagem/fundo_dh2.jpg'><img src='imagem/logo_dh2.jpg'></td>
<?
if($login_fabrica<>10){
?>
	<form method='post' action='<?= $prefixo ?>chamado_lista.php' name='frm_pesquisa'>
	<td align='left' nowrap background='imagem/fundo_dh3.jpg'>
...
<td alig='left' valign='middle' background='imagem/fundo_dh4.jpg'  height='25'>
...
<?if($login_fabrica<>10 ){ if($sistema_lingua<>'ES'){?>
		<td align='center'><font color='#666666'> | </font></td>
		<td align='center' width='100' class='cell_out' onmouseover="this.className='cell_over'" onmouseout="this.className='cell_out'"><a href='<?= $prefixo ?>estatistica.php'  style='text-decoration: none ; color: #000000 '>Estatísticas</a></b></td>
...
?>
		...
		<td align='center' width='90' class='cell_out' onmouseover="this.className='cell_over'" onmouseout="this.className='cell_out'"><a href='adm_producao_fabrica.php' style='text-decoration: none ; color: #000000 '>Rel.Atend.Fábrica</a></b></td>
		<td align='center'><font color='#666666'> | </font></td>
