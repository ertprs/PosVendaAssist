...
if($login_admin == '822' OR $login_admin == '852' OR $login_admin == '1169'){
	echo "<table width='630' align='center' cellpadding='0' cellspacing='0' border='0'>";
	echo "<tr style='font-family: arial ; color: #FFCC00' align='center'>";

	echo "<td nowrap align='left' colspan=2>PAR-IMPAR : <b>FRANCISCO</b>&nbsp;&nbsp;</td>";

	echo "<td nowrap align='left' colspan=2>IMPAR-PAR: <b>GUSTAVO</b>&nbsp;&nbsp;</td>";

	echo "<td nowrap align='left' colspan=2>IMPAR-IMPAR: <b>PAULO</b>&nbsp;&nbsp;</td>";
	echo "</tr>";
	echo "<tr style='font-family: arial ; color: #FFCC00' align='center'>";
	echo "<td nowrap align='left'>2-PAR : </td>";
	echo "<td nowrap align='left' rowspan='2'><b>FRANCISCO</b>&nbsp;&nbsp;";
	echo "<td nowrap align='left'>4,6-PAR : </td>";
	echo "<td nowrap align='left' rowspan='2'><b>GUSTAVO</b>&nbsp;&nbsp;";
	echo "<td nowrap align='left'>8,0-PAR : </td>";
	echo "<td nowrap align='left' rowspan='2'><b>PAULO</b>&nbsp;&nbsp;";
	echo "</tr>";
	echo "</table>";
