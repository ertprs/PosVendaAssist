...
if(strlen($atualiza_hd)==0){$atualiza_hd = $_POST['atualiza_hd'];}
...
<? if($analista_hd == "sim"){ ?>
	<tr>
		...
		<div id='result' style='position:absolute; display:none;  border: 1px solid #949494;background-color: #F1F0E7;width:100px;'></div>
		</td>
	</tr>
	<tr>
