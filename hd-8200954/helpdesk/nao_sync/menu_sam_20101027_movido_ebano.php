...
<tr bgcolor='FFFFFFF' valign='middle'>
	<td width='100%' align='left' background='imagem/fundo_dh5.jpg'>&nbsp;</td>
<?
if($login_fabrica<>10){
?>
...
<tr  bgcolor = '#eeeeee' valign='middle'>
	...
	<?if ($login_fabrica == 10) {?>
		<div class="imrcmain0 imgl" style="width:1000px;z-index:99;position:relative;">
			<div class="imcm imde" id="imouter0">
				<ul id="imenus0">
					<li class="imatm"  style="width:100px;">
						<a class="" href="#">
							<span class="imea imeam"></span>CHAMADOS
						</a>
						<div class="imsc">
							<div class="imsubc" style="width:120px;top:-1px;left:0px;">
								<div class="imunder">
								</div>
								<ul style="">
					...
					<li class="imatm"  style="width:20px;"><a href="#"> | </a></li>
					<li class="imatm"  style="width:90px;"><a href="adm_suporte.php"><span class="imea imeam"><span></span></span>SUPORTE</a></li>
					<li class="imatm"  style="width:20px;"><a href="#"> | </a></li>
					<li class="imatm" style="width:115px;">
						<a class="" href="">
							<span class="imea imeam">
							</span>RELATÓRIOS
						</a>
						<div class="imsc">
							<div class="imsubc" style="width:135px;top:-1px;left:0px;">
								<div class="imunder">
								</div>
								<ul style="">
									<li>
					...
					<li class="imatm"  style="width:20px;">
						<a href="#"> | </a>
					</li>
					<li class="imatm" style="width:115px;">
						<a class="" href="#">
