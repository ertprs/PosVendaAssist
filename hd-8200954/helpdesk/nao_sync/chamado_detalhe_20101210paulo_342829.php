...
/*--==VALIDAÇÕES=====================================================--*/
	...
	if(strlen($hd_chamado)>0){
		...
		elseif (intval($_POST["combo_tipo_chamado"]) == 5) {
			$msg_erro.= "Para chamado de erro, por favor, anexe um <i>PrintScreen</i> (imagem) da tela aonde o erro ocorreu<br>";
		}
	} else { // HD 307589 - Validar dados do chamado (título, tipo, ...) só na abertura do chamado.
