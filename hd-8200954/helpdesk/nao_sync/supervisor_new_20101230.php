...
$backlog = 1;
//Liberado temporáriamente 4 filas para Britânia. O certo são 2, as outras duas podem ser suspensas a qualquer momento.
if($login_fabrica == 3){
	$backlog = 4;
}
if($login_fabrica == 30){
...
if($aprova=='sim'){
	...
	$sql = "UPDATE tbl_hd_chamado
			SET exigir_resposta = 'f', status = 'Aguard.Execução', data = CURRENT_TIMESTAMP
