...
if($login_admin == '398' OR $login_admin == '568' OR $login_admin == '567'){
	echo "<table width='630' align='center' cellpadding='0' cellspacing='0' border='0'>";
	echo "<tr style='font-family: arial ; color: #666666' align='center'>";

	echo "<td nowrap align='left'>PAR-PAR: <b>IGOR</b><td>";

	echo "<td nowrap align='left'>PAR-IMPAR: <b>SONO</b><td>";

	echo "<td nowrap align='left'>IMPAR-PAR: <b>NOWAKI</b><td>";

	echo "<td nowrap align='left'>IMPAR-IMPAR: <b>MIOTO</b><td>";
