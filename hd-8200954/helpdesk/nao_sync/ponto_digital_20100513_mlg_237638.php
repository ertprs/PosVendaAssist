...
<img src='../imagens/btn_gravar.gif' onclick="javascript:
		if (document.frm_ponto_digital.btn_acao.value == '' ) {
			document.frm_ponto_digital.btn_acao.value='Gravar' ;
			document.frm_ponto_digital.submit()
		} else {
			alert ('Não clique no botão voltar do navegador, utilize somente os botões da tela')
		}"

		ALT="Gravar" border='0' style='cursor: hand;'>
</center>
</td>
</tr>
</form>
