...
//VARIAVEL QUE CONTROLA O NUMERO DE QUANTOS CHAMADOS PODEM SER APROVADOS POR FABRICANTE
$backlog = 1;
...
$data = date("d/m/Y  H:i:s");//HD 269744
    ...
    $sql = "SELECT count(*) as total
             ...
             WHERE tbl_hd_chamado.fabrica_responsavel = 10
               ...
               AND (tbl_hd_chamado.status     <> 'Resolvido'
                    ...
                    AND tbl_hd_chamado.status <> 'Novo');";

    $res = pg_exec($con,$sql);

    if (@pg_result($res,0,'total') > ($backlog -1)) {//HD 269744
...
<table width="700" align="center" bgcolor="#FFFFFF" border='0'>
    <tr>
        <td>
            <table width='100%' border='0'>
                <tr>
                    <td valign='middle'>
            <table width="700" align="center"><tr><td style='font-family: arial ; color: #666666; font-size:10px' align="justify"><?php
    ...
    <tr>
        <td colspan="2" class="Conteudo" align="center"><?php
...
if (pg_numrows($res) > 0) {
    ...
    echo "<table width = '700' align = 'center' class='tabela' cellpadding='0' cellspacing='0' border='0'>";
        ...
        echo "</tr>";
        echo "<tr bgcolor='#D9E8FF' style='font-family: arial ; color: #666666'>";
            echo "<td align='center' colspan='100%'>$mes/$ano Inicio: $periodo_inicio - </td>";
        echo "</tr>";
        echo "<tr style='font-family: arial ; font-size: 17px ; cursor: hand; ' height='25' bgcolor='#F2F7FF'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='#F2F7FF'\" >";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
            echo "<td align='center'>Total de franquia de horas deste mês: </td>";
        ...
        echo "<tr style='font-family: arial; font-size: 17px; cursor: hand; ' height='25' bgcolor='#FFFFFF' onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='#FFFFFF'\" >";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
            echo "<td align='center'>Saldo de Hora: </td>";
            echo "<td align='center'> $saldo_hora</td>";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_direito.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
        echo "</tr>";
        echo "<tr  style='font-family: arial ; font-size: 17px ; cursor: hand; ' height='25' bgcolor='#F2F7FF'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='#F2F7FF'\" >";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
            echo "<td align='center'>Total de horas utilizadas: </td>";
            echo "<td align='center'> $hora_utilizada</td>";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_direito.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
        echo "</tr>";
        echo "<tr  style='font-family: arial ; font-size: 17px ; cursor: hand; ' height='25' bgcolor='#F2F7FF'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='#F2F7FF'\" >";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
            echo "<td align='center'><font color='red'>A fabrica pode liberar este mês, sem cobrar, o total de : </td>";
        ...
        echo "<tr  style='font-family: arial ; font-size: 17px ; cursor: hand; ' height='25' bgcolor='#FFFFFF'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='#FFFFFF'\" >";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
            echo "<td align='center'>Hora faturada: </td>";
            echo "<td align='center'> $hora_faturada</td>";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_direito.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
        echo "</tr>";
        echo "<tr style='font-family: arial; font-size: 17px; cursor: hand;' height='25' bgcolor='#F2F7FF'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='#F2F7FF'\" >";
            echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
            echo "<td align='center'>Valor faturado: </td>";
    ...
    if (pg_numrows($res) > 1) {
        ...
        echo "<table width = '700' align = 'center' cellpadding='0' cellspacing='0' border='0'>";
            ...
            echo "</tr>";
            echo "<tr bgcolor='#D9E8FF' style='font-family: arial ; color: #666666'>";
                echo "<td align='center' colspan='100%'>$mes1/$ano1 Período: $periodo_inicio1 - $periodo_fim1 </td>";
            echo "</tr>";
            echo "<tr style='font-family: arial ; font-size: 17px ; cursor: hand; ' height='25' bgcolor='#F2F7FF'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='#F2F7FF'\" >";
                echo "<td background='/assist/helpdesk/imagem/fundo_tabela_centro_esquerdo.gif' ><img src='/assist/imagens/pixel.gif' width='9'></td>";
                echo "<td align='center'>Total de franquia de horas deste mês: </td>";
        ...
        for ($i = 0; $i < pg_numrows($res); $i++) {
            ...
            echo "<tr  style='font-family: arial ; font-size: 12px ; cursor: hand; ' height='25' bgcolor='$cor'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='$cor'\" ><a href='chamado_detalhe.php?hd_chamado=$hd_chamado'>";
                ...
                if ($status == "Análise" AND $exigir_resposta <> "t") {
                    echo "<img src='/assist/admin/imagens_admin/status_azul.gif' align='absmiddle'> ";
                } else if($exigir_resposta == "t" AND $status <> 'Cancelado' OR ($status == "Resolvido" AND strlen($resolvido)==0)) {
                    echo "<img src='/assist/admin/imagens_admin/status_vermelho.gif' align='absmiddle'> ";
                } else if (($status == "Resolvido" AND strlen($resolvido) > 0) OR $status == "Cancelado") {
            ...
            echo "<tr  style='font-family: arial ; font-size: 12px ; cursor: hand; ' height='25' bgcolor='$cor'  onmouseover=\"this.bgColor='#D9E8FF'\" onmouseout=\"this.bgColor='$cor'\" >";
                ...
                if ($supervisor == 't' AND ($status == 'Aprovação' or $status == 'Novo')) {
                    ...
                    $sql3 = "SELECT hora_utilizada
                              ...
                              GROUP BY hora_utilizada,hora_franqueada,
                                       saldo_hora,
                                       hd_franquia,
                                       hora_desenvolvimento
                    ...
                    $sql_dt = "SELECT tbl_hd_chamado.hora_desenvolvimento
                                ...
                                WHERE tbl_hd_chamado_item.hd_chamado = $hd_chamado
                                  AND tbl_hd_chamado_item.comentario ilike '%MENSAGEM AUTOMÁTICA - ESTE CHAMADO FOI ABERTO EM%';";

                    $res_dt      = pg_exec($con,$sql_dt);

                    $item_total  = pg_numrows($res_dt);
                    $hora_desenv = $item_total > 0 ? pg_result($res_dt,0,'hora_desenvolvimento') : null;
                    ...
                    //Se foi enviado para aprovação de horas e está em analise da equipe telecontrol
                    if ($item_total > ($backlog - 1) && strlen($hora_desenv) == 0) {
                        ...
                        echo "<td nowrap>";
                        echo "$href<img src='imagem/btn_ok.gif'border='0' align='absmiddle'>APROVA</a><br><a href='$PHP_SELF?hd_chamado=$hd_chamado&cancela=sim'><img src='imagem/btn_deletar.gif'border='0' align='absmiddle'>CANCELA</a>";
                    }
