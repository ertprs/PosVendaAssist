...
?>
<table width='100%'  border='0'height='60' cellpadding='0' cellspacing='0' border='0'>
<tr bgcolor='FFFFFFF' valign='middle'>
	<td width='100%' align='left' background='imagem/fundo_dh2.jpg'><img src='imagem/fundo_dh5.jpg'></td>
<?
if($login_fabrica<>10){
?>
	<form method='post' action='<?= $prefixo ?>chamado_lista.php' name='frm_pesquisa'>
	<td align='left' nowrap background='imagem/fundo_dh2.jpg'>
...
?>
	...
	<td align='left' nowrap background='imagem/fundo_dh2.jpg'>
<?
echo "<font size='2' color='#FFFFFF'>Login: <b>$analista_login</b><br>
...
<td alig='left' valign='middle' background='imagem/fundo_dh7.jpg'  height='25'>
...
?>
		...
		<td align='center'><font color='#666666'> | </font></td>
		<td align='center' width='90' class='cell_out' onmouseover="this.className='cell_over'" onmouseout="this.className='cell_out'"><a href='adm_producao_horas_cobradas.php' title='Relatório de horas cobradas da franquia de cada fabricante. São considerados os chamados aprovados dentro do mês.' style='text-decoration: none ; color: #000000 '>Relatório de Hora Cobrada </a></b></td>
		<td align='center'><font color='#666666'> | </font></td>
		
		<td align='center' width='90' class='cell_out' onmouseover="this.className='cell_over'" onmouseout="this.className='cell_out'"><a href='adm_producao_fabrica.php' style='text-decoration: none ; color: #000000 ' title='São considerados todas as interações de cada atendente cobrado ou não de cada fabricante'>Relatório Hora Trabalhada Fábrica</a></b></td>
		<td align='center'><font color='#666666'> | </font></td>

		<td align='center' width='90' class='cell_out' onmouseover="this.className='cell_over'" onmouseout="this.className='cell_out'"><a href='adm_producao_fabrica_adm.php' style='text-decoration: none ; color: #000000 ' title='São considerados todas as interações de cada atendente cobrado ou não de cada fabricante'>Relatório Hora Trabalhada Atendente</a></b></td>
		<td align='center'><font color='#666666'> | </font></td>

		<td align='center' width='90' class='cell_out' onmouseover="this.className='cell_over'" onmouseout="this.className='cell_out'"><a href='adm_relatorio_diario.php' style='text-decoration: none ; color: #000000 '>Relatório Diário</a></b></td>
		<td align='center'><font color='#666666'> | </font></td>
