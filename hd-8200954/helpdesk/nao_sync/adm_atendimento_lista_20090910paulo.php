...
### PÉ PAGINACAO###
	...
	if($login_admin == 822) {
		...
		echo "<a href='adm_chamado_lista.php' class='fisheyeItem2' target='_blank'><span>".pg_fetch_result($res,0,0)."</span><img src='imagem/fisheye/windows.png' width='30' /></a>";
		echo "<a href='adm_chamado_lista_novo.php' class='fisheyeItem2' target='_blank'><span>".pg_fetch_result($res,0,1)."</span><img src='imagem/fisheye/linux.png' width='30' /></a>";
		echo "<a href='adm_relatorio_diario.php' class='fisheyeItem2' target='_blank'><span>".pg_fetch_result($res,0,2)."</span><img src='imagem/fisheye/mac.png' width='30' /></a>";
		echo "</div>";
		echo "</div>";
