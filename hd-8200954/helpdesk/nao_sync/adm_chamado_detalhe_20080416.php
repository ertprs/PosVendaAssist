...
//echo $xcobrar; exit;
	...
	if (strlen($msg_erro) == 0){
		...
		if($status== "Aprovação" AND ($status_anterior == "Novo" OR $status_anterior == "Análise")){
...
<td valign='top'>
	...
	<tr>
		...
		<td  class ='sub_label'align='center'><? echo $horas."  h"; ?></td>
	</tr>
	...
	<tr>
		...
		//analistas podem colocar prazo apenas em chamados abertos por eles próprios
		//Sono - 27/12/2007
		if($analista_hd <> "sim" and $login_admin <> $admin) { echo "readonly";}
		?> class='caixa' onblur="javascript:checarNumero(this);"> h
...
<? if($analista_hd == "sim"){ ?>
	<tr>
		...
		<div id='result' style='position:absolute; display:none;  border: 1px solid #949494;background-color: #F1F0E7;width:100px;'>
		</div>
