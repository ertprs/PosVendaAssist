...
if (strpos($PHP_SELF, 'assist/')) {
	...
	$fabrica_nao_quer_anivs = array(96); //	MLG 18-04-201 - HD 413668 - BOSCH Sec. não quer popup de aniversários
...
p_echo("Fábrica atual: $login_fabrica, $fabrica");
pre_echo($fabrica_nao_quer_anivs, "BOSCH Sec.? $login_fabrica");
//	MLG 18-04-201 - HD 413668 - BOSCH Sec. não quer popup de aniversários
if (($e_posto or $e_admin) and !in_array($login_fabrica, $fabrica_nao_quer_anivs)) {
