...
<script language='javascript'>
 				$(document).mousemove(function() {
                    oTable = $('#relatorio').dataTable({
                        ...
                        fnInitComplete:function() { 
                            //RETIRA EVENTOS MOUSEMOVE DA TABELA DE     
	...
	echo "<table width = '100%' align = 'center' cellpadding='2' cellspacing='1' border='0' name='relatorio' id='relatorio' class='relatorio display'>";
	...
	$cabecalho .= "	<th nowrap title='Data da última transferência entre atendentes'>Transferido</td>";
...
//	$cabecalho .= "	<th nowrap title='Horas Trabalhadas'>Trab.</th>";
	...
	//		echo $sql2;
			...
			$sql = "SELECT TO_CHAR(MAX(data), 'DD/MM/YYYY') AS data FROM tbl_hd_chamado_item WHERE hd_chamado=$hd_chamado AND comentario='Chamado Transferido'";
			$res_transferido = pg_query($con, $sql);
			$data_transferido = pg_result($res_transferido, 0, 0);

			echo "</font></td>";
			echo "<td nowrap width='80'><font size='1'>$fabrica_nome</font></td>";
			echo "<td nowrap><font size='1'>$xxatendente[0]</font></td>";
			echo "<td nowrap align='center'><font size='1'>$data_transferido</font></td>";
