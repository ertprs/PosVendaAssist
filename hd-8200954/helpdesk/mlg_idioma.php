...
# Cambiar el nombre a idioma_es.php cuando estй OK... ;)
/*
	Alterado o visual, fazendo com que no MSIE nгo fique colado na margem esquerda
	Adicionado botгo para limpar o formulбrio
	Eliminada a adiзгo no campo "TEXTO" do texto do 'autocomplete', que nгo serve
	para nada, a nгo ser gerar erros por esquecer de apagar...
*/
...
<div style='width:700px; margin:0 auto;'>
	...
	<div>
		PARA REGISTRAR NUEVAS FRASES O PALABRAS, EL MSGID TIENE QUE ESTAR <U>SIEMPRE</U> EN <b>MINЪSCULAS, SEPARADO POR PUNTOS Y SIN ACENTOS</b>
	</div>.
	<BR><BR>
	<table>
		<tr>
		...
		<tr>
			<td><BR><input type='submit' name='btn_acao' VALUE='REGISTRAR NUEVO TEXTO' class='button'></td>
			<td><BR><input type='button' name='btn_reset' VALUE='LIMPIAR FORMULARIO' onclick='limpar_form();' class='button'></td>
		</tr>
	</table>
</div>
</form>
