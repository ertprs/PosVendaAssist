...
if($_GET['ajax']=='sim') {
	...
	" . $interacao . $justificativa;
					...
					$interacao_hd = str_replace("\n", "<br>", $interacao_hd);

					$mensagem = "Uma ou mais melhorias foram anexadas ao chamado $hd_chamado. Segue abaixo a interação do chamado:<br>
					<br>
					$interacao_hd<br>
					<br>
					Suporte Telecontrol";
					...
					$titulo = "Melhorias anexadas ao chamado $hd_chamado";

					mail($to, utf8_encode($titulo), utf8_encode($mensagem), $headers);
