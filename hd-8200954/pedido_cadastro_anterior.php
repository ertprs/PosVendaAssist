...
*/
if($login_fabrica == 5 and $login_posto<>6359 and $login_posto<>14055) {
	$layout_menu = 'pedido';
...
if(strlen($msg_erro)==0){
	if (strlen ($pedido) == 0 ) {
		...
		$sql = "INSERT INTO tbl_pedido (
				...
				if($ip=='200.157.142.131') echo nl2br($sql);
		$res = @pg_exec ($con,$sql);
			...
			?>
				<tr bgcolor="<? echo $cor ?>">
					<td align='left'>
						...
						<? if ($login_fabrica == 14 or $login_fabrica ==66) { ?> onclick="javascript: fnc_pesquisa_peca_lista_intel (document.frm_pedido.produto_referencia.value , document.frm_pedido.peca_referencia_<?echo $i?> , document.frm_pedido.peca_descricao_<?echo $i?> , document.frm_pedido.posicao, 'referencia')" <?
