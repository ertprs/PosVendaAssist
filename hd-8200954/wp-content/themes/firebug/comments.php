...
<?php if ($comment->comment_approved == '0') : ?>
			...
			<?php endif; ?>
			<p class="ucomen"><?php comment_author_link() ?> <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> at <?php comment_time() ?></a> <?php edit_comment_link('edit','&nbsp;&nbsp;',''); ?></p>
...
<p><label for="email"><small>Email (*) :</small></label>
...
<p><label for="url"><small>Comment (*) :</small></label>
<textarea name="comment" id="comment" cols="100%" rows="10" tabindex="4"></textarea></p>

<p><input name="submit" type="image" src="<?php bloginfo('template_directory'); ?>/images/submit.gif" id="submit" alt="Submit Comment" title="Submit Comment" tabindex="5" value="Submit Comment" />
