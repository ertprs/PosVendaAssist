...
$layout_menu = "os";
$title = "Ordens de Serviço do Extrato";
...
<tr>
<td align='center' width='25%'><a href='new_extrato_distribuidor.php?periodo=<? echo $periodo ?>'>Extrato total</a></td>
<td align='center' width='25%'><a href='new_extrato_distribuidor_posto.php?data=<? echo $periodo ?>'>Extrato dos Postos</a></td>
<td align='center' width='25%'><a href='new_extrato_posto_retornaveis.php?extrato=<? echo $extrato ?>'>Peças <br> Retornáveis</a></td>
<td align='center' width='25%'><a href='new_extrato_distribuidor.php'>Ver outro extrato</a></td>
</tr>
</table>
