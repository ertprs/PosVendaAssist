...
if ($btn_acao == "gravar") {
	...
	if (strlen ($msg_erro) == 0) {
		...
		header ("Location: os_press_meteor.php?os=$os");
		exit;
	}else{
...
<tr>
	...
	<td valign="top" align="center">
		...
		<tr>
			<td align='center'><input type="text" name="peca_<? echo $i ?>"    size="20" value="<? echo $peca ?>"><a href='#'><img src='imagens/btn_buscar5.gif' style="margin-left:5px;" border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_peca_lista (document.frm_os.peca_<? echo $i ?> , document.frm_os.descricao, document.frm_os.produto_referencia, document.frm_os.preco_<? echo $i ?>, <? echo $i ?>)' alt='Clique para efetuar a pesquisa'></a></td>
