			...
			*/		
				$sql = "SELECT os 
						...
						WHERE fabrica = $fabrica 
							AND posto = $posto 
							AND data_abertura = '$data_abertura' 
							AND upper(substr(nota_fiscal,length(nota_fiscal)-5,length(nota_fiscal))) = upper('$xnota_fiscal')
...
*/
			...
			if ($fabrica == 14 and 1==2 ) {
				...
				$URL_Info = parse_url("http://ww2.telecontrol.com.br/assist/os_cadastro.php");
			}
