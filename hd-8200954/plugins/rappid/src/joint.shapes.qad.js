joint.dia.Element.define('qad.Answer', {
    attrs: {
        rect: {
            fill: '#4b4a67', //cor fundo instrução
            stroke: 'none',
            refWidth: '100%',
            refHeight: '100%',
            rx: 3,
        ...
        text: {
            ...
            yAlignment: 'middle',
            xAlignment: 'middle',
            fill: '#f6f6f6', //cor texto instrução
...
joint.dia.Element.define('qad.Question', {
            ...
            'in': {
                ...
                attrs: {
                    circle: {
                        magnet: 'passive',
                        stroke: 'white',
                        fill: '#9B9BB2',//Quando adicionar (Cor da marca da Questão)
                        r: 14
                    },
                    text: {
                        pointerEvents: 'none',
            ...
            out: {
                ...
                attrs: {
                    'circle': {
                        magnet: true,
                        stroke: 'none',
                        fill: '#FAC81A',//Quando adicionar (Cor da marca da Resposta)
                        r: 14
                    }
                }
            }
    ...
    attrs: {
        ...
        '.body': {
            refWidth: '100%',
            refHeight: '100%',
            rx: '0.7%', //Border radius
            ry: '0.7%', //Border radius
            stroke: 'none',
            fill: {
                type: 'linearGradient',
                stops: [
                    { offset: '0%', color: '#373865' }, //Cor da caixa de dialogo
                    { offset: '100%', color: '#373865' }
                ],
...
joint.shapes.qad.QuestionView = joint.dia.ElementView.extend({
    ...
    onAddOption: function() {
        ...
        this.model.addOption({
            ...
            text: 'Op��o ' + this.model.get('options').length
        });
    },
