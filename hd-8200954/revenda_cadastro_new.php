...
<? if($login_fabrica == 3){ ?>
	...
	<center>
	<div style='display:none; font:14px Arial; background-color:#7092BE; width:700px;' class="alert alert-error" id='mensagem2'>
...
<form class='form-search form-inline tc_formulario' name="frm_revenda" method="post" action="<? echo $PHP_SELF ?>">
	...
	<div class='row-fluid'>
		<div class='span2'></div>
		<div class='span4'>
			<label class='control-label'><? echo traduz("cnpj.revenda",$con,$cook_idioma); if ($cook_idioma=='ES') echo " 1"; ?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input  type="text" id="cnpj" name="cnpj" size="20" maxlength='18' value="<? echo $cnpj ?>" onblur="buscaRevenda();" onfocus="displayText('&nbsp;Insira o n˙mero no Cadastro Nacional de Pessoa JurÌdica.');" tabindex='-1'>
					<span class='add-on' rel="lupa" style="cursor:pointer" name='revenda_fabrica' id='revenda_fabrica' onclick="javascript: fnc_pesquisa_revenda (document.frm_revenda.cnpj,'cnpj')"><i class='icon-search'></i></span>		 			
		 		</div>
		 	</div>
		</div>
		<div class='span4'>
			<label class='control-label'><? if ($cook_idioma=='ES') echo "ID DISTRIBUIDOR 2"; else echo traduz("ie",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" name="ie" id='ie' size="18" maxlength="20" value="<? echo $ie ?>">
				</div>
			</div>
		</div>
		<div class='span2'></div>
	...
	<div class='row-fluid'>
		<div class='span2'></div>		
		<div class='span4'>
			<label class='control-label'><? echo traduz("fone",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" name="fone" id='fone' class="telefone" size="15" maxlength="20" value="<? echo $fone ?>">
				</div>
			</div>
		</div>
		<div class='span4'>
			<label class='control-label'><? echo traduz("fax",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" name="fax" id='fax' class="telefone" size="15" maxlength="20" value="<? echo $fax ?>">
				</div>
			</div>
		</div>
		<div class='span2'></div>
	...
	<div class='row-fluid'>
		<div class='span2'></div>		
		<div class='span8'>
			<label class='control-label'><? echo "Raz„o";?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" id='nome' name="nome" size="70" maxlength="150" value="<? echo $nome ?>" style="width:500px">
				</div>
			</div>
		</div>
		<div class='span2'></div>
	...
	<div class='row-fluid'>
		<div class='span2'></div>		
		<div class='span2'>
			<label class='control-label'><? echo traduz("cep",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>			
					<input type="text" name="cep" class="addressZip" id='cep' size="10" maxlength="10" value="<? echo $cep ?>" style="width:100px">				
				</div>
			</div>
		</div>		
		<div class='span2'>
			<label class='control-label'><? echo traduz("estado",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>		
			        <?php
			        if ($pais == "BR") {
		...
		<div class='span2'>
			<label class='control-label'><? echo traduz("cidade",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
	...
	<div class='row-fluid'>
		<div class='span2'></div>		
		<div class='span4'>
			<label class='control-label'><? echo traduz("bairro",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" class="addressDistrict" name="bairro" id='bairro' size="35" maxlength="20" value="<? echo $bairro ?>">
				</div>
			</div>
		</div>		
		<div class='span4'>
			<label class='control-label'><? echo "EndereÁo";?></label>
			<div class='controls controls-row'>
				<div class='span12 input-append'>
					<input type="text" name="endereco" class="address" id='endereco' size="42" maxlength="50" value="<? echo $endereco ?>">
				</div>
			</div>
		</div>
		<div class='span2'></div>
	...
	<div class='row-fluid'>
		<div class='span2'></div>		
		<div class='span4'>
			<label class='control-label'><? echo "N˙mero";?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" name="numero" id='numero' size="10" maxlength="10" value="<? echo $numero ?>">
				</div>
			</div>
		</div>
		<div class='span4'>
			<label class='control-label'><? echo traduz("complemento",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" name="complemento" id='complemento' size="35" maxlength="30" value="<? echo $complemento ?>">
				</div>
			</div>
		</div>		
		<div class='span2'></div>
	...
	<div class='row-fluid'>
		<div class='span2'></div>		
		<div class='span4'>
			<label class='control-label'><? echo traduz("contato",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
					<input type="text" name="contato" id='contato' size="30" maxlength="30" value="<? echo $contato ?>">
				</div>
			</div>
		</div>
		<div class='span4'>
			<label class='control-label'><? echo traduz("email",$con,$cook_idioma);?></label>
			<div class='controls controls-row'>
				<div class='span7 input-append'>
	...
	<input class="tac btn" id='btn_gravar' name='btn_gravar' type='submit' style="cursor: pointer;" onclick="javascript: if (document.frm_revenda.btn_acao.value == '' ) { document.frm_revenda.btn_acao.value='gravar' ; document.frm_revenda.submit() } else { alert ('Aguarde') }" ALT="<?fecho ("gravar.formulario",$con,$cook_idioma);?>" border='0' value='Gravar'>
	<input class="tac btn" id='btn_limpar' name='btn_limpar' type='submit' style="cursor: pointer;" onclick="javascript: if (document.frm_revenda.btn_acao.value == '' ) { document.frm_revenda.btn_acao.value='reset' ; document.frm_revenda.reset(); window.location='<? echo $PHP_SELF ?>' } else { alert ('Aguarde') }" ALT="<?fecho ("limpar.campos",$con,$cook_idioma);?>" border='0' value='Limpar'>	
	<br><br><br>
</form>
<p>
<?
