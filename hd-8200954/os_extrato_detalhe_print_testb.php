...
//--=== OS DENTRO DO EXTRATO =====================================================================================--\\
	...
	}elseif ($login_fabrica == 50 or $login_fabrica == 52 or ($login_fabrica == 24 and $login_tipo_posto == 256) or $login_fabrica == 85 or $login_fabrica == 90){
...
/*
	...
	if ($login_fabrica == 6){
	...
	}elseif ($login_fabrica == 50 or $login_fabrica == 52 or $login_fabrica == 90){
		...
		if($login_fabrica == 90){
			echo "<td colspan=2 align='right' bgcolor='$cor' style='padding-right:2px' nowrap><b>  " . number_format ($total_tx_visita,2,",",".") . "</b></td>\n";
		}
	}else{
		echo "<td colspan=2 align='right' bgcolor='$cor' style='padding-right:2px' nowrap><b>  " . number_format ($total_mao_de_obra,2,",",".") . "</b></td>\n";
	...
	if ($login_fabrica == 19) {
		...
		if ($login_fabrica == 6){
			...
			echo "</b></td>\n";
			if($login_fabrica != 90)
				echo "<td colspan=\"4\" bgcolor='$cor' align='center'><b>  " . number_format ($total_mao_de_obra + $total_mao_de_obra_revenda + $total_pecas + $total_pecas_revenda +$total_km,2,",",".") . "</b></td>\n";
			else
				echo "<td colspan=\"6\" bgcolor='$cor' align='center'><b>  " . number_format ($total_mao_de_obra + $total_mao_de_obra_revenda +$total_km+$total_tx_visita,2,",",".") . "</b></td>\n";
