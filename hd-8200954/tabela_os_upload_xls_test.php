...
unlink("/tmp/assist/dados-upload-$login_fabrica-$data.html");
unlink("/tmp/assist/dados-upload-$login_fabrica-$data.xls");
unlink("/var/www/assist/www/download/dados-upload-$login_fabrica-$data.zip");

unlink("/tmp/assist/dados-upload-lista-basica-$login_fabrica-$data.html");
unlink("/tmp/assist/dados-upload-lista-basica-$login_fabrica-$data.xls");
unlink("/tmp/assist/dados-upload-lista-basica-$login_fabrica-$data.txt");
unlink("/var/www/assist/www/download/dados-upload-lista-basica-$login_fabrica-$data.zip");
unlink("/var/www/assist/www/download/dados-upload-lista-basica2-$login_fabrica-$data.zip");
...
rename("$tmp_dir/dados-upload-$login_fabrica-$data.html", "$tmp_dir/dados-upload-$login_fabrica-$data.xls");
//gera o zip
echo `zip -jquomT $tmp_dir/assist/www/download/dados-upload-$login_fabrica-$data.zip dados-upload-$login_fabrica-$data.xls > /dev/null`;
...
//gera o xls
rename("/tmp/assist/dados-upload-lista-basica-$login_fabrica-$data.html", "/tmp/assist/dados-upload-lista-basica-$login_fabrica-$data.xls");

//gera o zip
echo `zip -jquomT $tmp_dir/dados-upload-lista-basica-$login_fabrica-$data.zip /var/www/assist/www/download/dados-upload-lista-basica-$login_fabrica-$data.xls > /dev/null`;
...
//gera o zip
echo `zip -jquomT $tmp_dir/dados-upload-lista-basica2-$login_fabrica-$data.zip /var/www/assist/www/download/dados-upload-lista-basica-$login_fabrica-$data.txt > /dev/null`;
