		...
		http[curDateTime].onreadystatechange = function(){
			if (http[curDateTime].readyState == 4) 
			{
				if (http[curDateTime].status == 200 || http[curDateTime].status == 304) 
				{
					...
					if (response!="sem"){
						document.frm_os.link_comunicado.value=response;
...
function abreComunicado(){
	if (document.frm_os.link_comunicado.value!=""){
		window.open(document.frm_os.link_comunicado.value);
	}
}
			...
			<td nowrap>
				...
				if (strlen ($produto_referencia) >0) {
					$sql ="SELECT tbl_comunicado.comunicado, tbl_comunicado.extensao
						...
						WHERE tbl_comunicado.tipo='Comunicado'
					...
					$res = pg_exec($con,$sql);
					if (pg_numrows($res) > 0) 
						$arquivo_comunicado= "comunicados/".pg_result($res,0,comunicado).".".pg_result($res,0,extensao);
				}
/*visibility:<? if ($arquivo_comunicado) echo "visible;";else echo "hidden;"; ?>*/
				...
				<input class="frm" type="text" name="produto_referencia" size="15" maxlength="20"
					...
					onblur="this.className='frm'; displayText('&nbsp;');checarComunicado(<? echo $login_fabrica ?>);"
...
?>
		...
		<tr>
			...
			<td>
				<font size="1" face="Geneva, Arial, Helvetica, san-serif"><? if($sistema_lingua) echo "Teléfono";else echo "Fone";?></font>
				<br>
...
#			echo " -->";
		...
		<tr>
			...
			if ($login_fabrica <> 19) {
				...
				if($sistema_lingua) echo "Consumidor";else echo "Consumidor";
				...
				if($sistema_lingua) echo "o";else echo "ou";
				
				echo "</font></td>";

				echo "<td><font size='1' face='Geneva, Arial, Helvetica, san-serif'>";

				if($sistema_lingua) echo "Distribuidor";else echo "Revenda";
			...
			if($login_fabrica==11){
				...
				echo "<td>";
				echo "<font size='1' face='Geneva, Arial, Helvetica, san-serif'>";
				if($sistema_lingua) echo "Apariencia del producto";else echo "Aparência do Produto";
				echo "</font>";
			}
			echo "<br>";
			...
			if ($login_fabrica == 20) {
				...
				echo ">";
				if($sistema_lingua) echo "Buena aparencia";else echo "Bom Estado";
				echo "</option>";

				echo "<option value='USL' ";
				if ($aparencia_produto == "USL") echo " selected ";
				echo ">";
				if($sistema_lingua) echo "Uso continuo";else echo "Uso intenso";
				echo " </option>";

				echo "<option value='USN' ";
				if ($aparencia_produto == "USN") echo " selected ";
				echo ">";
				if($sistema_lingua) echo "Uso normal";else echo "Uso Normal";
				echo "</option>";

				echo "<option value='USH' ";
				if ($aparencia_produto == "USH") echo " selected ";
				echo ">";
				if($sistema_lingua) echo "Uso Pesado";else echo "Uso Pesado";
				echo "</option>";

				echo "<option value='ABU' ";
				if ($aparencia_produto == "ABU") echo " selected ";
				echo ">";
				if($sistema_lingua) echo "Uso Abusivo";else echo "Uso Abusivo";
				echo "</option>";

				echo "<option value='ORI' ";
				if ($aparencia_produto == "ORI") echo " selected ";
				echo ">";
				if($sistema_lingua) echo "Original, sin uso";else echo "Original, sem uso";
				echo "</option>";

				echo "<option value='PCK' ";
				if ($aparencia_produto == "PCK") echo " selected ";
				echo ">";
				if($sistema_lingua) echo "Embalaje";else echo "Embalagem";
				echo "</option>";
