...
//busca o nome do posto para colocar no corpo do e-mail de confirmacao de leitura========
	$sql = "SELECT nome
			FROM tbl_posto
...
//funçao envia e-mail====================================================================
	...
	$sql = "SELECT remetente_email, tbl_posto.nome , descricao FROM tbl_comunicado JOIN tbl_posto USING (posto) WHERE tbl_comunicado.comunicado = $comunicado_lido AND tbl_comunicado.posto IS NOT NULL AND tbl_comunicado.remetente_email IS NOT NULL";
	$res = pg_exec ($con,$sql);
	if (pg_numrows ($res) == 1) {
