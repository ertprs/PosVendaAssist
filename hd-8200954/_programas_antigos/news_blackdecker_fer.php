...
echo "<td valign='top'>";
	...
	<tr>
	<td valign='top'><img border='0' src='http://www.telecontrol.com.br/assist/imagens/esclamachion1.gif'></td>
	...
	<center><a href='promocao.php' class='menu'>Compre parafusadeira, furadeira e moto compressor para utilizar em sua oficina.</a></center></font>
	</tr></td>
	</table>";
echo "</td>";
...
echo "<table width='650' cellpadding='0' cellspacing='0' border='0' bordercolor='DDDDDD' class='contentBlockRight'>";
echo "<tr>";
...
echo "<tr>";
	...
	echo " <TD>
		<font size='1' face='Geneva, Arial, Helvetica, san-serif' color='#000000'><a href='mailto:rogerio_berto@blackedecker.com.br'><b>ROGÉRIO BERTO</b></a><br>
