...
if ($login_fabrica == 1 and $login_posto==5237 and 1==2) {
			...
			if ($login_fabrica == 1) {
				...
				if (($excluida == "f" || strlen($excluida) == 0) && strlen($fechamento) == 0) {
					if(strlen($tipo_atendimento) == 0)
						...
						if($valores_adicionais == 0) echo "<a href='os_cadastro_troca.php?os=$os'><img border='0' src='imagens/btn_alterar_cinza.gif'></a>";
				}else{
					echo "&nbsp;";
				}
				echo "</td>\n";
					...
					if ($excluida == "f" || strlen($excluida) == 0) {
						if (strlen ($admin) == 0) {
							if ($sistema_lingua=='ES')
								...
								if($login_fabrica == 1 AND $valores_adicionais == 0 AND ($tipo_atendimento == 17 OR $tipo_atendimento == 18))
			...
			if (strlen($fechamento) == 0 AND $status_os!="62" && $status_os!="65" && $status_os!="72") {
				if ($excluida == "f" || strlen($excluida) == 0) {
					if ($sistema_lingua=='ES'){
						...
						if($login_fabrica == 1 AND ($nota_fiscal_saida == 0 AND ($tipo_atendimento == 17 OR $tipo_atendimento == 18))){
							echo "&nbsp;";
						}else{
