...
if ($acao == "PESQUISAR") {
	...
	if (strlen($opcao1) == 0 && strlen($opcao2) == 0 && strlen($opcao3) == 0 && strlen($opcao4) == 0 && strlen($opcao5) == 0) {
		$msg .= " Selecione pelo menos uma opção para realizar a pesquisa. ";
	}

  	if (strlen($erro) == 0 && strlen($opcao1) > 0) {
  	if (strlen($_GET["data_inicial"]) == 0)$msg .= "Favor informar a data inicial para pesquisa<br>";
  	if ($_GET["data_inicial"] == 'dd/mm/aaaa') $msg .= "Favor informar a data inicial para pesquisa<br>";
  	if (strlen($erro) == 0) {
	...
	if (strlen($msg) == 0 && strlen($opcao3) > 0) {
		if (strlen($mes) == 0) $msg .= " Selecione o mês para realizar a pesquisa. ";
		if (strlen($ano) == 0) $msg .= " Selecione o ano para realizar a pesquisa. ";
...
<table width="450" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td width="10">&nbsp;</td>
		<td><input type="checkbox" name="opcao1" value="1" <? if (strlen($opcao1) > 0) echo "checked"; ?>> Período </td>
		<td>Mês</td>
		<td colspan="2">Ano</td>
		<td width="10">&nbsp;</td>
	</tr>
	<tr class="Conteudo" bgcolor="#D9E2EF">
		...
		<img border="0" src="imagens/btn_lupa.gif" align="absmiddle" onclick="javascript:showCal('DataInicial')" style="cursor: hand;" alt="Clique aqui para abrir o calendário"></td>
		<td colspan="2">
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td><input type="checkbox" name="opcao2" value="2" <? if (strlen($opcao2) > 0) echo "checked"; ?>> Revenda</td>
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		...
		<td>
			...
			<img border="0" src="imagens/btn_lupa.gif" style="cursor: hand;" align="absmiddle" alt="Clique aqui para pesquisar revendas pelo código" onclick="javascript: fnc_pesquisa_revenda (document.frm_relatorio.revenda_cnpj, 'cnpj');">
		</td>
		<td colspan="2">
			<input type="text" name="revenda_nome" size="15" value="<?echo $revenda_nome?>">
			<img border="0" src="imagens/btn_lupa.gif" style="cursor: hand;" align="absmiddle" alt="Clique aqui para pesquisar pelo nome da revenda." onclick="javascript: fnc_pesquisa_revenda (document.frm_relatorio.revenda_nome, 'nome');">
		</td>
		<td>
			&nbsp;
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td><input type="checkbox" name="opcao3" value="3" <? if (strlen($opcao3) > 0) echo "checked"; ?>> Produto</td>
		<td>Referência</td>
		<td>Descrição</td>
		<td>Voltagem</td>
		<td>&nbsp;</td>
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td><input type="text" name="produto_referencia" size="8" value="<?echo $produto_referencia?>"> <img src="imagens/btn_lupa.gif" width='20' height='18'  width='20' height='18' style="cursor: hand;" align='absmiddle' alt="Clique aqui para pesquisar postos pelo código" onclick="javascript: fnc_pesquisa_produto (document.frm_relatorio.produto_referencia, document.frm_relatorio.produto_descricao, 'referencia', document.frm_relatorio.produto_voltagem)"></td>
		<td><input type="text" name="produto_descricao" size="15" value="<?echo $produto_descricao?>"> <img src="imagens/btn_lupa.gif" width='20' height='18'  style="cursor: hand;" align='absmiddle' alt="Clique aqui para pesquisas pela referência do aparelho." onclick="javascript: fnc_pesquisa_produto (document.frm_relatorio.produto_referencia, document.frm_relatorio.produto_descricao, 'descricao', document.frm_relatorio.produto_voltagem)"></td>
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" name="opcao4" value="4" <? if (strlen($opcao4) > 0) echo "checked"; ?>> Número da OS Revenda</td>
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" name="opcao5" value="5" <? if (strlen($opcao5) > 0) echo "checked"; ?>> Número Série</td>
		<td colspan="2"><input type="text" name="numero_serie" size="10" value="<?echo $numero_serie?>"></td>
		<td>&nbsp;</td>
	</tr>
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td colspan="6">&nbsp;</td>
	...
	<tr bgcolor="#D9E2EF">
		<td colspan="6" align="center"><img border="0" src="imagens/btn_pesquisar_400.gif" onclick="document.frm_relatorio.acao.value='PESQUISAR'; document.frm_relatorio.submit();" style="cursor: hand;" alt="Preencha as opções e clique aqui para pesquisar"></td>
	</tr>
</table>
...
$data_final   = "$aux_data_inicial 23:59:59";
	...
	if (pg_numrows($res) > 0) {
		...
		if ($login_fabrica == 1 OR $login_fabrica == 14) {
			...
			if($login_fabrica == 1){
				...
				echo "<td align='left'><font size='1'>&nbsp; OSs Reincidentes, que tem uma OS no sistema lançada a menos de 90 dias com o mesmo CNPJ e o mesmo Número de Nota Fiscal</font></td>";
				echo "</tr>";
			}
			echo "</table>";
			echo "<br>";
...
//ao clicar aqui vc vai explodir a OS
				echo "<td width='80' align='center'>";
				//retirado a condição que verifica na tbl_os - Wellington 27-09-2006
				if (/*pg_numrows($resX) == 0 || */strlen($explodida) == 0) echo "<a href='os_revenda_finalizada.php?os_revenda=$os_revenda&btn_acao=explodir'><img border='0' src='imagens/btn_explodir.gif'></a>";
				else                                                                          echo "&nbsp;";
				echo "</td>";
				...
				if (strlen($consumidor_revenda) == 0) {
					...
					if($os_reincidente =='t'){
						echo "<a href='os_motivo_atraso.php?os=$os_revenda&justificativa=ok'><br><font color='FFFFFF'>JUSTIFICATIVA</a>";
					}
					echo "</td>\n";
//takashi
					echo "<td width='80' align='center'>";
					if (($excluida == "f" || strlen($excluida) == 0) && strlen($data_fechamento) == 0) if($login_fabrica==1)echo "<a href='os_revenda_alterar.php?os=$os_revenda'><img src='imagens/btn_alterar_cinza.gif'></a>";
					else                                                                               echo "&nbsp;";
					echo "</td>\n";
