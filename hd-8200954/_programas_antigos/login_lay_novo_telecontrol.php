...
//--######## ESQUERDO ########## -->
	...
	echo "<td height='160' align='center' valign='top' bgcolor='#F0CECE'>";
		...
		echo "<B><br><BR><a href='#'>Fechar Ordem Serviço</a></B></td>";
		echo "</tr>";
	echo "</table>";
	echo "</td>";
	echo "</tr>";
...
echo "<td>";
	...
	echo "</tr>";
	echo "<tr>";
		echo "<td bgcolor='#E4B998'>Mantenha as informações sobre seu posto atualizadas!! <a href='http://www.telecontrol.com.br/assist/posto_cadastro.php'>Clique aqui</a> para adicionar ou alterar alguma informação.";
		echo "</td>";
	echo "</tr>";
	echo "</table>";
	echo "<BR>";
...
echo "<table width='350' border='0' align='left' cellpadding='5' cellspacing='1' style='font-family: verdana; font-size: 12px; background-color: #CD4444'>";
	...
	echo "<td bgcolor='#F0CECE'>";
		...
		echo "<B>Cadastrar</B><BR>";
		echo "<a href='http://www.telecontrol.com.br/assist/os_cadastro.php' target='_blank'>Ordem Serviço</a><BR>";
		echo "<a href='http://www.telecontrol.com.br/assist/pedido_cadastro.php' target='_blank'>Pedidos de Peça</a><BR>";
		...
		echo "<td width='50%' valign='top' bgcolor='#F0CECE'> ";
		echo "<B>Consultar</b><BR>";
		echo "<a href='http://www.telecontrol.com.br/assist/os_consulta_lite.php' target='_blank'>Ordem Serviço</a><BR>";
		echo "<a href='http://www.telecontrol.com.br/assist/pedido_relacao.php' target='_blank'>Pedidos de Peça</a><BR>";
		echo "<a href='http://www.telecontrol.com.br/assist/menu_pedido.php#pendencia_relacao.php' target='_blank'>Pendência de Peça</a><BR>";
		...
		echo "<B><a href='http://www.telecontrol.com.br/assist/os_fechamento.php' target='_blank'>Fechar Ordem Serviço</a></B>";
		echo "</td>";
		echo "</tr>";
		echo "</table>";
	echo "</td>";
