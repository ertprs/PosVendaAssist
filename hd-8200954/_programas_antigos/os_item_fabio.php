...
//echo "1: $sql";
										...
										if ($login_fabrica==10  AND 1==1 AND $xservico=="52" AND ($intervencao_fabrica_peca=='t' OR $troca_obrigatoria_peca=='t') ){ // 20 trocar depois
...
if($login_fabrica==10  AND 1==1 AND strlen($msg_intervencao)<0){ // para nao mostrar - fabio
