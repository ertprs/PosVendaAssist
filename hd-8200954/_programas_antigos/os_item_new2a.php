...
if (strlen ($msg_erro) > 0) {
	...
	if($login_fabrica==6){
	echo "<b><font face='Arial, Helvetica, sans-serif' color='#465357' size='1'>Caso
algum tipo de defeito Constatado não esteja relacionado nas opções, favor informar o
Depto de Assistência Técnica através do (011) 3823-1713 ou mesmo através do E-mail :
duvidatecnicas@tectoy.com.br</font></b>";
	}
	if($login_fabrica==20){
...
<?
		if (($login_fabrica==6) or ($login_fabrica==15) or ($login_fabrica==11)){ 
	...
	echo "<INPUT TYPE='text' name='defeito_reclamado' size='30' value='$xdefeito_reclamado - $xdefeito_reclamado_descricao' disabled>";
		echo "<INPUT TYPE='hidden' name='xxdefeito_reclamado' value='$xdefeito_reclamado'>";
...
echo "familia: $produto_familia";*/
	...
	echo "<select name='solucao_os' class='frm'  style='width:200px;' onfocus='listaSolucao(document.frm_os.defeito_constatado.value, document.frm_os.xxproduto_linha.value, document.frm_os.xxdefeito_reclamado.value,  document.frm_os.xxproduto_familia.value);' >";
