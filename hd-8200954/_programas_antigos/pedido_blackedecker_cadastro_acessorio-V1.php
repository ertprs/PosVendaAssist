...
if (1 == 1) {
	if (strval(strtotime(date("Y-m-d H:i:s"))) < strval(strtotime("2005-10-28 08:00:00"))) { // DATA DA VOLTA
		if (strval(strtotime(date("Y-m-d H:i:s"))) >= strval(strtotime("2005-10-25 13:45:00"))) { // DATA DO BLOQUEIO
			...
			echo "<h4><b>";
			echo "Devido ao nosso fechamento mensal, conforme Calendário Fiscal disponível, o site ficará travado para a digitação de pedidos retornando no dia 28/10 às 08 horas. 
				<br><br>
				Salientamos que os pedidos finalizados  após esta data, serão enviados para a fábrica somente na segunda-feira dia 31/10.
				<br><br>
...
if ($tipo_posto <> 38 and $tipo_posto <> 39) {
