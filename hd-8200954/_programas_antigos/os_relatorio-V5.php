...
<option <?if ($status == "99") echo " selected ";?> value='99'><? if($sistema_lingua == 'ES') echo "Finalizadas";else echo "Finalizadas";?></option>
<option <?if ($status == "13") echo " selected ";?> value='13'><? if($sistema_lingua == 'ES') echo "Rechazadas";else echo "Recusadas";?></option>
	...
	<tr bgcolor="#D9E2EF">
		<td colspan="4"><img border="0" src="<?if($sistema_lingua=='ES')echo "admin_es/";?>imagens/btn_pesquisar_400.gif" onClick="document.frm_relatorio.acao.value='PESQUISAR'; document.frm_relatorio.submit();" style="cursor: hand;" alt="Preencha as opções e clique aqui para pesquisar"></td>
	</tr>
</table>
			...
			for ($i = 0 ; $i < pg_numrows($res) ; $i++) {
				...
				*/
				...
				if (($status == "00") or ($status == "99")) {
					if     (strlen($data_geracao) >  0  AND strlen($aprovado) == 0)                                                                          echo "Em aprovação";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
					elseif (strlen($data_geracao) == 0  AND strlen($aprovado) == 0 AND strlen($status_os) == 0 AND strlen(trim($data_fechamento)) <> 0)      echo "Finalizada";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
					elseif ($login_fabrica == 19 AND $status_os <> 13 AND strlen($aprovado) > 0)                                                             echo "Aprovada";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
					elseif ($login_fabrica <> 19 AND $login_fabrica <> 1 AND strlen($aprovado) > 0 AND strlen($extrato) > 0)                                 echo "Aprovada";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
					elseif ($login_fabrica == 1 AND strlen($aprovado) > 0 AND strlen($extrato) > 0 AND $status_os == 18)                                     echo "Em Análise";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
					elseif ($login_fabrica == 1 AND strlen($aprovado) > 0 AND strlen($extrato) > 0 )                                                         echo "Aprovada";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
					elseif ($login_fabrica == 19 AND $status_os == 13 AND strlen($extrato) > 0)                                                              echo "Recusada";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
					...
					elseif ($login_fabrica <> 19 AND $status_os == 13 AND strlen($extrato) == 0 AND strlen(trim($data_fechamento)) > 0)                      echo "Finalizada";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
...
//foi adicionado a linha acima AND tbl_os.excluida = 'f' para nao pegar as os que ja foram excluidas.
		...
		if (pg_numrows($res) > 0) {
			...
			for ($i = 0 ; $i < pg_numrows($res) ; $i++) {
				...
				if ($status_os == 14 OR $status_os == 13) echo " onclick=\"javascript: window.location='os_consulta_lite.php?btn_acao=PESQUISAR&sua_os=$sua_os';\" style='cursor: hand;' TITLE='CLIQUE PARA ACESSAR A OS'";
				echo ">";
				...
				echo "<td nowrap align='center'>" . $os . "</td>";
				echo "<td nowrap align='center'>";
				if     ($status_os == 13 and strlen($extrato) == 0)    echo "Recusada";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
				elseif ($status_os == 14 and strlen($extrato) == 0)    echo "Acumulada";//(Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
				elseif ($status_os == 15 and strlen($extrato) == 0)    echo "Excluída";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
				elseif ($status_os == 62 and strlen($extrato) == 0)    echo "Intervenção da Fábrica";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
				elseif ($status_os == 65 and strlen($extrato) == 0)    echo "Reparo na Fábrica";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
	...
	if (pg_numrows($res) > 0) {
		...
		for ($i = 0 ; $i < pg_numrows($res) ; $i++) {
			...
			if (strlen($data_geracao) > 0 AND strlen($aprovado) == 0 AND strlen($status_os) == 0)      echo "Em aprovação";// (Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
			elseif (strlen($data_geracao) == 0 AND strlen($aprovado) == 0 AND strlen($status_os) == 0) echo "Em aprovação";//(Sts=".$status_os.") (geracao=".$data_geracao.") (aprovado=".$aprovado.") (extrato=".$extrato.") (fechamento=".$data_fechamento.")";
...
//echo "$sql";
		if(pg_numrows($res) > 0){
			echo "<table width='600' border='1' cellpadding='2' cellspacing='0' style='border-collapse: collapse' bordercolor='#000000' align='center'>";
			echo "<tr class='Titulo'>";
			echo "<td colspan='3'>PEÇAS FATURADAS EXCLUÍDAS</td>";
			echo "</tr>";
			echo "<tr class='Titulo'>";
			echo "<td>OS</td>";
			echo "<td>ABERTURA</td>";
...
//echo "j $j ";
				$os_peca          = trim(pg_result($res,$j,observacao));
				$os_sua_os        = trim(pg_result($res,$j,sua_os));
				$os_data_abertura = trim(pg_result($res,$j,data_abertura));
...
//echo "$sqlZ";
					...
					echo "<td align='center'>$codigo_posto$os_sua_os</td>";
					echo "<td align='center'>$os_data_abertura</td>";
					echo "<td style='font-weight: bold; font-size: 10px'>$os_peca_referencia - $os_peca_descricao</td>";
					echo "</tr>";
				}
			}
			echo "</table>";
