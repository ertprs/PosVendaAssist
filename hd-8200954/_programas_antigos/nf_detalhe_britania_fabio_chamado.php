	...
	if (pg_numrows($res) > 0) {
		...
		if (strlen($conhecimento)>0){
			if ((strtoupper ($transp) == "E-SEDEX" OR strtoupper ($transp) == "SEDEX" OR strtoupper ($transp) == "PAC") AND $login_fabrica == "3") {
				echo "<br><center><a href='http://websro.correios.com.br/sro_bin/txect01$.QueryList?P_LINGUA=001&P_TIPO=001&P_COD_UNI=$conhecimento"."BR' target='_blank' class='link'>Clique aqui para rastrear a encomenda</a></center><br>";
