...
//PARA FABRICAS QUE NAO SAO BRITANIA
	...
	$sql = "SELECT tbl_peca.peca, 
			...
			GROUP BY tbl_peca.peca, tbl_peca.descricao,tbl_peca.referencia,  tbl_os_item.qtde, to_char(tbl_extrato.data_geracao, 'DD/MM/YYYY') 
	...
	if ($totalRegistros > 0){
		...
		if ($agrupar == "false") {
			echo "<TD align='center' >OS</TD>\n";
			echo "<TD align='center' >CLIENTE2</TD>\n";
		}
...
// 	echo nl2br($sql);
	if ($agrupar == "false") {
//   echo "entrou onde nao era pra entrar";
	echo "<TABLE width='650' align='center' border='0' cellspacing='1' cellpadding='1'>\n";
