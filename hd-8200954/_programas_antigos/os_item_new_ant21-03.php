...
if ((strlen($defeito_reclamado)>0) and (($login_fabrica==3) or ($login_fabrica==6) or ($login_fabrica==15) or ($login_fabrica==11) or ($login_fabrica==2) or ($login_fabrica==24) or ($login_fabrica==5))){ 
