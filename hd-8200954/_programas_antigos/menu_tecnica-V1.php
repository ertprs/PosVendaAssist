...
<?
	if ($login_fabrica == 1) {
?>
	<td nowrap width='260'><a href='comunicado_mostra_blackedecker.php' class='menu'>Comunicados / boletins / informativos</a></td>
<?
	}else{
?>
...
?>
	...
	<td nowrap class='descricao'>Apresenta os comunicados, boletins e informativos do Fabricante</td>
</tr>
<!-- ================================================================== -->
<tr bgcolor='#f0f0f0'>
	<td width='25'><img src='imagens/marca25.gif'></td>
