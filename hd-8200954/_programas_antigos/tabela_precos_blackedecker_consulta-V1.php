...
//if ($ip == "201.0.9.216") echo $sql;
		...
		if (pg_numrows($res) > 0) {
			...
			echo "<td bgcolor='#007711' align='center' nowrap><font face='arial' color='#ffffff'><b>Descrição</b></font></td>";
			echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>UN</b></font></td>";
			...
			if ($tabela == 54) {
				...
				echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>QUANTIDADE<BR>MÍNIMA</b></font></td>";
			}else{
				if ($liberar_preco) {
					switch ( substr($descricao,0,3) ) {
						case "Dis" :
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>COMPRA<br>Sem IPI</b></font></td>";
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>DISTRIBUIÇÃO<br>Com IPI</b></font></td>";
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>PREÇO<br>SUGERIDO<br>Com IPI</b></font></td>";
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>IPI</b></font></td>";
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>QUANTIDADE<BR>MÍNIMA</b></font></td>";
						break;
						case "Vip" :
						...
						break;
						default :
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>COMPRA<br>Com IPI</b></font></td>";
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>PREÇO<br>SUGERIDO<br>Com IPI</b></font></td>";
							echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>QUANTIDADE<BR>MÍNIMA</b></font></td>";
						break;
					}
...
//echo "<!-- $sql -->";
		...
		if (strlen($msg_erro) == 0){
			...
			for ($i = 0 ; $i < pg_numrows ($res) ; $i++) {
				...
				if ($i == 0) {
					flush();
					echo "<table width='700' align='center' cellspacing='3' border='1'>";
					echo "<tr>";
					echo "<td bgcolor='#007711' align='center'><font face='arial' color='#ffffff'><b>Peça</b></font></td>";
