...
echo "<form name='frm_pedido_lista' method='post' action='$PHP_SELF'>";
		...
		echo "<td align='center'><font size='2' face='Geneva, Arial, Helvetica, san-serif'><b>Data Recebimento</b></font></td>";
		...
		for ($i = 0 ; $i < pg_numrows ($res) ; $i++) {
			...
			echo "<td align='center'><font size='1' face='Geneva, Arial, Helvetica, san-serif'>". mostra_data ($data) ."</font></td>";
			echo "<td align='center'><font size='1' face='Geneva, Arial, Helvetica, san-serif'>". $finalizado ."</font></td>";
			
			if (strlen($pedido_status) > 0) {
				echo "<td nowrap><font size='1' face='Geneva, Arial, Helvetica, san-serif'>$pedido_status</font></td>";
			}else{
				echo "<td nowrap><font size='1' face='Geneva, Arial, Helvetica, san-serif'>$status_pedido</font></td>";
			}
