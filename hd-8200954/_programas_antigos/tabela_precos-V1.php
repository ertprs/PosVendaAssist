...
<tr>
	...
	<td align="left" width="300">
		<select name="tabela" size="1" tabindex="0" >
<?
...
<tr>
	<td align="left" width="200">
		<font face="arial"><b>&nbsp;&nbsp;<? if ($login_fabrica == 1) { ?>Código<? }else{ ?>Referência<? } ?> do produto</b></font>
	</td>
	...
	<td align="left" width="300">
		...
		&nbsp;
		<a href="#"><img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_produto (document.frm_tabela.referencia_produto,document.frm_tabela.descricao_produto,"referencia")'></a>
	</td>
</tr>
</table>
...
<tr>
	<td align="left" width="200">
		<font face="arial"><b>&nbsp;&nbsp;ou <? if ($login_fabrica == 1) { ?>Descrição<? }else{ ?>Modelo<? } ?> do produto</b></font>
	</td>
	
	<td align="left" width="300">
		<input type='text' name='descricao_produto' size='30' maxlength='50' value='<? echo $descricao_produto ?>' onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Insira a DESCRIÇÃO DO PRODUTO ou parte dela, depois, clique na lupa a direita para realizar a busca.');">
		&nbsp;
		<a href="#"><img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_produto (document.frm_tabela.referencia_produto,document.frm_tabela.descricao_produto,"descricao")'></a>
	</td>
</tr>
</table>
...
<tr>
	<td align="left" width="200">
		<font face="arial"><b>&nbsp;&nbsp;<? if ($login_fabrica == 1) { ?>Código<? }else{ ?>Referência<? } ?> da peça</b></font>
	</td>
...
<tr>
	<td align="left" width="200">
		<font face="arial"><b>&nbsp;&nbsp;ou <? if ($login_fabrica == 1) { ?>Descrição<? }else{ ?>Modelo<? } ?> da peça</b></font>
	</td>
	
	<td align="left" width="300">
		<input type='text' name='descricao_peca' size='30' maxlength='50' value='<? echo $descricao_peca ?>' onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Insira a DESCRIÇÃO DA PEÇA ou parte dela, depois, clique na lupa a direita para realizar a busca.');">
		&nbsp;
...
<tr>
	<td height="27" valign="middle" align="center" bgcolor="#FFFFFF">
		...
		<img src='imagens/btn_continuar.gif' onclick="javascript: if (document.frm_tabela.btn_acao.value == '' ) { document.frm_tabela.btn_acao.value='continuar' ; document.frm_tabela.submit() } else { alert ('Aguarde submissão') }" ALT="Listar tabela de preços" border='0' style='cursor: pointer'>
	</td>
</tr>
</table>
...
<?
if ($login_fabrica <> 3){
	echo "<p><center><font face='arial' size='-1'>Para fazer o download da tabela de preços em formato XLS ou TXT, <a href='tabela_precos_xls.php'>clique aqui</a></font></center><p>";
}

if (strlen ($_GET['relatorio']) > 0) {
	if ($login_fabrica == 1) $tab = $aux_tabela;
...
/*
		...
		$resZZ = @pg_exec ($con,$sql);
		$nome_fabrica = strtoupper(@pg_result ($resZZ,0,nome));

		echo `rm /var/www/assist/www/download/tabela-$data-$nome_fabrica.xls`;
		...
		if ($liberar_preco) {
			fputs ($fp,"<td bgcolor='#E9F3F3' align='center'>VALOR</td>");
		...
		$sql = "SELECT  tbl_peca.referencia ,
				...
				WHERE   trim(tbl_tabela.sigla_tabela) = 'BASE1'
				AND     tbl_tabela.fabrica = $login_fabrica
				ORDER BY lpad(tbl_peca.referencia,20,'0') ASC ";
		$res = pg_exec ($con,$sql);
		...
		echo `htmldoc --webpage --size 297x210mm --fontsize 11 --left 8mm -f /var/www/assist/www/download/tabela-$data-$nome_fabrica.xls /tmp/assist/tabela-$data-$nome_fabrica.html`;

		if ($login_fabrica <> 3){
			echo "<p><center><font face='arial' size='-1'>Para fazer o download da tabela de preços para EXCEL,<br>
				  <a href='download/tabela-$data-$nome_fabrica.xls'>clique aqui</a> com o botão direito do mouse, e escolha a opção 'Salvar Destino Como...'</font></center><p>";
		}
*/
