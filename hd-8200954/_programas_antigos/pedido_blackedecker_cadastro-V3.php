...
if (1 == 1 AND $login_posto <> 6359) {
	if (strval(strtotime(date("Y-m-d H:i:s")))  < strval(strtotime("2006-07-28 08:00:00"))) { // DATA DA VOLTA
		if (strval(strtotime(date("Y-m-d H:i:s")))  >= strval(strtotime("2006-07-25 13:30:00"))) { // DATA DO BLOQUEIO
			...
			echo "<h4><b>";
			echo "Devido ao nosso fechamento mensal, conforme Calendário Fiscal disponível, o site ficará travado para a digitação de pedidos de peças e acessórios, retornando no dia 28/07 às 08 horas. 
					<br>
					<br>
					Salientamos que os pedidos finalizados após esta data, serão enviados para a fábrica somente na segunda-feira dia 31/07/2006.
					<br>
					<br>
...
<table width="500" border="0" cellpadding="2" cellspacing="1" align="center">
<tr>
	<td colspan='2' align='center'><font face='verdana' size='2' color='#0000ff'><b>Data limite para colocação de pedidos neste mês:<br><font color='#ff0000'>28/07  à  22/08 , até às 13h30.</font></font></td>
</tr>
</table>
