...
if($login_fabrica == 3 and $login_bloqueio_pedido == 't') {
	$sql = "SELECT tbl_posto_linha.posto
			...
			AND    tbl_posto_linha.distribuidor = 4311
...
<tr>
	...
	<td align='center'>
		...
		<br><br>
		<font size="2" face="Geneva, Arial, Helvetica, san-serif" color='#990000'><b>*** Pedidos realizados no valor abaixo de R$80,00 não serão faturados ***</b></font>
		<br><br>
	</td>
	<? }else{ ?>
	<td nowrap align='center'>
