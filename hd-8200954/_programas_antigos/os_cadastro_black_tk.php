...
var http = getHTTPObject(); // Criado objeto HTTP
	...
	var cnpj = cnpj;
		...
		cnpj = cnpj.replace(' ','');
//alert('cnpj '+cnpj);
	http.open("GET", "http://www.telecontrol.com.br/assist/ajax_cnpj.php?cnpj="+ escape(cnpj), true);
...
#			echo "<!-- ";
		...
		<tr valign='top'>
			<td>
				...
				<br>
				<input class="frm" type="text" name="revenda_cnpj" size="20" maxlength="18" value="<? echo $revenda_cnpj ?>" onblur="this.className='frm'; displayText('&nbsp;'); fnc_cnpj_revenda(this.value,document.frm_os.revenda_nome,document.frm_os.revenda_fone,document.frm_os.revenda_cep,document.frm_os.revenda_endereco,document.frm_os.revenda_numero,document.frm_os.revenda_complemento,document.frm_os.revenda_bairro,document.frm_os.revenda_cidade,document.frm_os.revenda_estado,document.frm_os.revenda_email)" onfocus="this.className='frm-on'; displayText('&nbsp;Insira o número no Cadastro Nacional de Pessoa Jurídica.'); " onKeyUp="formata_cnpj(this.value, 'frm_os')">
			</td>
			<td>
				<font size="1" face="Geneva, Arial, Helvetica, san-serif">Nome Revenda</font>
				<br>
				<input class="frm" type="text" name="revenda_nome"  size="30" maxlength="50" value="<? echo $revenda_nome ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite o nome da REVENDA onde foi adquirido o produto.');">
			</td>
			<td>
			<font size="1" face="Geneva, Arial, Helvetica, san-serif">Fone</font>
			<br>
