...
if(strlen($info)>0){
	...
	if(pg_numrows($res) > 0) $email = pg_result($res,0,email);

	echo "<tr>";
	echo "<td bgcolor='#DBE5F5'>O link de confirmação será enviado no E-mail abaixo.<br>Somente após você confirmar em sua caixa-postal o email, você terá a validação da sua senha.<br><br>E-mail:&nbsp;&nbsp;
		<input type='text' size='30' maxlength='255' name='email' readonly value='$email' CLASS='Caixa'>
		&nbsp;&nbsp;<br><br><b>*Caso não tenha acesso a este E-mail, ou o campo acima esteja em branco, entre em contato com a TELECONTROL pedindo a alteração.</b>";
	echo "<br><br><center>";
	echo "</td>";
	echo "</tr>";
