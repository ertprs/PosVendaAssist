...
<tr height="20">
	<td align='center'>
		<input class="frm" type="text" name="produto_referencia" size="15" maxlength="20" value="<? echo $produto_referencia ?>">&nbsp;<img src='imagens/btn_buscar5.gif' style="cursor:pointer" border='0' alt="Clique para pesquisar pela referência do produto" align='absmiddle' onclick="javascript: fnc_pesquisa_produto (document.frm_pedido.produto_referencia,document.frm_pedido.produto_descricao,'referencia')">
	</td>
	<td align='center'>
...
<tr>
	...
	<H3>
		Para pesquisar uma peça, digite parte da descrição ou da referência, e clique neste botão. Na janela de pesquisa, clique sobre a peça que está procurando, ou refaça a busca com outra parte da descrição da peça.
	</H3>
	</td>
</tr>
</table>
