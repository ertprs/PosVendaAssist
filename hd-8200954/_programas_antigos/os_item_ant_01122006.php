...
if($sistema_lingua) $title = "Telecontrol - Servicio Post Ventas - Ordenes de Servicio";
...
?>
			...
			<td nowrap>
				<font size="1" face="Geneva, Arial, Helvetica, san-serif"><? if($sistema_lingua) echo "Consumidor";else echo "Consumidor";?></font>
				<br>
				<font size="2" face="Geneva, Arial, Helvetica, san-serif">
			...
			<? if ($login_fabrica == 19) { ?>
			<td nowrap>
				<font size="1" face="Geneva, Arial, Helvetica, san-serif"><? echo "Qtde.Produtos";?></font>
				<br>
				<font size="2" face="Geneva, Arial, Helvetica, san-serif">
				<b>
				<?
...
?>
		...
		if($sistema_lingua) echo "Descripción";else echo "Descrição";
		echo "</b></font></td>";

		if ($pergunta_qtde_os_item == 't') {
			echo "<td align='center'><font size='1' face='Geneva, Arial, Helvetica, san-serif' color='#ffffff'><b>";
			if($sistema_lingua) echo "Cantidad";else echo "Qtde";
			echo "</b></font></td>";
		}
		...
		echo "<td align='center'><font size='1' face='Geneva, Arial, Helvetica, san-serif' color='#ffffff'><b>";
		if($sistema_lingua) echo "Defecto";else echo "Defeito";
		echo "</b></font></td>";
		echo "<td align='center'><font size='1' face='Geneva, Arial, Helvetica, san-serif' color='#ffffff'><b>";
		if($sistema_lingua) echo "Servicio";else echo "Serviço";
		echo "</b></font></td>";
...
<tr>
	<td height="27" valign="middle" align="center" colspan="3" bgcolor="#FFFFFF">
		...
		<br><br>
		<FONT SIZE="1" COLOR="#ff0000"><? if($sistema_lingua) echo "El campo \"Observación\" es solo para el control del servicio autorizado.<br>El fabricante no se responsabiliza por los datos digitalizados";else echo "O campo \"Observação\" é somente para o controle do posto autorizado. <br>O fabricante não se responsabilizará pelos dados aqui digitados.";?></FONT>
		<br><br>
	</td>
</tr>
