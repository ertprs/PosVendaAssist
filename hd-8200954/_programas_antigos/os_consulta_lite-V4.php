...
if (strlen($acao) > 0 && $acao == "PESQUISAR") {
	...
	if (strlen($opcao4) == 0 && strlen($opcao5) == 0 && strlen($opcao6) == 0 && strlen($mes) == 0 && strlen($ano) == 0) {
		$erro .= " Selecione o mês e o ano desejado para realizar a pesquisa. ";
	}
...
<table width="400" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" name="opcao4" value="4" <? if (strlen($opcao4) > 0) echo "checked"; ?>> Número da OS</td>
		<td><input type="text" name="numero_os" size="17" value="<?echo $numero_os?>"></td>
		<td>&nbsp;</td>
	</tr>
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td colspan="2">&nbsp;</td>
		<td><input type="radio" name="tipo_os" value="C" <? if (strlen($tipo_os) == 0 || $tipo_os == "C") echo "checked"; ?>> OS Consumidor</td>
		<td><input type="radio" name="tipo_os" value="R" <? if ($tipo_os == "R") echo "checked"; ?>> OS Revenda</td>
		<td>&nbsp;</td>
	</tr>
	<tr bgcolor="#D9E2EF">
		<td colspan="5">&nbsp;</td>
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" name="opcao5" value="5" <? if (strlen($opcao5) > 0) echo "checked"; ?>> Número de Série</td>
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" name="opcao6" value="6" <? if (strlen($opcao6) > 0) echo "checked"; ?>> Número da NF</td>
