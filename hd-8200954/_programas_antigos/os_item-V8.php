...
/*			if ($login_fabrica == 5 and strlen($causa_defeito) == 0)
			...
			if ($login_fabrica == 3 && strlen($xpeca) > 0) {
				...
				if (pg_numrows($resX) > 0) {
					...
					$msg_erro = "Não há previsão de chegada da Peça $peca_previsao. Favor encaminhar e-mail para <a href='mailto:assistenciatecnica@britania.com.br'>assistenciatecnica@britania.com.br</a>, informando o número da ordem de serviço. Somente serão aceitas requisições via email! Não utilizar o 0800.";
				}
			}
