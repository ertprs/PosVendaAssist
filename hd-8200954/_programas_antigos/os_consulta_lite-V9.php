...
//coloquei "tbl_os.sua_os ILIKE '%$sua_os%' OR" pois não estava achando certas OS da britania HD 927 por takashi 21-12
			$sql .= " AND (tbl_os.sua_os ILIKE '%$sua_os%' OR tbl_os.sua_os LIKE '$sua_os%' OR tbl_os.sua_os LIKE '0$sua_os%' OR tbl_os.sua_os LIKE '00$sua_os%' OR tbl_os.sua_os LIKE '000$sua_os%' OR tbl_os.sua_os LIKE '0000$sua_os%' OR tbl_os.sua_os LIKE '00000$sua_os%' OR tbl_os.sua_os LIKE '000000$sua_os%' OR tbl_os.sua_os LIKE '0000000$sua_os%' OR tbl_os.sua_os LIKE '00000000$sua_os%') ";
		}
		if (strlen($os_off) > 0) {
			...
			if ($troca_garantia == "t") {
				...
				if ($excluida == "f" || strlen($excluida) == 0) {
					if (strlen ($importacao_fabrica) == 0) {
						if($login_fabrica == 20) echo "<a href='os_cadastro.php?os=$os&reabrir=ok'>";
						else                     echo "<a href='os_item.php?os=$os&reabrir=ok'>";
						echo "<img border='0' src='imagens/btn_reabriros.gif'></a>";
					}
				}
			}else{
				echo "&nbsp;";
