...
<table width="450" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td width="10">&nbsp;</td>
		<td nowrap><input type="checkbox" name="opcao1" value="1" checked disabled> Período </td>
		<td colspan="2">Mês</td>
		<td>Ano</td>
		<td width="10">&nbsp;</td>
	</tr>
	...
	<tr bgcolor="#D9E2EF">
		<td colspan="6"><img border="0" src="imagens/btn_pesquisar_400.gif" onclick="document.frm_pesquisa.acao.value='PESQUISAR'; document.frm_pesquisa.submit();" style="cursor: hand;" alt="Preencha as opções e clique aqui para pesquisar"></td>
	</tr>
</table>
