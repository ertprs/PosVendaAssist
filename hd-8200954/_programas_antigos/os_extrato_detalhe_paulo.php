...
if (@pg_numrows($res) > 0){
	...
	if($sistema_lingua == "ES") echo "DADOS REFERENTES AO PAGAMENTO DO EXTRATO";
	else echo "DADOS REFERENTES AO PAGAMENTO DO EXTRATO";
	echo "</TD>";	
	echo "	</TR>";
	for($i=0; $i<pg_numrows($res); $i++){
		...
		if($sistema_lingua == "ES") echo "Autorización nº";
		else echo "Autorização nº";
		echo "</TD>";
		echo "		<TD align='center'>";
		if($sistema_lingua == "ES") echo "NF Autorización";
		else echo "NF autorização";
		echo "</TD>";
		echo "		<TD align='center'>";
		if($sistema_lingua == "ES") echo "Data de Autorización"; 
		else echo "Data de autorização"; 
		echo "</TD>";
		echo "		<TD align='center'>";
		if($sistema_lingua == "ES") echo "Fecha de pagamiento"; 
		else echo "Data de pagamento"; 
		echo "</TD>";
		echo "	</TR>";
		...
		echo "	<TR class='menu_top'>";
		echo "		<TD align='center'>";
		if($sistema_lingua == "ES") echo "Valor total"; 
		else echo "Valor total"; 
		echo "</TD>";
		echo "		<TD align='center'>";
		if($sistema_lingua == "ES") echo "Agregación"; 
		else echo "Acréscimo"; 
		echo "</TD>";
		echo "		<TD align='center'>";
		if($sistema_lingua == "ES") echo "Descuento"; 
		else echo "Desconto"; 
		echo "</TD>";
		echo "		<TD align='center'>";
		if($sistema_lingua == "ES") echo "Valor total líquido"; 
		else echo "Valor total líquido"; 
		echo "</TD>";
		echo "	</TR>";
		echo "	<TR class='table_line'>";
		...
		if($sistema_lingua == "ES") echo "Observación"; 
		else echo "Observações"; 
		echo "</TD>";
		echo "	</TR>";
		echo "	<TR class='table_line'>";
...
if($login_fabrica==6){
	...
	echo "<center><font size='1'><a href='os_extrato_detalhe_rejeitadas.php?extrato=$extrato&posto=$login_posto'><B>";
	if($sistema_lingua == "ES") echo "Haga um click aquí para verificar la(s) OS (s) que no entraran em el extracto";
		else            echo "Clique aqui para verificar a(s) OS(s) que não entraram no Extrato";
...
echo "<br>";
	...
	if (pg_numrows($res_avulso) > 0) {
		...
		echo "<tr class='menu_top'>\n";
		echo "<td colspan='3'>";
if($sistema_lingua == "ES") echo "LANZAMIENTO DE EXTRACTO AVULSO";
else echo "LANÇAMENTO DE EXTRATO AVULSO";
echo "</td>\n";
		echo "</tr>\n";
		echo "<tr class='menu_top'>\n";
		echo "<td>";
		...
		echo "</td>\n";
		echo "<td>";
		if($sistema_lingua == "ES") echo "HISTÓRICO";
		else echo "HISTÓRICO"; 
		echo "</td>\n";
		echo "<td>";
		if($sistema_lingua == "ES") echo "VALOR";
		else echo "VALOR"; 
		echo "</td>\n";
		echo "</tr>\n";
		...
		echo "<tr class='menu_top'>\n";
		echo "<td colspan='3'>";
		if($sistema_lingua == "ES") echo "TOTAL ";
...
<tr>
	<td height='20' class="table_line" colspan='4'>
	<? 	if($sistema_lingua == "ES") echo "PAGAMIENTO";
		else  echo "PAGAMENTO";
?>
	</td>
</tr>
<tr>
	<td align='left' class="table_line" width='20%'>
	<? 	if($sistema_lingua == "ES") echo "EXTRACTO PAGO EN:";
	else  echo "EXTRATO PAGO EM:";
	?>
	 
	
	</td>
	<td class="table_line" width='15%'><? echo $baixado; ?></td>
	<td align='left' class="table_line" width='15%'><center>
	<? 	if($sistema_lingua == "ES") echo "Observaciones:";
		else  echo "OBSERVAÇÃO";
?>
	:</center></td>
...
if($login_fabrica==20 and $sistema_lingua <> "ES"){
	...
	if ($sistema_lingua == "ES") echo "OS por tipo atedimiento: ";
	else                         echo "OS por tipo atedimento: ";
	echo "</td>";
...
<tr class='menu_top'>
	...
	?></td>
	<TD>
<? 	if($sistema_lingua == "ES") echo "Descripción del pieza";
	else  echo "Descricação da Peça";
	?>
</td>
	<TD><? 	if($sistema_lingua == "ES") echo "Ctde";
	else  echo "Qtde";
	?></td>
</tr>
<?
...
<tr>
	<td>
		<br>
		<? if($sistema_lingua == "ES"){ ?>
			<img src="imagens/btn_volver.gif" onclick="javascript: window.location='os_extrato.php';" ALT="Voltar" border='0' style="cursor:pointer;">
		<? }else{ ?>
...
<p>
	...
	<BR><BR>
	<div id='wrapper'>
	<? echo "<a href='$PHP_SELF?extrato=$extrato&posto=$posto&listarpeca=1'>CLIQUE AQUI PARA AGRUPAR POR PEÇAS</a>" ?>
	</div> 
	<BR><BR>
	<? } ?>
	<?
	$listarpeca = $_GET['listarpeca'];
	if($listarpeca ==1 ) {
