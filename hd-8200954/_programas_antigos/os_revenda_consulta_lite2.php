...
//ao clicar aqui vc vai explodir a OS
				...
				if (strlen($consumidor_revenda) == 0) {
					...
					echo "<td width='80' align='center'>";
					if (($excluida == "f" || strlen($excluida) == 0) && strlen($data_fechamento) == 0) if($login_fabrica==1)echo "<a href='os_cadastro.php?os=$os_revenda'><img src='imagens/btn_alterar_cinza.gif'></a>";
					else                                                                               echo "&nbsp;";
					echo "</td>\n";
