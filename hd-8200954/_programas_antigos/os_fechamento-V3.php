...
<? if ($login_fabrica == 1) { ?> <td align="center" width="35%"><a href='<? echo $PHP_SELF."?listar=todas"; ?>'><FONT COLOR="#CC0000"> &middot; Listar todas as OS's</FONT></a></td> <? } ?>
	<TD>
...
<? if ($login_fabrica <> 1) { ?> <td align="right"><a href='<? echo $PHP_SELF."?listar=todas"; ?>'>Listar todas as OS's</a></td> <? } ?>
</tr>
</form>
</table>
