...
if (pg_numrows ($res) > 0 ) {
	echo "<br><br>
	<table style='font-family: verdana, arial ;  font-size: 16px; border-style: dotted; border-width: 2px; border-color: #330000; background-color: #FFFFFF;' width='700' border='0' align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#000000'>";
