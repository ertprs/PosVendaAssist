...
//	echo "<td align='center'><font color='#ffffff'><b>Data</b></font></td>";
	...
	for ($i=0; $i<$total; $i++) {
		...
		//if ($produto <> $produto_ant) {
			...
			echo pg_result ($res,$i,descricao) . " - " . pg_result ($res,$i,data) ; 
			}
			echo "</font>";
			echo "</td>\n";
		...
		$png = "comunicados/$Xcomunicado.png";
		...
		if (file_exists($png) == true) echo "Para visualizar o arquivo, <a href='comunicados/$Xcomunicado.png' target='_blank'>clique aqui</a>.";
		if (file_exists($gif) == true) echo "Para visualizar o arquivo, <a href='comunicados/$Xcomunicado.gif' target='_blank'>clique aqui</a>.";
		if (file_exists($jpg) == true) echo "Para visualizar o arquivo, <a href='comunicados/$Xcomunicado.jpg' target='_blank'>clique aqui</a>.";
		...
		echo "<font size='-1'>".pg_result ($res,$i,mensagem)."&nbsp;</font>\n";
