...
if (pg_numrows ($res) > 0 AND $_SERVER['REMOTE_ADDR'] == "201.43.28.75") {
	echo "<br><table width='500' border='0' align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#000000'>";
	echo "<tr>";
	echo "<TD align='center'><B><FONT COLOR='FF3300'>Existem comunicados de leitura obrigatória</FONT></B></TD>";
	...
	echo "</TR>";
		echo "<TR>";
		echo "<TD align='center'><a href='/assist/comunicados/$comunicado.$extensao' target='_blank'><FONT SIZE='2'>$descricao</FONT></a></TD>";
		echo "</TR>";
