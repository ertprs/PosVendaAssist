...
/*	if ($login_fabrica == 3 && getenv("REMOTE_ADDR") == "201.0.9.216") {
	...
	if ($contador > 50) {
		...
		echo "<tr>";
		if (($login_fabrica == 14) OR ($login_fabrica == 6)) {echo "<td><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Posição</font></td>";}
		if ($login_fabrica == 6) {echo "<td><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Série Inicial</font></td><td><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Série Final</font></td>";}
		if ($login_fabrica == 3) {echo "<td>Linha</td>";}
		echo "<td><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Referência</font></td>";
		echo "<td><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Descrição</font></td>";
		echo "</tr>";
		flush();
	}
	$contador++;
	...
	if ($login_fabrica == 6) {
	echo "<td nowrap>";
		echo "<font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>I:$serie_inicial</font>";
	echo "</td>\n";
		echo "<td nowrap>";
		echo "<font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>F:$serie_final</font>";
	echo "</td>\n";	
	}
