...
#	echo "<TD width='130'><a href='".$REQUEST_URI."&order=posto' class='linkTitulo'>POSTO</a></TD>\n";
	...
	echo "<TD><img src='imagens/img_impressora.gif' alt='Imprimir OS'></TD>\n";
	if($login_fabrica == 1) echo "<TD><img border='0' width='20' heigth='20' src='imagens/envelope.png' alt='Dados Carta Registrada'></TD>\n";
