		...
		<tr>
			...
			<td>
				...
				<? if ($login_fabrica == 20) {
					...
					echo "<option value='Bom Estado' ";
					if ($aparencia_produto == "Bom Estado") echo " selected ";
					echo "> Bom Estado </option>";

					echo "<option value='Uso intenso' ";
					if ($aparencia_produto == "Uso intenso") echo " selected ";
					echo "> Uso intenso </option>";

					echo "<option value='Novo' ";
					if ($aparencia_produto == "Novo") echo " selected ";
					echo "> Novo </option>";
