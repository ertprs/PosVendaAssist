...
$sql = "SELECT  tbl_comunicado.comunicado   ,
		...
		AND    (tbl_comunicado_posto_blackedecker.data_confirmacao < CURRENT_DATE - INTERVAL '1 DAY' 
...
if (pg_numrows ($res) > 0 ) {
	...
	echo "	<TD colspan='2' height='40' style='font-family: verdana, arial ; font-size: 16px; font-size: 14px; color:#FFFFFF;'><B>COMUNICADOS</B></TD>";
	echo "</TR>";
	...
	for ($i = 0 ; $i < pg_numrows ($res) ; $i++) {
		...
		echo "<TR align='center' style='font-family: verdana, arial ; font-size: 10px; color:#000000' bgcolor='#33CCFF' onmouseover=\"this.bgColor='#3399FF'\" onmouseout=\"this.bgColor='#33CCFF'\">";
	...
	echo "<TR>";
	echo "<TD align='center' colspan='2' nowrap><br><FONT SIZE='2' COLOR='919597'>*Clique no(s) comunicado(s) para acessar o site.</FONT></TD>";
	echo "</TR>";
	echo "</table>";
	exit;
}
