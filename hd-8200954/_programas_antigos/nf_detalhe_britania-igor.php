...
/*			echo "<tr style='font-size: 10px' bgcolor='$cor'>\n";
			...
			echo "<td align='left' nowrap><a href='os_press.php?os=$os' class='link'>$os</a></td>\n";
			echo "<td align='right'>$sua_os</font></td>\n";
			echo "<td align='right'>$posto</td>\n";
			...
			echo "<td nowrap align='center'><font color='blue'>ATENDIDO</font></td>\n";
			echo "</tr>\n";
*/
			...
			echo "<td align='center'>$emissao</td>\n";
			echo "<td nowrap align='center'><font color='red'>NAO ATENDIDO</font></td>\n";
			echo "</tr>\n";
			$c++;
		}
	}
