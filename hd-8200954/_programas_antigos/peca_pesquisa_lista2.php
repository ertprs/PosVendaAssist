...
for ( $i = 0 ; $i < pg_numrows($res) ; $i++ ) {
	...
	$serie_inicial  = trim(@pg_result($res,$i,serie_inicial));
	$serie_final  = trim(@pg_result($res,$i,serie_final));
...
/*	if ($login_fabrica == 3 && getenv("REMOTE_ADDR") == "201.0.9.216") {
	...
	if ($contador > 50) {
		...
		echo "<tr>";
		if (($login_fabrica == 14) OR ($login_fabrica == 6)) {echo "<td bgcolor='#d4d4d4'><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Posição</font></td>";}
		if ($login_fabrica == 6) {echo "<td bgcolor='#d4d4d4'><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Série Inicial</font></td><td bgcolor='#d4d4d4'><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Série Final</font></td>";}
		if ($login_fabrica == 3) {echo "<td bgcolor='#d4d4d4'>Linha</td>";}
		echo "<td bgcolor='#d4d4d4'><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Referência</font></td>";
		echo "<td bgcolor='#d4d4d4'><font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>Descrição</font></td>";
		echo "</tr>";
		flush();
	}
	$contador++;
	...
	if ($login_fabrica == 6) {
	echo "<td nowrap>";
		echo "<font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>$serie_inicial</font>";
	echo "</td>\n";
		echo "<td nowrap>";
		echo "<font face='Arial, Verdana, Times, Sans' size='1' color='#000000'>$serie_final</font>";
	echo "</td>\n";	
	}
	...
	echo "<td nowrap>";
//if ($ip == '201.0.9.216') echo strlen($peca_fora_linha)." OR ".strlen($para)." :: $para<br>";
