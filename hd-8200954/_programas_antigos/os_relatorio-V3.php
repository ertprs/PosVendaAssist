...
*/
	...
	$res = pg_exec($con,$sql);
//if ($ip == "201.27.31.151") echo nl2br($sql)."<br>".pg_numrows($res);
...
//			if     (strlen($data_geracao) > 0  AND strlen($aprovado) == 0 AND $status_os <> 13)        echo "Em aprovação";
			...
			elseif ($login_fabrica == 19 and strlen($aprovado) > 0 AND $status_os <> 13)                                          echo "Aprovada";
			elseif ($login_fabrica <> 19 and strlen($aprovado) > 0)                                                               echo "Aprovada";
