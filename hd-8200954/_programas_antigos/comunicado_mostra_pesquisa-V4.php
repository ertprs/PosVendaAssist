...
if ($acao == "PESQUISAR") {
	...
	#	if (getenv("REMOTE_ADDR") == "201.0.9.216") { echo nl2br($sql); }
		...
		// ##### PAGINACAO ##### //
		echo "<font size='1' color='#A02828'>Se você não possui o Acrobat Reader&reg;, <a href='http://www.adobe.com/products/acrobat/readstep2.html'>instale agora</a>.</font><br>";

		echo "<table width='600' border='1' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#000000' align='center'>";
		echo "<tr bgcolor='#D9E2EF' height='15'>";
		echo "<td colspan='4' align='center'><a href='comunicado_mostra.php'><img src='imagens/btn_nova_busca.gif'></a></td>";
		echo "</tr>";
		...
		if (pg_numrows($res) > 0) {
			...
			echo "<td colspan='4' bgcolor='#507196'>CLIQUE EM ABRIR ARQUIVO PARA VISUALIZAR</td>";
			echo "</tr>";
			...
			for ($i = 0 ; $i < pg_numrows($res) ; $i++) {
				...
				echo "<table align='center' border='1' bordercolor='#000000' style='border-collapse: collapse;' bgcolor='$cor' height='15' width='600' cellspacing='0' ><br>";
				echo "<tr class='Titulo' height='15'>";
				echo "<td>PRODUTO</td>";
...
//				echo "<td nowrap align='center'>" . $data . "</td>";
				...
				if (file_exists($gif) == true) {
					echo "<a href=$PHP_SELF?comunicado=$comunicado'target='_blank' >ABRIR ARQUIVO</a>";
				}
				...
				if (file_exists($doc) == true) {
					echo "<a href='comunicados/$comunicado.doc' target='_blank'>ABRIR ARQUIVO</a>.";
				}

				if (file_exists($rtf) == true) {
					echo "<a href='comunicados/$comunicado.rtf' target='_blank'>ABRIR ARQUIVO</a>.";
				}

				if (file_exists($xls) == true) {
					echo "<a href='comunicados/$comunicado.xls' target='_blank'>ABRIR ARQUIVO</a>.";
				}

				if (file_exists($pdf) == true) {
					echo "<a href='comunicados/$comunicado.pdf' target='_blank'>ABRIR ARQUIVO</a>";
					}
				echo "&nbsp;";
				echo "</td>";

				echo "<tr class='Titulo' height='15'>";
				echo "<td colspan='4'>Mensagem</td>";
				if (strlen($comunicado_mensagem) > 0) {
					echo "<tr class='Conteudo' bgcolor='$cor' height='15'>";
					echo "<td colspan='4'><br>" . nl2br($comunicado_mensagem) . "<br>&nbsp;</td>";
					echo "</tr>";
				}else{
					echo "<tr class='Conteudo' bgcolor='$cor' height='15' align='center'>";
					echo "<td colspan='4'><FONT COLOR='#757575'><br>Não há mensagem cadastrada<br>&nbsp;</FONT></td>";
					echo "</tr>";
				}
		...
		echo "<tr bgcolor='#D9E2EF' height='15'>";
		echo "<td colspan='4' align='center'><br><a href='comunicado_mostra.php'><img src='imagens/btn_nova_busca.gif'></a></td>";
		echo "</tr>";
		echo "</table>";
