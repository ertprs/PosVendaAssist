...
//					echo $sql;
			...
			echo "<td colspan='8'> Referente suas NFs. " . $notas_fiscais . " da série $serie</td>";
			echo "</td>";
			echo "</tr>";
			...
			$sql = "SELECT * FROM tbl_extrato_devolucao WHERE extrato = $extrato AND $condicao_1 AND $condicao_2 AND linha = $linha AND serie='$serie'";
