...
// 	if (strlen($xconsumidor_nome) == 0) $msg_erro .= " Digite o nome do consumidor. <br>";
	...
	if ($consumidor_cpf <> "null" and strlen($consumidor_cpf) <> 11 and strlen ($consumidor_cpf) <> 14) {
			$msg_erro = 'Tamanho do CPF/CNPJ do cliente inválido<BR>';
	}
	...
	if (strlen($consumidor_numero) == 0) $msg_erro .= " Digite o Número do Endereço do consumidor. <br>";
...
?>
			...
			<fieldset style="padding: 10;">
				...
				<center>
					...
					<input type="text" name="serie_locacao" size="15" maxlength="20" value="<? echo $serie_locacao; ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Entre com o número de série Locação e clique no botão para efetuar a pesquisa.');">
...
?>
		...
		echo "<table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' style='font-family: verdana; font-size: 12px'>";
				echo "<tr>";
				echo "<td valign='bottom'><BR><font color='#A22A26'><u><B>Informações do Produto</B></u></font></td>";
				echo "</tr>";
		echo "</table>"
		?>
		<p>
	...
	<tr valign='top' style='font-size:10px'>
		...
		<?
			...
			<td nowrap>
				N. Série
				<br>
				<input  type="text" name="produto_serie" size="12" maxlength="20" value="<? echo $produto_serie ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite aqui o número de série do aparelho.'); ">
			...
			<td nowrap>
				...
				<? }else{ ?>
						<input  type="text" name="produto_referencia" size="15" maxlength="20" value="<? echo $produto_referencia ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Entre com a referência do produto e clique na lupa para efetuar a pesquisa.');" <? if (strlen($locacao) > 0) echo "readonly"; ?>>&nbsp;<img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_produto (document.frm_os.produto_referencia, document.frm_os.produto_descricao,'referencia',document.frm_os.produto_voltagem)" style='cursor: hand'>
			...
			<td nowrap>
				N. Série
				<br>
				<input  type="text" name="produto_serie" size="8" maxlength="20" value="<? echo $produto_serie ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite aqui o número de série do aparelho.'); "><br><? if ($login_fabrica == 1) echo "(somente p/ linha DeWalt)"; ?>
			</td>
			<? } ?>
		</tr>
		</table>
		...
		Nota Fiscal
		<br>
		<input  type="text" name="nota_fiscal"  size="8"  maxlength="8"  value="<? echo $nota_fiscal ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Entre com o número da Nota Fiscal.');" <? if (strlen($locacao) > 0) echo "readonly"; ?>>
		</td>
		<td valign='top' width='100'>
		Data Compra
		<br>
		<input  type="text" name="data_nf" size="12" maxlength="10" value="<? echo $data_nf ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Entre com a data da compra. Verifique se o produto está dentro do PRAZO DE GARANTIA.');" tabindex="0" <? if (strlen($locacao) > 0) echo "readonly"; ?>><br>Ex.: <? echo date("d/m/Y"); ?>
		</td>
		<? if ($login_fabrica <> 5){ ?>
		<td valign='top'>
		Defeito Reclamado
...
?>
		...
		Acessórios
		<br>
		<input  type="text" name="acessorios" size="30" value="<? echo $acessorios ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Texto livre com os acessórios deixados junto ao produto.');">
		</td>
		<? } ?>
		<? if ($login_fabrica == 1) { ?>
		<td valign='top'>
		Laudo técnico
		<br>
		<input  name ="laudo_tecnico" type ="text" size ="20" maxlength="50" value ="<? echo $laudo_tecnico; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Digite aqui o laudo técnico.');">
		</td>
		<? } ?>
...
<? } ?>
		...
		echo "</tr>";
		echo "<tr>";
		echo "<td valign='bottom'><font color='#A22A26'><u><B>Informações do Consumidor</B></u></font><BR></td>";
		echo "</tr>";
		echo "</table>"
		?>
...
<table width='700' align='center' border='0' cellspacing='2' cellpadding='2' style='font-family: verdana; font-size: 10px'>
	...
	<tr>
	<td width='200'>
	<input  type="text" name="consumidor_endereco"   size="40" maxlength="60" value="<? echo $consumidor_endereco ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite o endereço do consumidor.');">
	</td>

	<td width='62'>
	<input  type="text" name="consumidor_numero"   size="10" maxlength="20" value="<? echo $consumidor_numero ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite o número do endereço do consumidor.');">
	</td>

	<td width='80'>
	<input  type="text" name="consumidor_complemento"   size="15" maxlength="30" value="<? echo $consumidor_complemento ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite o complemento do endereço do consumidor.');">
	</td>
...
-->
		...
		echo "</tr>";
		echo "<tr>";
		echo "<td valign='bottom'><font color='#A22A26'><u><B>Informações da Revenda</B></u></font><BR></td>";
		echo "</tr>";
		echo "</table>"
		?>
	...
	<table width='700' align='center' border='0' cellspacing='2' cellpadding='2' style='font-family: verdana; font-size: 10px'>
		...
		<tr>
		<td  width='200'>
		<input  type="text" name="revenda_endereco"   size="40" maxlength="60" value="<? echo $revenda_endereco ?>" onblur="this.className='frm_os'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite o endereço da Revenda.');">
		</td>

		<td  width='62'>
		<input  type="text" name="revenda_numero"   size="10" maxlength="20" value="<? echo $revenda_numero ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite o número do endereço da revenda.');">
		</td>

		<td  width='80'>
		<input  type="text" name="revenda_complemento"   size="15" maxlength="30" value="<? echo $revenda_complemento ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Digite o complemento do endereço da revenda.');">
		</td>
	...
	<table width="100%" border="0" cellspacing="5" cellpadding="0" style='font-family: verdana; font-size: 10px'>
		<tr>
			...
			<td>
				Chamado aberto por
				<br>
				<input  type="text" name="quem_abriu_chamado" size="20" maxlength="30" value="<? echo $quem_abriu_chamado ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Nome do funcionário do cliente que abriu este chamado.');">
			</td>
			<td>
				Observações
				<br>
				<input  type="text" name="obs" size="50" value="<? echo $obs ?>" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;ObservaçÕes e dados adicionais desta OS.');">
			</td>
		</tr>
		</table>
