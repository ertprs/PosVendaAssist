...
if (pg_numrows ($res) > 0 ) {
	...
	if($login_fabrica==1){
	echo "<TR>";
	echo "<TD align='center' colspan='3' nowrap><br><a href='menu_os.php'><FONT SIZE='4' COLOR='#880000'>Leio depois</FONT></a></TD>";
	echo "</TR>";
	}
...
$sql = "SELECT tbl_posto.estado, tbl_posto_fabrica.pedido_via_distribuidor
				FROM  tbl_posto 
...
//pedido via distribuidor adicionado - Fernando - em relação ao chamado 404

if (($login_fabrica == 3) AND ($pedido_via_distribuidor == 't')){
