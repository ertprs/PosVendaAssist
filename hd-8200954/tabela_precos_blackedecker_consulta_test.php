...
<tr class="titulo_tabela">
	<td colspan="4">
		<? fecho("Parâmetros da Pesquisa",$con,$cook_idioma); ?>
	</td>
</tr>
	...
	<tr>
		...
		<td width='52%'>
		<font face="arial" size='2'>Descrição do produto</font>
		</td>
	...
	<td align="left"width='52%'>
		<input type='text' name='descricao_produto' size='50' maxlength='50' value='<? echo $descricao_produto ?>' onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Insira a DESCRIÇÃO DO PRODUTO ou parte dela, depois, clique na lupa a direita para realizar a busca.');">
		&nbsp;
	...
	<tr>
		...
		<td width="28%">
			<font face="arial" size='2'>Cod. Peça</font>
		</td>
		
	<td align="left" width="52%">
		<font face="arial" size='2'>Descrição da peça</font>
	</td>
	...
	<tr>
		...
		<td align="left" width="52%">
				<input type='text' name='descricao_peca' size='50' maxlength='50' value='<? echo $descricao_peca ?>' onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Insira a DESCRIÇÃO DA PEÇA ou parte dela, depois, clique na lupa a direita para realizar a busca.');">
				&nbsp;
...
<tr>
	...
	<td height="27" width="50%" valign="middle" align="right">
		...
		<input type="button" value="Continuar" onclick="javascript: if (document.frm_tabela.btn_acao.value == '' ) { document.frm_tabela.btn_acao.value='continuar' ; document.frm_tabela.submit() } else { alert ('Aguarde submissão') }" ALT="Listar tabela de preços" border='0'>

	</td>

	<td width="50%">

		<input type="button" value="Voltar" onclick="javascript: history.back(-1);" ALT="Listar tabela de preços" border='0' style='cursor: hand;'>
...
<tr>
	<!--<td align="center"><a href="<? echo $PHP_SELF ?>?relatorio=1">Clique aqui</a> para ver relação de produtos.-->
	...
	<td>
	<td align="left">
	<!--Para fazer o download da tabela de preços em formato XLS ou TXT, <a href='tabela_precos_xls.php?tabela=<?//echo $tabela?>'><b>Clique Aqui</b></a> -->
...
if (strlen ($_GET['relatorio']) > 0) {
	...
	echo "<td align='left' class='titulo_coluna'>Referência</td>";
	echo "<td align='left' class='titulo_coluna'>Descrição</td>";
...
//			echo "<tr bgcolor='#007711'>";
			...
			echo "<b>Para facilitar a visualização dos itens, separamos por iniciais.<br>Para consultar um item, clique na inicial correspondente.</b>";
			...
			echo "<tr class='titulo_coluna'>";
				...
				echo "<td align='center' nowrap>Descrição</td>";
				...
				if ($tabela == 54) {
					...
					echo "<td align='center'>Quantidade<BR>múltipla</td>";
				}else{
					if ($liberar_preco) {
						switch ( substr($descricao,0,3) ) {
							case "Dis" :
				...
				for ($i = 0 ; $i < pg_num_rows ($res) ; $i++) {
					...
					if ($i == 0) {
						...
						echo "<tr class='titulo_tabela'";
							echo "<td colspan='9'>";
								echo"Peças do Produto: ".$descricao_produto;
							echo "</td>"; 
							...
							if ($liberar_preco) {
								switch ( substr($descricao,0,3) ) {
									case "Dis" :
										...
										echo "<td align='center'>Distribuição<br>com IPI</td>";
										echo "<td align='center'>Preço<br>sugerido<br>com IPI</td>";
										echo "<td align='center'>Quantidade<br>múltipla</td>";
									break;
									case "Vip" :
										echo "<td  align='center'>IPI</td>";
