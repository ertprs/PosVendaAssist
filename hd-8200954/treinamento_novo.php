...
<table width="700" bgcolor="FFFFFF" bordercolor="#FFFF00" border="0" cellspacing="2" cellpadding="2">
	<tr bgcolor='#fafafa'>
		<td width="20%" align="center"style="CURSOR: hand;" onmouseover="this.style.backgroundColor='#ced7e7';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#fafafa';"><b><? echo"<a href='$PHP_SELF?mostrar=obejtivo'>"; ?>Objetivos dos Treinamentos</b>
		</td>
	</tr>
	<tr bgcolor='#f0f0f0'>
			<td width="20%" align="center"style="CURSOR: hand;" onmouseover="this.style.backgroundColor='#ced7e7';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#f0f0f0';"><b>Treinamentos e Agendamentos</b>
			</td>
	</tr>
	<tr bgcolor='#fafafa'>
			<td width="20%" align="center"style="CURSOR: hand;" onmouseover="this.style.backgroundColor='#ced7e7';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#fafafa';"><b>Fotos dos Treinamentos</b>
			</td>
	</tr>
	<tr bgcolor='#f0f0f0'>
			<td width="20%" align="center"style="CURSOR: hand;" onmouseover="this.style.backgroundColor='#ced7e7;this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#f0f0f0';"><b>Informações para Manutenção</b>
			</td>
	</tr>
	...
	<table width="650" bgcolor="FFFFFF" bordercolor="#00000" border="0" cellspacing="5" cellpadding="5" align="center" class="tbl">
		<tr>
			<td width="220"  valign="top" bgcolor="#FFCC00">
			...
			<td width="215"  valign="top" bgcolor="#FF9900">
			<center><b>TREINAMENTO DE HAMMER&acute;S</b></center><br>
			...
			<td width="220"  valign="top" bgcolor="#FF6600">
			<b><center>TREINAMENTO DE COMPRESSORES</center></b><br>
							<b>Tempo de dura&ccedil;&atilde;o:</b> 3 dias - 24hs <br>
		...
		<tr class="tblbranca " >
			<td valign="top" colspan="3"><b>DESPESAS DOS TREINAMENTOS:</b><br>
			<br>
		...
		if($mostrar==obejtivo)echo"
		<tr class='tblbranca '>
			<td valign='top' colspan='3'><br><b>OBJETIVO DOS TREINAMENTOS:</b><br>
			<br>
		...
		?>
		<tr class="tblbranca ">
			<td valign="top" colspan="3"><br><strong>COPA DO MUNDO 2006!!!</strong><br>
			<br>
