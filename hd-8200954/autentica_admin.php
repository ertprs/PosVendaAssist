...
/*
PEGAR O VALOR DO COOKIE tc_mostra_comunicado_integracao
$_COOKIE['tc_mostra_comunicado_integracao']

VERIFICAR SE É TRUE (STRING)

SE FOR TRUE FAZER UM header('Location: link_do_comunicado');
SE FOR NÃO TRUE SEGUIR A VIDA
*/
?>
