...
$layout_menu = "os";
$title       = "Relação de Ordens de Serviços de Manutenção";
...
<table width="450" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td><input type="checkbox" name="opcao2" value="2" <? if (strlen($opcao2) > 0) echo "checked"; ?>> Cliente</td>
		<td>CNPJ/CNPJ do Cliente</td>
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		...
		<td>&nbsp;</td>
		<td>
			<input type="text" name="cliente_cnpj" size="8" value="<?echo $cliente_cnpj?>">
			<img border="0" src="imagens/btn_lupa.gif" style="cursor: hand;" align="absmiddle" alt="Clique aqui para pesquisar o cliente pelo código" onclick="javascript: fnc_pesquisa_cliente (document.frm_pesquisa.cliente_cnpj, 'cnpj');">
		</td>
		<td colspan="2">
			<input type="text" name="cliente_nome" size="15" value="<?echo $cliente_nome?>">
			<img border="0" src="imagens/btn_lupa.gif" style="cursor: hand;" align="absmiddle" alt="Clique aqui para pesquisar pelo nome do cliente." onclick="javascript: fnc_pesquisa_cliente (document.frm_pesquisa.cliente_nome, 'nome');">
		</td>
		<td>
			&nbsp;
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" name="opcao4" value="4" <? if (strlen($opcao4) > 0) echo "checked"; ?>> Número da OS Manutenção</td>
...
if (strlen($acao) > 0 && strlen($msg) == 0) {
	...
	if (strlen($revenda) > 0) {
		$sql .= " AND tbl_os_revenda.revenda = $revenda";
	}
	...
	if (strlen($numero_serie) > 0) {
		$sql .= " AND tbl_os_revenda_item.serie LIKE '%$numero_serie%'";
	}
