...
<div id="container">
	<div id="page">
		...
		<div id="contentcenter" style="width: 700px;">
...
<div id="container">
	<div id="page">
		<h2>
		Diagnóstico e Manutenções Executadas
		<div id="contentcenter" style="width: 700px;">
...
<div id='container'>
	...
	<div id="contentleft2" style="width: 150px;">
	<a href="os_cadastro_britania.php"><img src="imagens/btn_lancanovaos.gif"></a>
	</div>
	<div id="contentleft2" style="width: 150px;">
	<a href="os_print_britania.php?os=<? echo $os ?>" target="blank"><img src="imagens/btn_imprimir.gif"></a>
	</div>
</div>
