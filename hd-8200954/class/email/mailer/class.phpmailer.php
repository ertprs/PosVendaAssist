...
|   Founder: Brent R. Matz elle (original founder)                           |
...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'noreply@telecontrol.com.br';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Telecontrol - Gestão Pós-Venda';
   ...
   * @var string
   */
  public $Subject           = 'Telecontrol - Gestão Pós-Venda 100% Web';
   ...
   * @var string
   */
  public $Username      = 'no_reply@telecontrol.com.br';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'reply159';
 ...
 /**
  ...
  /**
  * Pega os endereços de emails adicionados.
  * @return array
  */
   ...
   * @return boolean
   */
  public function AddReplyTo($address = 'suporte@telecontrol.com.br', $name = 'Telecontrol - Gestão Pós-Venda') {
 ...
 */
  ...
  protected function PostSend() {
    try {
      ...
      * HD-940807
      *
      * Cancelado o lançamento de exceção.
      * Alterado para quando der uma exceção, enviar e-mail via funcão "mail" do PHP.
      *
      ****************
      ...
      *********************************/
      ...
      // Inicializa o array com os emails para onde serao enviados.
      $para = array();

      // Valida os emails em branco e atribui ao array
      foreach ($this->to as $to) {
          $para[] = $to[0];
      }

      // Faz implode dos emails
      $para = implode(", ", $para); 

      // Formata o texto
      $this->Body = str_replace(array("<br/>", "<br>", "</br>", "<p>", "</p>"), "\n", $this->Body);

      $headers = $this->MIMEHeader . "\r\n";
      $headers .= "From: $this->FromName <$this->Username>";

      if(mail(null, $this->Subject, $this->Body, $this->MIMEHeader))
        return true;
      else
        return false;
    }
  ...
  * @access public
  */
  function SetLanguage($langcode = 'br', $lang_path = 'language/') {
