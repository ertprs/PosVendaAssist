    ...
    */
    function webDescription(){
		...
		<style type="text/css">
		    ...
		    pre { background-color: #ededed; padding: 5px; font-family: Courier New; font-size: 11px; color: #000000;}
			...
			_background-color: #999999; width: 100%;
			margin-left: 0px; margin-right: 0px;
			padding-left: 20px; padding-bottom: 10px;}
		    .hidden {
			position: absolute; visibility: hidden; z-index: 200; left: 300px; top: 100px;
			font-family: arial; overflow: hidden; width: 700;
			padding: 20px; font-size: 11px; background-color:#D9E2EF;
		...
		<div class=content>
			<br><br>
			<div class=title><img src="http://www.telecontrol.com.br/site-wp/wp-content/themes/gadget/images/logo-2011-texto.png" alt="Telecontrol" title="Webservice Telecontrol" /></div>
			<div class=nav>
				<p>Veja o <a href="'.$PHP_SELF.'?wsdl">WSDL</a> para o servi&ccedil;o.<br />
				Clique em uma opera&ccedil;&atilde;o para ver os detalhes.</p>
				<ul>';
				foreach($this->getOperations() as $op => $data){
				    ...
				    foreach($data as $donnie => $marie){ // loop through opdata
						if($donnie == 'input' || $donnie == 'output'){ // show input/output data
						    $b .= "<font color='gray'>".ucfirst($donnie).':</font><br>';
						    ...
						    $b .= "<font color='gray'>".ucfirst($donnie).":</font> $marie<br>";
						}
				    }
					$b .= '</div>';
				}
