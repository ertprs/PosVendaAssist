...
<table width="700" border="0" cellspacing="0" cellpadding="0" align='center'>
	<tr bgcolor = '#efefef'>
		...
		<td  class="chapeu" colspan='2' ><?=traduz('vista.explodida', $con)?></td>
	</tr>
...
if (pg_numrows($res) > 0) {
	...
	for ($i = 0 ; $i < pg_numrows($res) ; $i++) {
		...
		if($linha_anterior <> $linha) {
						echo "<br><dt>&nbsp;&nbsp;<b>»</b> <a href='info_tecnica_visualiza.php?tipo=Vista+Explodida&linha=$linha'>$nome </a><br></dt>";
		}
		if($login_fabrica<>19){
