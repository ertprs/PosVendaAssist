<div id="mainCol">
	<div id="leftCol">
		...
		<!-- Insira aqui o texto de sua escolha -->
			<h3><a href="#">02.04.2004 </a>- LANÇAMENTO! Novo espaço para notícias você deve colocar aqui.</h3>
		</div>
	...
	<div class="contentBlockMiddle">
		<!-- Insira aqui o texto de sua escolha -->
		<a href='http://www.ibratele.com.br' target='new'><img src="imagens/destaque_<? echo strtolower($login_fabrica_nome) ?>.gif"></a>
