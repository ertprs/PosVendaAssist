...
<?php if($login_fabrica == 3) { ?>
	...
	function verifica_split(id) {
		...
		if (document.getElementById('div_mapa')){
			url = "http://www.telecontrol.com.br<?php echo $PHP_SELF ?>?consulta_split=s&referencia="+id;
            ...
            if ($login_fabrica <> 1) {
                if ($login_fabrica == 11) {
                    ...
                    <td>
                        ...
                        <br />
                        <input class="frm" type="text" name="acessorios" size="30" value="<? echo $acessorios ?>" <? if($login_fabrica==50){?>onChange="javascript: this.value=this.value.toUpperCase();"<?}?> onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Texto livre com os acessórios deixados junto ao produto.');">
                    </td><?php
                }
            }
