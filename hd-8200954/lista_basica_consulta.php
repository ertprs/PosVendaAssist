...
<table width='700' border='0' align='center' cellspacing='1' cellpadding='0'>
	<tr  height='20' bgcolor='#666666'>
		...
		<?if (isFabrica(6)) echo "<BR>Série: $produto_serie ";?>
		</b></font></td>
	</tr>
</table>
...
$cond_1 = "tbl_lista_basica.serie_inicial <= '$produto_serie'
		...
		$sql =	"SELECT tbl_lista_basica.posicao       ,
				...
				and $cond_1";
		$sql .= "ORDER BY tbl_peca.referencia,tbl_lista_peca.peca_pai, rpad(trim (tbl_lista_basica.posicao),20,' '), tbl_peca.descricao, tbl_lista_basica.type";
	$res = pg_exec ($con,$sql);
