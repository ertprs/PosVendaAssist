...
$title = "Seja bem vindo ao Sistema Assist Telecontrol - MAKITA";
...
<center>
<a href='http://www.telecontrol.com.br' target='_blank'><img src='logos/logo_tc_2009_pq.gif' border='0'></a><br>
</center>
	...
	<tr>
		<td align='center' valign='top' colspan='2'>
			<table><tr><td  width="160" align='center'>
				...
				<form name="frm_login" method="post" action="<? $PHP_SELF ?>" target='_parent'>
					...
					<tr>
						...
						<td align='right' colspan="2" class='Texto'>
							<a href="externos/primeiro_acesso.php" target='_blank'><?=$lingua_primeiro_acesso?></a>&nbsp;
							<IMG SRC="imagens_login/btn_ok.gif"  name="btnAcao" value="Enviar" onclick='document.frm_login.submit(); ' style='cursor: hand;' alt='Clique aqui para logar!'>&nbsp;
						</td>
					</tr>
					<tr>
