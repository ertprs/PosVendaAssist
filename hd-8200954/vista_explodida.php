...
<table border='1'cellspacing='0' cellpadding='0' bordercolor='#000000' width='650'>
	<tr>
...
for ($i=0; $i< pg_numrows($res); $i++){
	...
	$td[$i] .= "										<tr>\n";
	$td[$i] .= "											<td WIDTH='10%' class='fonttabela'>".pg_result($res,$i,ordem)."</td>\n";
	$td[$i] .= "											<td WIDTH='20%' class='fonttabela'>".pg_result($res,$i,referencia)."</td>\n";
	$td[$i] .= "											<td WIDTH='70%' class='fonttabela'>".pg_result($res,$i,descricao)."</td>\n";
	$td[$i] .= "											<!-- <td WIDTH='10%' class='fonttabela'>".pg_result($res,$i,qtde)."</td> -->\n";
	$td[$i] .= "										</tr>\n";
	$td[$i] .= "									</table>\n";
	$td[$i] .= "								</td>\n";
	$td[$i] .= "							</tr>\n";
								...
								<td>
									<table width='100%'>
										<tr>
											...
											<td WIDTH='70%' class='fonttabela'>DESCRIÇÃO</td>
											<!-- <td WIDTH='10%' class='fonttabela'>QTD.</td> -->
										</tr>
									</table>
								</td>
							</tr>
