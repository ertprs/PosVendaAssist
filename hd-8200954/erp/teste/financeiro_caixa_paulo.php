	...
	if (strlen($ok)>0 OR strlen($msg)>0) {
		...
		if(strlen($receber)>0){
			...
			if (@pg_numrows($res) > 0) {
				...
				echo "<tr>";
				echo "<td>&nbsp;</td>";
				echo "<td align='center' rowspan='2' bgcolor='#FFFFFF'><input type='button' name='btn_produto' value='Produto' onclick=\"javascript : produto_cliente()\" style='width: 120px;height:40px;font-size:12pt '></td>";
				echo "</td>";
				echo "</tr>";
				echo "</table>";
			}
...
<script language= javascript>
	function produto_cliente() {
		window.open('teste2.php');
	}	
</script>
