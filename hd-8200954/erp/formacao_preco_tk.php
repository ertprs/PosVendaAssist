...
//echo "<BR>numero:".pg_numrows($res);
	if (@pg_numrows($res) > 0) {
		...
		echo "<td colspan='11' align='center'>Formação de Preço do Produto</td>";
							...
							if(pg_numrows($xxres)>0){
								...
								//echo "$percentual_lucro&nbsp;";
									...
									echo "<input type='text' name='data_$i"."_"."$x'
										value='' 
										id='data_$i"."_"."$x' 
										size='3'  maxlength='10' style='text-align:right' onKeyUp=\"formata_data(this.value,'frm', 'data_$i"."_"."$x')\">";
									echo "</td>";
