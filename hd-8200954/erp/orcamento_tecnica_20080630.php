...
<? 
	...
	//		echo "<td align='center'>$vendedor</td>";
			...
			if(strlen($aprovacao)>0) echo "<input type='text' name='nf_saida_$x' value='$nf_saida' size='5' maxlenght='8'>";
			else                     echo " - ";
			echo "</td>";
			echo "<td align='center'>";
	...
	echo "<tfoot>";
	echo "<tr>";
	echo "<td  colspan='11' align='right'><b>Data Fechamento:</b> <input type='text' name='data_fechamento' id='data_fechamento' size='10' rel='data_fechamento'><input type='submit' value='Gravar' name='fechar_os' >";
	echo "</td>";
	echo "</tr>";
	echo "</tfoot>";
	echo "</table>";
