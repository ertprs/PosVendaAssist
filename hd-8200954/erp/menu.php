...
<table width='100%' border='0' cellspacing='0' align='center' cellpadding='0'>
	<tr height='25' >
		...
		<td  bgcolor='#4F94CD' align='right' ><font color='#FFFFFF' size='1'>&nbsp;<?echo "Usuário: <A HREF='alterar_dados_empregado.php' style='color: #ffffff;'><b>$login_empregado_nome</b></A> | Email: <b>$login_empregado_email</b> | ";?> 
			...
			//MENU VENDAS
			 if ($acesso[$x] == "vendas"){?>
				...
				<li>
					...
					<ul>
						<li><a href="orcamento_cadastro.php?tipo_orcamento=fora_garantia">Orçamento</a></li>
						...
						<ul>
							...
							<li><div align="left"><a class="MenuBarItemSubmenu" href="#">Contas a Receber</a></div>
								<ul>
									...
									<li><a href="retorno_consulta.php">Consulta Retorno Bancário</a></li>
								</ul>
							</li>
