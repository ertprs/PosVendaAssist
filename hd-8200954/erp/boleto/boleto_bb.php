...
$dadosboleto["data_documento"] = $receber_emissao; // Data de emissão do Boleto
$dadosboleto["data_processamento"] = $receber_emissao; // Data de processamento do boleto (opcional)
$dadosboleto["valor_boleto"] = $valor; 	// Valor do Boleto - REGRA: Com vírgula e sempre com duas casas depois da virgula
...
$dadosboleto["demonstrativo1"] = "Multa de $multa % para pagamento após vencimento.
";
