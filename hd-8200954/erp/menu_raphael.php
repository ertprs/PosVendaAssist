...
<ul id="imenus0" style="width:580px">
	...
	<li  style="width:145px;"><a href="inicial.php">Inicial</a>
	<li  style="width:145px;"><a href="interno.php">CRM</a>
		<div>
			<div style="width:145px;top:0px;left:0px;">
				<ul style="">

					<li><a href="">Consulta</a>
						<div>
							<div style="width:140px;top:-19px;left:133px;">
								<ul style="">
									<li><a href="">Tal</a></li>
									<li><a href="">Tal</a></li>
								</ul>
					...
					<li><a href="#">Help Desk</a>
						<div>
							<div style="width:140px;top:-19px;left:133px;">
								<ul style="">
									<li><a href="crm_chamado_lista.php">Consulta Chamado</a></li>
									<li><a href="crm_chamado_detalhe.php">Novo Chamado</a></li>
								</ul>
							</div>
						</div>
					</li>
...
<script language="JavaScript">function imenus_data0(){
   ...
   ---------------------------------------------*/
	...
	this.main_pointer_image = 'menu/arrow_down.gif'
	...
	this.sub_pointer_image = 'menu/arrow_right.gif'
   ...
   ---------------------------------------------*/
	...
	this.main_container_styles = "background-color:#B6D1EF; border-style:none; border-color:#000000; border-width:1px; padding:0px; margin:0px; "
	this.main_item_styles = "color:#b90000; text-align:left; font-family:Arial; font-size:12px; font-weight:normal; text-decoration:underline; border-style:solid; border-color:#B6D1EF; border-width:1px; padding:2px 8px; "
	this.main_item_hover_styles = "background-color:#d2e4fc; text-decoration:underline; "
	this.main_item_active_styles = "background-color:#ecf3fb; "



	//Sub Menu

	this.subs_container_styles = "filter:progid:DXImageTransform.Microsoft.Fade(duration=0.3); background-color:#fefefe; border-style:solid; border-color:#cccccc; border-width:1px; padding:5px; margin:4px 0px 0px; "
	...
	this.subs_item_active_styles = "background-color:#EBF3FE; "
