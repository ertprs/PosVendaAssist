...
*/
	...
	if(strlen($login)                > 0) $xlogin                = "TRUE";
	else                                  $xlogin                = "FALSE";
	if(strlen($senha_fornecedor)     > 0) $xsenha_fornecedor     = "TRUE";
	else                                  $xsenha_fornecedor     = "FALSE";
	if(strlen($url)                  > 0) $xurl                  = "TRUE";
	else                                  $xurl                  = "FALSE";
	...
	***************************************************************************/
	...
	/********** insert fornecedor-permissão linha/familia/modelo/marca ********
	***************************************************************************/
	...
	/******************** fim insert fornecedor-permissão *********************
	***************************************************************************/
				...
				<div id="container-Principal">
					...
					<div id="tab2Cadastrar">
						...
						<!-- <a href='<? echo $PHP_SELF ?>?tipo=<?=$tipo?>&btn_acao=cadastrar'><img src='imagens/edit2.png' align='absmiddle'> Cadastar um novo <?=$tipo?></a> -->
									...
									<table style='background-color: #e6eef7' align='center' width='670' border='0' class='tabela'>
											<tr>
												<td class='Label'>Nome</td>
												<td colspan='1'><input class="Caixa" type="text" name="nome" size="50" maxlength="60" value="<? echo $nome ?>"></td>
												<td class='Label'>Login</td>
												<td class='Label' align='left' colspan='1'>
													<input class="Caixa" name="login" size="10" maxlength="20" value="<? echo $login;?>" ></td>
											</tr>
											<tr>
												...
												<td class='Label' align='left' colspan='1'>
													<input class="Caixa" name="senha_fornecedor" size="10" maxlength="20" value="<? echo $senha_fornecedor ?>" ></td>
											</tr>
											<tr>
									...
									-->
											...
											<tr>
												...
												<td align='left' colspan='4'>
													<input class="Caixa" type="text" name="site"   size="40" maxlength="40" value="<? echo $site;?>" ></td>
											</tr>
												...
												<td colspan='6'><br>
													<div id="container-Dentro">
														<ul>
															...
															<li><a href="#tab6Fornecedor"><span><img src='imagens/people-alt2.png' align=absmiddle> Permissão</span></a></li>
															<? }?>
