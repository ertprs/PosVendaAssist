...
if( $btn_acao=="Confirmar Recebimento"  AND (strlen($pedido) > 0)) { 
	...
	if(@pg_numrows($res)==0){
		...
		//VALOR_FRETE
		if((strlen($frete)==0) AND (strlen($valor_frete) =="FOB")) {
...
<FORM NAME='form_rec' ACTION='recebimento_confirma.php' METHOD='POST'>
  ...
  <tr>
    <td colspan='3' align='left'><b>FORNECEDOR</b></td>
...
?>
  ...
  <tr>
	...
	<td nowrap align='center' colspan='1' width='20%'><b>SÉRIE</b><br>
		<input type='text' name='serie' size='10' value='<?echo $serie;?>'>	
	</td>
...
*/	
	...
	echo "  
	<tr>
	<td nowrap colspan='7' align='left'><b>FATURA</b> - Condição de Pag. <b>$descricao<b>";
...
?>
  ...
  <tr>
    <td colspan='7' align='left'>
      <font color='black'><b>CÁLCULO DO IMPOSTO</b></font>
    </td>
  </tr>
  ...
  <tr >
	<td nowrap colspan='1' align='right'><?echo $base_icms;?></td>
...
<? if($total_nota <= 0)
	...
	echo "<td nowrap align='center' colspan='2'>
			<input type='text' name='total_nota' size='20' maxlength='15' value='$total_nota'  onKeyDown='formataValor(this,13,event);'>
		  </td>";
?>
  </tr>
  ...
  <tr>
    <td colspan='7' align='left'>
      <font color='black'><b>TRANSPORTADOR </b></font>
    </td>
  </tr>
<?
...
if(strlen($faturamento)>0){
	...
	if($status_pedido == '16')  {
		...
		echo "status do pedido eh: $status_pedido";
	}
}
?>
  </tr>
