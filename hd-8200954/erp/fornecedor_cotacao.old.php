...
?>
  ...
  <tr>
	<td>
		<?
		$sql="select tbl_pessoa_banco.nome
				from tbl_pessoa_banco
				join tbl_pessoa_fornecedor on tbl_pessoa_fornecedor.pessoa=tbl_pessoa_banco.pessoa
				left join tbl_cotacao_fornecedor on tbl_pessoa_fornecedor.pessoa = tbl_cotacao_fornecedor.pessoa_fornecedor
				where cotacao_fornecedor=$cotacao_fornecedor";
		$res=pg_exec($con,$sql);
		if(pg_numrows($sql) > 0) {
			$banco_nome =trim(pg_result($res,0,nome));
		}
		echo "$banco_nome";
		?>
	</td>
  ...
  <table width='100%' align='left' class='table_line'>
	<tr >	
	  <td nowrap class='titulo' width='5%' align='center'>#</td>
	  <td nowrap class='titulo' width='5%' align='center'>+</td>
	  <td nowrap class='titulo' width='5%' align='center'>Cód.</td>
	  <td nowrap class='titulo' width='70%' align='center'>Itens da Cotação</td>
	  <td nowrap class='titulo' width='5%' align='center'>Cód Barra</td>
	  <td nowrap class='titulo' width='5%' align='center'>Quantidade</td>
	  <td nowrap class='titulo' width='5%' align='center'>Menor Lance</td>
	  <td nowrap class='titulo' width='5%' align='center'>Vlr Vista sem IPI</td>
	  <td nowrap class='titulo' width='5%' align='center'>Vlr Prazo sem IPI</td>
	  <td nowrap class='titulo' width='5%' align='center'>% IPI</td>
	  <td nowrap class='titulo' width='5%' align='center'>Vlr IPI</td>
	  <td nowrap class='titulo' width='5%' align='center'>% ICMS</td>
	  <td nowrap class='titulo' width='5%' align='center'>Status</td>
	</tr>
