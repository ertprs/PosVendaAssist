...
<table width='100%' border='0' cellspacing='0' align='center' cellpadding='0'>
	<tr height='25' >
		...
		<td  bgcolor='#4F94CD' align='left' ><font color='#FFFFFF' size='1'>&nbsp;<?echo "Usuário: <b>$login_empregado_nome</b> | Email: <b>$login_empregado_email</b> ";?> | <a href='http://www.telecontrol.com.br' style='color:#FFFFFF'>Sair</font></a>
		</td>
...
/*########################################################################
################### SELECT PERMISSÃO DE ACESSO AO MENU ###################
##########################################################################*/	
	$sql = "SELECT 
				tbl_pessoa.email ,
				tbl_pessoa.nome ,
			...
			WHERE tbl_pessoa.pessoa = $login_pessoa";
	$res = pg_exec ($con,$sql);
	if (pg_numrows ($res) > 0) {
	...
	echo "<ul id='MenuBar1' class='MenuBarHorizontal'>";
		for($i=0; $i < sizeof($acesso); $i++){
			...
			<?}if ($acesso[$i] == "compra"){?>
				<li><div align="center"><a class="MenuBarItemSubmenu" href="#">Compra</a></div>
					<ul>
						...
						<li><div align="left"><a class="MenuBarItemSubmenu" href="#">Recebimento</a></div>
							<ul>
								<li><a href="cotacao_consultar_pedido.php">Recebimento de Mercadoria</a></li>
							</ul>
						</li>
			...
			<?}if ($acesso[$i] == "*"){
				//header("Location: erp/menu_cadastro.php");
			}
			//exit;?>
		 </ul>
		<?
	}
/*############### FIM SELECT PERMISSÃO DE ACESSO AO MENU ###################*/
