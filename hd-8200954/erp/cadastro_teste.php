...
include '../dbconfig_erp.php';
include '../includes/dbconnect-inc_erp.php';
					...
					<div id="tab2Cadastrar">
						...
						<!-- <a href='<? echo $PHP_SELF ?>?tipo=<?=$tipo?>&btn_acao=cadastrar'><img src='imagens/edit2.png' align='absmiddle'> Cadastar um novo <?=$tipo?></a> -->
									...
									<table style='background-color: #e6eef7' align='center' width='670' border='0' class='tabela'>
											<tr>
												<td class='Label'>Nome</td>
												<td colspan='6'><input class="Caixa" type="text" name="nome" size="50" maxlength="60" value="<? echo $nome ?>"></td>
									...
									-->
											...
											<? if($tipo == 'fornecedor'){?>
											<tr>
												<td class='Titulo_Colunas' colspan='5'><BR>Informações site do fornecedor</td>
											</tr>
											<tr>
													...
													<div id="container-Dentro">
														...
														<div id="tab1Contato">
															...
															<table width='100%' border='0'>
																...
																<!-- **** -->
																<tr>
																	<td class='miudinho' align='left' colspan='6'>(*) Se informado o número, o DDD é obrigatório</td>
																</tr>
																<? if($tipo<>"cliente"){?> 
																<tr>
																<td colspan='6'>
...
************************************************************************************************-->
														<div id="tab7Banco">
															...
															if (@pg_numrows($res) > 0) {
																...
																echo "<BR>";
																echo "<P align='center'><font size='2'><b>Dados Bancarios - Débito/Créditos Lançados";
															...
															echo " </TABLE>";
																...
																echo "<b><center>Nenhuma conta de banco lançada</center></b>";
															}
															}
															?>
														</p>
