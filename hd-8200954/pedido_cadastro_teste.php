	...
	if (strlen ($msg_erro) == 0) {
		...
		for ($i = 0 ; $i < $qtde_item ; $i++) {
			...
			if (strlen ($peca_referencia) > 0) {
				...
				#hd 16782
				if ($nacional > 0 and $importado > 0 and $login_fabrica <> 3 and $login_fabrica <> 5 and $login_fabrica <> 8 and $login_fabrica <> 24 and $login_fabrica <> 6 and $login_fabrica <> 40 and $login_fabrica <> 42 and $login_fabrica <> 72) {
