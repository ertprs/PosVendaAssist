...
/*----------------------------------------------------*/
var CAPXOUS=new 
Object();CAPXOUS.isKHTML=navigator.appVersion.match(/Konqueror|Safari|KHTML/);
...
Object.extend(
	CAPXOUS.AutoComplete,{
		...
		style:{
			wait:'CAPXOUS_AutoComplete_waiting'
		},
		findPopup:function(v){
			var e=Event.element(v);
			e=e?e:v;while(e&&e.parentNode&&!e.object)e=e.parentNode;
			if(e==null)
				return null;
		...
		click:function(v){
			...
			if(p){
				var t=p.object.text;CAPXOUS.focus(t);
				var s=cls.F(v,p);
				var o=p.object;
				if(s){
