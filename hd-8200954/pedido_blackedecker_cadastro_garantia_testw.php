...
if (strval(strtotime(date("Y-m-d H:i:s"))) < strval(strtotime("2006-01-01 00:00:00"))) {
	$sql .= "AND tbl_pedido.tabela = 62 ";
}else{
	$sql .= "AND tbl_pedido.tabela = 109 ";
}
...
<table width="500" border="0" cellpadding="2" cellspacing="1" align="center">
<tr>
	<td class='menu_top' ><B><U>COMUNICADO IMPORTANTE</U>: Mudança de horário</B></td>
</tr>
<tr class='table_line1' bgcolor='#F1F4FA'>
	<td>
		<?/*<p>Com o objetivo de agilizar e melhorar o nosso tempo para o fornecimento de peças, trabalharemos com dois turnos no depósito/expedição para o embarque dos pedidos de peças.</p>
		<p>Em função desta melhoria, <B>apartir do dia 05/05/2008</B>, o horário padrão para o  envio dos pedidos de peças para a fábrica, será alterado de 13h30 para as <B><U>12horas</U>.</B></p>
		<p>Com <B>dois turnos</B>, os pedidos colocados no site até as 12hs, embarcarão no dia seguinte. O intuito é de melhorar o tempo de atendimento!</p>
		<p>Esperamos assim, exceder as expectativas de nossos parceiros.</p>
		<p></p>
		<p>Rúbia Lane Fernandes<br>
		Faturamento de Peças<br>
		Black & Decker do Brasil</p>*/?>
			<P style='font-size: 12px; font-family: arial; color: #FF0000;'>ATENÇÃO para o novo horário de envio de pedidos de peças para fábrica: de 12hs para 11h45.</P>
	</td>
</tr>
</table>
<br><br>
