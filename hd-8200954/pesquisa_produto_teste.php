...
if (@pg_numrows ($res) == 1 ) {
	...
	for ( $i = 0 ; $i < pg_numrows ($res) ; $i++ ) {
		...
		$imagem		= "imagens_produtos/$login_fabrica/pequena/$referencia.jpg";
		if ($login_fabrica==3 and file_exists("/var/www/assist/www/$imagem")) {
		    $imagem = (!is_readable("/var/www/assist/www/$imagem"))? false : $imagem;
		}
?>		<tr>
			<td>
			...
			<td>
				<a href="javascript: retorno(<?="'$produto','$referencia','$descricao'"?>)">
