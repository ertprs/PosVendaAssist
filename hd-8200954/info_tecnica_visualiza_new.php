...
//	echo nl2br($sql);
	...
	if (pg_numrows ($res) > 0) {	
		echo "<table width='700' align='center' class='table table-bordered table-large' style='width: 1000px; margin: 0 auto;height: auto !important'>";
		echo "<tr class='titulo_tabela'>";
		echo "<td align='center' colspan='2'>$tipo</td>";		
		echo "</tr>";
