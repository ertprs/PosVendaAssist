<?php 
    ...
    $logomarca_loja         = (!empty($logoLoja)) ? $logoLoja : "../layout/img/logo.png";
    ...
    <div class="box-print">
        ...
        <div class="row-fluid">
            <div class="span12">
                    ...
                    <?php
                    if ($login_fabrica == 42) {
                        $dadosFornecedor = $objCarrinhoCompra->dadosFornecedorCarrinho($pedido);
                    ?><br>
                        <span style="font-weight: normal;">
                            <strong>Dados Fornecedor</strong><br>
                            <strong>Fornecedor: </strong><?= $dadosPedido['itens'][0]['produto']['nome_fornecedor'] ?>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <strong>Celular: </strong><?= (empty($dadosFornecedor['cel_fornecedor'])) ? ' Não possui' : $dadosFornecedor['cel_fornecedor'] ?><br />
                            <strong>Fone:</strong> <?= (empty($dadosFornecedor['fone_fornecedor'])) ? ' Não possui' : $dadosFornecedor['fone_fornecedor'] ?><br />
            ...
            <tr class="titulo_tabela">
                ...
                <tr>
                    ...
                    <?php 
                        ...
                        } elseif (isset($configLojaFrete["meio"])) {
                             echo '
                            <tr>
                                <td colspan="3" class="tar"><b>FRETE</b></td>
                                <td class="tac">R$ '.$dadosPedido["valor_frete"].'</td>
                            </tr>';
                        } 
                    ?>
                <tr>
                    ...
                    <?php
                        if ($dadosPedido['valor_frete'] > 0) { ?>
                            <td class="tac"><?php echo "R$ ".number_format(array_sum($subtotal)+$dadosPedido['valor_frete'], 2, ',', '.');?></td>
                        <?php
                        } else { ?>
                            <td class="tac"><?php echo "R$ ".number_format(array_sum($subtotal), 2, ',', '.');?></td>
                        <?php
