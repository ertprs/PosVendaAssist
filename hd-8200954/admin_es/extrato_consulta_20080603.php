...
//				if ($sistema_lingua=='ES')
					echo "<td align='center' colspan='3' nowrap>Valores Adicionales al Extracto</td>\n";
//				else
//					echo "<td align='center' colspan='3' nowrap>Valores Adicionais ao Extrato</td>\n";
			...
			if ($msg_os_deletadas==""){
				...
				if (strlen($aprovado) == 0 OR $login_fabrica == 8)
					echo "<a href='extrato_avulso.php'><img src='imagens_admin/btn_nuevo_azul.gif' ALT='Catastrar un Nuevo Extracto'></a>";
				echo "</td>\n";
