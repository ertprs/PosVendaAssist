...
<TR>
  <TD width='10'><IMG src="imagens/corner_se_laranja.gif"></TD>
  <TD class=cabecalho>INFORMES</TD>
  <TD width='10'><IMG src="imagens/corner_sd_laranja.gif"></TD>
</TR>
</TABLE>
...
<tr bgcolor='#fafafa'>
	...
	<td class='descricao'>Reporte de averías de herramientas, tomando en cuenta la fecha de creación del extracto aprobado.</td>
</tr>
<!-- ================================================================== -->
<tr bgcolor='#f0f0f0'>
	<td><img src='imagens/rel25.gif'></td>
	<td><a href='relatorio_field_call_rate_pecas_defeitos.php' class='menu'>Field Call-Rate - Piezas</a></td>
	<td class='descricao'>Reporte de averías de piezas, tomando en cuenta la fecha de creación del extracto aprobado.</td>
</tr>
<!-- ================================================================== -->
...
<tr bgcolor='#f0f0f0'>
	...
	<td nowrap width='260'><a href='relatorio_percentual_defeitos.php' class='menu'>Porcentaje de Averías</a></td>
	<td class='descricao'>Porcentaje de averías de herramientas por período.</td>
</tr>
<!-- ================================================================== -->
<tr bgcolor='#fafafa'>
	<td width='25'><img src='imagens/rel25.gif'></td>
...
<tr bgcolor='#fafafa'>
	<td width='25'><img src='imagens/rel25.gif'></td>
	<td nowrap width='260'><a href='custo_por_os.php' class='menu'>Coste por OS</a></td>
	<td class='descricao'>Coste medio de reparación en garantía de extractos para cada servicio.</td>
</tr>
<!-- ================================================================== -->
<tr bgcolor='#f0f0f0'>
	<td width='25'><img src='imagens/rel25.gif'></td>
	<td nowrap width='260'><a href='relatorio_quebra_familia.php' class='menu'>Reporte de averías por Familia</a></td>
	<td class='descricao'>Reporte de cantidad de averías durante los últimos 12 meses, tomando en cuenta el cierre del extracto de cada mes.</td>
</tr>
...
<tr bgcolor='#fafafa'>
	...
	<td class='descricao'>Reporte de OS sin repuestos y sus respectivos defectos reclamados, constatados y solución.</td>
</tr>
<tr bgcolor='#fafafa'>
	<td width='25'><img src='imagens/rel25.gif'></td>
...
<tr bgcolor='#fafafa'>
	<td width='25'><img src='imagens/rel25.gif'></td>
	<td nowrap width='260'><a href='atualizacao_postos_bosch.php' class='menu'>Archivo de Actualización de Servicios</a></td>
	<td class='descricao'>Genera un archivo de registro de Servicios Técnicos Autorizados en el sistema de Alemania.</td>
</tr>
<!-- ================================================================== -->
<tr bgcolor='#D9E2EF'>
	<td colspan='3'><img src='imagens/spacer.gif' height='3'></td>
...
<tr bgcolor='#f0f0f0'>
	...
	<td class='descricao'>Envía mensajes vía e-mail a los Servicios Técnicos</td>
</tr>
<tr bgcolor='#D9E2EF'>
	<td colspan='3'><img src='imagens/spacer.gif' height='3'></td>
</tr>
