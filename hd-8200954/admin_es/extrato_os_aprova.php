...
/*
		...
		*/ # comentei somente este if, pois estava dando erro na exibição, e o select acima já estava comentado, então comentei este. Fabio 17-07-2007
	   /* if (pg_numrows($res_idioma) >0) { 
...
//fim
	...
	echo "ok|$resposta";	
	/*  # pra que begin?????????????? Retirei. Fabio 17/07/2007

	if (strlen ($msg_erro) == 0) {
		$res = pg_exec ($con,"COMMIT TRANSACTION"); # pra que begin?????????????? Retirei. Fabio 17/07/2007
		echo "ok|$resposta";
	}else{
...
<?
	...
	echo "<table width='750' align='center'><tr><td valign='top'>";
...
//	}
	...
	echo "<td class='Conteudo'>";
		...
		if ($login_fabrica==20) {
			echo "<tr>";
				echo "<td bgcolor='#FFFF99'>&nbsp;&nbsp;&nbsp;&nbsp;</td><td width='100%' valign='middle' align='left'>&nbsp;<b>CORTESÍA COMERCIAL</b></td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td colspan='2'>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
			echo "</tr>";
