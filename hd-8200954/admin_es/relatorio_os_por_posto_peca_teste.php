...
if (isset($_GET["q"])){
	...
	if (strlen($q)>2){
		$sql = "SELECT tbl_posto.cnpj, tbl_posto.nome, tbl_posto_fabrica.codigo_posto
				...
				AND   tbl_posto.pais = (SELECT pais FROM tbl_admin WHERE admin = $login_admin )";
...
if(strlen($btn_acao) >0){
	...
	if ((strlen($aux_data_inicial) == 0 or strlen($aux_data_final) == 0) and strlen($extrato) == 0) {
...
if (strlen($posto_codigo) == 0 AND strlen($posto_nome) == 0 AND strlen($data_inicial) == 0 AND strlen($data_final) == 0 AND strlen($btn_acao) > 0 AND strlen($extrato) == 0)
...
<tr>
	...
	<td>
		<input class="frm" type="text" name="posto_codigo" id='posto_codigo' size="15" value="<? echo $posto_codigo ?>">&nbsp;<img src='imagens_admin/btn_lupa.gif' border='0' align='absmiddle' style="cursor:pointer" onclick="javascript: fnc_pesquisa_posto2 (document.frm_os_posto.posto_codigo,document.frm_os_posto.posto_nome,'codigo')">
	</td>
	<td class='menu_top' nowrap>Nombre del servicio</td>
	<td>
		<input class="frm" type="text" name="posto_nome" id='posto_nome' size="30" value="<? echo $posto_nome ?>">&nbsp;<img src='imagens_admin/btn_lupa.gif' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto2 (document.frm_os_posto.posto_codigo,document.frm_os_posto.posto_nome,'nome')" style="cursor:pointer;">
	</td>
</tr>
<tr>
	<td colspan='4'></td>
...
<tr>
<TD nowrap class='menu_top' >Extrato</TD>
<TD><INPUT size="20" maxlength="10" TYPE="text" NAME="extrato"  value="<? if (strlen($extrato) > 0) echo $extrato;?>"></TD>
</tr>
</table>
...
if (strlen($btn_acao) > 0 AND strlen($msg_erro) == 0){
	...
	if(strlen($extrato) > 0) {
		$join_extrato =" JOIN tbl_os_extra ON tbl_os.os = tbl_os_extra.os ";
		$sql_extrato = " AND tbl_os_extra.extrato = $extrato ";
	}
