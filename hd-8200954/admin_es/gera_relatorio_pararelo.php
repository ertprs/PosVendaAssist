...
if ($gera_automatico != 'automatico'){
	...
	$res = pg_exec($con,$sql);
	if (pg_numrows($res) > 0) {
		$msg_erro = "Por favor, aguarde, el reporte está sendo processado en este momento";
		...
		echo "<p class='sucesso'>El reporte está sendo processado en este momento. Aguarde...</p>";
		...
		if ($ret <> "0"){
			$msg_erro .= "Ocorreu um erro inesperado duante o processamento. Tente novamente<br>";
			# Seta como executado
