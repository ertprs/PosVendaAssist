			...
			<table width='100%' border='0' cellspacing='1' cellpadding='2' class='Conteudo'>
				...
				<tr width='100%' >
					...
					<td colspan='2' align='left'>
						<input class="Caixa" type="text" name="codigo_posto" size="10" value="<? echo $codigo_posto ?>" &nbsp;<img src='imagens_admin/btn_lupa.gif' border='0' align='absmiddle' style="cursor:pointer" onclick="javascript: fnc_pesquisa_posto2 (document.frm.codigo_posto,document.frm.posto_nome,'codigo')"></A>
					</td>	
				</tr>
				<tr>
...
//				echo "$data_geracao<>".$mes[$x];
	...
	}else{echo "Ninguno extracto durante este período";}
}
