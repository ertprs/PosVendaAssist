...
<tr>
	<td>
		<select name='pais' size='1' class='frm'>
			...
			<option value='BO' <? if ($pais == 'BO') echo ' selected ' ?> >Bolívia</option>
			<option value='CO' <? if ($pais == 'CO') echo ' selected ' ?> >Colombia</option>
			<option value='CL' <? if ($pais == 'CL') echo ' selected ' ?> >Chile</option>
			<option value='CR' <? if ($pais == 'CR') echo ' selected ' ?> >Costa Rica</option>
			<option value='SV' <? if ($pais == 'SV') echo ' selected ' ?> >El Salvador</option>
			<option value='EC' <? if ($pais == 'EC') echo ' selected ' ?> >Ecuador</option>
			<option value='GT' <? if ($pais == 'GT') echo ' selected ' ?> >Guatemala</option>
			<option value='HN' <? if ($pais == 'HN') echo ' selected ' ?> >Honduras</option>
			<option value='MX' <? if ($pais == 'MX') echo ' selected ' ?> >México</option>
			<option value='NI' <? if ($pais == 'NI') echo ' selected ' ?> >Nicarágua</option>
			<option value='PN' <? if ($pais == 'PN') echo ' selected ' ?> >Panamá</option>
			<option value='PY' <? if ($pais == 'PY') echo ' selected ' ?> >Paraguay</option>
			<option value='PE' <? if ($pais == 'PE') echo ' selected ' ?> >Peru</option>
			<option value='DO' <? if ($pais == 'DO') echo ' selected ' ?> >Republica Dominicana</option>
			<option value='UY' <? if ($pais == 'UY') echo ' selected ' ?> >Uruguay</option>
			<option value='VE' <? if ($pais == 'VE') echo ' selected ' ?> >Venezuela</option>
		</select>
	</td>
	<td>
