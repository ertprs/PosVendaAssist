...
<form name='frm_percentual' action='<? echo $PHP_SELF ?>' METHOD='GET'>
  ...
  <TR>
   ...
   <TR>
    <TD class="table_line" style="width: 10px">&nbsp;</TD>
	<TD class="table_line" style="width: 185px"><center><INPUT size="10" maxlength="10" TYPE="text" NAME="data_inicial" id="data_inicial" value="<? if (strlen($aux_data_inicial) > 0) echo $aux_data_inicial;?>"></center></TD>
	<TD class="table_line" style="width: 185px"><center><INPUT size="10" maxlength="10" TYPE="text" NAME="data_final" id="data_final" value="<? if (strlen($aux_data_final) > 0) echo $aux_data_final; ?>"></center></TD>
    <TD class="table_line" style="width: 10px">&nbsp;</TD>
  </TR>
  <tr>
  ...
  <td colspan='4' class="table_line"></td>
	...
	<td align='center' colspan='4' class="table_line2"><img src='imagens_admin/btn_confirmar.gif' border=0 onclick="javascript: if ( document.frm_percentual.btn_confirmar.value == '0' ) { document.frm_percentual.btn_confirmar.value='1'; document.frm_percentual.submit() ; } else { alert ('Aguarde submisión...'); }" style="cursor:pointer "></td>
</tr>
</form>
</table>
...
//////////////////////////////////////
	...
	echo "<table width='700' align='center' border='0' cellspacing='2' cellpadding='2'>";
	echo "<tr class='table_line'>";
	echo "<td align='center' colspan=5>CINCO MAYORES DEFECTOS (CONVENCIONAIS) - Cantidad de OS</td>";
	echo "</tr>";
	...
	echo "<table width='700' align='center' border='0' cellspacing='2' cellpadding='2'>";
	echo "<tr class='table_line'>";
	echo "<td align='center' colspan=5>CINCO PIEZAS QUE MÁS OCURRIRAN DEFECTOS - Cantidad de OS</td>";
	echo "</tr>";
