...
/*
				...
				if ($reembolso_peca_estoque == "t" && $tipo_posto == "38" AND $login_fabrica == 1 and $posto <> 7103 and $posto <> 5122){
					...
					$msg_erro = " Reembolso de peças do estoque não é permitido para posto VIP. Altere o tipo do posto para a região dele.";
				}
*/
...
<? 
//ALTERAÇÃO FEITA POR RAPHAEL GIOVANINI...PARA BOSCH NA ESCOLHA DO PAÍS DO POSTO
if($login_fabrica==20){ 
