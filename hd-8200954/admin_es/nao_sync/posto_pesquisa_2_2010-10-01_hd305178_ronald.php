...
<img src="../imagens/pesquisa_posto<? if($sistema_lingua == "ES") echo "_es"; ?>.gif">
<br>
...
if ($tipo == "nome") {
	...
	echo "<h4>Buscando por <b>nombre del serivicio</b>: <i>$nome</i></h4>";
	echo "<p>";
...
if ($tipo == "codigo") {
	...
	echo "<font face='Arial, Verdana, Times, Sans' size='2'>Buscando de lo <b>código do posto</b>: <i>$codigo_posto</i></font>";
	echo "<p>";
