...
<table width="400" align="center" border="0" cellspacing="0" cellpadding="3">
	...
	<tr bgcolor="#D9E2EF">
		...
		<td class="table_line"><input type="radio" name="data_filtro" value="ABERTURA" <? if($data_filtro == 'ABERTURA' OR $data_filtro == 0){?>checked<?}?>> Abertura da OS<br><input type="radio" name="data_filtro" value="DIGITACAO" <? if($data_filtro=='DIGITACAO'){?>checked<?}?>> Digitación de OS<br><input type="radio" name="data_filtro" value="FINALIZADA" <? if($data_filtro=='FINALIZADA'){?>checked<?}?>> Finalización de OS</td>
		<td class="table_line">&nbsp;</td>
	</tr>
	<tr bgcolor="#D9E2EF">
...
//Fernando 15/09
		...
		echo " <FONT SIZE=\"2\"><B>Reporte generado: $data</B></FONT> <br><br>";
//==============================================================================================
