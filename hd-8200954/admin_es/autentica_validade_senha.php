...
//	echo "senha expirou $data_expira_senha";
	...
	if (strlen($msg_validade_cadastro)==0){
		$msg_validade_cadastro="<a href='alterar_senha.php'><font size='1' face='arial,verdana'>Su contraseña irá caducar en $data_expira_senha días. Click aquí para registrar una nueva contraseña.</font></a>";
	}
