...
if($acao=="PESQUISAR"){
	if(strlen($mes)==0) $msg_erro = "Introduzca el mes de búsqueda";
	if(strlen($ano)==0) $msg_erro = "Introduzca el año para la investigación";
...
?>
	...
	<table width="700px" align="center" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="4" class="titulo_tabela">Los parámetros de búsqueda</td>
		</tr>
		<tr class="Conteudo" bgcolor="#D9E2EF">
			<td width='10%'></td>
			<td width='40%' align='left'>Mes</td>
			<td width='40%' align='left'>Año</td>
			<td width='10%'></td>
		</tr>
		<tr class="Conteudo" bgcolor="#D9E2EF">
			<td width='10%'></td>
		...
		<tr class="Conteudo" bgcolor="#D9E2EF">
			<td width='10%'></td>
			<td width='40%' align='left' >Código Service</td>
			<td width='40%' align='left' >Nombre Service</td>
			<td width='10%'></td>
		</tr>
		<tr class="Conteudo" bgcolor="#D9E2EF">
			<td width='10%'></td>
		...
		<tr bgcolor="#D9E2EF">
			...
			<td colspan='2' align='left'>
				<select class='frm' name="estado" size="1">
					<option value=""   <? if (strlen($estado) == 0)    echo " selected "; ?>>TODOS LOS ESTADOS</option>
		...
		<tr bgcolor="#D9E2EF">
			<td width='10%'></td>
			<td width='40%' align='left'>Defecto</td>
			<td colspan='2'></td>
		</tr>
		<tr bgcolor="#D9E2EF">
			<td width='10%'></td>
		...
		<tr bgcolor="#D9E2EF">
			<td width='10%'></td>
			<td width='40%' align='left'>Presupuesto de estado</td>
		...
		<tr bgcolor="#D9E2EF">
			...
			<td width='40%' align='left'>
				<SELECT NAME="aprovado" class='frm'>
					<OPTION></OPTION>
					<OPTION value="t" <? if($aprovado=="t") echo "SELECTED"; ?>>Aprobado</OPTION>
					<OPTION value="f" <? if($aprovado=="f") echo "SELECTED"; ?>>Fallar</OPTION>
				</SELECT>
			</td>
			<td colspan="2" align='left'>
		...
		<tr bgcolor="#D9E2EF">
			<td colspan="4" align="center">
				...
				style="background:url(imagens/btn_pesquisar_400.gif); width:400px; height:20px;cursor:pointer; margin-bottom:5px;" value="" />
			</td>
		</tr>
	</table>
	</form>
...
if($acao=="PESQUISAR" AND strlen($msg_erro)==0){
    ...
    if(pg_numrows($res)>0) {
        ...
        $arquivo_nome     = "consulta-os-fuera-garantia-$login_fabrica.xls";
        ...
        fputs ($fp,"<td><b>Nombre del consumidor</b></td>");
        fputs ($fp,"<td><b>Teléfono del Consumidor</b></td>");
        fputs ($fp,"<td><b>Email de los consumidores</b></td>");
        fputs ($fp,"<td><b>Descripción del producto</b></td>");
        fputs ($fp,"<td><b>Defecto</b></td>");
        fputs ($fp,"<td><b>Apertura</b></td>");
        fputs ($fp,"<td><b>Envío Presupuesto</b></td>");
        fputs ($fp,"<td><b>Aprobación</b></td>");
        fputs ($fp,"<td><b>Presupuesto Aprobado</b></th>");
        fputs ($fp,"<td><b>Reparación</b></th>");
        fputs ($fp,"<td><b>Cierre</b></th>");
        fputs ($fp,"<td><b>Tiempo de espera del presupuesto</b></td>");
        fputs ($fp,"<td><b>Horas Pendiente de aprobación</b></td>");
        fputs ($fp,"<td><b>Horas de espera para la reparacióno</b></td>");
        fputs ($fp,"<td><b>En espera de horas Retiroa</b></td>");
        fputs ($fp,"<td><b>Horas Presupuesto + reparación</b></td>");
        fputs ($fp,"</TR>");
        ...
        $resposta .="<tr>";
        $resposta .= "<td align='center'><button onclick=\"window.location='../admin/xls/$arquivo_nome'\">Descargar en EXCEL</button></td>";
        $resposta .= "</tr>";
        $resposta .= "</table>";
        echo $resposta;
        ...
        echo "<table width='100%' border='0' cellpadding='0' cellspacing='1' align='center' class='tabela'>";
            echo "<tr class='titulo_coluna'>";
                echo "<td nowrap>Service</td>";
                echo "<td nowrap>País</td>";
                echo "<td nowrap>Nombre del consumidor</td>";
                echo "<td nowrap>Teléfono del Consumidor</td>";
                echo "<td nowrap>Email de los consumidores</td>";
                echo "<td nowrap>Descripción del producto</td>";
                echo "<td nowrap>Defecto</td>";
                echo "<td nowrap>Apertura</td>";
                echo "<td nowrap>Envio do Orçamento</td>";
                echo "<td nowrap>Aprobación</td>";
                echo "<td nowrap>Presupuesto aprobado</td>";
                echo "<td nowrap>Reparación</td>";
                echo "<td nowrap>Cierre</td>";
                echo "<td nowrap>Tiempo de espera del presupuesto</td>";
                echo "<td nowrap>Horas Pendiente de aprobación</td>";
                echo "<td nowrap>Horas de espera para la reparación</td>";
                echo "<td nowrap>En espera de horas Retiroa</td>";
                echo "<td nowrap>Horas + Presupuesto de reparación</td>";
            echo "</tr>";
