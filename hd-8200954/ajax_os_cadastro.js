...
function listaConstatado(linha,familia, defeito_reclamado,referencia) {
//verifica se o browser tem suporte a ajax
		try {ajax = new ActiveXObject("Microsoft.XMLHTTP");}
	catch(e) { try {ajax = new ActiveXObject("Msxml2.XMLHTTP");}
	catch(ex) { try {ajax = new XMLHttpRequest();}
...
//se tiver suporte ajax
	...
	ajax.open("GET","ajax_defeito_constatado.php?defeito_reclamado="+defeito_reclamado+"&produto_familia="+familia+"&produto_linha="+linha+"&produto_referencia="+referencia);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
