...
<table class="border" width='650' align='center' border='0' cellpadding="1" cellspacing="1">
<?
...
<?		$cliente_cep = substr ($cliente_cep,0,5) . "-" . substr ($cliente_cep,5,3); ?>
	...
	<tr>
		...
		<TD class="table_line2" colspan='2'><? echo $distancia ?>&nbsp</TD>
		<td class="menu_top">CONTATO</td>
		<TD class="table_line2"><? echo $quem_abriu_chamado ?>&nbsp</TD>
		<td class="menu_top">C/ CONTRATO</td>
		<TD class="table_line2"><? echo $contrato ?>&nbsp</TD>
	</tr>
	<tr>
		<td class="menu_top">OBS</td>
		<TD class="table_line2" colspan='5'><? echo nl2br($obs_os); ?>&nbsp</TD>
	</tr>
</table>

<br>

<table class="border" width='650' align='center' border='0' cellpadding="1" cellspacing="2">
	<tr>
		<td colspan='6' class="menu_top">Valores Combinados na Abertura da OS</td>
	</tr>
	<tr>
		<td class="menu_top">Chamado aberto por</td>
...
<!-- 		<td class="menu_top">Mão-de-obra</td> -->
		...
		<td class="menu_top">Valor / km</td>
<!-- 		<td class="menu_top">Nat. Serviço</td> -->
		<td class="menu_top">Cobrar percurso</td>
	</tr>
	<tr>
		<TD align='center'><INPUT TYPE="text" NAME="chamado" VALUE="<? echo $chamado; ?>" SIZE='15' MAXLENGTH=''></TD>
		<TD align='center'><INPUT TYPE="text" NAME="taxa_visita" VALUE="<? echo str_replace(".",",",$taxa_visita); ?>" SIZE='9' MAXLENGTH='10' style="text-align:right"></TD>
		<TD align='center'><INPUT TYPE="text" NAME="hora_tecnica" VALUE="<? echo $hora_tecnica ?>" SIZE='9' MAXLENGTH='10' style="text-align:right"></TD>
<!-- 		<TD align='center'><INPUT TYPE="text" NAME="mao_de_obra" VALUE="<? echo str_replace(".",",",$mao_de_obra) ?>" SIZE='9' MAXLENGTH='10' style="text-align:right"></TD> -->
		<TD align='center'><INPUT TYPE="text" NAME="valor_diaria" VALUE="<? echo str_replace(".",",",$valor_diaria) ?>" SIZE='9' MAXLENGTH='10' style="text-align:right"></TD>
		<TD align='center'><INPUT TYPE="text" NAME="valor_km" VALUE="<? echo $valor_km ?>" SIZE='9' MAXLENGTH='10' style="text-align:right"></TD>
		<TD align='center' class='table_line'>
			<INPUT TYPE="radio" NAME="cobrar_percurso" value='t' <? if ($cobrar_percurso == 't') echo " checked"; ?>> Sim 
			<INPUT TYPE="radio" NAME="cobrar_percurso" value='f' <? if ($cobrar_percurso <> 't') echo " checked"; ?>> Não
		</TD>
<!-- 		<TD align='center'>
...
<table class="border" width='650' align='center' border='0' cellpadding="1" cellspacing="1">
	<tr>
		<td class="menu_top">Data <br>(29/02/2004)</td>
		<td class="menu_top">Saída<br>Sede (13:40)</td>
		<td class="menu_top">Chegada<br>Cliente (13:40)</td>
		<td class="menu_top">Saída<br>Cliente (13:40)</td>
		<td class="menu_top">Chegada<br>Sede (13:40)</td>
		<td class="menu_top">Saída<br>Almoço (13:40)</td>
		<td class="menu_top">Chegada<br>Almoço (13:40)</td>
	</tr>
<?
if (strlen($os) > 0) {
...
for($x=0; $x < $qtde_visita; $x++) {
	...
	$corTD = ($x % 2 == 0) ? '#f5f5f5' : '#fefefe';

	echo "<TR class='table_line'>\n";
	echo "<TD align='center' bgcolor='$corTD'><INPUT TYPE='text' NAME='data_$x' value='$data' size='12' maxlength='10'></TD>\n";
	echo "<TD align='center' bgcolor='$corTD'><INPUT TYPE='text' NAME='hora_saida_sede_$x' value='$hora_saida_sede' size='06' maxlength='5'> h</TD>\n";
	echo "<TD align='center' bgcolor='$corTD'><INPUT TYPE='text' NAME='hora_chegada_cliente_$x' value='$hora_chegada_cliente' size='06' maxlength='5'> h</TD>\n";
	echo "<TD align='center' bgcolor='$corTD'><INPUT TYPE='text' NAME='hora_saida_cliente_$x' value='$hora_saida_cliente' size='06' maxlength='5'> h</TD>\n";
	echo "<TD align='center' bgcolor='$corTD'><INPUT TYPE='text' NAME='hora_chegada_sede_$x' value='$hora_chegada_sede' size='06' maxlength='5'> h</TD>\n";
	echo "<TD align='center' bgcolor='$corTD'><INPUT TYPE='text' NAME='hora_saida_almoco_$x' value='$hora_saida_almoco' size='06' maxlength='5'> h</TD>\n";
	echo "<TD align='center' bgcolor='$corTD'><INPUT TYPE='text' NAME='hora_chegada_almoco_$x' value='$hora_chegada_almoco' size='06' maxlength='5'> h</TD>\n";
	echo "</TR>\n";
...
<tr>
	<td class="table_line2"><? echo $i; ?></td>
	...
	<TD class="table_line2" align='center'><INPUT TYPE="text" NAME="serie" size='8' value='<? echo $serie ?>'>&nbsp</TD>
	<TD class="table_line2" align='center'><INPUT TYPE="text" NAME="capacidade" size='8' value='<? echo $capacidade ?>'>&nbsp</TD>
	<TD class="table_line2" align='center'><INPUT TYPE="text" NAME="regulagem_peso_padrao" size='9' value='<? echo $regulagem_peso_padrao ?>' style='text-align:right'>&nbsp</TD>
	<TD class="table_line2" align='center'><INPUT TYPE="text" NAME="certificado_conformidade" size='9' value='<? echo $certificado_conformidade ?>' style='text-align:right'>&nbsp</TD>
</tr>
</table>
...
if(strlen($os) > 0){
	...
	if(pg_numrows($res) > 0) {
		...
		for ($i = 0 ; $i < pg_numrows($res) ; $i++) {
			...
			$total				= $qtde * $preco;
			if ($servico_realizado == 12)
				$preco_recuperada = "";
			else
				$preco_nova       = "";

			echo "<TR height='20'>\n";
			echo "	<TD class='table_line'><input type='text' name='item_$i' value'$item' size=2 maxlength=2></TD>\n";
			echo "	<TD class='table_line'><input type='text' name='peca_$i' value'$peca' size=6 maxlength=20></TD>\n";
			echo "	<TD class='table_line'><input type='text' name='descricao_$i' value'$descricao' size=15 maxlength=50></TD>\n";
			echo "	<TD class='table_line'><input type='text' name='qtde_$i' value'$qtde' size=2 maxlength=2></TD>\n";
			echo "	<TD class='table_line'><input type='text' name='unid_$i' value'$unid' size=3 maxlength=10></TD>\n";
			echo "	<TD class='table_line' align='right' style='padding-right:3;'><input type='text' name='preco_recuperada_$i' value'".number_format ($preco_recuperada,2,',','.')."' size=6 maxlength=10></TD>\n";
			echo "	<TD class='table_line' align='right' style='padding-right:3;'><input type='text' name='preco_nova_$i' value'".number_format ($preco_nova,2,',','.')."' size=6 maxlength=10></TD>\n";
			echo "</TR>\n";
		}
		...
		echo "<TR height='20'>\n";
		echo "	<TD class='menu_top' colspan=5><B>TOTAL POR TIPO DE PEÇA</B></TD>\n";
		echo "	<TD class='menu_top' align='right' style='padding-right:3;'><b>".number_format ($valor_recuperada,2,',','.')."</b>&nbsp;</TD>\n";
		echo "	<TD class='menu_top' align='right' style='padding-right:3;'><b>".number_format ($valor_nova,2,',','.')."</b>&nbsp;</TD>\n";
		echo "</TR>\n";

		echo "<TR height='20'>\n";
		echo "	<TD class='menu_top' colspan=5><B>TOTAL GERAL</B></TD>\n";
		echo "	<TD class='menu_top' align='right' style='padding-right:3;' colspan=2><b>".number_format ($valor_recuperada,2,',','.')."</b>&nbsp;</TD>\n";
		echo "</TR>\n";
