...
<html>
	<head>
		<link rel="stylesheet" type="text/css" href="admin/bootstrap/css/bootstrap.css" media="all">
	</head>
	<body>
		<div class="container">			
			<div class="row">
			...
			*/
			...
			<div class="row">
				...
				<div class="span8" style="text-align: center">
					<a class="btn btn-success" href="<?php echo $PHP_SELF ?>?auditoria_online=<?php echo $auditoria_online ?>&op=aprovar">Aprovar</a>
					<a class="btn btn-danger" href="<?php echo $PHP_SELF ?>?auditoria_online=<?php echo $auditoria_online ?>&op=reprovar">Reprovar</a>
				</div>				
				<div class="span2"></div>
			</div>
			<div class="row">
