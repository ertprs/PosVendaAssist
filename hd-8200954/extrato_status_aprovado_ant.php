...
<tr>
	<td><font color='#FFFFFF'><b>Situção</b></FONT></td>
...
//if($xpendente=="t" and $xconfirmacao_pendente=="t"){$situacao = "Aguardando admin";}
		...
		if($situacao=="Aguardando posto"){ 
			echo "<a href=\"javascript: if (confirm('Confirmar resolução da pendência ?') == true) { window.location='$PHP_SELF?pendencia=$extrato'; }\">$situacao </a>";
		}else{
			echo "$situacao";
		}
		echo "</font></td>";
