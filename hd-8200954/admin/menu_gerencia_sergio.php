...
<? if($login_fabrica == 24 or $login_fabrica == 10){ ?>
...
<tr bgcolor='#fafafa'>
	<td width='25'>
	<? if($login_fabrica == 10){ ?>
		<a href='relatorio_usuario_admin_sergio.php?programa=/assist/credenciamento/suggar/index.php'>
	<? } ?>
	...
	<? if($login_fabrica == 10){
		echo " title='Fabrica:Suggar' ";
	}?>
	
	width='260'><a href='../credenciamento/suggar/index.php' target='blank_' class='menu'>Credenciamento de Assistências Técnicas</a></td>
...
<? if($login_fabrica == 25 or $login_fabrica == 10){ ?>
<TABLE width="700px" border="0" cellspacing="0" cellpadding="0" bgcolor='#D9E2EF' align = 'center'>
<TR>
	<TD width='10'><IMG src="imagens/corner_se_laranja.gif"></TD>
	<TD class=cabecalho>CREDENCIAMENTO DE ASSISTÊNCIAS TÉCNICAS</TD>
...
<tr bgcolor='#fafafa'>
	...
	<td nowrap 
	<? if($login_fabrica == 10){
		echo " title='Fabrica:HBTECH' ";
	}?>

	width='260'><a href='../credenciamento/hbtech/index_.php' target='blank_' class='menu'>Credenciamento de Assistências Técnicas</a></td>
	<td nowrap class='descricao'>Credenciamento e Descredenciamento de Assistências Técnicas.</td>
</tr>
<tr bgcolor='#f0f0f0'>
	<td width='25'><img src='imagens/rel25.gif'></td>
	...
	width='260'><a href='credenciamento_lista.php' class='menu'>Acompanhamento do recadastramento</a></td>
...
<? } ?>
<? if ($login_fabrica == 81 || $login_fabrica == 66) { ?>
	<tr>
                <td width='25'><img src='imagens/rel25.gif'></td>
                <td nowrap width='260'><a href='relatorio_troca_produto_total.php' class='menu'>Relatório Troca de Produto Total</a></td>
                <td class='descricao'>Relatório de produto trocado e arquivo .xls</td>
