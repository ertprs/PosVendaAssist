...
$title 				= traduz("GERAÇÃO DO PEDIDO X FATURAMENTO DO PEDIDO");
	...
	if(count($msg_erro['msg']) == 0){
		...
		if(count($msg_erro["msg"]) == 0){
			...
			$sql = "SELECT 	TO_CHAR(tbl_os.data_abertura , 'DD/MM/yyyy') as data_abertura,
							...
							tbl_faturamento.emissao - tbl_pedido.data::date as dias,
							tbl_os.posto,
							tbl_posto.nome,
						...
						FROM tbl_os
							...
							INNER JOIN tbl_pedido ON tbl_os_item.pedido = tbl_pedido.pedido
