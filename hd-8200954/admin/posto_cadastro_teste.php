...
if ($btn_acao == "gravar") {
	...
	if(strlen($xcnpj) <> 14 and !in_array($login_fabrica, array(2,5,7,14,30,35,45,49,50,51,52,86))) 
	{
...
// MLG	17/7/2009	HD 126810 -	Adicionado campo 'atende_consumidor'
		...
		if (strlen($msg_erro) == 0) {
			...
			if (strlen ($posto) > 0) {
				...
				//MARISA - NÃO PODE ALTERAR RAZÃO SOCIAL E CNPJ DE NENHUM POSTO - 16/03/2011 ORIENTAÇÃO DO TÚLIO
				if($login_fabrica ==1 OR $login_fabrica ==81 OR $login_fabrica ==51) { // HD 84547
#					$add_posto=", nome			= '$nome'                   ,
#								cnpj			= '$xcnpj'                  ,
#								ie				= $xie                      ";
					$add_posto=", ie			= $xie                      ";
...
if($login_fabrica == 15){$sql .= "im			= $xim                      ,";}
			...
			if($login_fabrica == 92){ //HD 356653 Inicio
	...
	//HD 356653 
	if($login_fabrica==92){ $sql .= ", centro_custo         = '$centro_custo',
    ...
    if($login_fabrica==2) { $sql .= "data_nomeacao			,";}
						    $sql .=	"qtde_os_item ";
		//HD 356653
	if($login_fabrica==92) { $sql .= ", centro_custo,
		                              conta_contabil,
									  local_entrega"; }
							$sql .="
								) VALUES (
	...
	$('#abre_mapa_br').click(function() {
		$("#mapa_pesquisa").slideToggle("slow",function() {
			if ($("#mapa_pesquisa").is(":hidden")) {
				$("#abre_mapa_br").html('<b>Consulte o Mapa da Rede &darr;</b>');
			} else {
				$("#abre_mapa_br").html('<b>Esconda o Mapa da Rede &uarr;</b>');
			}
		});
	});
	...
	<tr>
		<td align='center'>
			<span id='abre_mapa_br'>
				<b>Consulte o Mapa da Rede &darr;</b>
			</span>
			<br>
...
<?
	echo "<TABLE width='700px' class='formulario' align='center' border='0'>";
	echo "<TR>";
...
?>
	...
	<? } ?>
<? } ?>
<table class="formulario" width='700px' align='center' border='0' cellpadding="1" cellspacing="3">
	<tr>
	...
	<tr align='left'>
		<td><input class='frm' type="text" name="fone" size="15" maxlength="20" value="<? echo $fone ?>"></td>
		<td><input class='frm' type="text" name="fax" size="15" maxlength="20" value="<? echo $fax ?>"></td>
	...
	<tr align='left'>
		<td nowrap><input class='frm' type="text" name="cnpj" id="cnpj" size="20" maxlength="18" value="<? echo $cnpj ?>" <?php if($login_fabrica != 52){?>onKeyPress="formata_cnpj(this);"<?php }?>>&nbsp;<a href="#"><img src='imagens/lupa.png' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto (document.frm_posto.nome,document.frm_posto.cnpj,document.frm_posto.codigo,'cnpj')"></a></td>
		<td><input class='frm' type="text" name="ie" size="20" maxlength="20" value="<? echo $ie ?>" ></td>
		<td><input class='frm' type="text" name="fone" size="15" maxlength="15" value="<? echo $fone ?>"></td>
		<td><input class='frm' type="text" name="fax" size="15" maxlength="15" value="<? echo $fax ?>"></td>
	...
	<tr>
		<tr><td>&nbsp;</td></tr>
		<td colspan="2" align='left'>Código</td>
		<td colspan="<? echo $colspan; ?>" align='left'>Razão Social</td>
	</tr>
	<tr>
	
		<td colspan="2" align='left'><input class='frm' type="text" name="codigo" size="14" maxlength="14" value="<? echo $codigo ?>" style="width:150px"<?if(strlen($posto) > 0 and $login_fabrica == 45 AND strlen(trim($codigo)) > 0)  echo " readonly='readonly' ";?>>&nbsp;<a href="#"><img src='imagens/lupa.png' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto (document.frm_posto.nome,document.frm_posto.cnpj,document.frm_posto.codigo,'codigo')"></a></td>
		<td colspan="3" align='left'><input class='frm' type="text" name="nome" size="50" maxlength="60" value="<? if ($login_fabrica == 50) { echo strtoupper($nome); } else { echo $nome; } ?>" style="width:300px" >&nbsp;<a href="#"><img src='imagens/lupa.png' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto (document.frm_posto.nome,document.frm_posto.cnpj,document.frm_posto.codigo,'nome')"></a></td>
	</tr>
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td colspan="5">
...
<table class="formulario" width='700px' align='center' border='0' cellpadding="1" cellspacing="3">
	...
	<tr align='left'>
		<td><input class='frm' type="text" name="cep"    size="10" maxlength="10" value="<? echo $cep ?>" onblur=" buscaCEP(this.value, this.form.endereco, this.form.bairro, this.form.cidade, this.form.estado);"></td>
	...
	<tr align='left'>
		<td><input class='frm' type="text" name="bairro" size="30" maxlength="20" value="<? echo $bairro ?>"></td>
		<td><input  class='frm'type="text" name="cidade" size="30" maxlength="30" value="<? echo $cidade ?>"></td>
		<td>
...
<table class="formulario" width='700px' align='center' border='0' cellpadding="1" cellspacing="3">
	<tr align='left'>
		...
		<? } ?>
		<?if($login_fabrica == 50 or $login_fabrica == 52 or $login_fabrica == 72 or $login_fabrica == 24 or $login_fabrica == 91){?><td>Valor/km</td><?}?>
		<? // HD 12104
		if($login_fabrica == 14){ ?>
		<td>Liberar 10%</td>
		<? } ?>
	...
	<tr align='left'>
		<td>
			<input class='frm' type="text" name="email" size="40" maxlength="50" value="<? echo $email ?>">
		</td>
		<td>
...
--><?php
		if ($login_fabrica <> 86) {//HD 387824?>
			<td><input class='frm' type="text" name="desconto" size="5" maxlength="5" value="<?=$desconto?>">%</td><?php
		}
		// HD 110541
		if($login_fabrica==11){?>
		<td width = '33%'>
		...
		<? } ?>
		<?if($login_fabrica == 50 or $login_fabrica == 52 or $login_fabrica == 72 or $login_fabrica == 24 or $login_fabrica == 91){?>
...
<table class="formulario" width='700px' align='center' border='0' cellpadding="1" cellspacing="3">
	<tr align='left'>
		...
		<tr align='left'>
		<td>
			<input class='frm' type="text" name="nome_fantasia" size="20" maxlength="30" value="<? echo $nome_fantasia ?>" >
		</td>
		<td><input class='frm' type="text" name="senha" size="10" maxlength="10" value="<? echo $senha ?>"></td><?php
		if ($login_fabrica <> 86) {//HD 387824?>
			<td align='center'>
	...
	<tr align='left'>
		...
		<? if($senha_financeiro <> null){ 
				echo "$senha_financeiro";
			}
			else{
				echo "<font color='#ff0000'>Não Cadastrada</font>";
			}
		?>		 
		 </td>

		<td>Senha da Tabela de Preço <br />
		<? if($senha_tabela_preco <> null){ 
			 echo "$senha_tabela_preco"; 
		   }
		   else{
			   echo "<font color='#ff0000'>Não Cadastrada</font>";
		   }
...
<!--   Cobranca  -->
<table class="formulario" width='700px' align='center' border='0' cellpadding="1" cellspacing="3">
	<tr><td colspan=5 class='titulo_tabela'>Informações para cobrança</td></tr>
	<!-- Sem a linha abaixo, aparece errado no IE.. ??? -->
	<tr><td width=130></td><td width=130></td><td width=130></td><td width=130></td><td width=130></td></tr>
	<tr  align='left'>
		<td>CEP</td>
	...
	<tr align='left'>
		<td><input class='frm' type="text" name="cobranca_cep" size="10" maxlength="10" value="<? echo $cobranca_cep ?>" onblur=" buscaCEP(this.value, this.form.cobranca_endereco, this.form.cobranca_bairro, this.form.cobranca_cidade, this.form.cobranca_estado);"></td>
	...
	<tr align='left'>
		...
		<td colspan=2><input class='frm' type="text" name="cobranca_cidade"  id="cobranca_cidade" size="30" maxlength="30" value="<? echo $cobranca_cidade ?>"></td>
		<td>
				<select name="cobranca_estado" id="cobranca_estado" style="width:120px; font-size:9px" class="frm">
...
<?
if ($login_fabrica <> 1 OR ($login_fabrica == 1 && ($login_login == "fabiola" OR $login_login == "silvania"  OR $login_login == "kliferthi" || $login_login == "renan"))) {
# HD 55187
if ($login_fabrica == 45){
...
<br />
	<? if($login_fabrica == 92){ //HD 356653 Início?> 
		<table align='center' width='700' class='formulario'>
			<tr class='titulo_tabela'><td colspan='3'>Dados Contábeis</td></tr>
			<tr>
				<td align='left'>
					Conta Contábil <br />
					<input type='text' name='conta_contabil' id='conta_contabil' size='25' maxlength='25' value='<? echo $conta_contabil; ?>' class='frm'>
				</td>
				<td align='left'>
					Centro Custo <br />
					<input type='text' name='centro_custo' id='centro_custo' size='25' maxlength='25' value='<? echo $centro_custo; ?>' class='frm'>
				</td>
				<td align='left'>
					Local Entrega <br />
					<input type='text' name='local_entrega' id='local_entrega' size='55' maxlength='50' value='<? echo $local_entrega; ?>' class='frm'>
				</td>
			</tr>
...
if (strlen ($posto) > 0 AND $login_fabrica <> 20) {?>
	<TABLE  width='100%' class='formulario' align='center' border='0' cellpadding='1' cellspacing='3'>
	<TR align='left'>
	<? if ($login_fabrica <> 14) { ?>
	<TD>Linha</TD>
	<? } else { ?>
	...
	<? } ?>
	<TD>Atende</TD>
	<? if ($login_fabrica <> 40 and $login_fabrica <> 74) { ?>
	<TD>Tabela</TD>
	...
	<TD>Desconto</TD><?php
	if ($login_fabrica <> 86) {//HD 387824?>
		<TD>Distribuidor</TD><?php
	}
	
	if ($login_fabrica == 24){
		echo "<td>Divulgar linha ao consumidor</td>";
	}
	?>
	...
	if ($login_fabrica <> 14) {
		...
		for($i=0; $i < pg_num_rows($res); $i++){
			...
			if($login_fabrica == 40 or $login_fabrica == 74) { # HD 212563
				echo "<td align='left'>";
				$sql = "SELECT * FROM tbl_tabela WHERE fabrica = $login_fabrica AND ativa ORDER BY sigla_tabela";
				$resX = pg_query ($con,$sql);
			...
			if ($login_fabrica <> 86) {
				...
				echo "<select class='frm' name='distribuidor_$linha'>\n";
				echo "<option ></option>\n";
...
<table class="formulario" width='700px' align='center' cellpadding="3" cellspacing="2">
<TR>
	<TD colspan='2' class='titulo_coluna' >Posto pode Digitar:</TD>
</TR>
<TR>
...
if ($login_fabrica == 50 and strlen($posto) > 0) {
	...
	echo "<BR><table class='border' width='700px' align='center' border='0' cellpadding='1' cellspacing='3'>";
		echo "<tr>";
...
?>
<br>
<table class="formulario" width='700px' align='center' border='0' cellpadding="3" cellspacing="2">
<tr>
...
if ($_GET ['listar'] == 'todos') {
	...
	if (pg_num_rows($res) > 0) {
		...
		echo "<table border='0' cellpadding='3' cellspacing='0' class='formulario'>";
				echo "<tr class='titulo_coluna'>";
				if ($login_fabrica == 20) {
