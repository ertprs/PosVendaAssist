...
if (strlen($btn_acao) > 0){
	if (strlen ($mes) == 0) $msg = "Escolha o mês";
	if (strlen ($ano) == 0 ) $msg = "Escolha o ano";
	if (strlen ($distribuidor) == 0) $msg = "Escolha o distribuidor";
}
...
<tr>
	<td style="width:150px; padding-left:170px;">
		Distribuidor<br />
		<?
...
<tr>
	<td colspan="3" align="center" style="padding:10px 0 10px;">
		<input type="button" style="cursor:pointer" onclick="javascript: if (document.frm_os_posto.btn_acao.value == '' ) { document.frm_os_posto.btn_acao.value='continuar' ; document.frm_os_posto.submit() } else { alert ('Aguarde submissão') }" value="Pesquisar" />
	</td>
</tr>
</table>
