...
$title = "Gerenciamento das OS de Revenda";
...
<?
#---------------- 30 Revendas com mais OS em aberto ------------
$sql = "SELECT substr (revenda_cnpj,1,8) AS cnpj, COUNT(*) AS qtde FROM tbl_os WHERE fabrica = $login_fabrica AND data_fechamento IS NULL AND consumidor_revenda = 'R' GROUP BY substr (revenda_cnpj,1,8) ORDER BY COUNT(*) DESC LIMIT 30 ";
$res = pg_exec ($con,$sql);
