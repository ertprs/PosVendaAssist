...
//		}
		...
		$sql1 = "SELECT fn_tipo_posto_condicao($login_fabrica,$codigo_condicao,$tipo_posto,$tabela,'$visivel')";
...
if (strlen($condicao) > 0) {
	...
	$sql = "SELECT tipo_posto 
				...
				JOIN tbl_posto_condicao ON tbl_posto_fabrica.posto = tbl_posto_condicao.posto
