		...
		if (strlen($cliente) == 0) {
			if (strlen($xconsumidor_cpf) > 0){
				...
				if (pg_numrows($res) > 0){
					...
					// insere
					$sql = "INSERT INTO tbl_cliente (nome, cpf, cidade) values('$consumidor_nome',$xconsumidor_cpf, $cidade)";
					$res = pg_exec ($con,$sql);
...
<tr>
	...
	<td valign="top" align="left">
		...
		<TABLE width=700 border="0" cellpadding="2" cellspacing="0" class="Tabela">
			<TR class="Texto1Negrito">
				<TD colspan="2" width="50%">
					Atendente<BR>
					<INPUT TYPE="text" NAME="consumidor_nome" class ="frm" size="45" value="<? echo ucfirst($login_login); if (strlen($atendente_nome) > 0) echo ' / Atendido por: '.ucfirst($atendente_nome); ?>" disabled onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Nome do atendente.');">
				</TD>
				<TD colspan="2" width="50%">
					Natureza do chamado<BR>
					<SELECT NAME="natureza" class="frm" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Selecione a Natureza do chamado.');">
		...
		<br>
		<TABLE width=700 border="0" cellpadding="2" cellspacing="4" class="Tabela">
			<TR class="Texto1Negrito">
				<td width="100%" align="center" colspan="4" bgcolor="#D9E2EF">Cliente</td>
			</TR>
			<TR class="Texto1Negrito">
				<TD width="25%">
					Nome Cliente<BR>
					<INPUT TYPE="text" NAME="consumidor_nome" class="frm" size="20" value="<? echo $consumidor_nome; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Digite o Nome do Cliente.');">&nbsp;<img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_consumidor (document.frm_callcenter.consumidor_nome, "nome")' style='cursor: pointer'>
				</TD>
				<TD width="25%">
					CPF/CNPJ Cliente<BR>
					<INPUT TYPE="text" NAME="consumidor_cpf" class="frm" size="18" value="<? echo $consumidor_cpf; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Digite aqui o número do CPF/CNPJ do Cliente.');">&nbsp;<img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_consumidor (document.frm_callcenter.consumidor_cpf,"cpf")'  style='cursor: pointer'>
				...
				<TD width="25%">
					Cidade<BR>
					<INPUT TYPE="text" NAME="consumidor_cidade" class="frm" size="25" value="<? echo $consumidor_cidade; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Cidade do Cliente.');">
				</TD>
				<TD width="25%">
					Estado<BR>
					<select size='1' name='consumidor_estado' class="frm" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Estado do Cliente.');">
		...
		<TABLE width=700 border="0" cellpadding="2" cellspacing="4" class="Tabela">
			<TR class="Texto1Negrito">
				<td width="100%" align="center" colspan="3" bgcolor="#D9E2EF">Posto</td>
			</TR>
			<TR class="Texto1Negrito">
				<TD width="34%">
					Código Posto<BR>
					<INPUT TYPE="text" NAME="posto_codigo" class="frm" size="30" value="<? echo $posto_codigo; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Para localizar um posto pela Código do Posto, digite os dados no campo e clique na lupa ao lado.');">&nbsp;<img src='imagens/btn_buscar5.gif' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto_regiao (document.frm_callcenter.posto_nome,document.frm_callcenter.consumidor_cidade,document.frm_callcenter.consumidor_estado)" style="cursor:pointer;">
				</TD>
				<TD width="33%">
					Nome Posto<BR>
					<INPUT TYPE="text" class="frm" NAME="posto_nome" size="30" value="<? echo $posto_nome; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Para localizar um posto pela Nome do Posto, digite os dados no campo e clique na lupa ao lado.');">&nbsp;<img src='imagens/btn_buscar5.gif' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto_regiao (document.frm_callcenter.posto_nome,document.frm_callcenter.consumidor_cidade,document.frm_callcenter.consumidor_estado)" style="cursor:pointer;">
				</TD>
				<TD width="33%">
					Cidade<BR>
					<INPUT TYPE="text" class="frm" NAME="posto_cidade" size="30" value="<? echo $posto_cidade; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Para localizar um posto pela Cidade, digite os dados no campo e clique na lupa ao lado.');">&nbsp;<img src='imagens/btn_buscar5.gif' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto_regiao (document.frm_callcenter.posto_nome,document.frm_callcenter.consumidor_cidade,document.frm_callcenter.consumidor_estado)" style="cursor:pointer;">
				</TD>
			</TR>
<?
	if (strlen($selecione_posto) > 0){
		echo "<TR class='menu_top'\n>";
		echo "<TD colspan=3>Selecione o posto na lista abaixo</TD>\n";
		echo "</TR>\n";
...
?>
		...
		<TABLE width=700 border="0" cellpadding="2" cellspacing="4" class="Tabela">
			<TR class="Texto1Negrito">
				<td width="100%" align="center" colspan="4" bgcolor="#D9E2EF">Produto</td>
			</TR>
			<TR class="Texto1Negrito">
				<TD width="34%">
					Descrição Produto<BR>
					<INPUT TYPE="text" NAME="produto_nome" class="frm" size="30" value="<? echo $produto_nome; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Para localizar um Produto pela Descrição, digite os dados no campo e clique na lupa ao lado.');">&nbsp;<img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' style="cursor:pointer" onclick="javascript: fnc_pesquisa_produto (document.frm_callcenter.produto_referencia,document.frm_callcenter.produto_nome,'descricao')">
				</TD>
				<TD width="33%">
					Série<BR>
					<INPUT TYPE="text" NAME="produto_serie" class="frm" size="15" value="<? echo $produto_serie; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Digite aqui a série na qual o produto pertence.');">
					<input type='hidden' name='produto_referencia' value="<? echo $produto_referencia; ?>">
				</TD>
				<TD width="33%">
					Data da compra<BR>
					<INPUT TYPE="text" NAME="data_nf" class="frm" size="15" maxlength='10' value="<? echo $data_nf; ?>" onblur = "this.className='frm'; displayText('&nbsp;');" onfocus ="this.className='frm-on';displayText('&nbsp;Digite aqui a data da compra do produto. Ex.: DD/MM/AAAA');">
				</TD>
			</TR>
		</TABLE>
		<br>
		<TABLE width=700 border="0" cellpadding="3" cellspacing="3">
			...
			<TR class='table_line'>
				<TD><INPUT TYPE="text" NAME="sua_os" size="10" value="<? echo $sua_os; ?>">&nbsp;<img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_os (document.frm_callcenter.sua_os)' style='cursor: pointer'></TD>
			...
			<TR class='table_line'>
				<TD><INPUT TYPE="text" NAME="produto_nome" size="30" value="<? echo $produto_nome; ?>">&nbsp;<img src='imagens/btn_buscar5.gif' border='0' align='absmiddle' style="cursor:pointer" onclick="javascript: fnc_pesquisa_produto (document.frm_callcenter.produto_referencia,document.frm_callcenter.produto_nome,'descricao')"></TD>
...
?>
			<TR class='menu_top'>
				<TD colspan='3'>Revenda</TD>
			</TR>
			<TR class='table_line'>
				<TD colspan='3'><INPUT TYPE="text" NAME="revenda_nome" size="50" value="<? echo $revenda_nome; ?>"></TD>
			</TR>
			<TR>
