...
if ($listartudo == 1 and strlen($produto) > 0){
	...
	<table width='700' border='0'  cellspacing='1' cellpadding='0'>
		<tr  height='20' bgcolor='#666666'>
			<td align='center'>
				<font size='3' face='Geneva, Arial, Helvetica, san-serif' color='#ffffff'>
				<b>Produto: <?echo $referencia ." - ". $descricao_produto;?></b>
				</font>
			</td>
		</tr>
<?		if ($login_fabrica==3) {
			$imagem		= "imagens_produtos/$login_fabrica/media/$produto.jpg";
		    if (file_exists("/var/www/assist/www/$imagem")) {
				echo "<tr>\n\t<td title='$referencia - $descricao_produto' width='100%' align='center'>\n";
