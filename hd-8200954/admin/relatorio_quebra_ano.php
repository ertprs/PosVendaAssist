...
$sql = "SELECT  vw_visao_geral.mes                ,
		...
		FROM    vw_visao_geral
		WHERE   vw_visao_geral.$aux_criterio BETWEEN '2005-05-01 00:00:00' AND '2005-06-01 23:59:59'
		AND     vw_visao_geral.fabrica = $login_fabrica
		AND     vw_visao_geral.mes <= 30
...
for ( $i = 0 ; $i < pg_numrows ($res) ; $i++ ) {
	...
	$qtde1 = trim(pg_result($res,$i,qtde));

	$qtde_2= $qtde_2+$qtde1;
	
	echo"Mes - $mes  -  Qtde - $qtde1  - <br>";
}
fim teste=======================================================================*/ 
...
<? 
//View não existente no sistema - Modificado por Fernando 29/09
if(1==2){ 
	
	echo "<FONT SIZE=\"3\">Desativado temporariamente</FONT>";
...
<TABLE width="400" align="center" border="0" cellspacing="0" cellpadding="2">
  ...
  <TR>
    <TD class="table_line" style="width: 10px">&nbsp;</TD>
	<TD class="table_line" style="width: 185px"><INPUT size="12" maxlength="10" TYPE="text" NAME="data_inicial_01" value="" rel="data"></TD>
	<TD class="table_line" style="width: 185px"><INPUT size="12" maxlength="10" TYPE="text" NAME="data_final_01" value="" rel="data"></TD>
    <TD class="table_line" style="width: 10px">&nbsp;</TD>
  </TR>
<!--
	<TR>
...
if ($listar == "ok") {
	$sql = "SELECT
			(
				...
				AND     vw_visao_geral.fabrica = $login_fabrica
				AND     vw_visao_geral.mes >= 0 AND vw_visao_geral.mes <= 12
			) AS qtde_1_ano,
			(
				SELECT  sum(vw_visao_geral.qtde)
				FROM    vw_visao_geral
...
//		if ( $_SERVER['REMOTE_ADDR'] == "201.26.19.184" )
//		{ echo "$mest";}
