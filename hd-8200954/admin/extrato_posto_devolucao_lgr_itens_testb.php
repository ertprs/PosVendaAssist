...
echo '<b>Data do Extrato ' . $data . '</b>';
echo "<br /><br />";
echo "$codigo - $nome";

?>
<br />
<a href='manutencao_logistica_reversa.php'>Ver outro extrato</a>

<div id='loading'></div>

<? if (strlen($msg_erro) > 0) { ?>
<br>
<div class="msg_erro"><?echo $msg_erro ?></div>
<? } ?>
...
########################################################
	...
	echo "<br /><center><input type='button' value='Cancelar Todas as Notas' onclick=\"javascript: if ('Deseja cancelar todas as notas deste extrato? Após este procedimento, as notas canceladas não poderão ser recuperadas!')this.form.submit();\"></center>";
	echo "</form><br /></div>";
}else{
