...
if ($ajax == "yes") {
	...
	$resposta .= "<table width='650' border='0' cellpadding='2' cellspacing='2' align='center'>";
	$resposta .= "<tr>";
	
	$resposta .= "<td bgcolor='#FFFFFF' align='center' width='100%'>";
	$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#FF0000' size='2'>$msg</font>";
	$resposta .= "</td>";
	...
	if( $todas == 6 ) {
		...
		JOIN tbl_os_produto ON tbl_os_item.os_produto = tbl_os_produto.os_produto
		JOIN $tmp_table     ON $tmp_table.os = tbl_os_produto.os
		WHERE tbl_os_item.servico_realizado NOT IN (62, 90,115)
		;
	...
	*/
	...
	//echo `cat /tmp/blackedecker/garantia-mensal.txt | sed -e 's/#//g' > /tmp/blackedecker/garantia-mensal-$ano-$mes.txt`;
		...
		if (pg_numrows($res) > 0) {
			...
			$resposta .= "<table width='700' border='0' cellpadding='2' cellspacing='2' align='center'>";
			$resposta .= "<tr>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>Produto</b></font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>Referência</b></font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>Ocorrência</b></font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>Total MO</b></font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>Total PC</b></font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>Total GERAL</b></font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>%</b></font>";
			$resposta .= "</td>";
			...
			for ($x = 0; $x < pg_numrows($res); $x++) {
				...
				$resposta .= "<td bgcolor='$cor' align='left' nowrap>";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>";
				$resposta .= substr(pg_result($res,$x,nome),0,45);
				$resposta .= "</font>";
				$resposta .= "</td>";
				...
				$resposta .= "<td bgcolor='$cor' align='left' nowrap>";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2' nowrap>";
				$resposta .= "<a href='black_quebra_acumulado_pecas-prov.php?referencia=$referencia&voltagem=$voltagem&data_inicial=$x_data_inicial&data_final=$x_data_final&linha=$linha&estado=$estado' target='_blank'>";
				$resposta .= $referencia ." - ". $voltagem ;
				$resposta .= "</a>";
				$resposta .= "</font>";
				$resposta .= "</td>";
				
				$resposta .= "<td bgcolor='$cor' align='center'>";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>";
				$resposta .= "<a href='black_quebra_acumulado_os-prov.php?referencia=$referencia&voltagem=$voltagem&data_inicial=$x_data_inicial&data_final=$x_data_final&linha=$linha&estado=$estado' target='_blank'>";
				$resposta .= $ocorrencia;
				$resposta .= "</a>";
				$resposta .= "</font>";
				$resposta .= "</td>";
				
				$resposta .= "<td bgcolor='$cor' align='right'>";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>";
				$resposta .= number_format($soma_mobra,2,",",".");
				$resposta .= "</td>";
				
				$resposta .= "<td bgcolor='$cor' align='right'>";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>";
				$resposta .= number_format($soma_peca,2,",",".");
				$resposta .= "</font>";
				$resposta .= "</td>";
				
				$resposta .= "<td bgcolor='$cor' align='right'>";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>";
				$resposta .= number_format($soma_total,2,",",".");
				$resposta .= "</font>";
				$resposta .= "</td>";
				
				$resposta .= "<td bgcolor='$cor' align='center'>";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>";
				$resposta .= number_format($porcentagem,2,",",".");
				$resposta .= "</font>";
				$resposta .= "</td>";
				$resposta .= "<td bgcolor='$cor' align='center' nowrap >";
				$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>";
				$resposta .= $linha_nome;
				$resposta .= "</font>";
				$resposta .= "</td>";
			...
			$resposta .= "<td bgcolor='#B6DADA' align='left' colspan='2'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>TOTAL</b></font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>$total_ocorrencia</font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='right'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>". number_format($total_mobra,2,",",".") ."</font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='right'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>". number_format($total_peca,2,",",".") ."</font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='right'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>". number_format($total_geral,2,",",".") ."</font>";
			$resposta .= "</td>";
			
			$resposta .= "<td bgcolor='#B6DADA' align='center'>";
			$resposta .= "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'>100%</font>";
			$resposta .= "</td>";
		...
		$data = date ("d-m-Y-H-i");
			$resposta .= `mkdir /tmp/assist`;
			$resposta .= `chmod 777 /tmp/assist`;
			$resposta .= `rm /tmp/assist/black_quebra_acumulado.txt`;
			$resposta .= `rm /tmp/assist/black_quebra_acumulado.zip`;
			$resposta .= `rm /var/www/assist/www/download/black_quebra_acumulado.zip`;
			...
			flush();
			//gera o zip
			$resposta .= `cd /tmp/assist/; rm -rf black_quebra_acumulado.zip; zip -o black_quebra_acumulado.zip black_quebra_acumulado.txt > /dev/null`;
		
			//move o zip para "/var/www/assist/www/download/"
			$resposta .= `mv  /tmp/assist/black_quebra_acumulado.zip /var/www/assist/www/download/black_quebra_acumulado.zip`;
	...
	######################################################################################// 
			...
			$resposta .= "\"Garantia Geral\" (importação para o MFG) <br>
...
function exibir(formulario,pagina) {
	var acao = 'gravar';
	url = escape(pagina)+"?ajax=yes&acao="+acao;
		...
		if (formulario.elements[i].type !='button'){
			if(formulario.elements[i].type=='radio' || formulario.elements[i].type=='checkbox'){
				if(formulario.elements[i].checked == true){
					parametros = parametros+"&"+formulario.elements[i].name+"="+escape(formulario.elements[i].value);
				}
			}else{
				parametros = parametros+"&"+formulario.elements[i].name+"="+escape(formulario.elements[i].value);
			}
	...
	div_erro.innerHTML = " ";
	div_resp.innerHTML = "&nbsp;&nbsp;Aguarde...&nbsp;&nbsp;<br><img src='../imagens/carregar2.gif' >";
	div_load.innerHTML= "&nbsp;Buscando informações...&nbsp;";
		...
		if (http_forn[curDateTime].readyState == 4){
			...
			var response = http_forn[curDateTime].responseText.split("|");
				...
				if (response[0]=="ok"){
					...
					div_erro.innerHTML = "";
					div_resp.innerHTML = response[1];
					
					formulario.btnacao.value='BUSCAR';
				}else{
					formulario.btnacao.value='BUSCAR';
					div_dados.innerHTML = http_forn[curDateTime].responseText;
				}
				if (response[0]=="1"){
					div_erro.style.visibility = "visible";
					div_resp.innerHTML = "<font color='#990000'>Ocorreu um erro, verifique!</font>";
						div_erro.innerHTML = response[1];
					formulario.btn_acao.value='BUSCAR';
				}
				div_load.innerHTML   = "&nbsp;Completado!&nbsp;";
...
?>
	...
	<tr>
		<td class="Conteudo" bgcolor="#ffffff" align="center" colspan="2" >
			<input type="button" value="BUSCAR" name="btnacao" class="btnrel" style="width:100px" onClick="if (this.value!='BUSCAR'){ alert('Aguarde');}else {this.value='Buscando...'; exibir(this.form,'<?=$PHP_SELF?>');}">
		</td>
	</tr>
</table>
