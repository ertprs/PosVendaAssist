...
if($mostra_valor_faturada =='sim' and !empty($os)) { // HD 181964
	echo "<script>window.open('http://www.telecontrol.com.br/assist/admin/produto_valor_faturada.php?os=$os','','height=300, width=650, top=20, left=20, scrollbars=yes')</script>";
}
...
if($btn_acao == 'gravar_interacao'){
    ...
    if ( strtolower($_POST['admin_transfere']) == 'posto' && empty($msg_erro) ) {
		...
		if ( empty($msg_erro) ) {
            ...
            $email_origem = $email_admin ;//'suporte@telecontrol.com.br';
			...
			<TABLE width="700" border="0" cellspacing="1" align='center' cellpadding="0" class='Tabela' >
					...
					<tr>
						...
						<td	class='conteudo' style='padding:0px 5px;' width='226' >
							<a href='http://www.telecontrol.com.br/assist/admin/extrato_consulta_os.php?extrato=<? echo $extrato; ?>' ><? echo $extrato; ?></a>
						</td>
						<td class='titulo' style='padding:0px 5px;' width='120' >
							DATA DO PAGAMENTO
						</td>
...
<!-- 	<TD class="conteudo" style="text-align:left;"><? echo pg_fetch_result ($res,$i,referencia) . " - " . pg_fetch_result ($res,$i,descricao); ?></TD> -->
	...
	<? if ($login_fabrica==43){?>
			...
			echo "<a href='print_pedido.php?pedido=$pedido' target='_blank'>$pedido";
		}else{ ?>
...
if ($anexaNotaFiscal and $os and temNF($os, 'bool')) {
