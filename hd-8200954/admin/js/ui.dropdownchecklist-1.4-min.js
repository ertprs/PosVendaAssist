...
*/
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function( controlItem ) {
            ...
            container.css({"overflow-y": "auto","overflow-x": "scroll","height": "180px"});
        ...
        _appendControl: function() {
            ...
            control.css({"border":"1px solid #888888", "padding":"3px 3px 3px 3px", "height":"12px" , "color":"#000000"});
            control.css({"background":"#F0F0F0 url(a_imagens/arrow_sans_down_32.png) no-repeat right"});
        ...
        _createDropItem: function(index, tabIndex, value, text, optCss, checked, disabled, indent) {
            ...
            // the div
            var item = $("<div/>");
            item.addClass("dropdownchecklist-item");
            item.css({'white-space': "nowrap", 'padding':'5px 5px 5px 5px', 'width':'190px','border':'0', 'background':'#FFFFFF'});
