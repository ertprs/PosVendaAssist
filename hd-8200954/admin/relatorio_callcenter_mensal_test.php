...
if($btn_acao=="Consultar"){
	if(strlen($mes_inicial) == 0){
		...
		$msg_erro = "ENTRE COM LINHA PARA A FILTRAGEM";
	}
}
	...
	<table width='500' class='Conteudo' style='background-color: #485989' border='0' cellpadding="0" cellspacing="0" align='center'>
		<tr>
			<td width='100%' class='Titulo' background='imagens_admin/azul.gif' colspan="2">
				<span style="font-size:13px">Relatório dos Atendimentos</span>
			</td>
		</tr>
		<tr>
			<tr bgcolor="#D9E2EF">
				...
				<tr bgcolor="#D9E2EF">
					<td colspan="2">
						<br />
						<div style="float:left; width:140px;padding-left:55px">
							<span style="margin-right: 20px"> Código Linha</span>
							<br />
							<?
								echo "<select name='linha' size='1' class='frm' style='width:100px'>";
						...
						<div style="float:left; width:250px;padding-left:20px">
							<span style="margin-right: 20px">Descrição da linha</span>
							<br />
							<?
								echo "<select name='familia' size='1' class='frm' style='width:230px'>";
									echo "<option value=''></option>";
										$sql = "SELECT familia,
													descricao 
												FROM tbl_familia 
