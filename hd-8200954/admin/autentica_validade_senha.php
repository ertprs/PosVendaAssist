<? 
##Retirado a pedido do Túlio HD10401
...
//	echo "senha expirou $data_expira_senha";
	...
	if (strlen($msg_validade_cadastro)==0){
		$msg_validade_cadastro="<a href='alterar_senha.php' style='font-size: 11px;font-family:arial,verdana;color: white'>Sua senha irá expirar em $data_expira_senha dias. Clique aqui para cadastrar uma senha nova.</a>";
	}
