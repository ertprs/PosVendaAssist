...
if ($login_fabrica==3) {
	$sql = "
		...
		AND data_abertura < (current_date - interval '45 days')
...
if (@pg_numrows($res) == 0) {
	...
	echo `rm /tmp/assist/auditoria_os_aberta_45.xls`;

	$fp = fopen ("/tmp/assist/auditoria_os_aberta_45.html","w");
	...
	$arquivo = "/www/assist/www/admin/xls/auditoria_os_aberta_45.xls";

	echo `htmldoc --webpage --size 297x210mm --fontsize 11 --left 8mm -f $arquivo /tmp/assist/auditoria_os_aberta_45.html`;
