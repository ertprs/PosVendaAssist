...
echo "$linha|";
	echo "<table border=1 cellpadding=1 cellspacing=0 style=border-collapse: collapse bordercolor=#d2e4fc align=center width=500>";
		...
		echo "<td><font color=white>Os</td>";
		echo "<td><font color=white>Posto</td>";
		echo "<td ><font color=white>Data de Abertura</td>";
		echo "<td ><font color=white>Cliente</td>";		
		echo "<td ><font color=white>Fone</td>";		
		echo "<td ><font color=white>Produto</td>";
		echo "</tr>";
...
//			echo $consumidor_fone_s_mascara; echo $fone;
			...
			echo "<td bgcolor=$cor align=left nowrap>$codigo_posto - $nome</td>";
			echo "<td bgcolor=$cor align=left nowrap>$data</td>";
			echo "<td bgcolor=$cor align=left nowrap>$cliente</td>";
