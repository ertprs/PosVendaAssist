...
//HORA ENVIO
	if($hora_envio < '0' OR $hora_envio > '24'){
		$msg_erro = "Verifique a hora de envio.";
	}
	if($min_envio < '0' OR $min_envio > '59'){
...
//DATAS
	...
	if(strlen($msg_erro) == 0){
		$abrir = fopen("bloqueio_pedidos/bloqueia_pedido_black.txt", "w+");
...
<script type="text/javascript" charset="utf-8">
	$(function(){
		$("#data_inicio").datePicker({startDate:'01/01/2000'});
		$("#data_fim").datePicker({startDate:'01/01/2000'});
		$("#data_envio").datePicker({startDate:'01/01/2000'});
		$("#data_inicio_fiscal").datePicker({startDate:'01/01/2000'});
		$("#data_fim_fiscal").datePicker({startDate:'01/01/2000'});
		$("#data_inicio_promocao").datePicker({startDate:'01/01/2000'});
		$("#data_fim_promocao").datePicker({startDate:'01/01/2000'});

		$("#data_inicio").maskedinput("99/99/9999");
		$("#data_fim").maskedinput("99/99/9999");
		$("#data_envio").maskedinput("99/99/9999");
		$("#data_inicio_fiscal").maskedinput("99/99/9999");
		$("#data_fim_fiscal").maskedinput("99/99/9999");
		$("#data_inicio_promocao").maskedinput("99/99/9999");
		$("#data_fim_promocao").maskedinput("99/99/9999");
	});
</script>
