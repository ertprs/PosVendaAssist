...
/*
select tbl_os.os, tbl_os.consumidor_nome, tbl_os.consumidor_cidade, tbl_os.consumidor_cidade from tbl_suggar_questionario join tbl_os using(os) where tbl_os.produto = 20690;
...
echo "<tr>";
echo "<td  colspan='5'><a href='$PHP_SELF?listarcliente=1&produto=$produto'><font color='#FFCC00' >Relação dos $total consumidor(es)</FONT></a></td>";
echo "</tr>";
echo "<tr>";
