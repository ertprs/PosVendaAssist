 ...
 * @version v1779368 - desenvolvido conforme chamado HD 1779368
 *
 */
...
include 'relatorio_extratificacao.class_v1779368.php';
/**
 *
 * REGRAS:
 *
...
<script>
	...
	function pareto(fabricacao, abertura, meses, familia, peca01, peca02, fornecedores, datas, produtos, pecas, posto) {
		...
		if( $("#sem_peca").is(":checked") ){
			...
			var url="relatorio_extratificacao_pareto_sem_peca.php?ab=" + abertura + "&fb=" + fabricacao + "&fm=" + meses + "&f=" + familia + "&defeito=" + sem_peca + "&po=" + posto;
		}else{
			var url="relatorio_extratificacao_pareto.php?fb=" + fabricacao + "&ab=" + abertura + "&fm=" + meses + "&fa=" + familia + "&p1=" + peca01 + "&p2=" + peca02 + "&fo=" + fornecedores + "&d=" + datas + "&pd=" + produtos + "&pc=" + pecas + "&po=" + posto;
		}
