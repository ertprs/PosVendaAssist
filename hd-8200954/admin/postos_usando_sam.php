...
if($login_fabrica==24){ $sql .= "  and tbl_linha.fabrica = $login_fabrica ";}
	$sql .= " WHERE   tbl_pecas_por_os.mes = '$pesquisa_mes'
...
//==============================================================================================
		...
		echo "<td class='menu_top' nowrap align='center' rowspan='2'>Total Peças</td>";
		echo "</tr>";
		$qtde_linhas = $i ;
