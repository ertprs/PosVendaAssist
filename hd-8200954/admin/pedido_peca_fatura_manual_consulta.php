...
<?
	...
	$sql = "SELECT
			...
			AND       (tbl_pedido.data >= '2010-04-01 00:00:00')
...
if (@pg_numrows($res) == 0) {
	...
	echo "	<TD nowrap width='85'><a href='pedido_nao_faturado_cadastro.php?pedido=$pedido' target='_blank'><img src='imagens/btn_faturar_".$btn.".gif'></a></TD>\n";
