<?php
	...
	echo $dir = "/var/www/$fabria_nome/vista_explodida_$fabria_nome/*";
	...
	foreach(glob($dir) as $file) {
		...
		$arquivo = str_ireplace('.PDF','',$fim[5]);
		echo $arquivo . "<br />\n";
		...
		if ( pg_numrows($res1) > 0 ) {
			...
			$de = "/var/www/$fabria_nome/vista_explodida_$fabria_nome/$arquivo.pdf";
			$para = "/var/www/$fabria_nome/vista_explodida_$fabria_nome/$prod.pdf";
