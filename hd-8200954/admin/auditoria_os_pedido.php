    ...
    for ($x=0;$x<$qtde_os;$x++){
        ...
        if (strlen($xxos) > 0 AND strlen($msg_erro) == 0){
            ...
            if($select_acao == "recusada"){
                ...
                * A MESMA É EXCLUÍDA
                */
                $sqlOs = "SELECT fn_os_excluida($xxos,$login_fabrica,null);";
...
$title = "Auditoria de OSs abertas, para geração de pedidos";
...
<table width="700" align="center" border="0" cellspacing='0' cellpadding='0' class='PesquisaTabela'>
    <caption>Auditoria de OS para postos com itens a gerar pedidos</caption>
    <tbody>
        <tr>
            <td colspan="2">
                Número da OS<br />
                ...
                FROM    (
                            SELECT  ultima.os,
                                    (
                                        ...
                                        AND     descricao = 'AUDITORIA DE PEDIDO'
