...
if (strlen($btn_acao)>0 AND strlen($msg_erro)==0){
	...
	$sql =	"
		...
		LEFT JOIN tbl_lista_basica        ON tbl_lista_basica.peca  = tbl_peca.peca AND                                tbl_lista_basica.produto = tbl_os_produto.produto AND
		                          tbl_lista_basica.fabrica = tbl_posto_fabrica.fabrica AND 
	                              tbl_lista_basica.posicao = tbl_os_item.posicao
