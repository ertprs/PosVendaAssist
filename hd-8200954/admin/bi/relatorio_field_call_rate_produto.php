...
//???? Duvidas aqui, pra que serve essa condição?
...
<TABLE width="400" align="center" border="0" cellspacing="0" cellpadding="2">
  ...
  <TR>
    <TD class="table_line" style="width: 10px">&nbsp;</TD>
	<TD class="table_line" style="width: 185px"><center><INPUT size="12" maxlength="10" TYPE="text" NAME="data_inicial_01" id="data_inicial_01" value="<? if (strlen($data_inicial) > 0) echo $data_inicial; ?>" >
	...
	<TD class="table_line" style="width: 185px"><center><INPUT size="12" maxlength="10" TYPE="text" NAME="data_final_01" id="data_final_01" value="<? if (strlen($data_final) > 0) echo $data_final; ?>" >
...
// Para identificar as peças inativas, trocei o * pela cor de funco avermelhada
			if ($login_fabrica==5 and $ativo=='f') {
				...
				echo "<TD class='conteudo10' align='left' nowrap>$ativo<a href='javascript:AbrePeca(\"$produto\",\"$aux_data_inicial\",\"$aux_data_final\",\"$linha\",\"$estado\",\"$pais\",\"$origem\",\"$posto\",\"$tipo_os\",\"$tipo_pesquisa\");'>$referencia</a></TD>";
				echo "<TD class='conteudo10' align='left' nowrap>$descricao</TD>";
				echo "<TD class='conteudo10' align='center' nowrap>$ocorrencia</TD>";
				echo "<TD class='conteudo10' align='right' nowrap title=''>". number_format($porcentagem,2,".",".") ." </TD>";
				echo "</TR>";
