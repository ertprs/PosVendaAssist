...
if ($listar == "ok") {
	...
	$sql = "SELECT  PR.produto                           ,
					...
					LI.nome                AS l_nome     ,
					MA.nome                AS m_nome     ,
					SUM(BI.qtde_os)        AS ocorrencia ,
					SUM(BI.mao_de_obra)    AS mao_de_obra,
					SUM(BI.pecas)          AS pecas      ,
					BI.origem                            
		FROM      bi_fcr_mes  BI
	...
	if (pg_numrows($res) > 0) {
		...
		if($login_fabrica==3 OR $login_fabrica == 15) echo "<TD><b>Marca</b></TD>";
		echo "<TD><b>Linha</b></TD>";
		echo "<TD><b>Família</b></TD>";
		echo "<TD width='120' height='15'><b>Ocorrência</b></TD>";
		echo "<TD width='50' height='15'><b>%</b></TD>";
		echo "<TD width='50' height='15'><b>M.O</b></TD>";
		echo "<TD width='50' height='15'><b>Peças</b></TD>";
		echo "</TR>";
		echo "</thead>";
		echo "<tbody>";
		...
		for ($i=0; $i<pg_numrows($res); $i++){
			...
			if($login_fabrica==3 OR $login_fabrica == 15) echo "<TD align='left' nowrap>$marca</TD>";
			echo "<TD align='left' nowrap>$linha</TD>";
			echo "<TD align='left' nowrap>$familia</TD>";
			echo "<TD align='center' nowrap>$ocorrencia</TD>";
			echo "<TD align='right' nowrap title=''>$porcentagem</TD>";
			echo "<TD align='center' nowrap>$mao_de_obra</TD>";
			echo "<TD align='center' nowrap>$pecas</TD>";
			echo "</TR>";
		}
		$total_mo    = number_format($total_mo,2,".","");
		$total_pecas = number_format($total_pecas,2,".","");
		echo "</tbody>";
		echo "<tr class='table_line'><td colspan='5'><font size='2'><b><CENTER>TOTAL</b></td>";
		echo "<td colspan='2'><font size='2' color='009900'><b>$total</b></td>";
		echo "<td><font size='2' color='009900'><b>$total_mo</b></td>";
