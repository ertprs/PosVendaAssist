...
<?
if (1==2){ // retirei a versão antiga- HD 21404
	echo "<div style='background-color:#FCDB8F;width:600px;margin:0 auto;text-align:center;padding:2px 10px 2px 10px;'>";
	echo "<p style='text-align:left;padding:0px;'><b>ATENÇÃO: </b>Este relatório de BI considera toda  OS que está finalizada. Foi feita a carga apenas do mês de março, caso queira utilizar o antigo relatório <a href='../postos_usando.php'>clique aqui.</a> </p>";
...
<TABLE width="700" align="center" border="0" cellspacing="0" cellpadding="2" class="formulario" id='Formulario'>
...
-->
	...
	<TR>	
		<td width="100">&nbsp;</td>
		<TD><INPUT size="12" maxlength="10" TYPE="text" NAME="data_inicial" id="data_inicial" value="<? if (strlen($data_inicial) > 0) echo $data_inicial; ?>" class='frm'></TD>
		<TD><INPUT size="12" maxlength="10" TYPE="text" NAME="data_final" id="data_final" value="<? if (strlen($data_final) > 0) echo $data_final; ?>" class='frm'></TD>
		<td width="100">&nbsp;</td>	
	</TR>
	<TR>
		<td width="100">&nbsp;</td>
	...
	<tr>
		<td width="100">&nbsp;</td>
		<td   colspan="2">Tipo Arquivo para Download</td> 
		<td width="100">&nbsp;</td>
	</tr>
	<tr>
		<td width="100">&nbsp;</td>
	...
	<TR>
		...
		<TD colspan="4" align="center"><input type="button" value="&nbsp;" style="background:url(imagens_admin/btn_pesquisar_400.gif); width:400px;cursor:pointer;" onclick="javascript: if ( document.frm_pesquisa.btn_finalizar.value == '0' ) { document.frm_pesquisa.btn_finalizar.value='1'; document.frm_pesquisa.submit() ; } else { alert ('Aguarde submissão da OS...'); }"  alt='Clique AQUI para pesquisar'>
		</TD>
	</TR>
	</TFOOT>
</TABLE>
...
//exit;
	...
	$conteudo .= "<td  nowrap rowspan='2'>Posto</td>\n";
	$conteudo .= "<td  nowrap rowspan='2'>Nome do Posto</td>\n";
	if ($login_fabrica == 15) {
		$conteudo .= "<td  nowrap rowspan='2'>e-mail</td>\n";
	}
	$conteudo .= "<td  nowrap rowspan='2'>Estado</td>\n";
	...
	$conteudo .= "<td  nowrap align='center' rowspan='2'>Total OS</td>\n";
	$conteudo .= "<td  nowrap align='center' rowspan='2'>Total Peças</td>\n";
	$conteudo .= "</tr>\n";
	$qtde_linhas = $i ;

	$conteudo .= "<tr class='subtitulo'>\n";
	for ($i = 0 ; $i < $qtde_linhas ; $i++) {
		$conteudo .=  "<td  nowrap align='center'>Qtde OS</td>\n";
		$conteudo .=  "<td  nowrap align='center'>Qtde Peças</td>\n";
	}
