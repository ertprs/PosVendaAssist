...
//echo nl2br($sql);exit;
	...
	if (pg_numrows($res) > 0) {
		...
		if ($formato_arquivo=='CSV'){
			$conteudo = "";
			$conteudo .= "OS;CONSUMIDOR;CONSUMIDOR FONE;DT ABERTURA OS;DT FECHAMENTO OS;REFERÊNCIA;PRODUTO;SÉRIE;N. NF;DATA NF;REVENDA;CÓD POSTO;POSTO;CNPJ;UF POSTO;DEFEITO RECLAMADO;DEFEITO CONSTATADO;SERVIÇO;LINHA;FAMÍLIA;QTDE. PECAS;M.O \n";
		}
		fputs ($fp,$conteudo);
		...
		for ($i=0; $i<pg_numrows($res); $i++){
			...
			if ($formato_arquivo=='CSV'){
				$conteudo = "";
				$conteudo .= $ocorrencia.";".$consumidor.";".$consumidor_fone.";".$data_abertura.";".$data_fechamento.";".$referencia.";".$descricao.";".$serie.";".$nota_fiscal.";".$data_nf.";".$revenda_nome.";".$codigo_posto.";".$nome_posto.";'$cnpj_posto' ;".$uf_posto.";".$dr_descricao.";".$dc_descricao.";".$desc_servico.";".$$linha_nome.";".$familia_nome.";".$qtde_pecas.";".$mao_de_obra.";\n";
			}
			fputs ($fp,$conteudo);
		}
		$conteudo = "";
