...
#				$preco        = trim(pg_result($res,$i,preco));
				...
				echo "<a href='$PHP_SELF?produto=$produto&peca=$peca&data_inicial=$data_inicial&data_final=$data_final&aux_data_inicial=$aux_data_inicial&aux_data_final=$aux_data_final&tipo_data=$tipo_data&posto=$posto'>";
				echo "$referencia</TD>";
