...
if ($listar == "ok") {
	...
	// CHAMADO DE ERRO HD 244075 - foi retirado da condição WHERE o seguinte ítem
	//	AND   BI.troca_de_peca IS TRUE
...
//	echo $sql;
	...
	if (pg_numrows($res) > 0) {
		...
		echo "<TD width='100' height='15'><b>Porcentagem OS</b></TD>";
		...
		for ($i=0; $i<pg_numrows($res2); $i++){
			...
			echo "<TD align='center' nowrap>$porcentagem_os</TD>";
		...
		echo "<td colspan='3'><font size='2'><b><CENTER>TOTAL</b></td>";
	...
	if (pg_numrows($res) > 0) {
		...
		echo "<TD width='100' height='15'><b>Qtde OS</b></TD>";
		echo "<TD width='50' height='15'><b>Porcentagem de OS</b></TD>";
		echo "<TD width='50' height='15'><b>Custo</b></TD>";
		echo "</TR>";
		echo "</thead>";
		echo "<tbody>";
		...
		echo "<tr class='table_line'><td colspan='3'><font size='2'><b><CENTER>TOTAL</b></td>";
		echo "<td><font size='2' color='009900'><b>$total_pecas2</b></td>";
		echO "</tr>";
		if ($login_fabrica==11){
			echo "<tr class='table_line'>";
			echo "<td colspan='3'>$div</td>";
		...
		if (pg_numrows($res) > 0) {
			...
			for ($i=0; $i<pg_numrows($res); $i++){
				...
				if ($login_fabrica==51){	#HD 216673
					echo "<TD align='left' nowrap>$de_descricao</TD>";
				}
...
//				}
			...
			echo "</td>";
			echo "<td><font size='2' color='009900'><b>$total_pecas3</b></td>";
			echO "</tr>";
			echo " </TABLE></div>";
			echo "<a href='javascript:history.back()'>[Voltar]</a>";
		}
