...
<TABLE width="700" align="center" border="1" cellspacing="0" cellpadding="2" id='Formulario' class="formulario">
...
-->
	...
	<TR>
		...
		<TD colspan="4" align="center"><input type="image" src="imagens_admin/btn_pesquisar_400.gif" onclick="javascript: if ( document.frm_pesquisa.btn_finalizar.value == '0' ) { document.frm_pesquisa.btn_finalizar.value='1'; document.frm_pesquisa.submit() ; } else { alert ('Aguarde submissão da OS...'); } return false;" style="cursor:pointer " alt='Clique AQUI para pesquisar'>
		</TD>
	</TR>
	</TFOOT>
</TABLE>
...
#	echo nl2br($sql);
	...
	if (pg_numrows($res) > 0) {
		...
		$conteudo .="<center><div style='width:98%;'><TABLE width='1200px' border='0' cellspacing='2' cellpadding='2' align='center'   name='relatorio' id='relatorio' class='tablesorter;tabela'>";
		$conteudo .="<thead>";
