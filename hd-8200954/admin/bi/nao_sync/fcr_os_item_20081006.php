...
if ($listar == "ok") {
	...
	if(strlen($peca)>0){
		...
		if (pg_numrows($res) > 0) {
			...
			echo "</tbody>";
			echo "<tr class='table_line'><td colspan='6'><font size='2'><b><CENTER>TOTAL</b></td>";
...
#				$preco        = trim(pg_result($res,$i,preco));
				...
				echo "<a href='$PHP_SELF?produto=$produto&peca=$peca&data_inicial=$data_inicial&data_final=$data_final&aux_data_inicial=$aux_data_inicial&aux_data_final=$aux_data_final&tipo_data=$tipo_data'>";
				echo "$referencia</TD>";
