...
-->
	...
	<TR>
		...
		<TD colspan='3'>
			...
			<input type='radio' name='tipo_data' id='extrato_aprovacao' value='extrato_aprovacao'<?if($tipo_data=="extrato_aprovacao") echo "CHECKED";?> /><label for="extrato_aprovacao"><?=($login_fabrica == 5) ? 'Geração do Pedido' : 'Aprovação do Extrato'?></label>
			<?if($login_fabrica==20){?>
