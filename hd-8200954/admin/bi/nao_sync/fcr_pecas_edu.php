...
function AbrePeca(peca,data_inicial,data_final,linha,estado,posto,produto,pais,marca,tipo_data,aux_data_inicial,aux_data_final){
	janela = window.open("fcr_pecas_item_test.php?peca=" + peca + "&data_inicial=" + data_inicial + "&data_final=" + data_final + "&linha=" + linha + "&estado=" + estado +"&posto=" + posto +"&produto="+ produto + "&pais=" + pais +"&marca=" + marca + "&tipo_data=" + tipo_data +"&aux_data_inicial="+aux_data_inicial+"&aux_data_final="+aux_data_final,"peca",'resizable=1,scrollbars=yes,width=750,height=550,top=0,left=0');
	janela.focus();
}
