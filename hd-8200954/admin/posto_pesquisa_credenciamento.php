...
if ($tipo == "nome") {
	...
	$sql = "SELECT   tbl_posto.posto, tbl_Posto.nome, tbl_posto.cnpj, tbl_posto_fabrica.codigo_posto, tbl_posto_fabrica.contato_cidade as cidade, tbl_posto_fabrica.contato_estado as estado
			FROM     tbl_posto
