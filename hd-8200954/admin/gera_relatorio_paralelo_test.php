...
if ($gera_automatico != 'automatico'){
	...
	$res = pg_exec($con,$sql);
	if (pg_numrows($res) > 0) {
		$msg_erro = "O Relatório está sendo processado, dentro de instantes você receberá a confirmação por e-mail.";
		...
		echo "<div class='texto_avulso' style='width:700px;margin:auto;'>O relatório está sendo processado neste momento. Aguarde alguns instantes.</div>";
