...
if ($btn_acao=="gravar"){
	...
	$aux_mensagem  = "Posto Autorizado,<br><br> 
						Seu lote referente(s) ao(s) extrato(s)  \"$total_data\" foi conferido em $data_conferencia, no campo descrição dos serviços  colocar somente o seguinte código: $codigo.
						<br/>
