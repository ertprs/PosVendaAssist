	...
	<table width='500' class='Conteudo' style='background-color: #485989' border='0' cellpadding="0" cellspacing="0" align='center'>
		<tr>
			<td width='100%' class='Titulo' background='imagens_admin/azul.gif' colspan="2">
				<span style="font-size:13px">Estatistica de Serviços por Grupo (Ano Base)</span>
			</td>
		</tr>
		<tr>
			<tr bgcolor="#D9E2EF">
				<td colspan="2">
				<br />
					<div style="float:left; width:140px;padding-left:80px">
						<span>Ano Base</span>
						<br />
					...
					<div style="float:left; width:200px;padding-left:10px">
						...
						<br />
						<?
						echo "<select name='linha' size='1' class='frm' style='width:170px'>";
