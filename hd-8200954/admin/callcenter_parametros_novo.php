...
<FORM name="frm_pesquisa" METHOD="GET" ACTION="callcenter_consulta.php">
...
<TR>
	...
	<TD class="table_line" align="left"><INPUT TYPE="text" NAME="codigo_posto" SIZE="8" <? if ($login_fabrica == 5) { ?> onblur="javascript: fnc_pesquisa_posto (document.frm_pesquisa.codigo_posto,document.frm_pesquisa.nome_posto,'codigo')" <? } ?>><IMG src="imagens_admin/btn_lupa.gif" style="cursor:pointer " align='absmiddle' alt="Clique aqui para pesquisar postos pelo código" onclick="javascript: fnc_tamanho_minimo(document.frm_pesquisa.codigo_posto,3); fnc_pesquisa_posto (document.frm_pesquisa.codigo_posto,document.frm_pesquisa.nome_posto,'codigo')"></TD>
...
<TR>
	<TD colspan="5" class="table_line">Condição dos Atendimentos</TD>
</TR>
<TR>
	<TD class="table_line" style="text-align: left;">&nbsp;</TD>
	<TD  class="table_line"><input type="radio" name="situacao" value="TODAS"  checked>Todos</TD>
	<TD  class="table_line"><input type="radio" name="situacao" value="PENDENTES" >Pendentes</TD>
	<TD  class="table_line"><input type="radio" name="situacao" value="ATENDIDOS" >Atendidos</TD>
	<TD  class="table_line" style="text-align: left;">&nbsp;</TD>
</TR>
