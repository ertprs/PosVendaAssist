...
?>
		<table align="center" class="Conteudo" cellpadding="2">
		<tr class="Titulo">
			<td width="80px" rowspan="2">Login</td>
			<td width="175px" rowspan="2">Nome Completo</td>
			<td width="90px" rowspan="2" title="Chamados em que o usuário é atendente">Chamados</td>
			<td width="90px" colspan="<?php echo count($aStatusInteracoes)+1; ?>">Interações</td>
		</tr>
		<tr class="Titulo">
