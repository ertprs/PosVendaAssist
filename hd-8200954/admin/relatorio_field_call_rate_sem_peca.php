...
$sql = "SELECT * from (
			SELECT tbl_os.os, 
				...
				tbl_os.solucao_os , ";
				if($login_fabrica<>24 and $login_fabrica<>6 and $login_fabrica<>15 and $login_fabrica<>3 and $login_fabrica<>11 AND $login_fabrica<>1) {$sql .= "tbl_servico_realizado.descricao AS solucao_descricao, ";}else{
			...
			if($login_fabrica<>24 and $login_fabrica<>6 and $login_fabrica<>15 and $login_fabrica<>3 and $login_fabrica<>11 AND $login_fabrica<>1) 
...
/*takashi 19/09 3977 where X.status_2 not in (13,15) or status_2 is null*/
if($login_fabrica==24){
