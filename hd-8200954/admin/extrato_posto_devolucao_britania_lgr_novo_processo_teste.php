...
if(strlen($somente_consulta)> 0){
	echo "<td align='center' width='33%'><a href='extrato_posto_mao_obra_novo_britania_teste.php?extrato=$extrato&posto=$posto&somente_consulta=$somente_consulta'>Ver Mão-de-Obra</a></td>";
}else{
	echo "<td align='center' width='33%'><a href='extrato_posto_mao_obra_novo_britania_teste.php?extrato=$extrato&posto=$posto'>Ver Mão-de-Obra</a></td>";
}


?>
<td align='center' width='33%'><a href='extrato_posto_britania_novo_pocesso_teste.php?somente_consulta=sim'>Ver outro extrato</a></td>
</tr>
</table>
