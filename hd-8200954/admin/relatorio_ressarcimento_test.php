...
<TABLE width="700px" align="center"cellspacing='1' cellpadding='0' class='formulario'>
	<? if( strlen( $msg_erro ) >0 ){ ?>
			<tr>
				<td class='msg_erro' colspan='6'><?=$msg_erro?></td>
			</tr>
	<? } ?>
	<tr>
...
if($cont > 31){
$msg_erro="O intervalo entre as datas não pode ser maior que 31 dias.";
}
		...
		if (strlen($msg_erro)==0) {
			$sql = "SELECT	tbl_hd_chamado.hd_chamado,
						...
						WHERE
							...
							$sql_ressarcimento_status
							AND tbl_os_troca.data between '$data_inicial 00:00:00' and '$data_final 23:59:59'
							$sql_posto
							$sql_os";
			...
			if (pg_num_rows($res)>0) {
				...
				echo "<table width='1150px' align='center' cellpadding='1' cellspacing='1' class='tabela'>";
