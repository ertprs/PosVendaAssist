	...
	if (pg_numrows ($res) > 0) {
		...
		for ($i = 0 ; $i < pg_numrows ($res) ; $i++) {
			...
			if ($login_fabrica==2 and 1==2){
				/*hd 3163 Dynacom não estava conseguindo abrir os extratos, todo o extrato o sistema fazia esse select na tbl_os_status, que é muito lento e nao consiguia exibir as informações, retirei por que efetuei teste com extratos sem OSs e não mudou nada, se alguem reclamar volte... takashi 20/07/07*/
