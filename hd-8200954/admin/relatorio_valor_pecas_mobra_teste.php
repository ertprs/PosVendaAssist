...
<div class="texto_avulso" style="width:700px;">A geração desse relatório é a partir da data de digitação de OS para todos os países.</div>

<table width="700" border="0" cellspacing="1" cellpadding="1" align="center" class="formulario">

	<tr>
		<td colspan="4" class="titulo_tabela">Selecione os Parâmetros Para a Pesquisa</td>
	</tr>
...
?>
	...
	<TR  class="Conteudo" bgcolor="#D9E2EF" align='center'>
	   <TD colspan='4'>Origem Produto</TD>
	</TR>
