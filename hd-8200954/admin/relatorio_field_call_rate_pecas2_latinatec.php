...
function AbreDefeito(peca,data_inicial,data_final,linha,estado,pais,produto){
	janela = window.open("relatorio_field_call_rate_defeitos.php?peca=" + peca + "&data_inicial=" + data_inicial + "&consumidor_revenda=<? echo $consumidor_revenda?>&data_final=" + data_final + "&linha=" + linha + "&estado=" + estado  + "&pais=" + pais + "&produto=<? echo $produto ?>","peca",'scrollbars=yes,width=750,height=450,top=315,left=0');
	janela.focus();
}
function AbreSerie(peca,data_inicial,data_final,linha,estado,pais,produto){
	janela = window.open("relatorio_field_call_rate_serie.php?peca=" + peca + "&data_inicial=" + data_inicial + "&consumidor_revenda=<? echo $consumidor_revenda?>&data_final=" + data_final + "&linha=" + linha + "&estado=" + estado + "&pais=" + pais + "&produto=<? echo $produto ?>","peca",'resizable=1,scrollbars=yes,width=750,height=450,top=315,left=0');
	janela.focus();
}
