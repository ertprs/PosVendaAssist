...
//			$msg_erro = "aaa";
	...
	##CALCULAR DIAS ULTIMA INTERAÇÃO##
	##CALCULAR DIAS ULTIMA INTERAÇÃO##
	if (strlen($msg_erro) == 0) {
		//	$res = pg_exec($con,"ROLLBACK TRANSACTION");
			$res = pg_exec($con,"COMMIT TRANSACTION");
        ...
        <table width='700' border='0' align='center' cellpadding="2" cellspacing="2" style='border:#485989 1px solid; background-color: #e6eef7;font-size:10px'>
          <tr> 
			...
			<?	if(strlen($callcenter)>0){ ?>
				...
				<? }else{ ?>
			<input name="data_abertura_callcenter" class="input" type="text" 
            ...
            <td align='left'>
			<?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido"  style="width:100px" id="natureza_chamado"><? echo "$natureza_chamado";?></h1>
			<? }else{ ?>
...
<? } ?>
 ...
 <? } ?>
          ...
          <tr>
			...
			<? }else{ ?>
			<input name="consumidor_bairro" value='<?echo $consumidor_bairro ;?>'   <?if(strlen($callcenter)>0)echo "DISABLED";?>  class="input" type="text" size="33" maxlength="500">
			<? } ?>
			</td>
  ...
  <tr>
	...
	<table width='700' border='0' align='center' cellpadding="2" cellspacing="2" style='border:#485989 1px solid; background-color: #e6eef7;font-size:10px'>
        <tr> 
		  ...
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido" style="width:200px" id="assunto"><? echo "$assunto";?></h1>
			<? }else{ ?>
		  ...
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido" style="width:100px" id="sua_os"><? echo "$sua_os";?></h1>
			<? }else{ ?>
...
<? } ?>
		  ...
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido" style="width:80px" id="data_abertura"><? echo "$data_abertura";?></h1>
			<? }else{ ?>
		  <input name="data_abertura" value='<?echo $data_abertura ;?>'  <?if(strlen($callcenter)>0)echo "DISABLED";?>  class="input" type="text" size="11" maxlength="10" onKeyUp="formata_data(this.value,'frm_callcenter', 'data_abertura')">
		  <? } ?>
		  </td>
        </tr>
        <tr> 
		  ...
		  <? if(strlen($callcenter)==0){ ?> mostraDefeitos(document.frm_callcenter.natureza_chamado.value,document.frm_callcenter.produto_referencia.value)<?}?>" type="text" size="35" maxlength="500"> 
		 ...
		 <td align='left'><strong>Série:</strong></td>
          <td align='left'>
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido"  style="width:100px" id="serie"><? echo "$serie";?></h1>
			<? }else{ ?>
          ...
          <td align='left'>
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido"  style="width:80px" id="data_nf"><? echo "$data_nf";?></h1>
			<? }else{ ?>
			<input name="data_nf"  value='<?echo $data_nf ;?>'  <?if(strlen($callcenter)>0)echo "DISABLED";?>  class="input" type="text" size="11" maxlength="10" onKeyUp="formata_data(this.value,'frm_callcenter', 'data_nf')">
			<? } ?>
			</td>
        </tr>
        <tr> 
          ...
          <td align='left'>
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido" style="width:100px" id="nota_fiscal"><? echo "$nota_fiscal";?></h1>
			<? }else{ ?>
		  ...
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido" style="width:200px" id="revenda_nome"><? echo "$revenda_nome";?></h1>
			<? }else{ ?>
        ...
        <tr> 
		  ...
		  <?	if(strlen($callcenter)>0){ ?>
				<h1 class="respondido" style="width:200px" id="posto_nome"><? echo "$posto_nome";?></h1>
			<? }else{ ?>
   ...
   <tr>
    <td align='left'><span style=' position:absolute;float:left;'><strong>Ocorrência</strong></span><span style='position:relative;float:right;'><a href="javascript:minimizar('dados_3');"><img src='imagens_admin/btn_fechar.gif' border='0' alt='Minimizar'></a></span>
	<BR>
