<?php
   ################# ELGIN - INICIO ############################################################
	...
	//CODIGO DO POSTO
	$campos_telecontrol[117]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['posto_codigo']['obrigatorio'] = 1;

	//NOME DO POSTO
	$campos_telecontrol[117]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	...
	$campos_telecontrol[117]['tbl_os']['consumidor_nome']['obrigatorio'] = 0;

	//CPF DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_cpf']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['consumidor_cpf']['obrigatorio'] = 0;

	//FONE DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_fone']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['consumidor_fone']['obrigatorio'] = 0;

	//CEP DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_cep']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['consumidor_cep']['obrigatorio'] = 0;

	//ENDERECO DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_endereco']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['consumidor_endereco']['obrigatorio'] = 0;

	//NUMERO DO ENDEREÇO DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_numero']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['consumidor_numero']['obrigatorio'] = 0;
	...
	$campos_telecontrol[117]['tbl_os']['consumidor_bairro']['obrigatorio'] = 0;

	//CIDADE DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_cidade']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['consumidor_cidade']['obrigatorio'] = 0;


	//ESTADO DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_estado']['tipo'] = 'select';
	$campos_telecontrol[117]['tbl_os']['consumidor_estado']['obrigatorio'] = 0;


	//EMAIL DO CONSUMIDOR
	$campos_telecontrol[117]['tbl_os']['consumidor_email']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['consumidor_email']['obrigatorio'] = 0;
	...
	//Aparencia Produto
	$campos_telecontrol[117]['tbl_os']['aparencia_produto']['tipo'] = 'select';
	...
	//DEFEITO RECLAMADO
	$campos_telecontrol[117]['tbl_os']['defeito_reclamado']['tipo'] = 'select';
	$campos_telecontrol[117]['tbl_os']['defeito_reclamado']['obrigatorio'] = 0;

	//PRATELEIRA/BOX
	$campos_telecontrol[117]['tbl_os']['prateleira_box']['tipo'] = 'texto';
	$campos_telecontrol[117]['tbl_os']['prateleira_box']['obrigatorio'] = 0;
