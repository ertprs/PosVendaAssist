...
############################# DELONGHI - INICIO ############################
	...
	//CODIGO DO POSTO
	$campos_telecontrol[101]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[101]['tbl_os']['posto_codigo']['obrigatorio'] = 1;

	//NOME DO POSTO
	$campos_telecontrol[101]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[101]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	...
	$campos_telecontrol[101]['tbl_os']['revenda_cnpj']['obrigatorio'] = 1;
