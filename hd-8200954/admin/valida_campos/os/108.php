<?php
################################# BEAT SOUND - PROJECT MUSIC#####################################################
	//CODIGO DO POSTO
	$campos_telecontrol[108]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[108]['tbl_os']['posto_codigo']['obrigatorio'] = 1;
	
	$campos_telecontrol[111]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[111]['tbl_os']['posto_codigo']['obrigatorio'] = 1;

	//NOME DO POSTO
	$campos_telecontrol[108]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[108]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	
	$campos_telecontrol[111]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[111]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	...
	//CPF DO CONSUMIDOR
	$campos_telecontrol[108]['tbl_os']['consumidor_cpf']['tipo'] = 'texto';
	$campos_telecontrol[108]['tbl_os']['consumidor_cpf']['obrigatorio'] = 0;
	
	$campos_telecontrol[111]['tbl_os']['consumidor_cpf']['tipo'] = 'texto';
	$campos_telecontrol[111]['tbl_os']['consumidor_cpf']['obrigatorio'] = 0;
	...
	//ORIENTACAO SAC
	$campos_telecontrol[108]['tbl_os']['orientacao_sac']['tipo'] = 'texto';
	$campos_telecontrol[108]['tbl_os']['orientacao_sac']['obrigatorio'] = 0;
	
	$campos_telecontrol[111]['tbl_os']['orientacao_sac']['tipo'] = 'texto';
	$campos_telecontrol[111]['tbl_os']['orientacao_sac']['obrigatorio'] = 0;
	
################# FIM BEAT SOUND - PROJECT MUSIC ###########################################
?>