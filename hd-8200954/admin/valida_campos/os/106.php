...
############################# HOUSTON - INICIO ############################
	...
	//CODIGO DO POSTO
	$campos_telecontrol[106]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[106]['tbl_os']['posto_codigo']['obrigatorio'] = 1;

	//NOME DO POSTO
	$campos_telecontrol[106]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[106]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	...
	//ORIENTACAO SAC
	$campos_telecontrol[106]['tbl_os']['orientacao_sac']['tipo'] = 'texto';
	$campos_telecontrol[106]['tbl_os']['orientacao_sac']['obrigatorio'] = 0;
