<?php
   ################# NEWMAQ - INICIO ############################################################
	...
	//CODIGO DO POSTO
	$campos_telecontrol[120]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[120]['tbl_os']['posto_codigo']['obrigatorio'] = 1;

	//NOME DO POSTO
	$campos_telecontrol[120]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[120]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	...
	//CPF DO CONSUMIDOR
	$campos_telecontrol[120]['tbl_os']['consumidor_cpf']['tipo'] = 'texto';
	$campos_telecontrol[120]['tbl_os']['consumidor_cpf']['obrigatorio'] = 0;
	...
	//EMAIL DO CONSUMIDOR
	$campos_telecontrol[120]['tbl_os']['consumidor_email']['tipo'] = 'texto';
	$campos_telecontrol[120]['tbl_os']['consumidor_email']['obrigatorio'] = 0;
	...
	//Aparencia Produto
	$campos_telecontrol[120]['tbl_os']['aparencia_produto']['tipo'] = 'select';
	...
	$campos_telecontrol[120]['tbl_os']['defeito_reclamado']['obrigatorio'] = 1;

	//PRATELEIRA/BOX
	$campos_telecontrol[120]['tbl_os']['prateleira_box']['tipo'] = 'texto';
	$campos_telecontrol[120]['tbl_os']['prateleira_box']['obrigatorio'] = 0;
