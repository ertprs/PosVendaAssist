<?php
	...
	//CODIGO DO POSTO
	$campos_telecontrol[98]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[98]['tbl_os']['posto_codigo']['obrigatorio'] = 1;

	//NOME DO POSTO
	$campos_telecontrol[98]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[98]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	...
	//Aparencia Produto
	$campos_telecontrol[98]['tbl_os']['aparencia_produto']['tipo'] = 'texto';
	$campos_telecontrol[98]['tbl_os']['aparencia_produto']['obrigatorio'] = 0;

	//Acessórios
	$campos_telecontrol[98]['tbl_os']['acessorios']['tipo'] = 'texto';
	$campos_telecontrol[98]['tbl_os']['acessorios']['obrigatorio'] = 0;

	//ORIENTACAO SAC
	$campos_telecontrol[98]['tbl_os']['orientacao_sac']['tipo'] = 'texto';
	$campos_telecontrol[98]['tbl_os']['orientacao_sac']['obrigatorio'] = 0;
##### FIM DELLAR#############################################	
?>