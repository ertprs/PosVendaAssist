...
#########  VONDER 104 - DWT 105 - INICIO ###############

	//CODIGO DO POSTO
	$campos_telecontrol[104]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[104]['tbl_os']['posto_codigo']['obrigatorio'] = 1;
	
	$campos_telecontrol[105]['tbl_os']['posto_codigo']['tipo'] = 'texto';
	$campos_telecontrol[105]['tbl_os']['posto_codigo']['obrigatorio'] = 1;



	//NOME DO POSTO
	$campos_telecontrol[104]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[104]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	
	$campos_telecontrol[105]['tbl_os']['posto_nome']['tipo'] = 'texto';
	$campos_telecontrol[105]['tbl_os']['posto_nome']['obrigatorio'] = 1;
	...
	//CPF DO CONSUMIDOR
	$campos_telecontrol[104]['tbl_os']['consumidor_cpf']['tipo'] = 'texto';
	$campos_telecontrol[104]['tbl_os']['consumidor_cpf']['obrigatorio'] = 0;
	
	$campos_telecontrol[105]['tbl_os']['consumidor_cpf']['tipo'] = 'texto';
	$campos_telecontrol[105]['tbl_os']['consumidor_cpf']['obrigatorio'] = 0;
	...
	//EMAIL DO CONSUMIDOR
	$campos_telecontrol[104]['tbl_os']['consumidor_email']['tipo'] = 'texto';
	$campos_telecontrol[104]['tbl_os']['consumidor_email']['obrigatorio'] = 0;
	
	$campos_telecontrol[105]['tbl_os']['consumidor_email']['tipo'] = 'texto';
	$campos_telecontrol[105]['tbl_os']['consumidor_email']['obrigatorio'] = 0;
