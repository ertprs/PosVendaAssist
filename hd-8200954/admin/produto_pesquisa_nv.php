						...
						<tbody><? 
							for ($i = 0 ; $i < pg_num_rows($res); $i++) {
								...
								elseif($produto_so_troca == 0)
									...
									$onclick = "onclick= \"javascript: window.parent.retorna_dados_produto('$referencia','$descricao','$produto','$linha','$nome_comercial','$voltagem','$referencia_fabrica','$garantia','$ativo','$valor_troca','$troca_garantia','$troca_faturada'); window.parent.Shadowbox.close();\"";
									if(pg_num_rows($res) == 1){
										echo "<script type='text/javascript'>";
											echo "window.parent.retorna_dados_produto('$referencia','$descricao','$produto','$linha','$nome_comercial','$voltagem','$referencia_fabrica','$garantia','$ativo','$valor_troca','$troca_garantia','$troca_faturada'); window.parent.Shadowbox.close();";
										echo "</script>";
									}
								}
