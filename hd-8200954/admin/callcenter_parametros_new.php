...
if($login_fabrica<>6){
	header ("Location: callcenter_parametros_interativo.php");
...
<FORM name="frm_pesquisa" METHOD="GET" ACTION="callcenter_consulta_lite_new.php">
...
<TR>
	...
	<TD width="19" class="table_line" style="text-align: left;">&nbsp;</TD>
		<td class="table_line">
			<input type="text" name="data_inicial" id="data_inicial" size="8" maxlength="10" class='Caixa' value="<? if (strlen($data_inicial) > 0) echo $data_inicial; ?>">
		...
		<td class="table_line">
			<input type="text" name="data_final" id="data_final" size="10" maxlength="10" class='Caixa' value="<? if (strlen($data_final) > 0) echo $data_final;?>">
