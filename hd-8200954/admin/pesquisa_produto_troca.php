...
<img src="imagens/pesquisa_produtos.gif"><?php
...
if (strlen($voltagem_produto) > 0) {//HD 308648
	$where = "AND   UPPER(voltagem) = UPPER('$voltagem_produto')";
}
	...
	for ( $i = 0 ; $i < pg_numrows ($res) ; $i++ ) {
		...
		if ($kit == 0) {
			echo "<tr bgcolor='$cor'>\n";
				...
				echo "<td>\n";
				echo "<a href=\"javascript:produto.value=$produto;descricao.value='$descricao';referencia.value='$referencia';voltagem.value='$voltagem';window.opener.buscaValorTroca();this.close();\">";
