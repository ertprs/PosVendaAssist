...
if ($btn_acao == "confirmar") {
	...
	if (strlen ($msg_erro) == 0) {
		...
		$msg_ok = "Email agendado com sucesso";
	...
	<script language="JavaScript">
		...
		oFCKeditor.ToolbarSet = 'CorpoEmail' ;
...
<TABLE  width='800px' class='formulario' align='center' border='0' cellspacing = '1' cellpadding='3'>
	<tr>
		<td colspan="3" class="titulo_tabela">E-Mail</td>
	</tr>
	<TR>
		<TD>
			&nbsp;
		...
		<TD>
			<button type="button" onclick="window.location='mensagem_enviada.php'">Exibir Mensagens Enviadas</button>
		</TD>
		<TD>
			<button type="button" onclick="window.location='mensagem_agendada.php'">Exibir Mensagens Agendadas</button>
		</TD>
	</TR>
</table>
<br>
<TABLE  width='800px' class='formulario' align='center' border='0' cellspacing = '1' cellpadding='3'>
	...
	<TR>
		<TD colspan="4" align='center'><font color='red'><b>A T E N Ç Ã O</b></font></TD>
	</TR>
	<TR>
		<TD colspan="4" align='center'><font color='red'><b>Os emails cadastrados nesta tela serão agendados para serem disparados durante a madrugada a partir da 1h.</b></font></TD>
	</TR>
	<TR>
		<TD colspan="4" align='center'><font color='red'><b>Confira antes de clicar porque não existe a opção de abortar ou alterar este processo!</b></font></TD>
	</TR>
	<br>
	<TR>
		<td width='10%'>&nbsp;</td>
		<TD align='left'>Linha</TD>
		<TD colspan="2" align='left'>E-Mail remetente</TD>
	</TR>
	<TR align='left'>
	<td width='10%'>&nbsp;</td>
		<TD>
