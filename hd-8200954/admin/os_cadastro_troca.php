...
if ($login_fabrica==1) {
    ...
    header("Location: os_cadastro_troca_black.php?os=$os&acao=$acao");
    exit;
}
//if ($login_fabrica == 1) {
...
#  fazer rotina para contar 6 caracteres antes do "-"
	...
	if (strlen (trim ($tipo_atendimento)) == 0) $msg_erro .= " Escolha o Tipo de Atencimento<BR>";
...
//if ($ip == '201.42.109.101') echo $sql;
	...
	if (strlen ($msg_erro) == 0) {
		...
		if (strlen($os) == 0) {
		$xxsql = "UPDATE tbl_os set finalizada=current_timestamp, data_fechamento=current_date where os=$os";
...
//echo "$sql";
	if (pg_numrows ($res) == 1) {
		...
		$xsql  = "SELECT tbl_revenda.revenda,tbl_revenda.nome, tbl_revenda.cnpj, tbl_revenda.fone, tbl_revenda.endereco, tbl_revenda.numero, tbl_revenda.complemento, tbl_revenda.bairro, tbl_revenda.cep, tbl_revenda.cidade,	tbl_cidade.estado FROM tbl_revenda LEFT JOIN tbl_cidade USING (cidade) WHERE tbl_revenda.revenda = $xxxrevenda";
...
<font size="1" face="Geneva, Arial, Helvetica, san-serif">N. Série</font>
		<br>SELECT tbl_os.sua_os , to_char(tbl_os.data_abertura,'DD/MM/YYYY') AS data_abertura , tbl_os.consumidor_nome , tbl_os.consumidor_cpf , tbl_os.consumidor_cidade , tbl_os.consumidor_fone , tbl_os.consumidor_estado , tbl_os.consumidor_endereco , tbl_os.consumidor_numero , tbl_os.consumidor_complemento , tbl_os.consumidor_bairro , tbl_os.consumidor_cep , tbl_os.revenda , tbl_os.revenda_cnpj , tbl_os.revenda_nome , tbl_os.nota_fiscal , tbl_os.tipo_atendimento , to_char(tbl_os.data_nf,'DD/MM/YYYY') AS data_nf , tbl_os.consumidor_revenda , tbl_os.aparencia_produto , tbl_os.codigo_fabricacao , tbl_os.type , tbl_os.satisfacao , tbl_os.laudo_tecnico , tbl_os.tipo_os_cortesia , tbl_os.serie , tbl_os.qtde_produtos , tbl_os.troca_faturada , tbl_os.acessorios , tbl_os.tipo_os , tbl_os.tipo_atendimento , tbl_produto.referencia AS produto_referencia , tbl_produto.descricao AS produto_descricao , tbl_produto.voltagem AS produto_voltagem , tbl_posto_fabrica.codigo_posto FROM tbl_os JOIN tbl_produto ON tbl_produto.produto = tbl_os.produto JOIN tbl_posto_fabrica ON tbl_posto_fabrica.fabrica = 1 WHERE tbl_os.os = 1532928 AND tbl_os.fabrica = 1 limit 1
...
<td nowrap valign='top'><font size="1" face="Geneva, Arial, Helvetica, san-serif">Voltagem</font><br>
...
//				if (strlen($data_abertura) == 0 and $login_fabrica <> 1) $data_abertura = date("d/m/Y");
				echo $data_abertura;
?>" type="text" class="frm" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on'; displayText('&nbsp;Entre com a Data da Abertura da OS.'); " tabindex="0"><br><font face='arial' size='1'>Ex.: <? echo date("d/m/Y"); ?></font>
</td>
<? if ($login_fabrica <> 6){ ?>
<td nowrap valign='top'><font size="1" face="Geneva, Arial, Helvetica, san-serif">N. Série</font><br>
...
<table width="100%" border="0" cellspacing="5" cellpadding="2">
<tr>
<td nowrap width='40' valign='top'><font size="1" face="Geneva, Arial, Helvetica, san-serif">Nota Fiscal</font><br>
...
<td nowrap width='50' valign='top'><font size="1" face="Geneva, Arial, Helvetica, san-serif">Data Compra</font><br>
...
<? if ($login_fabrica == 1) { ?>
<td nowrap width='50' valign='top'><font size="1" face="Geneva, Arial, Helvetica, san-serif">Código Fabricação</font><br>
...
<? } ?>
		<td  nowrap width='60%' valign='top'><font size="1" face="Geneva, Arial, Helvetica, san-serif">Tipo de Atendimento</font><BR>
<select name="tipo_atendimento" size="1" style='width:200px; height=18px;'>
<option selected></option>
<?
if($login_fabrica==1)$sql_add1 = " AND tipo_atendimento IN (17,18,35) ";
...
?>
	...
	<tr>
	<td><font size="1" face="Geneva, Arial, Helvetica, san-serif">Endereço</font><BR>
	...
	<td ><font size="1" face="Geneva, Arial, Helvetica, san-serif">Número</font><BR>
	...
	<td ><font size="1" face="Geneva, Arial, Helvetica, san-serif">Complemento</font><BR>
	...
	<td ><font size="1" face="Geneva, Arial, Helvetica, san-serif">Bairro</font><BR>
	...
	<td ><font size="1" face="Geneva, Arial, Helvetica, san-serif">Cidade</font><BR>
	...
	<td ><font size="1" face="Geneva, Arial, Helvetica, san-serif">Estado</font><BR>
...
#			echo "<!-- ";
		...
		<td class="txt1"><font size="1" face="Geneva, Arial, Helvetica, san-serif">Bairro</font>
		<br>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
<tr>
		<td><font size="1" face="Geneva, Arial, Helvetica, san-serif">Valor Adicional 01</font><BR>
		<input class="frm" type="text" name="Valor Adicional_01"   size="15" maxlength="50" value="" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on';">
</td>
		<td><font size="1" face="Geneva, Arial, Helvetica, san-serif">Valor Adicional 02</font><BR>
		<input class="frm" type="text" name="Valor Adicional_02"   size="15" maxlength="50" value="" onblur="this.className='frm'; displayText('&nbsp;');" onfocus="this.className='frm-on';">
</td>
</tr>
</table>
		<? } ?>
