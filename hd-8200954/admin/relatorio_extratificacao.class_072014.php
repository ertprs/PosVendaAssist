...
class relatorioExtratificacao
{
    ...
    private function geraGraficoMaioresDefeitosPorPecas()
	{
        ...
        $qry = pg_query("SELECT ('{$data_inicial_pesquisa}'::date - interval '$periodo1 month')::date");
        $data_inicial_defeitos = pg_fetch_result($qry, 0, 0);

        $qUltimoDiaMes = $this->executePreparedStatements("ultimo_dia_do_mes", array($this->getDataInicial()));
        ...
        $fabricacao_inicio = $data_inicial_pesquisa;
