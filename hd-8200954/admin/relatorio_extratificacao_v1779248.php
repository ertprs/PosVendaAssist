...
include 'relatorio_extratificacao.class_v1779248.php';
/**
 *
 * REGRAS:
 *
...
<script>
	...
	function pareto(fabricacao, abertura, meses, familia, peca01, peca02, fornecedores, datas, produtos, pecas, posto) {
		...
		if( $("#sem_peca").is(":checked") ){
			...
			var url="relatorio_extratificacao_pareto_sem_peca.php?ab=" + abertura + "&fb=" + fabricacao + "&fm=" + meses + "&f=" + familia + "&defeito=" + sem_peca + "&po=" + posto + '&regiao=' + regiao;
		}else{
