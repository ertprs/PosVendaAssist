...
<center>
<font face='arial' color='red'><b>Relatório Visão Geral está disponível de 01/09/2006 até <?echo $data_fim;?></b></font>
<center>
	...
	<tr>
		<td align="center" bgcolor="#FFFFFF">
			...
			if (@pg_num_rows($res) > 0) {
				...
				if ($linha == 347) { 
					echo " SELECTED "; 
					$descricao_linha = "Compressor";
				}
				echo ";>Compressor</option>"; # HD 76271
				echo "<option value='0006'";
				if ($linha == '0006') { 
					echo " SELECTED "; 
					$descricao_linha = "Ferramentas";
				}
				echo ";>Ferramentas</option>"; # HD 209392
...
if ($relatorio == "gerar" ) {	
	...
	if (strlen ($linha) > 0) {
		if ($linha == 347) {
			...
			$sql_join = " JOIN tbl_produto ON tmp_os_visao_geral.produto = tbl_produto.produto";
			$cond_linha = " (tbl_produto.linha in (198,200,467) or tbl_produto.familia = 347 ) ";
		}else{
			$cond_linha = " tmp_os_visao_geral.linha = $linha AND tbl_produto.familia <> 347 ";
			$sql_join = " JOIN tbl_produto ON tmp_os_visao_geral.produto = tbl_produto.produto";
		}
	}
...
*/
  ...
  if (strtoupper($btnacao) == "LISTAR" and @pg_num_rows($res)>0)  {
	...
	*/
	...
	if (@pg_num_rows($res) > 0) {
		...
		echo "<td bgcolor='#B6DADA' align='center'>";
		echo "<font face='Verdana, Arial, Helvetica, sans' color='#000000' size='2'><b>Code Convention</b></font>";
		echo "</td>";
		...
		echo "<td bgcolor='#B6DADA' align='left' colspan='3'>";
