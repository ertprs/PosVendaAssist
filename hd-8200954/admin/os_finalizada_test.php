...
<table width='700' border='0' cellpadding='0' cellspacing='4' class='formulario' align='center'>
	<form name="frm_os" method="post" action="<? echo $PHP_SELF ?>">
	<input type="hidden" name="os" value="<? echo $os; ?>">
	<tr class='titulo_tabela'><td colspan='4'>INFORMAÇÃO	 DO CONSUMIDOR</td></tr>
<tr class='subtitulo'>
...
if (strlen($troca_faturada) == 0) {
	...
	if (strlen($os) > 0) {
		...
		echo "<table width='700' border='0' align='center' class='tabela'>";
		echo "<tr class='titulo_coluna'>";
		if($os_item_subconjunto == 't') {
			echo "<td align='center'>Subconjuto</td>";
			echo "<td align='center'>Posição</td>";
		}
		echo "<td align='center'>Referência</td>";
		echo "<td align='center'>Descrição</td>";
		echo "<td align='center'>Defeito</td>";
		echo "<td align='center'>Serviço</td>";
...
<table width='700' border='0' cellpadding='0' cellspacing='4' bordercolor='#D9E2EF' align='center'>
<tr class='subtitulo'>
	<td>Observações</td>
</tr>
<tr class='descricao'>
...
<center>
		...
		onclick="window.location='os_cortesia_cadastro.php?os=<? echo $os?>'"
		<? }else{ ?>
		onclick="window.location='os_cadastro.php?os=<? echo $os?>'"
		<? } ?>
		>
		
		<input type='button' value='Lançar Nova OS'
		<? if ($cortesia == 't' AND $login_fabrica == 1) { ?>
		onclick="window.location='os_cortesia_cadastro.php'"
		<? }else{ ?>
		onclick="window.location='os_cadastro.php'"
		<? } ?>
		>
</center>
