...
.Conteudo {
	...
	<FORM METHOD="POST" NAME="frm_relatorio" ACTION="<?php echo $PHP_SELF; ?>">
		<TABLE WIDTH='700' BORDER='0' CELLPADDING='0' CELLSPACING='0' ALIGN='CENTER'>
			...
			<tr bgcolor="#D9E2EF"><td colspan="100%">&nbsp;</td></tr>
			<tr bgcolor="#D9E2EF">
				<td><input class="frm" type="text" name="codigo_posto" size="15" value="<?php echo $codigo_posto ?>">&nbsp;<img src='imagens/btn_lupa.gif' border='0' align='absmiddle' style="cursor:pointer" onclick="javascript: fnc_pesquisa_posto2 (document.frm_relatorio.codigo_posto,document.frm_relatorio.posto_nome,'codigo')"></td>
				<td><input class="frm" type="text" name="posto_nome" size="40" value="<?php echo $posto_nome ?>">&nbsp;<img src='imagens/btn_lupa.gif' style="cursor:pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto2 (document.frm_relatorio.codigo_posto,document.frm_relatorio.posto_nome,'nome')" style="cursor:pointer;"><br></td>
			</tr>
...
if($acao=="PESQUISAR"){
	...
	fputs ($fp,"</head>");
	fputs ($fp,"<body>");*/
	$tabela = "<TABLE WIDTH='100%' BORDER='0' CELLPADDING='2' CELLSPACING='2' ALIGN='CENTER'>";
	...
	if ( in_array($login_fabrica, array(3,11,172)) ) {
		...
		//echo `htmldoc --webpage --size 297x210mm --fontsize 11 --left 8mm -f xls/relatorio-indicadores-pa-$login_fabrica-$data_xls.xls /tmp/assist/relatorio-indicadores-pa-$login_fabrica.html`;
        
        echo `mv /tmp/assist/relatorio-indicadores-pa-$login_fabrica.html xls/relatorio-indicadores-pa-$login_fabrica-$data_xls.xls`;
