...
if (strlen ($extrato) > 0 ) {
	header ("Location: extrato_posto_devolucao_britania.php?extrato=$extrato&posto=$posto&somente_consulta=$somente_consulta");
	exit;
}
...
if(isset($btnacao)){
	if(empty($codigo_posto)){
		$msg_erro = "Informe Parâmetros para Pesquisa";
	}
}
		...
		<td>
			<TABLE width='100%' align='center' border='0' cellspacing='0' cellpadding='0' class='formulario'>
				<FORM METHOD='GET' NAME='frm_extrato' ACTION="<?=$PHP_SELF?>">
					...
					<tr>
						<td style='padding-left:200px;' width='100'>
							Posto <br />
							...
							<img border="0" src="imagens/lupa.png" style="cursor: pointer;" align="absmiddle" alt="Clique aqui para pesquisar postos pelo código" onclick="javascript: fnc_pesquisa_posto (document.frm_extrato.codigo_posto, document.frm_extrato.nome, 'codigo')">
						</td>
