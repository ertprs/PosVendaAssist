...
<table width="450" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<tr class="Conteudo" bgcolor="#D9E2EF">
		<td>&nbsp;</td>
		<td align="left" colspan="2"><input type="checkbox" name="opcao5" value="5" class="frm" <? if (strlen($opcao5) > 0) echo "checked"; ?>> Número da OS</td>
...
if ($acao == "PESQUISAR") {
	...
	if (strlen(trim($_GET["opcao6"])) > 0)  $opcao5 = trim($_GET["opcao6"]);
...
if ($acao == "PESQUISAR" && strlen($msg) == 0 and strlen($os)==0 and strlen($opcao6)==0) {
	...
	//echo $sql;
	if(pg_numrows($res)>0){
		echo "<table border='0' cellpadding='4' cellspacing='1' width='750' bgcolor='#596D9B' align='center' style='font-family: verdana; font-size: 9px'>";
		echo "<tr>";
		...
		echo "<td><font color='#FFFFFF'><B>Telefone</B></FONT></td>";
		echo "<td><font color='#FFFFFF'><B>Ação</B></FONT></td>";
		echo "</tr>";
		...
		for($x=0;pg_numrows($res)>$x;$x++){
			...
			echo "<td align='center'><a href='$PHP_SELF?os=$os'><B>Fazer Pesquisa</b></A></td>";
			echo "</tr>";
		}
		echo "</table>";
	}else{
...
//exit;
	if(pg_numrows($res)>0){
		echo "<table border='0' cellpadding='4' cellspacing='1' width='450' bgcolor='#596D9B' align='center' style='font-family: verdana; font-size: 9px'>";
		echo "<tr>";
		echo "<td><font color='#FFFFFF'><B>Posto</B></FONT></td>";
...
//	echo $xsql;
	...
	if(pg_numrows($xres)>0){
		...
		echo "<table border='0' cellpadding='4' cellspacing='1'  bgcolor='#596D9B' width='600' align='center' style='font-family: verdana; font-size: 10px'>";
		echo "<tr>";
		echo "<td  colspan='5'><font color='#FFFFFF' ><B>Dados para entrevista</B></FONT></td>";
		echo "</tr>";
		echo "<tr>";
		...
		$res = pg_exec($con,$sql);
		if(pg_numrows($res)>0){
			echo "<BR><BR><table border='0' cellpadding='4' cellspacing='1'  bgcolor='#FF3300' width='600' align='center' style='font-family: verdana; font-size: 11px'><tr><TD align='center'>Pesquisa já realizada para essa OS</TD></tr></table>";
		...
		echo "<tr>";
		echo "<td  colspan='5'><font color='#FFFFFF' ><B>Perguntas da entrevista</B></FONT></td>";
		echo "</tr>";
		echo "<tr>";
		echo "<td bgcolor='#d2d7e1' colspan='3' align='left'><B>O que levou a escolher o produto $produto_descricao?</B></td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_1' bgcolor='#FFFFFF'>";
		echo "<td  align='left'> &nbsp;&nbsp;a. Foi o preço ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='preco' id='preco' value='t' onclick=\"javascript:marcaLinha('linha_1');\"> Sim ";
		echo " <input type='radio' name='preco' id='preco' value='f' onclick=\"javascript:marcaLinha('linha_1');\"> Não</td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_2' bgcolor='#e7e1d2'>";
		echo "<td align='left'> &nbsp;&nbsp;b. Foi a qualidade ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='qualidade' id='qualidade' value='t' onclick=\"javascript:marcaLinha('linha_2');\"> Sim ";
		echo " <input type='radio' name='qualidade' id='qualidade' value='f' onclick=\"javascript:marcaLinha('linha_2');\"> Não</td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_3' bgcolor='#FFFFFF'>";
		echo "<td align='left'> &nbsp;&nbsp;c. Foi o design ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='design' id='design' value='t' onclick=\"javascript:marcaLinha('linha_3');\"> Sim ";
		echo " <input type='radio' name='design' id='design' value='f' onclick=\"javascript:marcaLinha('linha_3');\"> Não</td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_4' bgcolor='#e7e1d2'>";
		echo "<td align='left'> &nbsp;&nbsp;d. Foi a tradição da marca ";
		echo "<input type='radio' name='tradicao' id='tradicao' value='t' onclick=\"javascript:marcaLinha('linha_4');\"> Sim ";
		echo " <input type='radio' name='tradicao' id='tradicao' value='f' onclick=\"javascript:marcaLinha('linha_4');\"> Não</td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_5' bgcolor='#FFFFFF'>";
		echo "<td align='left'> &nbsp;&nbsp;e. Foi por indicação ";
 		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='indicacao' id='indicacao' value='t' onclick=\"javascript:marcaLinha('linha_5');\"> Sim ";
		echo " <input type='radio' name='indicacao' id='indicacao' value='f' onclick=\"javascript:marcaLinha('linha_5');\"> Não</td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_6' bgcolor='#e7e1d2'>";
		echo "<td align='left'> &nbsp;&nbsp;f. Foi pela capacidade ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='capacidade' id='capacidade' value='t' onclick=\"javascript:marcaLinha('linha_6');\"> Sim ";
		echo " <input type='radio' name='capacidade' id='capacidade' value='f' onclick=\"javascript:marcaLinha('linha_6');\"> Não</td>";
		echo "</tr>";

		echo "<tr id = 'linha_7' bgcolor='#FFFFFF'>";
		echo "<td  align='left'> &nbsp;&nbsp;g. Foi por inovação ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='inovacao' id='inovacao' value='t' onclick=\"javascript:marcaLinha('linha_7');\"> Sim ";
		echo " <input type='radio' name='inovacao' id='inovacao' value='f' onclick=\"javascript:marcaLinha('linha_7');\"> Não</td>";
		echo "</tr>";

		echo "<tr id = 'linha_8' bgcolor='#d2d7e1'>";
		echo "<td colspan='3' align='left'><B>Com relação ao $produto_descricao </B></td>";
		echo "</tr>";

		echo "<tr id = 'linha_9' bgcolor='#FFFFFF'>";
		echo "<td align='left'> &nbsp;&nbsp;a. Satisfeito ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='satisfeito' id='satisfeito' value='t' onClick=\"javascript:verificaSatisfeito('sim');marcaLinha('linha_9');\"> Sim ";
		...
		echo "<tr id = 'linha_10' bgcolor='#d2d7e1'>";
		echo "<td  colspan='3' align='left'> &nbsp;&nbsp;<B>b. Se satisfeito: Sua satisfação é com relação.</B></td>";
		echo "</tr>";

		echo "<tr id = 'linha_11' bgcolor='#FFFFFF'>";
		echo "<td align='left'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i. Modo de usar o produto ";
		//echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='satisfeito_usar' id='satisfeito_usar' value='t' onclick=\"javascript:marcaLinha('linha_11');\"> Sim ";
		echo " <input type='radio' name='satisfeito_usar' id='satisfeito_usar_1' value='f' onclick=\"javascript:marcaLinha('linha_11');\"> Não</td>";
		echo "</tr>";

		echo "<tr id = 'linha_12' bgcolor='#e7e1d2'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ii. Manual de orientação ";
		echo "&nbsp;&nbsp;";
		echo "<input type='radio' name='satisfeito_manual' id='satisfeito_manual' value='t' onclick=\"javascript:marcaLinha('linha_12');\"> Sim ";
		...
		echo "<tr id = 'linha_13' bgcolor='#FFFFFF'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;iii. Consumo de energia ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='satisfeito_energia' id='satisfeito_energia' value='t' onclick=\"javascript:marcaLinha('linha_13');\"> Sim ";
		...
		echo "<tr id = 'linha_14' bgcolor='#e7e1d2'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;iv. Nível de ruído ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='satisfeito_barulho' id='satisfeito_barulho' value='t' onclick=\"javascript:marcaLinha('linha_14');\"> Sim ";
		...
		echo "<tr id = 'linha_15' bgcolor='#FFFFFF'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v. Cor do produto ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='satisfeito_cor' id='satisfeito_cor' value='t' onclick=\"javascript:marcaLinha('linha_15');\"> Sim ";
		echo " <input type='radio' name='satisfeito_cor' id='satisfeito_cor_1' value='f' onclick=\"javascript:marcaLinha('linha_15');\"> Não</td>";
		echo "</tr>";

		echo "<tr id = 'linha_16' bgcolor='#d2d7e1'>";
		echo "<td colspan='3' align='left'> &nbsp;&nbsp;<B>c. Se insatisfeito: Sua insatisfação é com relação.</B></td>";
		echo "</tr>";

		echo "<tr id = 'linha_17' bgcolor='#FFFFFF'>";
		echo "<td align='left'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i. Modo de usar o produto ";
		//echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='insatisfeito_usar' id='insatisfeito_usar' value='t' onclick=\"javascript:marcaLinha('linha_17');\"> Sim ";
		...
		echo "<tr id = 'linha_18' bgcolor='#e7e1d2'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ii. Manual de orientação ";
		echo "&nbsp;&nbsp;";
		echo "<input type='radio' name='insatisfeito_manual' id='insatisfeito_manual' value='t' onclick=\"javascript:marcaLinha('linha_18');\"> Sim ";
		...
		echo "<tr id = 'linha_19' bgcolor='#FFFFFF'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;iii. Consumo de energia ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='insatisfeito_energia' id='insatisfeito_energia' value='t' onclick=\"javascript:marcaLinha('linha_19');\"> Sim ";
		...
		echo "<tr id = 'linha_20' bgcolor='#e7e1d2'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;iv. Nível de ruído ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='insatisfeito_barulho' id='insatisfeito_barulho' value='t' onclick=\"javascript:marcaLinha('linha_20');\"> Sim ";
		...
		echo "<tr id = 'linha_21' bgcolor='#FFFFFF'>";
		echo "<td  align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v. Cor do produto ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='insatisfeito_cor' id='insatisfeito_cor' value='t' onclick=\"javascript:marcaLinha('linha_21');\"> Sim ";
		echo " <input type='radio' name='insatisfeito_cor' id='insatisfeito_cor_1' value='f' onclick=\"javascript:marcaLinha('linha_21');\"> Não</td>";
		echo "</tr>";

		echo "<tr id = 'linha_22' bgcolor='#e7e1d2'>";
		echo "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vi. Quebrou com pouco uso ";
		echo "&nbsp;";
		echo "<input type='radio' name='insatisfeito_quebra_uso' id='insatisfeito_quebra_uso' value='t' onclick=\"javascript:marcaLinha('linha_22');\"> Sim ";
		...
		echo "<tr>";
		echo "<td bgcolor='#d2d7e1' colspan='3' align='left'><B>Com relação ao atendimento da autorizada</B></td>";
		echo "</tr>";

		echo "<tr id = 'linha_23' bgcolor='#FFFFFF'>";
		echo "<td align='left'> &nbsp;&nbsp;a. O atendimento foi rápido ";
		echo "&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='atendimento_rapido' id='atendimento_rapido' value='t' onclick=\"javascript:marcaLinha('linha_23');\"> Sim ";
		...
		echo "<tr id = 'linha_24' bgcolor='#e7e1d2'>";
		echo "<td align='left'> &nbsp;&nbsp;b. O aspecto da loja, gerou confiança?";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='confianca' id='confianca' value='t' onclick=\"javascript:marcaLinha('linha_24');\"> Sim ";
		echo " <input type='radio' name='confianca' id='confianca' value='f' onclick=\"javascript:marcaLinha('linha_24');\"> Não</td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_25' bgcolor='#FFFFFF'>";
		echo "<td  align='left'> &nbsp;&nbsp;c. O problema foi resolvido ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='radio' name='problema_resolvido' id='problema_resolvido' value='t' onclick=\"javascript:marcaLinha('linha_25');\"> Sim ";
		...
		echo "<tr id = 'linha_26' bgcolor='#e7e1d2'>";
		echo "<td align='left'> &nbsp;&nbsp;d. De 0 a 10, qual nota daria ao posto autorizado? ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='text' name='nota' id='nota' value='' maxlength='2' size='3'> Nota </td>";
		echo "</tr>";
		
		echo "<tr id = 'linha_27' bgcolor='#FFFFFF'>";
		echo "<td align='left'> &nbsp;&nbsp;e. De 0 a 10, qual nota daria ao produto? ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<input type='text' name='nota_produto' id='nota_produto' value='' maxlength='2' size='3'> Nota </td>";
		echo "</tr>";
...
echo "<input type='hidden' name='os' id='os' value='$os'>";
		echo "<img src='imagens/btn_continuar.gif' style='cursor:pointer' onclick=\"javascript: if (document.frm_pesquisa_satisfacao.btn_gravar.value == '' ) { validaCampos(); } else { alert ('Aguarde submissão') }\" ALT='Confirmar pesquisa' border='0'>";
echo "</form>";
	}
}
