	...
	<tr>
		...
		<td valign="top" align="left">
			...
			<table width="100%" border="0" cellspacing="3" cellpadding="2">
				...
				<tr>
					<td align='center'>
						<font size="1" face="Geneva, Arial, Helvetica, san-serif"><? echo $cliente_cnpj ?></font>
					</td>
					<td align='center'>
						<font size="1" face="Geneva, Arial, Helvetica, san-serif"><? echo $cliente_nome ?></font>
					</td>
				</tr>
			</table>
...
?>
	<TR>
		<TD colspan="8">
			<img src='imagens/btn_imprimir.gif' onclick="javascript: window.open('os_print_manutencao.php?os_manutencao=<? echo $os_numero; ?>','os_manutencao');" ALT="Imprimir" border='0' style="cursor:pointer;">
