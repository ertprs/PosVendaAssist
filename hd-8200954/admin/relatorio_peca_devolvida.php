...
if (strlen ($btn_acao) > 0) {
	...
	if (strlen($codigo_posto) > 0){
		...
		if (pg_numrows($res) > 0){
			...
			$msg_erro = 'Posto '.$codigo_posto.' não está na lista de postos com exigência de devolução!';
		}
	}
...
<tr class="titulo_tabela">
	<td colspan='8' >Parâmetros de Pesquisa</td>
</tr>
<tr>
	<td width="60">&nbsp;</td>
...
<tr>
	<td colspan='8' ><center><input type='submit' name='btn_acao' value='Gerar Relatório'></center></td>
</tr>
</form>
</table>
...
?>
	...
	<tr class='titulo_tabela' >
		<td colspan='9' style="font-size:14px;"> <center>Relátorio do Mês <B><? echo $aux_mes; ?></B> Ano <b><? echo $ano; ?></b></center>
	</td>
	</tr>
...
?>
	...
	<table width='700' align='center' cellpadding='3' cellspacing='1' border='0' CLASS='tabela'>
	<tr CLASS='titulo_tabela'>
		<td colspan='8' style="font-size:14px;"> <center>Relátorio do Mês <B><? echo $aux_mes; ?></B> Ano <b><? echo $ano; ?></b> Posto <B><? echo $codigo_posto; ?></b></center></td>
	</tr>
	<tr CLASS='titulo_coluna'>
		<td >OS</td>
		<td >Extrato</td>
