	...
	for ($i = 0 ; $i < pg_numrows ($resPosto) ; $i++){
		...
		if($login_fabrica<>59){//hd 45740
			...
			if($login_fabrica ==3) {
				...
				if(isset($callcenter)) echo "<a href=\"javascript: posto_tab.value= '$posto'; codigo_posto_tab.value='$codigo_posto' ; posto_nome_tab.value='$nome' ; posto_this.close(); \">\n";
			}
			echo $nome ;
			echo "</a>";
			echo "</td>";
		...
		if(isset($callcenter)) {
			if($login_fabrica == 3) {
				...
				echo "<a href=\"javascript: posto_tab.value= '$posto'; codigo_posto_tab.value='$codigo_posto' ; posto_nome_tab.value='$nome' ; this.close(); \">\n";
			}
		}
		echo $nome_fantasia ;
		echo "</a>";
