...
/**
 *
 * relatorio_extratificacao_vdnf.php
 *
...
<script>
	var mes = null;
	function pareto(fabricacao, abertura, meses, familia, peca01, peca02, fornecedores, datas, produtos, pecas, posto) {
		...
		if( $("#sem_peca").is(":checked") ){
			...
			var url="relatorio_extratificacao_pareto_sem_peca_vdnf.php?ab=" + abertura + "&nf=" + fabricacao + "&fm=" + meses + "&f=" + familia + "&defeito=" + sem_peca + "&po=" + posto;
		}else{
			var url="relatorio_extratificacao_pareto_vdnf.php?nf=" + fabricacao + "&ab=" + abertura + "&fm=" + meses + "&fa=" + familia + "&p1=" + peca01 + "&p2=" + peca02 + "&fo=" + fornecedores + "&d=" + datas + "&pd=" + produtos + "&pc=" + pecas + "&po=" + posto;
		}
		...
		<table cellspacing="1" align="center" class="form">
			...
			<tr>
				<td colspan="2">
					...
					?>
                    <input type="checkbox" name="sem_peca" id="sem_peca" value="<?php echo $chk_sem_peca[$login_fabrica] ?>" class="frm" <?=$checked?> >
