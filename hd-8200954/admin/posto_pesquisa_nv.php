...
<html>
	...
	<body>
		...
		if (strlen($cnpj) > 2) {			
			...
			$cnpj = preg_replace('/[^0-9]/', '', $cnpj); /* retornar apenas dígitos, sem hífem: 01064811000119 */
			...
			echo "<div class='lp_pesquisando_por'>Pesquisando pelo Código do Posto: $codigo</div>";
			$sql = "SELECT  tbl_posto.posto,
							tbl_posto_fabrica.codigo_posto,
							tbl_posto.nome,
							tbl_posto.cnpj,
