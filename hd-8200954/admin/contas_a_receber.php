...
if (!in_array("analista_contas_receber", $permissoesLogin)) {
    exit("<div class='alert alert-danger'><h4>Apenas o analista de contas a receber tem acesso à esta tela</h4></div>");
}
?>
<script>
    ...
    $(function(){
        ...
        $(".visualiza-protocolo").click(function(){
            ...
            Shadowbox.open({
                content: "detalhe_protocolo.php?protocolo="+protocolo+"&tipo=contas_receber",
                player: "iframe",
...
<?php
    $dadosProtocolo = $classProtocolo->listaProtocolos(["status_protocolo.codigo = 'an_cr'"]);
