...
$title = "CONSULTA E MANUTENÇÃO DE PENDÊNCIA DE EXTRATOS";
...
echo "	</TD>\n";
echo "	<TD width=''  valign='bottom'>Data Final <br>";
...
echo "&nbsp;<img src='imagens/lupa.png' style='cursor: hand;' align='absmiddle' alt='Clique aqui para pesquisar postos pelo código' onclick=\"javascript: fnc_pesquisa_posto (document.frm_extrato.posto_codigo, document.frm_extrato.posto_nome,'codigo');\">";
echo "</td>";
echo "<td>";
echo "Nome do Posto <br>";
echo "<input type='text' name='posto_nome' id='posto_nome' size='30' value='$posto_nome' class='frm'>";
echo "&nbsp;<img src='imagens/lupa.png' style='cursor: hand;'' align='absmiddle' alt='Clique aqui para pesquisas postos pelo nome' onclick=\"javascript: fnc_pesquisa_posto (document.frm_extrato.posto_codigo, document.frm_extrato.posto_nome,'nome');\">";
...
echo "	<TD COLSPAN='4' ALIGN='center'>";
echo "Código Posto";
echo "<input type='radio' name='ordenar' id='ordenar' value='' "; if ($ordenar=="") echo " CHECKED "; echo " class='frm'>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
echo "Primeira interação: ";
echo "<input type='radio' name='ordenar' id='ordenar' value='data_primeira_interacao' "; if ($ordenar=="data_primeira_interacao") echo " CHECKED "; echo " class='frm'>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
echo "Última interação: ";
echo "<input type='radio' name='ordenar' id='ordenar' value='data_ultima_interacao' "; if ($ordenar=="data_ultima_interacao") echo " CHECKED "; echo " class='frm'>";
echo "</TD>";
echo "<TR>\n";
*/
echo "<tr><td colspan='4' align='center'>";
echo "<br><input type='button' style='background:url(imagens_admin/btn_filtrar.gif); width:75px; cursor:pointer;' value='&nbsp;' onclick=\"javascript: document.frm_extrato.btnacao.value='filtrar' ; document.frm_extrato.submit() \" ALT=\"Filtrar extratos\" border='0' style=\"cursor:pointer;\">\n";
echo "</td></tr>";
echo "</TABLE>\n";
...
//echo $sql;exit;
	...
	if (pg_numrows ($res) == 0) {
		...
		if ($download_pendencia == 't'){
			...
			#$arquivo_conteudo .= "<td><b>Tipo</b></td>";
			#$arquivo_conteudo .= "<td><b>Extrato</b></td>";
			#$arquivo_conteudo .= "<td><b>Data</b></td>";
			#$arquivo_conteudo .= "<td><b>Qtde. OS</b></td>";
			#$arquivo_conteudo .= "<td><b>Total Peça</b></td>";
			#$arquivo_conteudo .= "<td><b>Total MO</b></td>";
			#$arquivo_conteudo .= "<td><b>Total Avulso</b></td>";
			#$arquivo_conteudo .= "<td><b>Total Geral</b></td>";
			#$arquivo_conteudo .= "<td><b>NF Autorizado</b></td>";
			$arquivo_conteudo .= "</tr>";
