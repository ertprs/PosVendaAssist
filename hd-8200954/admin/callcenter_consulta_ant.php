...
$sql = "SELECT  tbl_callcenter.callcenter                                    ,
		...
		$sql .= " WHERE	tbl_callcenter.fabrica = $login_fabrica AND (1=2 ";
...
if(strlen($chk1) > 0){
	...
	$msg .= " e atendimentos lançados hoje";
...
if(strlen($chk2) > 0) {
	...
	$msg .= " e atendimento lançados ontem";
...
if(strlen($chk3) > 0){
	...
	$msg .= " e atendimentos lançados nesta semana";
...
if(strlen($chk4) > 0){
	...
	$msg .= " e atendimentos lançados neste mês ";
...
if(strlen($chk5) > 0){
	...
	if((strlen($data_inicial_01) == 10) && (strlen($data_final_01) == 10)){
		...
		$msg .= " e atendimentos lançados entre os dias $data_inicial_01 e $data_final_01 ";
	}
}
...
if(strlen($chk6) > 0){
	...
	if (strlen($codigo_posto) > 0){
		...
		$msg .= " e atendimentos lançados para o posto $nome_posto";
...
if(strlen($chk7) > 0){
	...
	if ($produto_referencia) {
		...
		$msg .= " e atendimentos lançados contendo o produto $produto_nome";
...
if(strlen($chk8) > 0){
	...
	if ($numero_serie) {
		...
		$msg .= " e atendimentos lançados contendo produtos com número de série $numero_serie";
...
if(strlen($chk9) > 0){
	...
	if ($nome_consumidor){
		...
		$msg .= " e atendimentos lançados para o consumidor $nome_consumidor";
...
if(strlen($chk10) > 0){
	...
	if ($cpf_consumidor){
		...
		$msg .= " e atendimentos lançados para o consumidor com CPF/CNPJ: $cpf_consumidor";
...
if(strlen($chk11) > 0){
	...
	if ($cidade){
		...
		$msg .= " e atendimentos lançados para a cidade $cidade";
...
if(strlen($chk12) > 0){
	...
	if ($uf){
		...
		$msg .= " e atendimentos lançados para o estado $estado";
...
if(strlen($chk13) > 0){
	...
	if ($numero_os){
		...
		$msg .= " e atendimentos lançados com OS número $numero_os";
...
if(strlen($chk14) > 0){
	...
	if ($nota_fiscal){
		...
		$msg .= " e atendimentos lançados com nota fiscal número $nota_fiscal";
...
if(strlen($chk15) > 0){
	...
	if ($callcenter){
		...
		$msg .= " e o atendimento de Callcenter número $callcenter";
...
//	echo "<br>".nl2br($sql);
	...
	//echo "<br></b>Total de Chamadas Concluídas: <b>".$concluida."</b></font>";
