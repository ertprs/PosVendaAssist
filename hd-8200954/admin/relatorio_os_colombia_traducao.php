...
if($sistema_lingua == "ES") $title = "Reporte de OS";
else                        $title = "Relatório Colômbia";
...
<tr class='topo'>
	<td colspan='2'>
	<?
	if($sistema_lingua == "ES") echo "Rellene los campos para hacer la búsqueda";
	else                        echo "Preencha os campos p/ efetuar a pesquisa";
	?>
	</td>
</tr>
<tr class='menu_top'>
	<td>
	<?
	if($sistema_lingua == "ES") echo "Código del Servicio Autorizado";
	else                        echo "Código do Posto";
	?>
	</td>
	<td>
	<?
	if($sistema_lingua == "ES") echo "Nombre del Servicio Autorizado";
...
<tr class='menu_top' bgcolor="#D9E2EF">
	<td>
	<?
	if($sistema_lingua == "ES") echo "País";
	else                        echo "País";
// MLG 2009-08-04 HD 136625
    $sql = 'SELECT pais,nome FROM tbl_pais';
    $res = pg_query($con,$sql);
...
//exit;
	...
	if ($numero_registros > 0) {
		...
		echo "<td align='center'<font face='Arial, Verdana, Times, Sans' size='2' color='#000000'>";
			if($sistema_lingua == "ES") echo "Bajar en formato texto (columnas separadas con TABULACIÓN)";
			else                        echo "Downalod em formato TXT (Colunas separadas com TABULAÇÃO)";
		echo "</font><br><a href='xls/$arquivo_nome.zip'><font face='Arial, Verdana, Times, Sans' size='2' color='#0000FF'>"
			if($sistema_lingua == "ES") echo "Haga un click para bajar el archivo";
			else                        echo "Clique aqui para fazer o download";
		echo "</font></a>";
		echo "</td>";
		echo "</tr>";
		echo "</table>";
		...
		echo "<br><center>";
		if($sistema_lingua == "ES") echo "¡Ningún resultado encontrado!";
