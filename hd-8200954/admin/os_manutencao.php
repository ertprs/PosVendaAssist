...
if ($btn_acao == "gravar") {
	...
	if (strlen($_POST['posto_codigo']) > 0) {
		...
		$msg_erro .= "Posto $posto_codigo não localizado";
		$posto = "null";
	}
	...
	if (strlen ($msg_erro) == 0) {
		...
		if(strlen($os_manutencao) > 0 AND strlen($msg_erro) ==0){
			$sql = "SELECT fn_valida_os_revenda ($os_manutencao,$posto,$login_fabrica)";
			$res = @pg_exec ($con,$sql);
			$msg_erro = pg_errormessage($con);
		}
...
<script language="JavaScript">
	...
	$(function(){
		...
		$("#cliente_fone").maskedinput("(99) 9999-9999");
		$("#revenda_fone").maskedinput("(99) 9999-9999");
		$("#cliente_cep").maskedinput("99999-999");
		$("#revenda_cep").maskedinput("99999-999");
	});
		...
		<td valign="top" align="left">
			...
			<table width="100%" border="0" cellspacing="3" cellpadding="2">
				...
				<tr>
					...
					<td align='center'>
						<input class="frm" type="text" name="posto_nome" onblur="busca_valores();" size="50" value="<? echo $posto_nome ?>" >&nbsp;<img src='imagens_admin/btn_lupa.gif' border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_posto (document.frm_os.posto_codigo,document.frm_os.posto_nome,'nome')" style="cursor:pointer;"></A>
					</td>
				</tr>
			</table>
<!-- CLIENTE -->
		...
		<div id='tbl_cliente' <?=$esconde_cliente?>>
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2">
				...
				<tr class='table_line3'>
					...
					<td >
						Telefone<br>
						<input class="frm" type="text" name="cliente_fone" id='cliente_fone' size="18" maxlength="18" value="<? echo $cliente_fone ?>">
					</td>
					<td>Distância (KM)<br>
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2">
				<tr class='table_line3'>
					...
					<td >CEP<br>
						<input class="frm" type="text" name="cliente_cep" id='cliente_cep' size="10" maxlength="10" value="<? echo $cliente_cep ?>" onBlur="buscaCEP(this.value, document.frm_os.cliente_endereco, document.frm_os.cliente_bairro, document.frm_os.cliente_cidade, document.frm_os.cliente_estado)">
					</td>
					<td >Bairro<br>
...
<!-- Revenda -->
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2">
				...
				<tr class='table_line3'>
					...
					<td>
						Fone<br>
						<input class="frm" type="text" name="revenda_fone" id='revenda_fone' size="18" maxlength="18" value="<? echo $revenda_fone ?>">
					</td>
					<td>
						E-Mail<br>
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2">
				<tr class='table_line3'>
					...
					<td>CEP<br>
						<input class="frm" type="text" name="revenda_cep" id='revenda_cep' size="10" maxlength="10" value="<? echo $revenda_cep ?>" onBlur="buscaCEP(this.value, document.frm_os.revenda_endereco, document.frm_os.revenda_bairro, document.frm_os.revenda_cidade, document.frm_os.revenda_estado)">
					</td>
					<td>Bairro<br>
...
for ($i=0; $i<$qtde_item; $i++) {
	...
	echo "<td align='center'><input class='frm' type='text' name='produto_referencia_$i' onBlur='busca_valores_produto($i);busca_valores();' rel='produtos' size='8' maxlength='50' value='$produto_referencia'><img src='imagens_admin/btn_lupa.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_produto (document.frm_os.produto_referencia_$i,document.frm_os.produto_descricao_$i,\"referencia\",document.frm_os.produto_voltagem_$i,document.frm_os.produto_capacidade_$i)' style='cursor:pointer;'></td>\n";
	echo "<td align='center'><input class='frm' type='text' name='produto_descricao_$i' onBlur='busca_valores_produto($i);busca_valores();' size='30' maxlength='18' value='$produto_descricao'><img src='imagens_admin/btn_lupa.gif' border='0' align='absmiddle' onclick='javascript: fnc_pesquisa_produto (document.frm_os.produto_referencia_$i,document.frm_os.produto_descricao_$i,\"descricao\",document.frm_os.produto_voltagem_$i,document.frm_os.produto_capacidade_$i)' style='cursor:pointer;'></td>\n";
	echo "<td align='center'><input class='frm' type='text' name='produto_serie_$i'  size='7'  maxlength='20'  value='$produto_serie' onFocus='busca_valores_produto($i);busca_valores();'></td>\n";
	echo "<td align='center'><input class='frm' type='text' name='produto_capacidade_$i'  size='5'  maxlength='20'  value='$produto_capacidade' onFocus='busca_valores_produto($i);busca_valores();'></td>\n";
