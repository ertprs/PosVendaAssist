...
if($_GET['ajax']=='sim') {
	...
	$resposta .="</td>";
	$resposta .="<td class='titulo' colspan='5' align='right'>";
	$resposta .="<input type='submit' name='baixar_sel' value='Baixar Selecionados' class='frm'> ";
	$resposta .="</td>";
	$resposta .="</tr>";

	$resposta .="<tr class='Titulo2' >";
	$resposta .="<td colspan='9' align='left' background='admin/imagens_admin/azul.gif'><font size='3' color='#ffffff'>LISTAS DE CONTAS A PAGAR</font></td>";
	$resposta .="</tr>";
	$resposta .="<tr class='Titulo2'>";
	...
	if(pg_numrows($res)>0){
		for ( $i = 0 ; $i < pg_numrows ($res) ; $i++ ) {
			...
			$resposta .="<tr bgcolor='$cor' class='Conteudo2' id='linha_$i'>";
			...
			$resposta .="<td nowrap align='center' onclick=\"javascript:selecionarLinha($i,'$cor')\" style='cursor:pointer'>";
