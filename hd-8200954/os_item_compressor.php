...
//TAKASHI 26/10
	...
	//COMPRESSOR TEM UM DIFERENCIAL
		...
		echo "<tr>";
		echo "<td nowrap colspan='3'><B><font size='2' face='Geneva, Arial, Helvetica, san-serif'>VALORES
		ADICIONAIS</font></b></td>";
		echo "</tr>";
		echo "<tr>";
		echo "<td nowrap><font size='1' face='Geneva, Arial, Helvetica, san-serif'>Deslocamento</font><br><INPUT
		TYPE='text' NAME='qtde_km' value='$qtde_km' size='10' maxlength='10' class='frm'> <font size='1'
face='Geneva,Arial, Helvetica, san-serif'>Km</font></td>";
		echo "<td nowrap width='300'><font size='1' face='Geneva, Arial, Helvetica, san-serif'>Tempo de
Serviço</font><br><INPUT TYPE='text' NAME='qtde_hora' value='$qtde_hora' size='10' maxlength='10' class='frm'>	
		<font size='1' face='Geneva, Arial, Helvetica, san-serif'>Minutos (ex. 1:20hrs = 80min)</font></td>";
		echo "<td nowrap><font size='1' face='Geneva, Arial, Helvetica, san-serif'>Despesas
		adicionais<br>R$ </font><INPUT TYPE='text' NAME='valores_adicionais' value='$valores_adicionais' size='10'
maxlength='10' class='frm'></td>";
		echo "</tr>";
	echo "</table>";*/
	...
	$flag = pg_numrows($res);
		...
		echo "<BR><table class='border' width='100%' align='center' border='0' cellpadding='1' cellspacing='3'>\n";
		echo "<tr>\n";
...
//TAKASHI 26/10
		if($compressor=='t'){
	echo "<table class='border' width='500' align='center' border='0' cellpadding='1' cellspacing='3'>";
		echo "<tr>";
		echo "<td class='menu_top'><font size='1' face='Geneva, Arial, Helvetica, san-serif'>Relatório do Técnico</font></td>";
		echo "</tr>";
		echo "<tr>";
		echo "<TD class='table_line'><TEXTAREA NAME='tecnico' ROWS='3' COLS='100' class='frm'>$tecnico</TEXTAREA></TD>";
		echo "</tr>";
		echo "</table><BR>";
}
//TAKASHI 26/10
