...
// HD 350051 - Obrigatoriedade para as que exigem imagem da NF.
    ...
    } else if($login_fabrica <> 42) {//PARA OUTRAS FÁBRICAS SETA NULL
...
/*            if ($login_fabrica == 5 and strlen($causa_defeito) == 0)
        ...
        if ($login_fabrica == 6 or
            ($login_fabrica == 15 and
             in_array($login_posto,array(6359,10950,10952,20235,2405,5551,12008,11946,11467,10806,11958,11946,11471,11732)))           ) { //HD 2599, 15180, 11/12/09-HD 183336
...
<!-----------HD 341319 FIM---------->
            ...
            <?php
                if ($anexaNotaFiscal and (!temNF($os, 'bool') and !temNF($os, 'bool', 2))) {
                    echo "<td><a style='font-size:9pt' href='javascript:$(\"input[name=foto_nf]\").focus();'>";
...
<?
        ...
        echo "<td align='center'><b>Serviço</b></td>";
...
if ($login_fabrica==6 or ($login_fabrica == 15 and in_array($login_posto, array(6359,10950,10952,20235,2405,5551,12008,11946,11467,10806,11958,11946,11471,11732)) and $consumidor_revenda == 'R')){
    ...
    <?php
        if ($anexaNotaFiscal) {
			if (!temNF($os, 'bool')) {
				...
				if (count(temNF($os, 'path'))<LIMITE_ANEXOS)
					echo $inputNotaFiscal;
			}
?>	</td>
