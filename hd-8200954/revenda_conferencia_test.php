...
//					$teste .= "<br>$sql";
	...
	$resposta .= "\n <br><div class='msg_erro'>LOTE JÁ CONFERIDO, NÃO É POSSÍVEL LANÇAR PRODUTOS</div><br>\n";
...
if($_GET['ajax']=='sim' AND $_GET['acao']=='ver') {
	...
	if($conferencia !='nao_mostra'){
		...
		if ( $conferencia=='parcdevolvido') {
			...
			$sql_add1 = "and (tbl_lote_revenda_item.qtde - tbl_lote_revenda_item.conferencia_qtde) >0
				and tbl_os.data_nf_saida is not null
							AND (
							(
							/*SUBSELECT CORRESPONDE À QTDE_ITENS DA LEGENDA*/
							...
							-
							(
							/*SUBSELECT CORRESPONDE À ITEM_DEVOLVIDO DA LEGENDA*/
								SELECT count(*) 
								FROM tbl_os
								JOIN tbl_os_revenda_item ON tbl_os.os = tbl_os_revenda_item.os_lote
								JOIN tbl_os_revenda      USING(os_revenda)
		...
		$totalResultado = pg_numrows($res);

	}
		$resposta  .=  '<table align="center" width="700" cellspacing="1" class="formulario">';
		$resposta  .=  "<tr>";

		$resposta  .=  "<td align='left'>";
		$resposta  .=  '<table align="center" width="700" cellspacing="1" class="formulario">';
		$resposta  .=  "<tr class='titulo_coluna' height='25'>";
		$resposta  .=  "<td align='left'><strong>Sistema de Revendas</strong></td>";
		$resposta  .=  "</tr>";
		/*
		...
		$resposta  .=  "<TD style='text-align:justify'>
			...
			A TELECONTROL estão desenvolvendo um meio de informação centralizada para gerenciamento do fluxo de produtos entre a REVENDA <-> REDE AUTORIZADA & REVENDA <-> FÁBRICA.<br>
		...
		*/
		...
		$resposta  .=  '<table align="center" width="700" cellspacing="1" class="formulario">';
		$resposta  .=  "<tr class='subtitulo'  height='25'>";
		$resposta  .=  "<td align='left' colspan='6'><b>Legenda</b></td>";
		$resposta  .=  "</tr>";
		$resposta  .=  '<tr bgcolor="#d9e2ef">';
		$resposta  .=  "<td align='left'><img src='admin/imagens_admin/status_vermelho.gif' title='à receber'> <a href='javascript:mostrar_treinamento(\"dados\",\"&conferencia=areceber\");'style='font-size:10px;'>À receber</a></TD>";
		...
		$resposta  .=  "<TD align='left' valign='top'><img src='admin/imagens_admin/status_rosa.gif' title='Orçamento'> <a href='javascript:mostrar_treinamento(\"dados\",\"&conferencia=orcamento\");'style='font-size:10px;'>Orçamento</a></TD>";
		$resposta  .=  "</TR>";
		$resposta  .= "</table>";
		...
		$resposta  .=  '<table align="center" width="700" cellspacing="1" class="formulario">';
		$resposta  .=  "<tr class='subtitulo'  height='25'>";
		$resposta  .=  '<td align="left" colspan="2"><b>'.$situacao.'</b></td>';
		$resposta  .=  "</tr>";
		$resposta  .=  '<tr bgcolor="#d9e2ef">';
		$resposta  .=  "<td align='left'><input type='button' onclick='mostrar_treinamento(\"dados\",\"\");' value='Ver todas as notas fiscais' /></td>";
		$resposta  .=  "<td align='left'><input type='button' onclick='mostrar_treinamento(\"dados\",\"&conferencia=recebido\");' value='Ver notas fiscais a receber' /></td>";
		$resposta  .=  "</tr>";

		$resposta  .=  '<tr bgcolor="#d9e2ef">';
		$resposta  .=  "<td align='left'><input type='button' onclick='mostrar_treinamento(\"dados\",\"&conferencia=explodido\");' value='Ver notas fiscais explodidas em OS' /></td>";
		$resposta  .=  "<td align='left'><input type='button' onclick='mostrar_treinamento(\"dados\",\"&conferencia=nao_explodido\");' value='Ver notas fiscais não explodidas em OS' /></td>";
	...
	if ($totalResultado > 0 ) {
		...
		$resposta  .=  "<TR class='titulo_coluna'  height='25'>";
		$resposta  .=  "<TD><b>Revenda</b></TD>";
		$resposta  .=  "<TD><b>Código Lote</b></TD>";
		$resposta  .=  "<TD><b>Lote OS</b></TD>";
		$resposta  .=  "<TD><b>Nota Fiscal</b></TD>";
		$resposta  .=  "<TD><b>Data NF</b></TD>";
		$resposta  .=  "<TD><b>Recebido</b></TD>";
		$resposta  .=  "<TD><b>Explodido</b></TD>";
		...
		for ($i=0; $i<$totalResultado; $i++){
			...
			else                         $situacao = "<img src='admin/imagens_admin/status_vermelho.gif' title='à receber'>";
			...
			if($oa>0)$situacao = "<img src='admin/imagens_admin/status_rosa.gif' title='Orçamento Aprovado'>";
	...
	}elseif(pg_numrows($res) == 0 && $conferencia =='nao_mostra' && $login_fabrica == 3){

		$resposta  .=  "<br />";
		$resposta  .=  '<table align="center" width="700" cellspacing="1" class="formulario">';
		$resposta  .=  "<tr class='titulo_coluna'>";
		$resposta  .=  "<td align='center'>";
		$resposta  .=  "<b>Selecione uma legenda ou alguns links de Notas Fiscais</b>";
		$resposta  .=  "</td>";
		$resposta  .=  "</tr>";
		$resposta  .=  "</table>";
		...
		$resposta  .=  '<table align="center" width="700" cellspacing="1" class="formulario">';
		$resposta  .=  "<tr>";
		$resposta  .=  "<td align='center' class='texto_avulso'>Não foram Encontrados Resultados para esta Pesquisa</td>";
		$resposta  .=  "</tr>";
		$resposta  .=  "<tr>";
		$resposta  .=  "</tr>";
		$resposta  .=  "</table>";
		$resposta  .=  "<br /><div align='center'><input type='button' onclick='mostrar_treinamento(\"dados\",\"&conferencia=recebido\");' value='Ver outro lote' /></div>";
	}
...
if($_GET['ajax']=='sim' AND $_GET['acao']=='detalhes_os') {
	...
	if ($totalResultado > 0) {
		...
		$resposta .=  "<tr align='center'class='titulo_coluna'>\n";
		$resposta .=  "<td height='20'>OS</td>\n";
		$resposta .=  "<td height='20'>Produto</td>\n";
		$resposta .=  "<td height='20'>Situação</td>\n";
		$resposta .=  "<td height='20' colspan='2'>Nota Fiscal de Devolução</td>\n";
		$resposta .=  "</tr>\n";
		...
		for ($i=0; $i<$totalResultado; $i++){
			...
			else                     $situacao .= "<li> <font color='#FF0000'>Não gerou OS</font></li>";
			if(strlen($finalizada)>0)$situacao .= "<Li> OS finalizada</li>";
			else                     $situacao .= "<Li> OS não foi finalizada</li>";
			if($total==0)            $situacao .= "<li> Nenhuma peça lançada</li>";
			else                     $situacao .= "<li> Foram lançadas $total peça(s)</li>";
			...
			$resposta .= "$situacao";
			$resposta .= "</td>\n";
#Comentado por Thiago Contardi, não entendi o porquê que está fechando um link </a> então deixei comentado
//			$resposta .= "</a></td>\n";

			if(strlen($os_sua_os)>0){
				$resposta .= "<td align='left'>";
				$resposta .= "Número<br><input name='nf_$i' type='text' class='Caixa' size='10' value='$nota_fiscal_saida' maxlength='6'>";
				...
				$resposta .= "<td align='left' colspan='2'> É necessário gerar OS</td>";		
			}
...
if($_GET['ajax']=='sim' AND $_GET['acao']=='formulario') {
	...
	$resposta .= '<table align="center" width="700" cellspacing="1" class="tabela">\n';
	$resposta .=  "<thead>\n";
	$resposta .=  "<tr align='left' class='titulo_coluna'>\n";
	$resposta .=  "<td bgcolor='#BCCBE0' colspan='3' style='font-size:18px'>\n";
	$resposta .=  "<b>&nbsp;<b>Recebimento do Lote Código $lote </b><br>\n";
	$resposta .=  "</td>\n";
	$resposta .=  "<td align='center' onmouseover=\"this.style.backgroundColor='#FFFFDD';this.style.cursor='hand';\" onmouseout=\"this.style.backgroundColor='#e6eef7';\">
	<input type='button' value='Voltar' onclick='mostrar_treinamento(\"dados\",\"&conferencia=recebido\");' /></td>\n";
	$resposta .=  "</tr>\n";
	...
	if(strlen($data_recebido)==0) $resposta .= "Não foi recebido";
	else                          $resposta .= $data_recebido;
	$resposta .= "</b> </td>\n";		
	$resposta .= "<td>Explodido <br> <b>";
	if(strlen($data_explodido)==0) $resposta .= "Não foi explodido";
	...
	if ($qtde > 0) {
		...
		$resposta .=  "<td width='80' height='20'><b>Código</b></td>\n";
		...
		$resposta .=  "<td width='100'><b>Qtde Recebida <acronym title='Este campo é necessário informar a quantidade real recebida'>[?]</acronym></b></td>\n";
		$resposta .=  "</tr>\n";
		...
		if($conferencia<>'t' OR strlen($conferencia)==0) {
			...
			$resposta .= "<tr class='titulo_coluna'>";
			$resposta .= "<td align='left' colspan='4' height='20'><b>Produto recebidos que não constam no Lote</b></td>";
			$resposta .= "</tr>";
			...
			$resposta .= "<tr><td colspan='4'>";
				...
				$resposta .= '<table align="center" width="700" cellspacing="1" class="tabela">\n';
				$resposta .= "<tr>\n";
				$resposta .= "<td align='center' class='Conteudo' width='200'>Código <input class='Caixa' type='text' name='add_referencia' id='add_referencia' size='8' value='' onblur=\" fnc_pesquisa_produto (window.document.frm_os.add_referencia, window.document.frm_os.add_peca_descricao, 'referencia',window.document.frm_os.voltagem.value); \">\n";
				...
				$resposta .= "<td align='center' class='Conteudo' nowrap>Descrição <input class='Caixa' type='text' name='add_peca_descricao' id='add_peca_descricao' size='40' value='' >\n";
			...
			$resposta .= '<table align="center" width="700" cellspacing="1" class="tabela">\n';
			$resposta .= "<thead>\n";
			$resposta .= "<tr height='20' class='titulo_coluna'>\n";
			$resposta .= "<td align='center' class='Conteudo'><b>Código</b></td>\n";
			$resposta .= "<td align='center' class='Conteudo'><b>Descrição</b></td>\n";
			$resposta .= "<td align='center' class='Conteudo'><b>Qtde</b></td>\n";
			$resposta .= "<td align='center' class='Conteudo'><b>Ações</b></td>\n";
			$resposta .= "</tr>\n";
			$resposta .= "</thead>\n";
			//$resposta .= "<tbody></tbody>\n";
			$resposta .= "<tfoot>\n";
			$resposta .= "<tr height='12' class='subtitulo'>\n";
			$resposta .= "<td align='center' colspan='2'><b>Total</b></td>\n";
			$resposta .= "<td align='center'><span style='font-weight:bold' id='valor_total_itens'>0</span></td>\n";
		...
		if($conferencia<>'t' OR strlen($conferencia)==0) {
			$resposta  .= "<br><center><input type='button' value='VER OUTROS LOTES' onclick='mostrar_treinamento(\"dados\",\"&conferencia=recebido\");' /></center><br>";
			$resposta .= "<div id='saida' style='display:inline;'></div><div id='erro' class='msg_erro' style='display:inline;'></div>";
		}else{
			$resposta .= "<br><div class='msg_erro'>LOTE JÁ CONFERIDO, NÃO É POSSÍVEL LANÇAR PRODUTOS</div><br>";
			$resposta .= "<br /><div id='saida' style='display:inline;'></div><div id='erro' class='msg_erro' style='display:inline;'></div>";

			if(strlen($data_explodido)==0){
				$resposta .= "<input type='button' name='btn_explodir'  value='Explodir' onClick=\"if (this.value!='Explodir'){ alert('Aguarde');}else {this.value='Executando...'; window.location = '$PHP_SELF?explodir=$lote_revenda';}\" style=\"width: 150px;\" class='Explodir'>";
			}else{
				$resposta .= "<div class='msg_erro'>LOTE JÁ EXPLODIDO</div><br>";
				$resposta  .= "<br><center><input type='button' value='VER OUTROS LOTES' onclick='mostrar_treinamento(\"dados\",\"&conferencia=recebido\");' /></center><br>";
				$sql = "SELECT DISTINCT
				...
				if ($totalResposta > 0) {
					...
					$resposta .=  "<tr align='center' class='titulo_coluna'>\n";
					$resposta .=  "<td height='20' colspan='3'>Não geraram OS</td>\n";
					$resposta .=  "</tr>\n";

					$resposta .=  "<tr align='center' class='subtitulo'>\n";
					$resposta .=  "<td height='20'><b>OS Revenda</b></td>\n";
					$resposta .=  "<td height='20'><b>Situação</b></td>\n";
					...
					for ($i=0; $i<$totalResposta; $i++){
						...
						*/
						...
						else                     $situacao = "Não gerou OS";
						if(strlen($finalizada)>0)$situacao = "OS finalizada";

						$cor = ($i % 2) ? "#F7F5F0" : "#F1F4FA";

						$resposta .= "<tr bgcolor='".$cor."'>\n";
						$resposta .= "<td align='left' style=';cursor:pointer' onclick=\"javascript:MostraEsconde('dados_$i','$os_revenda','visualizar_$i','$cor');\"><img src='imagens/mais.gif' id='visualizar_$i' style='cursor: pointer' align='absmiddle'>";
						$resposta .= "$sua_os</a>";
						$resposta .= "</td>\n";
						$resposta .= "<td align='left'>";
						$resposta .= "$situacao";
						...
						$resposta .=  "<tr heigth='1' class='subtitulo' bgcolor='$cor'><td colspan='4'>";
				...
				if (@pg_numrows($res) > 0) {
					...
					$resposta .=  "<tr align='center' class='titulo_coluna'>\n";
					$resposta .=  "<td height='20' colspan='6'>Devolução</td>\n";
					$resposta .=  "</tr>\n";
					...
					$resposta .=  "<td height='20' rowspan='2'><b>Situação</b></td>\n";
					$resposta .=  "<td height='20' colspan='2'><b>Nota Fiscal de Devolução</b></td>\n";
					$resposta .=  "</tr>\n";

					$resposta .=  "<tr align='center' class='subtitulo'>\n";
					$resposta .=  "<td>Número</td>\n";
					$resposta .=  "<td>Data</td>\n";
					$resposta .=  "</tr>\n";
					...
					for ($i=0; $i<@pg_numrows($res); $i++){
						...
						if (strlen($solucao_os)==0)$situacao.="<li> OS sem solução</li>";
						if($total==0)            $situacao .= "<li> Nenhuma peça lançada</li>";
						else                     $situacao .= "<li> Foram lançadas $total peça(s)</li>";
						...
						$cor_da_letra       = "#000000";
						$hint_os            = "";
						# se já digitou, nao permite mudar a nota fiscal
						if (strlen($nota_fiscal_saida)>0 AND strlen($finalizada)>0){
							...
							if (strlen($solucao_os)==0){
								$hint_os = "title='OS sem solução. Abra a OS e preencha!'";
							}
						}
						...
						$resposta .= "<tr id='$i' bgcolor='$cor' style='color:$cor_da_letra ; align:left ; font-size:10px ' $hint_os>\n";
	...
	$resposta .= "</form>";
	$resposta .= "<div id='erro' class='msg_erro' name='erro'></div>";
	echo "ok|?".$resposta;
	exit;
...
$layout_menu = "os";
$title = "Conferência de Lote de Revenda";
