...
define('ENV','production');  // producao Alterar para produção ou algo assim
	...
	if ($logs_erro) {
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS Ferragens Negrão", $logs_erro);
