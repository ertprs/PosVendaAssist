...
$sql_embarque_garantia = "
	...
	JOIN tbl_pedido_item USING(pedido,peca,qtde)
	JOIN tbl_os_produto using(os_produto)
	WHERE fabrica in (25,10,114,81,122)
	AND distribuidor =4311
	AND data >'2010-04-30'
	AND fabrica_i in (10,25,114,81,122)
	AND tbl_os_produto.os = 32371818
	$cond
	...
	WHERE (fabrica in (114,25,81,122))
