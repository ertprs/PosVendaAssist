 ...
 *
 * Importação de lista basica de produtos passando a fabrica
 *
 */
		...
		if (filesize($err_log) > 0) {
			...
			if ($retorno == 0) {
				...
				if (!$mail->Send()) {
					...
					echo "Não foi possível fazer a importação da Lista Básica.<br / >Verifique o arquivo de log enviado no e-mail < $email_admin >";
