        ...
        if ($rows > 0) {
            for ($i = 0; $i < $rows; $i++) {
              ...
              if (strlen(imap_last_error()) > 0) {
					// imap_errors() é chamada aqui para limpar a pilha de erros - https://www.php.net/manual/en/function.imap-errors.php
					$imap_errors = imap_errors();
                    throw new Exception("Erro ao tentar iniciar conexão com o email: $username. Erro: $imap_errors[0]\n");
                }
                ...
                if(is_array($emails)) {
                    ...
                    foreach($emails as $email_number) {
                        ...
                        if ($fabrica == 186) {
                            $titulo   = (!empty($overview[0]->subject)) ? $overview[0]->subject : "[E-MAIL SEM TÍTULO]";
                            $titulo   = " <b>TÍTULO: ".iconv_mime_decode(preg_replace('/<.+$/','',$titulo))."</b> ";
