    ...
    */
    ...
    $sqlChamado = "SELECT
        ...
        WHERE tbl_hd_chamado.status <> 'Resolvido'
          ...
          AND tbl_hd_chamado.tipo_chamado = 1
          ...
          AND tbl_hd_chamado.previsao_termino = current_date + interval '2 day'";
    ...
    if (pg_num_rows($resChamado) > 0) {
      ...
      $chamados .= "<br>
        ...
        $mensagem = "Os seguintes chamados de <b>Alteração de Dados</b>, vencerão o prazo daqui 2 dias. <b style='color:#ff0000;'>Favor Priorizar!</b> <br>";
        ...
        Log::envia_email($email_admin,"CHAMADOS PENDENTES  DE ALTERAÇÃO DE DADOS, COM PRAZO DE VENCIMENTO EM 2 DIAS",$mensagem);
    }
