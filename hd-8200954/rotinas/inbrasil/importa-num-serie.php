<?php
/*
 * @description Importa numero de sÃ©rie - inbrasil - HD 250208
 * @author Brayan L. Rastelli
 */

define('APP','Importa Número de Série - Inbrasil'); // Nome da rotina, para ser enviado por e-mail
define('ENV','dev'); // Em produÃ§Ã£o alterar para producao e em desenvolvimento para dev
