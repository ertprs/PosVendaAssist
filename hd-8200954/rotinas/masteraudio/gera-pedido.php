...
try {
    ...
    $sql = "SELECT  
						...
						tbl_os.sua_os      ,
					       tbl_os.os	
						INTO TEMP tmp_pedido_masteraudio
				FROM    tbl_os_item
				...
				SELECT DISTINCT posto, linha from tmp_pedido_masteraudio ;
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - Master Audio - Erro na geração de pedido(gera-pedido.php)", $msg);
}?>
