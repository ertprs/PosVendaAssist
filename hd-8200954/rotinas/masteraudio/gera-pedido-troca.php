...
try {
    ...
    $arquivo_err = "/tmp/masteraudio/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/masteraudio/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/masteraudio/ 2> /dev/null ; chmod 777 /tmp/masteraudio/" );
	...
	if ($logs_erro) {
		...
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS Master Audio", $logs_erro);
