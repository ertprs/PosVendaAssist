...
try {
    ...
    if (strlen($bug) > 0) {
        ...
        Log::envia_email($vet, 'Log - Extrato masteraudio', $bug);

    }

} catch (Exception $e) {

    Log::envia_email($data,Date('d/m/Y H:i:s')." - masteraudio - Erro na geração de extrato(gera-extrato.php)", $e->getMessage());
