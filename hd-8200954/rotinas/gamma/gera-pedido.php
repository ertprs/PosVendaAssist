...
try {
    ...
    $data['login_fabrica'] 	= 124;
    $data['fabrica_nome'] 	= 'gamma';
    ...
    $phpCron = new PHPCron($data['login_fabrica'], __FILE__); 
	$phpCron->inicio();  
    ...
    $sql = "SELECT  
				...
				SELECT DISTINCT posto, os, linha from tmp_pedido_gamma ;
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - gamma - Erro na geração de pedido(gera-pedido.php)", $msg);
}?>
