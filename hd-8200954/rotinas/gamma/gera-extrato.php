...
try {
    ...
    #$dia_extrato = '2014-02-01 00:00:00';
    ...
    if (strlen($bug) > 0) {
        ...
        Log::envia_email($vet, 'Log - Extrato gamma', $bug);
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - gamma - Erro na geração de extrato(gera-extrato.php)", $e->getMessage());
