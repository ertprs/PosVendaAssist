	...
	if (file_exists($arquivo) and (filesize($arquivo) > 0)) {
		...
		foreach ($conteudo as $linha) {
			if (!empty($linha)) {
				...
				/*
				Referência	Referencia da peça - tamanho máximo de 20 caracteres - sem caracteres especiais
				Descrição	Descrição da peça - tamanho máximo de 50 caracteres - sem caracteres especiais
				Unidade	Unidade de medida da peça. EX: PC ou UM
				Origem	NAC ou IMP
