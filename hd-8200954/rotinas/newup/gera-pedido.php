...
try {
    ...
    $sql = "SELECT   DISTINCT 
				...
				SELECT DISTINCT posto,linha from tmp_pedido_newup ;
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - newup - Erro na geração de pedido(gera-pedido.php)", $msg);
}?>
