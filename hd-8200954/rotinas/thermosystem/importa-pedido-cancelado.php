<?php
	define('APP','Importa Pedido Cancelado - Thermo System'); // Nome da rotina, para ser enviado por e-mail
	...
	try {
		...
		$file = 'pedido-cancelado.txt';

		if ( ENV == 'testes' ) {
			$dir 	= '/home/ronald/perl/'.$vet['fabrica'].'/entrada';
		} else {
			$dir 	= '/home/' . $vet['fabrica'] . '/hydratelecontrol';
		}
		...
		$sql = "DROP TABLE IF EXISTS ".$vet['fabrica']."_cancelado;
				...
				COPY ".$vet['fabrica']. "_cancelado FROM stdin DELIMITER ';'";
