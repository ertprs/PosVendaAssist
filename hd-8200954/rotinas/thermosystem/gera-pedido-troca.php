...
try {
    ...
    $arquivo_err = "/tmp/thermosystem/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/thermosystem/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/thermosystem/ 2> /dev/null ; chmod 777 /tmp/thermosystem/" );
