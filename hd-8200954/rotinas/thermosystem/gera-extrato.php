...
try {
	...
	if (strlen($bug) > 0) {
		...
		Log::envia_email($vet, 'Log - Extrato thermosystem', $bug);
	...
	Log::envia_email($data,Date('d/m/Y H:i:s')." - ThermoSystem - Erro na geração de extrato(gera-extrato.php)", $e->getMessage());
