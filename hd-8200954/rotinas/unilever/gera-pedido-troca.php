...
try {
    ...
    $arquivo_err = "/tmp/unilever/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/unilever/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/unilever/ 2> /dev/null ; chmod 777 /tmp/unilever/" );
    ...
    if ($logs_erro) {
        Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS UNILEVER", $logs_erro);
    }
