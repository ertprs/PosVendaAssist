<?php
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro Abastecimento de Estoque - Tecvoz")); // Titulo
//     $logClass->adicionaEmail("alberico@tecovz.com.br");
    ...
    if($postos_controlam_estoque != false){
        ...
        foreach ($postos_controlam_estoque as $value) {
            ...
            try{
                ...
                $emails = array('alberico@tecovz.com.br.');
//                 $emails = array('william.brandino@telecontrol.com.br.');
