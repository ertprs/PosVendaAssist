...
try {
    ...
    include dirname(__FILE__) . '/../../classes/Posvenda/Fabricas/_165/Extrato.php';
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro Geração de Extrato - Tecvoz")); // Titulo
     if ($env == 'producao' ) {
        $logClass->adicionaEmail("helpdesk@telecontrol.com.br");
        $logClass->adicionaEmail("alberico@tecvoz.com.br");
    } else {
    ...
    */
    ...
    $classExtratoTecvoz = new ExtratoTecvoz($classExtrato);
        ...
        try {
            ...
            */
            if($usa_lgr == true){
                 ...
                 * - LGR de Estoque
                 */
                $classExtratoTecvoz->LGRTecvoz($extrato,$posto,$fabrica);
            }
