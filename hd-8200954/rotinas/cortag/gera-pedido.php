...
try {
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro - Geração de Pedidos Cortag")); // Titulo

    if ($env == 'producao' ) {
        $logClass->adicionaEmail("helpdesk@telecontrol.com.br");
        $logClass->adicionaEmail("martins.ti@cortag.com.br");
    } else {
    ...
    */
    ...
    if(!empty($msg_erro)){
      ...
      $fp = fopen("/tmp/{$fabrica_nome}/pedidos/gera-pedido-".date("dmYH").".txt", "a");
