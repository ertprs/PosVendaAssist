...
try {
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro - Geração de Pedidos - Estoque Ibramed")); // Titulo
    $logClass->adicionaTituloEmail("Log erro - Geração de Pedidos - Estoque Ibramed"); // Titulo
    if ($env == 'producao' ) {
    ...
    * Resgata a condição da Fabrica
    */
    $tipo_pedido = $pedidoClass->getTipoPedidoGarantiaAntecipada();
    $array_posto = 0;
