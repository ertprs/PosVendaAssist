...
try {
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro Geração de Extrato Ibramed")); // Titulo
    ...
    */
    ...
    $classExtratoFabrica = new ExtratoIbramed($fabrica);
    ...
    */
    ...
    /**
    * Libera extrato automaticamente assim que é gerado | HD-7327725
    */
    ...
    */
    ...
    for ($i = 0; $i < count($os_posto); $i++) {
        ...
        try {
            ...
            */
            // if($usa_lgr == true){
                 $classExtratoFabrica->verificaLGR($extrato, $posto, $data_15);
            // }
