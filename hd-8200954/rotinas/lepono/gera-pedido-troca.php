...
try {
    ...
    $arquivo_err = "/tmp/milwaukee/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/milwaukee/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/milwaukee/ 2> /dev/null ; chmod 777 /tmp/milwaukee/" );
	...
	if ($logs_erro) {
		...
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS milwaukee", $logs_erro);
