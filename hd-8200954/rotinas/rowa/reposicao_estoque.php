...
try {
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro - Geração de Pedidos - Estoque Rowa")); // Titulo
    $logClass->adicionaTituloEmail("Log erro - Geração de Pedidos - Estoque Rowa"); // Titulo
    if ($env == 'producao' ) {
