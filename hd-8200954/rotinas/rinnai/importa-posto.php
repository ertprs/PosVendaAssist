...
try {
  ...
  list($codigo, $razao, $nome_fantasia, $cnpj, $ie, $endereco, $numero, $complemento, $bairro, $cep, $cidade, $estado, $email, $telefone, $fax, $contato, $interior_capital) = explode("\t",$linha);
		...
		system("mv $arquivo /tmp/$fabrica_nome/posvenda/posto-$data_arq_process.txt");
