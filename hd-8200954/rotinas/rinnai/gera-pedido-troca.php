...
try {
    ...
    $arquivo_err = "/tmp/rinnai/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/rinnai/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/rinnai/ 2> /dev/null ; chmod 777 /tmp/rinnai/" );
