...
try {
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro - Geração de Pedidos EINHELL")); // Titulo
    if ($env == 'producao' ) {
    ...
    */
                ...
                foreach ($pecas as $key => $peca) {
                    ...
                    */
                    ...
                    if($preco == '10000' or $preco == '0'){
                        ...
                        $emailPecaPeco->adicionaEmail("daniel.pereira@einhell.com");
                        $emailPecaPeco->adicionaEmail("luiz.munoz@einhell.com");
    ...
    if(!empty($msg_erro)){
        ...
        $fp = fopen("/tmp/{$fabrica_nome}/gera_pedido_erro.text", "a");
