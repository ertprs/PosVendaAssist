...
try {
    ...
    if (ENV == 'teste') {
        ...
        $diretorio_origem = '/home/einhell/einhell-telecontrol';
    }
    ...
    if (ENV == 'teste') {
        $arquivo = 'entrada/' . $arquivo_origem;
    }
    ...
    if (file_exists($arquivo) and (filesize($arquivo) > 0)) {
        ...
        foreach ($conteudo as $linha) {
            if (!empty($linha)) {
                list ($referencia, $descricao, $unidade, $origem_arq, $ipi,$ncm, $ativo, $multiplo, $bloqueada_garantia,$peca_critica) = explode ("\t",$linha);
                $original = array($referencia, $descricao, $unidade, $origem_arq, $ipi,$ncm, $ativo, $multiplo, $bloqueada_garantia,$peca_critica );
                ...
                $descricao = utf8_decode(strtim($descricao));
        ...
        if (filesize($arq_log) > 0) {
            ...
            if ($retorno == 0) {
                ...
                if (ENV == 'producao') {
                    $mail->AddAddress('daniel.pereira@einhell.com', 'luiz.munoz@einhell.com');
                } else {
