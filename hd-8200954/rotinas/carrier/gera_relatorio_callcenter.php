...
$sql = "
        SELECT  DISTINCT
                ...
                CASE
                    WHEN length(TPE.referencia) > 0
                    THEN TPE.referencia
                    ELSE TPI.referencia
                END                                                         AS referencia_produto,

                CASE
                    WHEN length(TPE.descricao) > 0
                    THEN TPE.descricao
                    ELSE TPI.descricao
                ...
                (
                    ...
                    FROM    (
                        ...
                        FROM    tbl_os,
                                ...
                                tbl_peca
                        WHERE   (
                                        tbl_os.os               IN (COALESCE(hi2.os, tbl_hd_chamado_extra.os))
   ...
   LEFT JOIN    tbl_hd_chamado_item hi2 ON hi2.hd_chamado = tbl_hd_chamado.hd_chamado
   ...
   LEFT JOIN    tbl_produto TPI         ON  TPI.produto                                 = hi2.produto
                                        AND TPI.fabrica_i                               = $fabrica
   ...
   LEFT JOIN    tbl_pedido_item         ON  tbl_pedido_item.pedido                      = tbl_hd_chamado_extra.pedido
                                        OR  (
                                                tbl_pedido_item.pedido                  = tbl_os_item.pedido
   ...
   LEFT JOIN    tbl_faturamento_item    ON  tbl_faturamento_item.pedido                 = tbl_hd_chamado_extra.pedido
                                        OR  (
   ...
   LEFT JOIN    tbl_faturamento         ON  tbl_faturamento.faturamento                 = tbl_faturamento_item.faturamento
        ...
        AND     (
                ...
                OR  tbl_hd_chamado.hd_chamado IN (
                        ...
                        AND     WHDI.data BETWEEN '$dataHoraInicial' and '$dataHoraFinal'
                ...
                OR  tbl_hd_chamado.hd_chamado IN (
                        ...
                        WHERE   HDID.hd_chamado     = tbl_hd_chamado.hd_chamado
                        AND     HDID.status_item    = 'Resolvido'
                        AND     HDID.data BETWEEN '$dataHoraInicial' and '$dataHoraFinal'
                    )
                )
       ";
...
//        $file = fopen("xls/{$fileName}", "w");
        $file = fopen("/home/carrier/{$fileName}","w");
