...
try {
    ...
    mail('maicon.luiz@telecontrol.com.br, waldir@telecontrol.com.br, guilherme.curcio@telecontrol.com.br', 'Exportação de OS Midea/Carrier - Erro na execução da rotina', $e->getMessage());
}
