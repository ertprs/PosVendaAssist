...
try {
	...
	if (ENV == 'prod' ) {
		...
		$vet['dest'][] 		= 'vanilde.sartorelli@wackerneuson.com';
    }else{
    	$vet['dest'] 		= 'guilherme.curcio@telecontrol.com.br';
    	$arquivo_err = "/tmp/wacker neuson/gera-pedido-troca-{$data_sistema}.err";
    	$arquivo_log = "/tmp/wacker neuson/gera-pedido-troca-{$data_sistema}.log";
    }
	...
	if ($logs_erro) {
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS wacker neuson", $logs_erro);
