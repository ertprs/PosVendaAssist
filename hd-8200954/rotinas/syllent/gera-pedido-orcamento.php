...
try {
    ...
    */
    ...
    include dirname(__FILE__) . '/../../classes/Posvenda/Fabricas/_195/Os.php';
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro - Geração de Pedidos Orçamentos Syllent")); // Titulo
    if ($env == 'producao' ) {
    ...
    */
    ...
    $osOrcamentoMq = new \Posvenda\Fabricas\_195\Os($fabrica);
    $os_garantia = $osOrcamentoMq->getOsOrcamento();
    ...
    */
    $condicao = $osOrcamentoMq->getCondicaoBoleto();

    /*
    * Resgata a condição da Fabrica
    */
    $tipo_pedido = $osOrcamentoMq->getTipoPedidoOrcamento();
    ...
    for ($i = 0; $i < count($os_garantia); $i++) {
        ...
        try {
            ...
            $tabela = $osOrcamentoMq->getTabelaVenda($os);
            /*
            * Begin
            */
            ...
            */
	        ...
	        //if(strtoupper($os_garantia[$i]["status_os"]) <> "PAGAMENTO CONFIRMADO") continue;
            ...
            $pecas = $osOrcamentoMq->getPecasPedidoOrcamento($os);
