<?php 
    try {
		...
		AND tbl_os.posto <> 6359
                    ...
                    AND tbl_os.data_digitacao::date < current_date - INTERVAL '60 days'
                            ...
                            $res_verifica = pg_query($con, $sql);
                             ...
                             if(pg_num_rows($res_verifica) == 0){
                                 $sql = "INSERT INTO tbl_os_status (
                                            ...
                                            $os,
                                            15,
                                            'Os excluida automaticamente por estar 60 dias em aberto sem peça',
                                            1020,
                                            true
                                        );";
                                    pg_query($con, $sql);
        ...
        if (strlen($bug) > 0) {
            Log::envia_email($vet, 'Log - Exclui OS aberta a mais de 60 dias', $bug);
        }
