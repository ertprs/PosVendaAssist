...
try{
	...
	if($total > 0){
		...
		for ($i=0; $i < $total; $i++) { 
			...
			// $vet['dest'][] = 'flavio.zequin@telecontrol.com.br';

			$titulo_email = "Audiência Processo $num_processo";
			...
			if ($data_audienciax1 == 1) {
				$msg = "<P align=left><STRONG>Nota: Este e-mail é gerado automaticamente. **** POR FAVOR NÃO RESPONDA ESTA MENSAGEM ****.</STRONG> </P>
									...
									A audiência 1 do processo $num_processo está marcada para o dia: $data_audiencia1.<br><br>
			...
			if ($data_audienciax2 == 1) {
				$msg = "<P align=left><STRONG>Nota: Este e-mail é gerado automaticamente. **** POR FAVOR NÃO RESPONDA ESTA MENSAGEM ****.</STRONG> </P>
									Prezado".$nome.",<br><br><br>
									A audiência 2 do processo $num_processo está marcada para o dia: $data_audiencia2.<br><br>
									Favor confirmar presença do preposto.";
				Log::envia_email($vet,$titulo_email,$msg);				
			}			
		}
