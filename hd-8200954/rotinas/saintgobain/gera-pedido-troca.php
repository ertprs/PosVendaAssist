...
try {
    ...
    $arquivo_err = "/tmp/saintgobain/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/saintgobain/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/saintgobain/ 2> /dev/null ; chmod 777 /tmp/saintgobain/" );
	...
	if ($logs_erro) {
		...
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS saintgobain", $logs_erro);
