	...
	if (file_exists($arquivo) and (filesize($arquivo) > 0)) {
		...
		foreach ($conteudo as $linha) {
			...
			if (!empty($linha)) {
				...
				Código Posto	Código de controle do fabricante, será o "login" do Posto Autorizado para acesso ao sistema
				Razão Social	Razão Social do Psoto Autorizado
				Fantasia	Nome Fantasia
				CNPJ	Conforme exemplo - Sem formatação
				IE	Conforme exemplo - Sem formatação
				...
				Contato	Importante para contato direto com o responsável NOME
