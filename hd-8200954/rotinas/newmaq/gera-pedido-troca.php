...
try {
    ...
    $arquivo_err = "/tmp/newmaq/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/newmaq/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/newmaq/ 2> /dev/null ; chmod 777 /tmp/newmaq/" );
	...
	if ($logs_erro) {
		...
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS NEWMAQ", $logs_erro);
