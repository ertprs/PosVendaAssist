...
try {
    ...
    $arquivo_err = "/tmp/ello/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/ello/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/ello/ 2> /dev/null ; chmod 777 /tmp/ello/" );
	...
	if ($logs_erro) {
		...
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS Ello", $logs_erro);
