...
try {
    ...
    $data['login_fabrica'] 	= 136;
    $data['fabrica_nome'] 	= 'ello';
    ...
    $sql = "SELECT
				...
				SELECT DISTINCT posto,os from tmp_pedido_ello ;
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - Ello - Erro na geração de pedido(gera-pedido.php)", $msg);
}?>
