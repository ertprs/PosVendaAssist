...
try {
    ...
    $arquivo_err = "/tmp/wurth/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/wurth/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/wurth/ 2> /dev/null ; chmod 777 /tmp/wurth/" );
	...
	if ($logs_erro) {
		...
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS wurth", $logs_erro);
