...
try {
	...
	/* Log */
    $log = new Log();
    $log->adicionaLog(array("titulo" => "Log erro Geração de Pedidos Hikari")); // Titulo
    ...
    $arquivo_err = "/tmp/hikari/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/hikari/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/hikari/ 2> /dev/null ; chmod 777 /tmp/hikari/" );
