<?php
	...
	*/
	$logClass = new Log2();
	$logClass->adicionaLog(array("titulo" => "Log erro Abastecimento de Estoque - Mondial")); // Titulo
	...
	if($postos_controlam_estoque != false){
		...
		foreach ($postos_controlam_estoque as $value) {
			...
			try{
				...
				$emails = array('rogerio.soares@mondialline.com.br', 'jefferson.nogueira@mondialline.com.br', 'arnaldo.furtado@mondialline.com.br');
