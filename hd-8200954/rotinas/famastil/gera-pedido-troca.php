...
try {
    ...
    $arquivo_err = "/tmp/famastil/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/famastil/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/famastil/ 2> /dev/null ; chmod 777 /tmp/famastil/" );
