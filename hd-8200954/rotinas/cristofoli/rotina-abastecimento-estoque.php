<?php
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro Abastecimento de Estoque - Cristófoli")); // Titulo
    ...
    if($postos_controlam_estoque != false){
        ...
        foreach ($postos_controlam_estoque as $value) {
            ...
            try{
                ...
                $emails = ($env == 'producao') ? array('informatica@cristofoli.com') : array('guilherme.silva@telecontrol.com.br');
