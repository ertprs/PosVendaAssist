...
$logClass = new Log2();
$logClass->adicionaLog(array("titulo" => "Log de erro rotina finaliza os 90 dias - ESAB"));

$logClass->adicionaEmail("helpdesk@telecontrol.com.br");

$oOs = new Posvenda\Fabricas\_152\Os($fabrica);
...
if(count($erro)){
    ...
    $fp = fopen("/tmp/esab/finaliza-os-90-dias-log-erro-".date('d-m-Y').".txt", "a");
