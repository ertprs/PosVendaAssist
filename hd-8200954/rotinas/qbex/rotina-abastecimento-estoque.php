<?php
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro Abastecimento de Estoque - Qbex")); // Titulo
    $logClass->adicionaEmail("fabio@qualyti.com.br");
    $msg_erro = "";
    ...
    if($postos_controlam_estoque != false){
        ...
        foreach ($postos_controlam_estoque as $value) {
            ...
            try{
                ...
                $emails = array('fabio@qualyti.com.br.');
