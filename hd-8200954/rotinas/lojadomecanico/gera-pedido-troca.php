...
try {
    ...
    */
    ...
    /*
    * A variavel $param define se o pedido vai ser por posto ou OS, sendo o padrão pedido por posto
    */
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro - Geração de Pedidos Loja do Mecanico")); // Titulo
    ...
    */
    ...
    if(!empty($msg_erro)){
        ...
        system("mkdir /tmp/{$fabrica_nome}/pedido-troca/ 2> /dev/null ; chmod 777 /tmp/{$fabrica_nome}/pedido-troca/" );

        $fp = fopen("tmp/{$fabrica_nome}/pedido-troca/gera-pedido-troca-".date("dmYH").".txt", "w");
