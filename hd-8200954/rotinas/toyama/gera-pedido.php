...
try {
    ...
    $sql = "SELECT  
				...
				SELECT DISTINCT posto,linha, sua_os from tmp_pedido_toyama ;
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - TOYAMA - Erro na geração de pedido(gera-pedido.php)", $msg);
}?>
