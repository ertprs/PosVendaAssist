...
try {
    ...
    $sql = "SELECT  
				...
				AND tbl_os_status.status_os IN (62,64,67,102,103,148,149,150,151,163, 98,161, 162)
				)
				...
				AND (tbl_os_status.status_os IN(64,103,149,151) OR tbl_os_status.status_os IS NULL);
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - NORDTECH - Erro na geração de pedido(gera-pedido.php)", $msg);
}?>
