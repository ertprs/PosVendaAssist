...
try {
    ...
    $data['login_fabrica'] 	= 121;
    $data['fabrica_nome'] 	= 'milwaukee';
    ...
    $sql = "SELECT  
						...
						tbl_os_item.qtde    ,
						tbl_os.sua_os       
						INTO TEMP tmp_pedido_milwaukee
				FROM    tbl_os_item
				...
				SELECT DISTINCT posto,linha from tmp_pedido_milwaukee ;
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - milwaukee - Erro na geração de pedido(gera-pedido.php)", $msg);
}?>
