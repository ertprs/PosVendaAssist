...
try {
	...
	$vet['fabrica'] = 'loyal';
	$vet['tipo']    = 'extrato';
	$vet['dest']    = 'francisco.ambrozio@telecontrol.com.br';
	$vet['log']     = 2;
	...
	if (strlen($bug) > 0) {
		...
		Log::envia_email($vet, 'Log - Extrato loyal', $bug);
	...
	Log::envia_email($data,Date('d/m/Y H:i:s')." - Loyal - Erro na geração de extrato(gera-extrato.php)", $e->getMessage());
