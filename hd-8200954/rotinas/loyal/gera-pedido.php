...
try {
    ...
    $data['login_fabrica'] 	= 132;
    $data['fabrica_nome'] 	= 'loyal';
	...
	if (ENV == 'producao' ) {
    	...
    	$data['dest'] = 'francisco.ambrozio@telecontrol.com.br';
    }
    ...
    $sql = "SELECT  
				...
				AND tbl_os_status.status_os IN (13,19,62,64,118,185)
				)
				...
				SELECT DISTINCT posto, linha from tmp_pedido_loyal ;
    ...
    Log::envia_email($data,Date('d/m/Y H:i:s')." - Loyal - Erro na geração de pedido(gera-pedido.php)", $msg);
}
