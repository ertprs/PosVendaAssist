...
try {
    ...
    $arquivo_err = "/tmp/dleletronicos/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/dleletronicos/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/dleletronicos/ 2> /dev/null ; chmod 777 /tmp/dleletronicos/" );
	...
	if ($logs_erro) {
		...
		Log::envia_email($vet, "Log de ERROS - Geração de Pedido de Troca de OS DL Eletronicos", $logs_erro);
