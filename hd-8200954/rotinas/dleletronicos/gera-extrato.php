...
try {
	...
	if (strlen($bug) > 0) {
		...
		Log::envia_email($vet, 'Log - Extrato dleletronicos', $bug);
	...
	Log::envia_email($data,Date('d/m/Y H:i:s')." - DL Eletronicos - Erro na geração de extrato(gera-extrato.php)", $e->getMessage());
