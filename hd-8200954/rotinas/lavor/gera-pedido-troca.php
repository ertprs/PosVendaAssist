...
try {
    ...
    $arquivo_err = "/tmp/lavor/gera-pedido-troca-{$data_sistema}.err";
    $arquivo_log = "/tmp/lavor/gera-pedido-troca-{$data_sistema}.log";
    system ("mkdir /tmp/lavor/ 2> /dev/null ; chmod 777 /tmp/lavor/" );
