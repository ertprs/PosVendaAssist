...
$arr = $routine->SelectRoutine("Abertura de Tickets com Erro Alta");
...
$arquivo_log = "/tmp/cockpit-atendimento-os-erro-alta-".date("YmdHi").".txt";
$arq_email = [];
...
try {
    ...
    $semHD   = $cockpit->getCockpitSemHD(true, false, true);
        ...
        if ($dados) {
            if ($debug) {
                ...
                $arq_email[$i] = ["os_kof"=>$dados['osKof'],
                                  ...
                                  "rotina"=>"cockpit-atendimento-os-erro-alta.php",
                                  "erros"=>[]
                                 ];
            }
            ...
            if (
                ...
                if ($debug) {
                    echo "localização encontrada, verificando compatibilidade da cidade e estado\n";
            ...
            if ($cockpit->verificaOsAgendada($json["hd_chamado_cockpit"]) == true) {
                if ($debug) {
                    echo "Atendimento já agendado, ignorando para evitar duplicidade...\n";
                }
                continue;
            }
