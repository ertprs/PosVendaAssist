...
$arr = $routine->SelectRoutine("Abertura de Tickets com Erro Baixa-Normal");
...
$arquivo_log = "/tmp/cockpit-atendimento-os-erro-baixa-".date("YmdHi").".txt";
$arq_email = [];
...
try {
    ...
    $semHD   = $cockpit->getCockpitSemHD(false, true, true);
        ...
        if ($dados) {
            if ($debug) {
                ...
                $arq_email[$i] = ["os_kof"=>$dados['osKof'],
                                  ...
                                  "rotina"=>"cockpit-atendimento-os-erro-baixa.php",
                                  "erros"=>[]
                                 ];
            }
    ...
    if ($debug) {
        ...
        flushLog();
        $routineSchedule->enviaEmail($fabrica,$arq_email,true);
