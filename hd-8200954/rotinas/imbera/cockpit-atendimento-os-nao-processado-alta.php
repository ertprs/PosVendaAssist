...
$arr = $routine->SelectRoutine("Abertura de Tickets não Processados Alta");
...
$arquivo_log = "/tmp/cockpit-atendimento-os-nao-processado-alta-".date("YmdHi").".txt";
$arq_email = [];
...
try {
    ...
    $semHD   = $cockpit->getCockpitSemHD(true, false, false);
        ...
        if ($dados) {
            if ($debug) {
                ...
                $arq_email[$i] = ["os_kof"=>$dados['osKof'],
                                  ...
                                  "rotina"=>"cockpit-atendimento-os-nao-processado-alta.php",
                                  "erros"=>[]
                                 ];
