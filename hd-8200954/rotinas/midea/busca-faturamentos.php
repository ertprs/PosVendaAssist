...
try {
    ...
    */
    ...
    $dataCorte = date('Y-m-d', strtotime('-90 days', strtotime($data)));
    ...
    */
	...
	AND p.data BETWEEN '{$dataCorte} 00:00' AND '2019-05-06 19:00';
    ";
    ...
    */
    ...
    for ($i = 0; $i < $countOrdens; $i++) {
	    ...
	    $osFabricaClass->flushLog(utf8_encode("Pesquisando os->$os posto->$posto"));
            ...
            $osFabricaClass->flushLog(utf8_encode("Faturamento encontrado iniciando inserção no Telecontrol -> $codigo_posto"));
		    ...
		    $doc_envio		= (int) $faturamentos['DOC_ENV'];
