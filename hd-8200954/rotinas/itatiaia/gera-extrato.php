...
try {
    ...
    */
    $logClass = new Log2();
    $logClass->adicionaLog(array("titulo" => "Log erro Geração de Extrato Itatiaia")); // Titulo
 ...
 #   $classExtrato->encontroContas(4126117);
#exit;
    ...
    for ($i = 0; $i < count($os_posto); $i++) {
        ...
        try {
            ...
            */
            ...
            /*
            * Calcula Encontro de Contas
            */
                //$classExtrato->encontroContas($extrato);
    ...
    */
    if(!empty($msg_erro)){
        ...
        $fp = fopen("/tmp/itatiaia/extrato/gera-extrato-".date("dmYH").".txt", "a");
