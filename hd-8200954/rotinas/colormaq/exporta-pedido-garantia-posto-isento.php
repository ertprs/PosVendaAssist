...
try{
	...
	$vet['tipo']    = 'exporta-pedido-garantia-posto-nao-isento';
	$vet['dest']    = array('otavio.arruda@telecontrol.com.br');
	$vet['log']     = 1;
    ...
    $conds = array(
        'ALL' => "WHERE peca_referencia <> '661.1.205'",
        'DF' => "WHERE peca_referencia = '661.1.205'",
        'AUT' => "WHERE linha = 545"
    );
    ...
    foreach ($conds as $idx => $cond) {
        ...
        if ($numrows) {
            ...
            switch ($idx) {
                case 'ALL':
                    $file_pedido_g = $dir.'/pedido_G_SIE.txt';
                    $file_pedido_item_g = $dir.'/item_G_SIE.txt';
                    $file_pedido_d = $dir.'/pedido_D_SIE.txt';
                    $file_pedido_item_d = $dir.'/item_D_SIE.txt';
                    ...
                    break;
                case 'DF':
                    $file_pedido_f = $dir.'/pedido_D_F_SIE.txt';
                    $file_pedido_item_f = $dir.'/item_D_F_SIE.txt';
                ...
                case 'AUT':
                    ...
                    $file_pedido_g_a = $dir.'/pedido_G_A_SIE.txt';
                    $file_pedido_item_g_a = $dir.'/item_G_A_SIE.txt';
                    $file_pedido_d_a = $dir.'/pedido_D_A_SIE.txt';
                    $file_pedido_item_d_a = $dir.'/item_D_A_SIE.txt';
            ...
            for ($i = 0; $i < $numrows; $i++) {
                ...
                if(!isset($posto_isento) || $posto_isento == 'f'){
                    continue;
                } 
            ...
            if (file_exists($file_pedido_g)) {
                ...
                $destino  = '/home/colormaq/telecontrol-'.$fabrica_nome.'/pedido_G_SIE-'.$data_arquivo.'.txt';
                $destino2 = '/home/colormaq/telecontrol-'.$fabrica_nome.'/item_G_SIE-'.$data_arquivo.'.txt';
            ...
            if(file_exists($file_pedido_d)){
                ...
                $destino  = '/home/colormaq/telecontrol-'.$fabrica_nome.'/pedido_D_SIE-'.$data_arquivo.'.txt';
                $destino2 = '/home/colormaq/telecontrol-'.$fabrica_nome.'/item_D_SIE-'.$data_arquivo.'.txt';
                $dirbkp   = '/home/colormaq/telecontrol-'.$fabrica_nome.'/bkp';
            ...
            if (file_exists($file_pedido_g_a)) {
                ...
                $destino  = '/home/colormaq/telecontrol-'.$fabrica_nome.'/pedido_G_A_SIE-'.$data_arquivo.'.txt';
                $destino2 = '/home/colormaq/telecontrol-'.$fabrica_nome.'/item_G_A_SIE-'.$data_arquivo.'.txt';
                $dirbkp   = '/home/colormaq/telecontrol-'.$fabrica_nome.'/bkp';
            ...
            if(file_exists($file_pedido_d_a)){
               ...
               $sql_pd = "UPDATE tbl_pedido
                ...
                $destino  = '/home/colormaq/telecontrol-'.$fabrica_nome.'/pedido_D_A_SIE-'.$data_arquivo.'.txt';
                $destino2 = '/home/colormaq/telecontrol-'.$fabrica_nome.'/item_D_A_SIE-'.$data_arquivo.'.txt';
                $dirbkp   = '/home/colormaq/telecontrol-'.$fabrica_nome.'/bkp';
            ...
            if(file_exists($file_pedido_f) and $arquivo_D_F){
                ...
                $destino  = '/home/colormaq/telecontrol-'.$fabrica_nome.'/pedido_D_F_SIE-'.$data_arquivo.'.txt';
                $destino2 = '/home/colormaq/telecontrol-'.$fabrica_nome.'/item_D_F_SIE-'.$data_arquivo.'.txt';
                $dirbkp   = '/home/colormaq/telecontrol-'.$fabrica_nome.'/bkp';
