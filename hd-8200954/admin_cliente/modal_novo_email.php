...
function sendSMS($celular, $codigo)
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://sms.comtele.com.br/api/0bbae429-b1c7-48d6-988c-5278ccb12705/sendmessage?sender=6154311&receivers=" . urlencode($celular) . "&content=" . urlencode($message),
