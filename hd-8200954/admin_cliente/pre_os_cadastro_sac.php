...
$mostra_mapa_rede = !in_array($login_fabrica, array(3,85,156,190));
					...
					for ($w=1;$w<=$qtde_produto;$w++) {
						...
						if (strlen($produto_referencia)>0) {
							...
							if(pg_numrows($res_ref)>0){
								...
								if($login_fabrica == 85){
									$msg_erro .= "Informe o modelo do produto <br>";
								}
							$xproduto = "null";
							}
							}else{
...
<tr>
	...
	<div id='div_consumidor' style='display:inline; Position:relative;background-color: #e6eef7;width:100%'>
		<table width='100%' border='0' align='center' cellpadding='2' cellspacing='2' style='border:#485989 1px solid; background-color: #e6eef7;font-size:11px;padding:10px;' id='tabela_consumidor'>
		<!--HD36903-->
		<?php if ($login_fabrica == 2) { ?>
		<tr>
		...
		<tr>
			...
			<td align='left'>
                ...
                <input name="consumidor_cpf" id="cpf" value='<? echo $consumidor_cpf ;?>' class="input_req" type="text" size="18" maxlength="<?=$limite?>" <?php
		...
		<tr>
			...
			<td align='left'>
				...
				<input name="consumidor_cep" id="cep" value="<? echo $consumidor_cep ;?>"  class="input_req" type="text" size="14" maxlength="9" <?php echo $endereco_readonly; ?> >
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align='left'>
                ...
                $estados_BR,
                $consumidor_estado,
                " style='width:81px; font-size:9px'", ' ', false
                ); ?>
			</td>
		</tr>
		...
		<? if($login_fabrica == 85){ ?>
			...
			<tr id="nome_fantasia">
				...
				<td colspan="4" align="left">
					<input name="nome_fantasia" value="<?=$nome_fantasia?>" class="input_req" spellcheck="true" type="text">
				</td>
			</tr>
		<? } ?>
		...
		<tr>
            ...
            echo array2select(
                ...
                $origens,
                $origem,
                "style='width:110px; font-size:9px'", ($login_fabrica == 3 ? '' : ' '), ($login_fabrica == 156)
            ); ?>
			</td>
	...
	<? }else{ ?>
		...
		<tr>
			...
			<td align="left"><input type="text" name="numero_controle" value=""></td>
	...
	<table width='100%' border='0' align='center' cellpadding="2" cellspacing="2" style=' border:#485989 1px solid; background-color: #e6eef7;font-size:11px;padding: 10px;margin-bottom: 10px;' name='tabela_itens' id='tabela_itens'>
		<tr>
	...
	<table width='100%' border='0' align='center' cellpadding="2" cellspacing="2" style=' border:#485989 1px solid; background-color: #e6eef7;font-size:11px;padding: 10px;margin-bottom: 10px;'>
		<tr>
	...
	<? } ?>
			<table width='100%' border='0' align='center' cellpadding="2" cellspacing="2" style=' border:#485989 1px solid; background-color: #e6eef7;font-size:11px;padding: 10px;'>
