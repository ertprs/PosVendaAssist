...
// HD 120306 - envia e-mail para o posto informando pre-OS cadastrada
				if($abre_os=='t'){
					...
					$message="<b>Nova Pré-OS cadastrada - Atendimento: $hd_chamado</b><br><br>";
					$message .= "<b> Favor dar continuidade no atendimento dessa Pré-OS.<br><br>";
					$message .= "<b> Atenciosamente<br><br>";
					$message .= "<b> SAC <br>";

					$headers = "From: Call-center <telecontrol@telecontrol.com.br>\n";
					$headers .= "Cc: waldir@telecontrol.com.br \n";
