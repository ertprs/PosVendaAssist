  ...
  return array(
        'secao0'     => array( // CALLCENTER
            ...
            array(
                ...
                'titulo'   => 'Cadastro Pré-atendimento',
                'descr'    => 'Cadastro de Atendimento para o Call-Center',
            ),
            array(
                'icone'   => $icone['consulta'],
                'link'    => 'consulta_atendimento_cliente_admin_contrato.php',
        ...
        'secao4' => array( 
            ...
            array(
                ...
                'titulo' => 'Consulta de Contratos',
                'descr'  => 'Consulta meus contratos',
            ),
            array('link' => 'linha_de_separação'),
        ),
        'secao5' => array( 
    ...
    'secao5' => array( // USUÁRIO
        ...
        array(
         ...
         array(
            'icone'  => $icone['consulta'],
            'link'   => 'consulta_atendimento_revenda.php',
            'titulo' => 'Consultar OS',
            'descr'  => 'Consulta Ordens de Serviço Lançadas',
        ),
        array(
            'icone'  => $icone['usuario'],
            'link'   => 'altera_senha_new.php',
            'titulo' => 'Alterar Senha',
            'descr'  => 'Permite alterar a senha do seu usuário no sistema'
        ),
        array('link' => 'linha_de_separação'),
