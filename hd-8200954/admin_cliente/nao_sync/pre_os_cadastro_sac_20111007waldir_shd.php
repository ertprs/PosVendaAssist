...
*/
	...
	$nome			= substr($_POST['nome'], 0 ,49);
	$cnpj				= $_POST['cnpj'];
	$ie				= $_POST['ie'];
	$email			= $_POST['email'];
	$telefone			= $_POST['telefone'];
	$cep				= $_POST['cep'];
	$endereco			= substr($_POST['endereco'], 0, 59);
	$numero			= $_POST['numero'];
...
function add_linha_bosch_security(linha2) {
	...
	var dados = "<tr>";
		...
		dados += "<td style='padding: 0; width: 160px'>";
			dados += "<select name='defeito_reclamado_"+linha+"' id='defeito_reclamado_"+linha+"' style='width: 155px;' class='frm' onfocus='atualizaDefeito(document.frm_callcenter.produto_"+linha+".value,"+linha+",'');'>";
				dados += "<option value='0' id='opcoes' > - selecione -</option>";
			dados += "</select>";
		dados += "</td>";
...
?>
	...
	<table width="700px" border="0" align="center" cellpadding="0" cellspacing="1" class='formulario'>
		...
		<tr>
			...
			<td>
				Número da NF<br>
				<input type="text" name="numero_nf" value="<?php echo $numero_nf?>" class='frm' style='width: 110px' maxlength='20' /> 
			</td>
			</td>
			<td colspan='3'>
