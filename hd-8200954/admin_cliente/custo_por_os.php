			...
			<div class='row-fluid'>
                ...
                <div class="span4">
                    <div class="control-group">
                        <label class='control-label' for='macro_linha'>Linha</label>
                        <div class='controls controls-row'>
                        <?
                            $sql = "SELECT 
...
?>
		<div class='row-fluid'>
			...
			<div class='span4'>
				<div class='control-group <?=(in_array("tipo_atendimento", $msg_erro["campos"])) ? "error" : ""?>'>
					<label class='control-label' for='Mes'>Tipo Atendimento</label>
					<div class='controls controls-row'>
						<div class='span4'>
							<h5 class='asteristico'>*</h5>
	...
	<br />
		<center>
			<input class="btn" type="submit" alt="Gerar Relatório" value="Gerar Relatório">
		</center>
	<br />
</form>
<br />
...
if (strlen($mes) > 0 && strlen($ano) > 0 && count($msg_erro) == 0)
{
			...
			if(pg_num_rows($res_graf))
			{
				...
				$(function () {
					$('#container-highcharts').highcharts({
						...
						title: {
							text: 'Custo total por tipo de OS'
						},
						tooltip: {
		...
		echo "	<table id='gridRelatorioPosto' class='table table-striped table-bordered table-hover table-fixed'>
				<thead>
					<tr class='titulo_coluna'>
						...
						<th nowrap>Média R$ </th>";

						if($login_fabrica == 40) echo "<th nowrap>Total R$</th>";
