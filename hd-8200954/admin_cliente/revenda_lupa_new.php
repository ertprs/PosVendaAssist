...
$usa_rev_fabrica = in_array($login_fabrica, array(3,24)); /*HD-3992758 Retirada a fábrica 15*/
			...
			<div class="span1"></div>
				<div class="span4">
					...
					<select name="parametro"  >
						...
						<option value="razao_social" <?=($parametro == "razao_social") ? "SELECTED" : ""?> >Razão Social</option>
					</select>
				</div>
				<div class="span4">
