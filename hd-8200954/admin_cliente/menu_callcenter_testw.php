...
<!--
	...
	<? if($login_fabrica==30){ ?>
		...
		<tr bgcolor='#f0f0f0'>
			<td width='25'><img src='imagens/marca25.gif'></td>
				<td nowrap width='260'><a href='chamados_alert_corrigir.php' class='menu'>Atendimentos não Integrados
			</a></td>
			<td class='descricao'>Verifica Atendimentos que não foram integrados ALERTxTELECONTROL</td>
		</tr>
		<?}?>
