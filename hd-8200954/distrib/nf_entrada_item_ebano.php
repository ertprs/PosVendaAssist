...
<tr bgcolor='#FF9933' style='color:#ffffff ; font-weight:bold'>
	...
	<td align='center' class='noprint'>Qtde Divergente</td>
</tr>
...
for ($i = 0 ; $i < pg_num_rows ($res) ; $i++) {
	...
	echo "<td align='left' nowrap><font size='3' class='Matricial'><b>$referencia</b></font></td>\n";
	echo "<td align='left' nowrap class='descricaoprint'>$descricao</td>\n";

	if ($qtde_estoque == 0) $qtde_estoque = "";
	if ($qtde_quebrada == 0) $qtde_quebrada = "";

	echo "<td align='right' nowrap><font size='3' class='qtdeimpressao'>$qtde</font></td>\n";
	echo "<td align='right' nowrap class='qtdeimpressao'><input type='text' name='qtde_estoque_$i'  value='$qtde_estoque' class='qtdeimpressao' id='qtde_estoque_$i' size='5'  maxlength='5' onblur='verificaQtde($peca,this,document.getElementById(\"qtde_quebrada_$i\"))'></td>\n";
	echo "<td align='right' nowrap><input type='text' name='localizacao_$i'   value='$localizacao'   size='10' maxlength='15'></td>\n";
	echo "<td align='right' nowrap class='noprint'><input type='text' name='qtde_quebrada_$i' value='$qtde_quebrada' size='5'  maxlength='5' id='qtde_quebrada_$i' onblur='verificaQtde($peca,document.getElementById(\"qtde_estoque_$i\"),this)'></td>\n";
	echo "</tr>\n";
}
