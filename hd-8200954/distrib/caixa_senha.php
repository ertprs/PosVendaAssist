...
if (isset($_POST['senha'])) {
	if (md5($_POST['senha']) != '7edccc661418aeb5761dbcdc06ad490c' or $_POST['acao'] != 'logar') {
		echo "<p>Sem permissão de acesso!</p>";
		exit;
	}
} else {?>
...
accept-charset="windows-1252" enctype="application/x-www-form-urlencoded">
	...
	<input type="password" accesskey="S" name="senha" class="frm">
    <button type="submit" title="Acessar" name="acao" value="logar">
     Acessar
    </button>
  </form>
</center>
