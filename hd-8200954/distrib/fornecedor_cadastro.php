		...
		if (pg_numrows ($res) > 0) {
			...
			if (strlen($msg_erro) == 0) {
				...
				if(pg_numrows($res) > 0){
					...
					// se nao estiver cadastrada, cadastra
...
function fnc_pesquisa_fornecedor(campo, tipo) {
	...
	if (xcampo.value != "") {
		...
		janela.estado		= document.frm_fornecedor.estado;
		janela.fone1		= document.frm_fornecedor.fone1;
		janela.fone2		= document.frm_fornecedor.fone2;
		janela.cnpj			= document.frm_fornecedor.revenda_cnpj;
		janela.ie			= document.frm_fornecedor.ie;
		janela.cep			= document.frm_fornecedor.cep;
...
<tr align='center'>
	<td>
		<font face='arial, verdana' color='#FF0000' size='-2'>
...
<tr class="table_line">
	...
	<td>
		<img src='../admin/imagens_admin/btn_buscar5.gif' style="cursor: pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_fornecedor (document.frm_fornecedor.revenda_cnpj,'cnpj')">
	</td>
	<td>
		<input type="text" name="ie" size="21" maxlength="20" value="<? echo $ie ?>" class="frm">
	</td>
	<td>
		<img src='../admin/imagens_admin/btn_buscar5.gif' style="cursor: pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_fornecedor (document.frm_fornecedor.ie,'ie')">
	</td>
	<td>
		<input type="text" name="nome" size="50" maxlength="50" value="<? echo $nome ?>" class="frm">&nbsp;<img src='../admin/imagens_admin/btn_buscar5.gif' style="cursor: pointer" border='0' align='absmiddle' onclick="javascript: fnc_pesquisa_fornecedor (document.frm_fornecedor.nome,'nome')">
	</td>
</tr>
</table>
<p>
...
<tr class="table_line">
	...
	<td>
		<input type="text" name="cep" size="10" maxlength="15" value="<? echo $cep ?>" class="frm" style="width:70px" >
	</td>
	<td>
...
<a href='#'><img src="../admin/imagens_admin/btn_gravar.gif" onclick="javascript: if (document.frm_fornecedor.btn_acao.value == '' ) { document.frm_fornecedor.btn_acao.value='gravar' ; document.frm_fornecedor.submit() } else { alert ('Aguarde submissão') }" ALT="Gravar formulário" border='0'></a>
<? //<a href='#'><img src="../admin/imagens_admin/btn_apagar.gif" onclick="javascript: if (document.frm_fornecedor.btn_descredenciar.value == '' ) { document.frm_fornecedor.btn_descredenciar.value='descredenciar' ; document.frm_fornecedor.submit() } else { alert ('Aguarde submissão') }" ALT="Descredenciar" border='0'></a> ?>
<a href='#'><img src="../admin/imagens_admin/btn_limpar.gif" onclick="javascript: if (document.frm_fornecedor.btn_acao.value == '' ) { document.frm_fornecedor.btn_acao.value='reset' ; window.location='<? echo $PHP_SELF ?>' } else { alert ('Aguarde submissão') }" ALT="Limpar campos" border='0'></a>
