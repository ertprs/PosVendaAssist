...
if($fabrica == 0)
    ...
    $sql = "SELECT tbl_peca.referencia, tbl_peca.descricao, x_pedido_$fabrica.*  FROM x_pedido_$fabrica JOIN tbl_peca USING (peca) ORDER BY x_pedido_$fabrica.dias30 DESC";
