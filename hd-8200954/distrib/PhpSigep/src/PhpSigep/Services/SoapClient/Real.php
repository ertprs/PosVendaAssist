...
class Real implements ServiceInterface
{
     ...
     * @return \PhpSigep\Services\Result<\PhpSigep\Model\FechaPlpVariosServicosRetorno>
     */
    public function fechaPlpVariosServicosImplantacao(\PhpSigep\Model\PreListaDePostagem $params)
    {
        $service = new ServiceImplementation\FecharPreListaDePostagemImplantacao();
        return $service->execute($params);
    }
