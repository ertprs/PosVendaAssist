...
$sql = "SELECT tbl_os.posto, 
			...
			UNION 
			select distinct distrib_lote, tbl_posto_fabrica.codigo_posto, tbl_posto.nome,tbl_posto_fabrica.banco, tbl_posto_fabrica.agencia,tbl_posto_fabrica.conta,
			0 as med_qtde_os,0 as med_qtde_pecas,0 as med_custo,extrato,0 as qtde_os,0 as mao_de_obra,0 as mobra_total, nota_fiscal_mo from tbl_extrato_lancamento
			...
			and distrib_lote = $lote
			order by distrib_lote, nome, extrato, nota_fiscal_mo;
	...
	for ($i = 0 ; $i < @pg_numrows ($res) ; $i++) {
		if ($i == pg_numrows ($res) ) $codigo_posto = "*";
			...
			$sql2 = "SELECT DISTINCT nf_mobra, to_char(data_nf_mobra,'dd/mm/yyyy') as data_nf_mobra, 
						...
						and tbl_extrato_lancamento.nota_fiscal_mo = tbl_distrib_lote_posto.nf_mobra 
						WHERE tbl_distrib_lote.distrib_lote = $lote AND tbl_posto_fabrica.codigo_posto = '$codigo_posto' AND tbl_distrib_lote_posto.nf_mobra = '$nota_fiscal_mo' ";
			...
			echo "<td align='right' title='$relacao_nome'><b>";
			...
			echo "<td align='right'>";
			echo "<div rel='nf_mobra' style='font-weight:bold'>";
			echo  $nota_mobra . "</div> - " ;
			echo "<div rel='data_nf_mobra' style='font-weight:bold'>";
