...
$sql = "SELECT distrib_lote, LPAD (lote,6,'0') AS lote, TO_CHAR (fechamento,'DD/MM/YYYY') AS fechamento
...
if (strlen ($distrib_lote) > 0) {
	...
	$res = pg_exec ($con,$sql);
//echo "sql: $sql";
	$sql = "SELECT LPAD (lote,6,'0') AS lote , TO_CHAR (fechamento,'DD/MM/YYYY') AS fechamento FROM tbl_distrib_lote WHERE distrib_lote = $distrib_lote";
