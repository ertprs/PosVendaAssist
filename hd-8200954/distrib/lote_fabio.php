...
<p align='center'>Escolha a fábrica <SELECT NAME="fabrica">
...
<tr>
	<td nowrap>
		Código Posto <input type='text' name='codigo_posto' size='10' onblur="javascript: ajax_posto (this.value, 'posto_nome' , document.frm_lote.posto, document.frm_lote.fabrica.value) " onfocus="javascript: nextfield='nf_mobra' " >
	</td>
